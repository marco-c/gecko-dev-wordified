...
(
"
enterprise_firefox_with_tests_tasks
"
)
def
target_tasks_enterprise_firefox_with_tests
...
def
target_tasks_geckoview_perftest
(
full_task_graph
parameters
graph_config
...
def
target_tasks_perftest_fenix_startup
(
full_task_graph
parameters
graph_config
...
def
retrigger_perftests_autoland_commits
(
full_task_graph
parameters
graph_config
...
def
target_tasks_android_l10n_sync_beta_to_release
(
...
def
target_tasks_test_info_timings_periodic
(
full_task_graph
parameters
graph_config
...
android
-
macrobenchmark_daily
"
)
def
target_tasks_android_macrobenchmark_daily
(
...
(
"
devtools_backward_compat
"
)
def
target_tasks_devtools_backward_compat
(
full_task_graph
parameters
graph_config
