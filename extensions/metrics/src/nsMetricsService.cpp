...
#
ifdef
NS_METRICS_SEND_UNCOMPRESSED_DATA
#
define
NS_METRICS_MIME_TYPE
"
application
/
vnd
...
newTopic
=
NS_METRICS_WEBNAVIGATION_DESTROY
;
}
else
{
newTopic
=
NS_METRICS_CHROME_WEBNAVIGATION_DESTROY
;
}
obsSvc
-
