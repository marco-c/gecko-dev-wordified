...
constexpr
char
kBrowserPermissionChangeNotification
[
]
=
...
-
>
SendRecordUserInteractionForPermissions
(
)
NS_ERROR_FAILURE
)
...
:
:
permissions_expireUnused_enabled
(
)
)
{
...
:
:
permissions_expireUnusedThresholdSec
(
)
)
*
