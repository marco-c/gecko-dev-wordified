...
;
const
SESSION_STORE_SAVED_TAB_GROUPS_TOPIC
=
"
sessionstore
-
...
externallyOpenedTabsNextToActiveTab
:
new
WeakSet
(
)
externallyOpenedTabsAtEndOfTabStrip
:
new
WeakSet
(
...
this
.
_onTabGroupExpandOrCollapseTask
=
new
lazy
.
