...
this
.
responseReadCallback
=
null
;
this
.
responseUnreadChunks
=
[
]
;
...
*
/
PPB_AudioConfig_CreateStereo16Bit
:
function
(
json
...
*
/
PPB_AudioInput_Dev_EnumerateDevices
:
function
(
json
...
*
/
PPB_BrowserFont_Trusted_GetFontFamilies
:
function
(
json
...
*
/
PPB_BrowserFont_Trusted_Create
:
function
(
json
...
*
/
PPB_BrowserFont_Trusted_Describe
:
function
(
json
...
*
/
PPB_BrowserFont_Trusted_DrawTextAt
:
function
(
json
...
*
/
PPB_BrowserFont_Trusted_MeasureText
:
function
(
json
...
*
/
PPB_CharSet_Dev_GetDefaultCharSet
:
function
(
json
...
*
/
PPB_CharSet_Dev_UTF16ToCharSet
:
function
(
json
...
*
/
PPB_CharSet_Dev_CharSetToUTF16
:
function
(
json
...
*
/
PPB_CursorControl_Dev_SetCursor
:
function
(
json
...
*
/
PPB_Find_Private_NumberOfFindResultsChanged
:
function
(
json
...
*
/
PPB_Find_Private_SelectedFindResultChanged
:
function
(
json
...
*
/
PPB_Flash_Clipboard_IsFormatAvailable
:
function
(
json
...
*
/
PPB_Flash_SetInstanceAlwaysOnTop
:
function
(
json
...
*
/
PPB_Flash_GetLocalTimeZoneOffset
:
function
(
json
...
*
/
PPB_Flash_File_ModuleLocal_OpenFile
:
function
(
json
...
*
/
PPB_Flash_File_ModuleLocal_RenameFile
:
function
(
json
...
*
/
PPB_Flash_File_ModuleLocal_DeleteFileOrDir
:
function
(
json
...
*
/
PPB_Flash_File_ModuleLocal_CreateDir
:
function
(
json
...
*
/
PPB_Flash_File_ModuleLocal_QueryFile
:
function
(
json
...
*
/
PPB_Flash_File_ModuleLocal_GetDirContents
:
function
(
json
...
*
/
PPB_Flash_File_ModuleLocal_CreateTemporaryFile
:
function
(
json
...
*
/
PPB_FlashFullscreen_IsFullscreen
:
function
(
json
...
*
/
PPB_FlashFullscreen_SetFullscreen
:
function
(
json
...
*
/
PPB_FlashFullscreen_GetScreenSize
:
function
(
json
...
*
/
PPB_InputEvent_RequestFilteringInputEvents
:
function
(
json
...
*
/
PPB_Instance_Private_GetWindowObject
:
function
(
json
...
*
/
PPB_Instance_Private_ExecuteScript
:
function
(
json
...
*
/
PPB_KeyboardInputEvent_IsKeyboardInputEvent
:
function
(
json
...
*
/
PPB_KeyboardInputEvent_GetKeyCode
:
function
(
json
...
*
/
PPB_KeyboardInputEvent_GetCharacterText
:
function
(
json
...
*
/
PPB_TextInput_Dev_SetTextInputType
:
function
(
json
...
*
/
PPB_TextInput_Dev_UpdateCaretPosition
:
function
(
json
...
*
/
PPB_IMEInputEvent_Dev_IsIMEInputEvent
:
function
(
json
...
*
/
PPB_IMEInputEvent_Dev_GetSegmentNumber
:
function
(
json
...
*
/
PPB_IMEInputEvent_Dev_GetTargetSegment
:
function
(
json
...
*
/
PPB_IMEInputEvent_Dev_GetSegmentOffset
:
function
(
json
...
*
/
PPB_IMEInputEvent_Dev_GetSelection
:
function
(
json
...
*
/
PPB_MouseInputEvent_IsMouseInputEvent
:
function
(
json
...
*
/
PPB_MouseInputEvent_GetPosition
:
function
(
json
...
*
/
PPB_MouseInputEvent_GetClickCount
:
function
(
json
...
*
/
PPB_MouseInputEvent_GetMovement
:
function
(
json
...
*
/
PPB_NetworkMonitor_UpdateNetworkList
:
function
(
json
...
*
/
PPB_OpenGLES2_BindRenderbuffer
:
function
(
json
...
*
/
PPB_OpenGLES2_BlendEquationSeparate
:
function
(
json
...
*
/
PPB_OpenGLES2_CheckFramebufferStatus
:
function
(
json
...
*
/
PPB_OpenGLES2_CopyTexSubImage2D
:
function
(
json
...
*
/
PPB_OpenGLES2_DeleteFramebuffers
:
function
(
json
...
*
/
PPB_OpenGLES2_DeleteRenderbuffers
:
function
(
json
...
*
/
PPB_OpenGLES2_DisableVertexAttribArray
:
function
(
json
...
*
/
PPB_OpenGLES2_EnableVertexAttribArray
:
function
(
json
...
*
/
PPB_OpenGLES2_FramebufferTexture2D
:
function
(
json
...
*
/
PPB_OpenGLES2_GenRenderbuffers
:
function
(
json
...
*
/
PPB_OpenGLES2_GetAttribLocation
:
function
(
json
...
*
/
PPB_OpenGLES2_GetShaderInfoLog
:
function
(
json
...
*
/
PPB_OpenGLES2_GetUniformLocation
:
function
(
json
...
*
/
PPB_OpenGLES2_ReleaseShaderCompiler
:
function
(
json
...
*
/
PPB_OpenGLES2_RenderbufferStorage
:
function
(
json
...
*
/
PPB_OpenGLES2_StencilFuncSeparate
:
function
(
json
...
*
/
PPB_OpenGLES2_StencilMaskSeparate
:
function
(
json
...
*
/
PPB_OpenGLES2_StencilOpSeparate
:
function
(
json
...
*
/
PPB_OpenGLES2_UniformMatrix3fv
:
function
(
json
...
*
/
PPB_OpenGLES2_VertexAttribPointer
:
function
(
json
...
*
/
PPB_OpenGLES2ChromiumMapSub_MapTexSubImage2DCHROMIUM
:
function
(
json
...
*
/
PPB_OpenGLES2ChromiumMapSub_UnmapTexSubImage2DCHROMIUM
:
function
(
json
...
*
/
PPB_PDF_GetFontFileWithFallback
:
function
(
json
...
*
/
PPB_TCPSocket_Private_GetLocalAddress
:
function
(
json
...
*
/
PPB_URLLoader_ReadResponseBody
:
function
(
json
...
*
/
PPB_URLLoaderTrusted_GrantUniversalAccess
:
function
(
json
...
*
/
PPB_URLResponseInfo_GetProperty
:
function
(
json
...
*
/
PPB_URLUtil_Dev_GetDocumentURL
:
function
(
json
...
*
/
PPB_URLUtil_Dev_GetPluginInstanceURL
:
function
(
json
...
*
/
PPB_Var_Deprecated_IsInstanceOf
:
function
(
json
...
*
/
PPB_Var_Deprecated_CreateObject
:
function
(
json
...
*
/
PPB_Var_Deprecated_GetProperty
:
function
(
json
...
*
/
PPB_VideoCapture_Dev_EnumerateDevices
:
function
(
json
...
*
/
PPB_WheelInputEvent_IsWheelInputEvent
:
function
(
json
...
*
/
PPB_WheelInputEvent_GetScrollByPage
:
function
(
json
