...
def
DefineInterfaceMethodSerializer
(
self
iface
releases
...
def
DefineTypedefSerializerAndParser
(
self
node
releases
...
def
DefineStructSerializerAndParser
(
self
node
releases
