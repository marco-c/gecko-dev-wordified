...
def
testContentScriptsAreCorrectlyPersisted
(
self
)
:
...
self
.
wait_until_webcompat_addon_is_ready
(
)
.
values
...
self
.
rebootWithInterventionsAndShims
(
{
}
[
...
self
.
nextRemoteSettingsUpdateVersion
=
9000
