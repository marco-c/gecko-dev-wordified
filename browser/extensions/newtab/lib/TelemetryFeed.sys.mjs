...
;
const
PREF_PRIVATE_PING_INFERRED_ENABLED
=
"
telemetry
.
...
;
const
TRAINHOP_PREF_DAILY_CLICK_EVENT_CAP
=
"
dailyClickEventCap
"
;
const
TRAINHOP_PREF_WEEKLY_CLICK_EVENT_CAP
=
"
weeklyClickEventCap
"
...
;
const
PRIVATE_PING_SURFACE_COUNTRY_MAP
=
{
/
/
...
get
privatePingInferredInterestsEnabled
(
)
{
return
...
/
get
trainhopOptimizeInferredEnabled
(
)
{
return
...
.
const
includeInferredInterestsInTelemetry
=
this
.
privatePingInferredInterestsEnabled
...
this
.
handleInlineSelectionUserEvent
(
action
)
;
...
this
.
handleTopicNavigationUserEvent
(
action
)
;
...
this
.
handleUnifiedWidgetContainerAction
(
action
)
;
