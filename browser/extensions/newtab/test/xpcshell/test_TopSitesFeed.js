...
.
const
CONTILE_CACHE_VALID_FOR_SECONDS_PREF
=
"
browser
.
...
async
function
test_getLinksWithDefaults_ranks_with_local_pref_fallback
(
)
{
let
...
async
function
test_getLinksWithDefaults_remote_false_skips_ranking
(
)
{
let
...
async
function
test_refresh_discards_stale_results
(
)
{
let
...
async
function
test_getLinksWithDefaults_with_DiscoveryStream
(
)
{
let
...
async
function
test_sponsored_tile_retained_when_default_search
(
)
{
/
...
async
function
test_filterBlockedSponsors_invalid_pref
(
)
{
info
...
async
function
test_readDefaults_invalid_blocked_sponsors_pref
(
)
{
info
...
async
function
test_saveGroupedPins_preserves_hole_pattern
(
)
{
let
...
async
function
test_pinSiteAtGrouped_growsRowWhenFullOfPins
(
)
{
let
...
async
function
test_pin_replacesLastFrecencyTileOnFullRow
(
)
{
let
...
async
function
test_pinSiteAtGrouped_clears_stale_custom_screenshot
(
)
{
let
...
async
function
test_fetchSites_callsAdsClientWhenEnabled
(
)
{
let
