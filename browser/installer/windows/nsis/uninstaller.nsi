...
net
/
Application_Association_Registration_plug
-
in
#
BitsUtils
...
un
.
LaunchAppForRefreshFromElevatedProcess
UAC
:
:
ExecCodeSegment
...
/
{
TELEMETRY_UNINSTALL_PING_NAMESPACE
}
/
5
/
{
TELEMETRY_UNINSTALL_PING_DOCTYPE
}
/
{
AppName
...
!
insertmacro
INSTALLOPTIONS_WRITE_UNCONVERT
"
ioSpecial
.
ini
