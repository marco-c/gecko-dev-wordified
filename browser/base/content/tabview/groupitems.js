...
this
.
_makeLastActiveGroupItemActive
(
)
;
}
...
:
function
GroupItem__makeClosestTabActive
(
)
{
let
...
(
function
GroupItem_arrange_children_each
(
child
i
)
...
:
function
GroupItem_expand_animate_complete
(
)
{
self
...
:
function
GroupItem_collapse_animate_complete
(
)
{
iQ
...
:
function
GroupItems__handleAttrModified
(
xulTab
)
{
...
:
function
GroupItem_getLastActiveGroupItem
(
)
{
return
...
:
function
GroupItems_getUnclosableGroupItemId
(
)
{
let
unclosableGroupItemId
=
null
;
if
...
:
function
GroupItems_updateGroupCloseButtons
(
)
{
let
