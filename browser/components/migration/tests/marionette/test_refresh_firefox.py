...
def
checkBookmarkToolbarVisibility
(
self
)
:
...
def
checkStartupMigrationStateCleared
(
self
)
:
...
class
TestSelectableProfileFirefoxRefresh
(
TestFirefoxRefresh
)
:
...
def
check_selectable_profile_service
(
self
)
:
