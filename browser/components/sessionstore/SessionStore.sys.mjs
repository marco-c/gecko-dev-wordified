...
;
const
NOTIFY_LAST_SESSION_RE_ENABLED
=
"
sessionstore
-
...
;
const
NOTIFY_SAVED_TAB_GROUPS_CHANGED
=
"
sessionstore
-
...
sessionstore
.
restore_windows_to_virtual_desktop
"
)
;
/
...
:
function
ss_getClosedTabCountFromClosedWindows
(
)
{
return
...
:
function
ss_getClosedTabDataFromClosedWindows
(
)
{
return
...
:
function
ss_undoClosedTabFromClosedWindow
(
aSource
aClosedId
aTargetWindow
...
*
/
forgetClosedTabGroup
:
function
ss_forgetClosedTabGroup
(
aSource
tabGroupId
)
...
this
.
_closedTabsFromAllWindowsEnabled
=
this
.
_prefBranch
...
this
.
_closedTabsFromClosedWindowsEnabled
=
this
.
_prefBranch
...
this
.
_collectSplitViewDataForTabGroup
(
tabGroup
.
tabs
...
:
function
ssi_getClosedWindowDataByClosedId
(
aClosedId
)
{
...
:
function
ssi_getClosedTabCountForWindow
(
aWindow
)
{
...
:
function
ssi_getClosedTabCountFromClosedWindows
(
)
{
const
...
:
function
ssi_getClosedTabDataFromClosedWindows
(
)
{
const
...
:
function
ssi_getStateForClosedTabsAndClosedGroupTabs
(
winData
aIndex
)
...
*
/
_getClosedTabStateFromUnifiedIndex
:
function
ssi_getClosedTabForUnifiedIndex
(
sourceWinData
tabState
)
...
:
function
ssi_undoClosedTabFromClosedWindow
(
aSource
aClosedId
aTargetWindow
...
this
.
_trimSavedTabGroupMetadataInClosedWindow
(
closedWinData
)
;
...
this
.
_createTabsForSavedOrClosedTabGroup
(
tabGroupData
targetWindow
)
...
this
.
_removeSavedTabGroupFromClosedWindow
(
closedWinData
tabGroupData
.
