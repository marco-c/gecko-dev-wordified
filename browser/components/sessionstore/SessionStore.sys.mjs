...
.
#
collectSplitViewDataForTabGroup
(
tabGroup
.
tabs
...
.
#
getStateForClosedTabsAndClosedGroupTabs
(
windowState
)
;
...
/
#
getClosedTabStateFromUnifiedIndex
(
sourceWinData
tabState
)
...
.
#
trimSavedTabGroupMetadataInClosedWindow
(
closedWinData
)
;
...
.
#
sendWindowRestoringNotification
(
aWindow
)
;
...
.
#
sendWindowRestoredNotification
(
resizedWindow
)
;
...
.
#
sendRestoreCompletedNotifications
(
)
;
}
...
.
#
createTabsForSavedOrClosedTabGroup
(
tabGroupData
targetWindow
)
...
.
#
removeSavedTabGroupFromClosedWindow
(
closedWinData
tabGroupData
.
