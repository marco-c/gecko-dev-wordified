...
async
function
test_auto_open_settings_toggle
(
)
{
await
...
async
function
test_auto_open_no_thanks_button_click
(
)
{
await
...
;
let
noThanksButtonEvents
=
Glean
.
shopping
.
surfaceNoThanksButtonClicked
.
testGetValue
(
)
...
async
function
test_auto_open_yes_keep_closed_button
(
)
{
await
...
;
let
yesKeepClosedButtonEvents
=
Glean
.
shopping
.
surfaceYesKeepClosedButtonClicked
.
testGetValue
(
)
