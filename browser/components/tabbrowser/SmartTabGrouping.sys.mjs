...
;
const
EXPECTED_TOPIC_MODEL_OBJECTS
=
6
;
const
EXPECTED_EMBEDDING_MODEL_OBJECTS
=
4
;
const
MAX_NON_SUMMARIZED_SEARCH_LENGTH
=
26
;
export
...
.
FIXED
pregroupedHandlingMethod
:
PREGROUPED_HANDLING_METHODS
.
EXCLUDE
pregroupedSilhouetteBoost
:
2
/
/
...
groupingResult
.
getRepresentativeDocsAndKeywords
(
otherGroupingResult
?
otherGroupingResult
