...
.
#
checkIfShouldTriggerTabSelectMessage
(
oldTab
newTab
)
...
.
#
updateMultiselectedTabCloseButtonTooltip
(
)
;
}
...
*
#
maybeRequestReplyFromRemoteContent
may
call
*
aEvent
