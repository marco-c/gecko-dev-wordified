...
.
#
updateOverflowPanelArrowOffset
(
)
;
/
...
.
#
addCustomizeTargetDragAndDropHandlers
(
target
)
;
...
/
#
removeCustomizeTargetDragAndDropHandlers
(
aTarget
)
{
...
case
"
customizationPaletteItemContextMenuAddToToolbar
"
:
this
.
...
case
"
customizationPaletteItemContextMenuAddToPanel
"
:
this
.
...
.
#
findVisiblePreviousSiblingNode
(
targetNode
.
lastElementChild
