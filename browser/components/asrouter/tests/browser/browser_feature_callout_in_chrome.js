...
async
function
triggered_feature_tour_with_advance_screens
(
)
{
let
...
async
function
newtab_feature_callout_does_not_appear_if_newtab_disabled
(
)
{
await
...
async
function
test_triggeredTabBookmark_selector
(
)
{
/
...
async
function
test_triggeredTabBookmark_selector_prefers_uri_match
(
)
{
/
...
async
function
test_triggeredTabBookmark_selector_fallback_overflow
(
)
{
/
...
async
function
test_reused_callout_dispatches_with_current_browser
(
)
{
const
...
async
function
test_triggerTab_selector_on_reused_callout
(
)
{
const
...
async
function
test_triggeredTabBookmark_selector_on_reused_callout
(
)
{
/
...
:
"
REUSED_CALLOUT_TRIGGERED_TAB_BOOKMARK
"
template
:
"
...
:
"
REUSED_CALLOUT_TRIGGERED_TAB_BOOKMARK_1
"
anchors
:
[
...
async
function
force_shown_feature_tour_advances_screens
(
)
{
const
