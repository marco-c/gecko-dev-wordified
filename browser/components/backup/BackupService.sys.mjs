...
;
const
SQLITE_ENCRYPTION_ENABLED_PREF_NAME
=
"
security
.
...
payload
.
intermediate_profile_creation_date
=
backupMetadata
.
...
BACKUP_STEPS
.
CREATE_BACKUP_CREATE_BACKUPS_FOLDER
;
/
/
First
...
BACKUP_STEPS
.
CREATE_BACKUP_CREATE_STAGING_FOLDER
;
let
stagingPath
=
...
BACKUP_STEPS
.
CREATE_BACKUP_FINALIZE_STAGING
;
renamedStagingPath
=
await
...
BACKUP_STEPS
.
CREATE_BACKUP_RESOLVE_DESTINATION
;
let
...
BACKUP_STEPS
.
CREATE_BACKUP_COMPRESS_STAGING
;
let
...
;
let
archiveSizeBytesNearestMebibyte
=
MeasurementUtils
.
fuzzByteSize
...
BACKUP_STEPS
.
CREATE_BACKUP_FINALIZE_ARCHIVE
;
let
archivePath
=
...
handled
in
maybeDeleteAndQuitCurrentSelectableProfile
.
try
{
lazy
...
RESTORE_STEPS
.
RESTORE_WRITE_POST_RECOVERY
;
try
{
postRecovery
.
backupServiceInternal
=
{
/
/
