...
;
const
PREF_MEMORIES_HAS_SEEN_MEMORIES
=
"
browser
.
...
;
const
MAX_SIDEBAR_STARTER_CACHE_KEYS
=
20
;
const
...
;
#
removeClientErrorListeners
=
null
;
#
swapDocShellsChromeWindow
=
null
;
#
...
;
#
hasModelChoiceOverride
=
false
;
#
isGeneratingResumeActivityConversation
=
false
;
get
...
.
#
resumeActivitiesToStarterPrompts
(
await
resumeStartersPromise
)
...
.
#
saveMemoriesToggleToConversation
(
event
.
detail
...
.
#
generateResumeActivityConversation
(
resumePrompt
)
.
...
.
#
getModelRequestLatencyAndDuration
(
requestStart
firstTokenTime
)
...
#
getConversationLastMessageAndCount
(
role
)
{
