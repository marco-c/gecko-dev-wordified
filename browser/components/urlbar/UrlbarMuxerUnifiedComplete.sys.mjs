...
results
.
globalSuggestedIndexResultSpan
:
0
/
/
...
.
let
globalSuggestedIndexAvailableSpan
=
Math
.
min
...
;
let
suggestedIndexAvailableSpan
=
0
;
let
suggestedIndexAvailableCount
=
0
;
if
