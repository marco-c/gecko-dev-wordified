...
case
"
placesCmd_setAsBookmarksToolbarFolder
"
:
if
(
...
:
function
PC__selectionOverlapsSystemArea
(
)
{
var
...
*
/
openSelectedNodeWithEvent
:
function
PC_openSelectedNodeWithEvent
(
aEvent
)
{
...
:
function
PC_showBookmarkPropertiesForSelection
(
)
{
var
...
(
new
PlacesRemoveSeparatorTransaction
(
asFolder
(
node
...
/
function
PlacesSetLoadInSidebarTransaction
(
aBookmarkId
aLoadInSidebar
)
...
/
function
PlacesEditFolderTitleTransaction
(
id
newTitle
)
