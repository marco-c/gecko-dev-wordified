...
__sessionContinueAtom
:
null
get
_sessionContinueAtom
(
)
{
if
...
_computeShowSessions
:
function
PTV__computeShowSessions
(
)
{
NS_ASSERT
...
:
1
SESSION_STATUS_CONTINUE
:
2
_getRowSessionStatus
:
function
PTV__getRowSessionStatus
(
aRow
)
{
...
*
/
_countVisibleRowsForItem
:
function
PTV__countVisibleRowsForItem
(
aNode
)
{
