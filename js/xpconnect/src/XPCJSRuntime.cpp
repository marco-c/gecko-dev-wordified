...
(
obj
eUseCounter_custom_JS_generatorFunctionCreated
)
;
return
;
...
(
obj
eUseCounter_custom_JS_asyncGeneratorFunctionCreated
)
;
return
;
...
(
obj
eUseCounter_custom_JS_generatorFunctionIonEligible
)
;
return
;
