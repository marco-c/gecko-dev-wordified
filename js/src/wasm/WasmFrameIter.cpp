...
:
:
funcbeginToUncheckedCallEntry_
.
/
/
(
...
;
Address
savedCurrentStackSlot
=
savedStackSlots
;
Address
savedBaseHandlersSlot
=
Address
(
savedStackSlots
