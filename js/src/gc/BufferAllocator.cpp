...
{
usedBytesInRetainedChunks
=
0
;
freeBytesInRetainedChunks
=
0
;
adminBytesInRetainedChunks
=
0
;
}
...
.
bool
hasNurseryOwnedSmallRegions
=
false
;
size_t
smallRegionBytesFreed
=
0
;
size_t
smallRegionBytesRetained
=
0
;
for
