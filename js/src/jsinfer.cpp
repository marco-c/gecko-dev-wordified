...
.
class
ConstraintDataFreezeObjectForGetterSetter
{
PropertyName
*
name
...
:
:
watchStateChangeForRedefinedProperty
(
CompilerConstraintList
*
constraints
...
:
:
maybeClearNewScriptAddendumOnOOM
(
)
{
if
