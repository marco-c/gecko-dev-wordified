...
Stencil
>
CreateInitialStencilAndDelazifications
(
FrontendContext
*
fc
...
static
bool
ConvertGlobalScriptStencilMaybeInstantiate
(
JSContext
*
maybeCx
...
input
.
initForGlobalWithExtraBindings
(
fc
maybeExtraBindings
)
