...
/
/
emitInitIndexOrComputedProp
emitInitIndexOrComputedGetter
/
/
emitInitIndexOrComputedSetter
emitMutateProto
or
emitSpread
.
...
field
.
initializer_contains_super_or_eval
(
)
)
{
