...
fn
get_context_param_for_optional
(
&
self
optional
...
#
define
FOR_EACH_BIN_FIELD_IN_INTERFACE_UNINITIALIZED
(
\
F
PRIMITIVE
...
const
size_t
BINAST_NUMBER_OF_FIELDS_IN_INTERFACE_
{
interface_macro_name
}
=
