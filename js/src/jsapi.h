...
#
define
JSID_DEFAULT_XML_NAMESPACE_TYPE
0x6
#
define
JSID_TYPE_MASK
...
friend
bool
SamePrimitiveTypeOrBothObjects
(
const
Value
&
...
{
return
JSVAL_SAME_PRIMITIVE_TYPE_OR_BOTH_OBJECTS_IMPL
(
lhs
.
data
