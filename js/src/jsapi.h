...
#
ifdef
JS_USE_JSVAL_JSID_STRUCT_TYPES
/
*
Well
-
...
JS_NewObjectWithGivenProtoAndType
(
JSContext
*
cx
...
JS_ConstructObjectWithArgumentsAndType
(
JSContext
*
cx
...
JSAutoByteString
(
JS_GUARD_OBJECT_NOTIFIER_PARAM0
)
:
mBytes
(
