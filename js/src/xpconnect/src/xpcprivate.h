...
#
define
XPC_REPORT_NATIVE_INTERFACE_AND_SET_FLUSHING
/
/
#
define
XPC_REPORT_JSCLASS_FLUSHING
/
/
#
define
...
inline
JSBool
GetDestroyJSContextInDestructor
(
)
const
;
...
=
=
mMostRecentJSContext
?
mMostRecentXPCContext
:
nsnull
;
}
...
#
define
DEFINE_AUTO_MARKING_ARRAY_PTR_TYPE
(
class_
type_
)
