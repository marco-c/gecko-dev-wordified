...
unsigned
globalSimdVarIndexToGlobalDataOffset
(
unsigned
i
)
...
void
*
globalScalarVarIndexToGlobalDatum
(
unsigned
i
)
...
void
*
globalSimdVarIndexToGlobalDatum
(
unsigned
i
)
