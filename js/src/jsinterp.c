...
void
js_FlushPropertyCacheForScript
(
JSContext
*
cx
...
if
(
JAVASCRIPT_FUNCTION_RVAL_ENABLED
(
)
)
jsdtrace_function_rval
(
cx
fp
fp
...
if
(
JAVASCRIPT_FUNCTION_INFO_ENABLED
(
)
)
jsdtrace_function_info
(
cx
fp
fp
...
if
(
JAVASCRIPT_FUNCTION_ARGS_ENABLED
(
)
)
jsdtrace_function_args
(
cx
fp
fun
