...
prototype
.
setHasSuperReferenceInFatArrowFunction
=
function
(
)
...
this
.
externallyVisibleImportedSymbols
=
[
]
;
...
prototype
.
AddExternallyVisibleImportedSymbol
=
function
(
symbol
...
;
var
classPropertiesMustComeAfterSuperCall
=
hasNonObjectBaseType
&
&
...
this
.
parsingClassConstructorDefinition
=
false
;
this
...
this
.
inferPropertiesFromThisAssignment
=
false
;
this
...
this
.
parseClassConstructorDeclaration
(
currentMemberMinChar
errorRecoverySet
modifiers
...
this
.
parseClassMemberFunctionDeclaration
(
id
currentMemberMinChar
errorRecoverySet
...
this
.
interveningWhitespace
=
false
;
this
.
interveningWhitespacePos
=
0
;
this
...
;
var
dualGlobalScopedAmbientEnclosedTypes
=
new
TypeScript
.
...
this
.
provisionalStartedTypecheckObjects
=
[
]
;
...
prototype
.
signatureGroupIsSubtypeOfTarget
=
function
(
sg1
...
this
.
signatureGroupIsRelatableToTarget
(
sg1
sg2
false
...
function
createNewConstructGroupForType
(
type
)
{
...
;
var
publicAmbientEnclosedTypesTable
=
(
publicEnclosedAmbientTypes
=
...
prototype
.
functionArgumentPrivacyErrorReporter
=
function
(
funcDecl
...
prototype
.
checkBaseTypeMemberInheritance
=
function
(
derivedType
...
prototype
.
getEnclosingScopeContextIfSingleScopeEdit
=
function
(
previousScript
...
prototype
.
canEmitTypeAnnotationSignature
=
function
(
declFlag
