...
lineNumber
"
ImportEntryObject_lineNumberGetter
0
)
JS_PSG
(
...
columnNumber
"
ImportEntryObject_columnNumberGetter
0
)
JS_PS_END
}
...
exportName
"
ExportEntryObject_exportNameGetter
0
)
JS_PSG
(
...
moduleRequest
"
ExportEntryObject_moduleRequestGetter
0
)
JS_PSG
(
...
localName
"
ExportEntryObject_localNameGetter
0
)
JS_PSG
(
...
lineNumber
"
ExportEntryObject_lineNumberGetter
0
)
JS_PSG
(
...
moduleRequest
"
RequestedModuleObject_moduleRequestGetter
0
)
JS_PSG
(
...
lineNumber
"
RequestedModuleObject_lineNumberGetter
0
)
JS_PSG
(
...
columnNumber
"
RequestedModuleObject_columnNumberGetter
0
)
JS_PS_END
}
...
specifier
"
ModuleRequestObject_specifierGetter
0
)
JS_PS_END
}
...
evaluationError
"
ModuleObject_evaluationErrorGetter
0
)
JS_PSG
(
...
localExportEntries
"
ModuleObject_localExportEntriesGetter
0
)
JS_PSG
(
...
indirectExportEntries
"
ModuleObject_indirectExportEntriesGetter
0
)
JS_PSG
(
...
starExportEntries
"
ModuleObject_starExportEntriesGetter
0
)
JS_PSG
(
...
dfsAncestorIndex
"
ModuleObject_dfsAncestorIndexGetter
0
)
JS_PSG
(
...
topLevelCapability
"
ModuleObject_topLevelCapabilityGetter
0
)
JS_PSG
(
...
asyncEvaluatingPostOrder
"
ModuleObject_asyncEvaluatingPostOrderGetter
0
)
JS_PSG
(
...
asyncParentModules
"
ModuleObject_asyncParentModulesGetter
0
)
JS_PSG
(
...
pendingAsyncDependencies
"
ModuleObject_pendingAsyncDependenciesGetter
0
)
JS_PS_END
}
...
;
bool
FinishDynamicModuleImport_impl
(
JSContext
*
cx
...
*
xdr
MutableHandleModuleRequestObject
moduleRequestObj
bool
allowNullSpecifier
)
...
*
xdr
MutableHandleImportEntryObject
impObj
)
{
JSContext
