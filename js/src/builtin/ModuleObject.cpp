...
module
"
ResolvedBindingObject_moduleGetter
0
)
JS_PSG
(
...
bindingName
"
ResolvedBindingObject_bindingNameGetter
0
)
JS_PS_END
}
...
:
:
getOrCreateResolvedBindingPrototype
(
cx
cx
-
...
assertions
"
ModuleRequestObject_assertionsGetter
0
)
JS_PS_END
}
