...
JSObject
*
NewStringInterruptCallbackGlobal
(
JSContext
*
cx
...
static
bool
RegisterScriptPathWithModuleLoader
(
JSContext
*
cx
...
(
"
AccumulateTelemetrySamplesCallback
"
)
;
}
...
static
bool
ConvertTranscodeResultToJSException
(
JSContext
*
cx
...
static
bool
InvokeInterruptCallbackWrapper
(
JSContext
*
cx
...
static
bool
CompileAndSerializeInSeparateProcess
(
JSContext
*
cx
...
static
void
PrintProfilerTerminatingFlow_Callback
(
mozilla
:
:
...
const
JSClass
TransplantableProxyObjectClass
=
PROXY_CLASS_DEF
(
"
TransplantableProxyObject
"
JSCLASS_HAS_RESERVED_SLOTS
(
SwappableProxyReservedSlots
...
const
JSClass
SideEffectfulResolveObject_class
=
{
"
...
static
bool
PrintExtraGlobalEnumeratedHelp
(
JSContext
*
cx
...
static
bool
DefineStringInterruptCallbackGlobalFunctions
(
JSContext
*
cx
...
-
>
setOffthreadBaselineCompilationEnabled
(
offthreadBaselineCompilation
)
;
...
:
:
setAtStartup_extra_gc_poisoning
(
false
)
;
...
:
:
setAtStartup_experimental_atomics_pause
(
true
)
;
...
:
:
setAtStartup_experimental_joint_iteration
(
true
)
;
...
:
:
setAtStartup_experimental_legacy_regexp
(
true
)
;
...
:
:
setAtStartup_experimental_intl_locale_info
(
true
)
;
...
:
:
setAtStartup_experimental_iterator_includes
(
true
)
;
...
:
:
setAtStartup_experimental_iterator_join
(
true
)
;
...
:
:
setAtStartup_experimental_iterator_chunking
(
true
)
;
...
:
:
setAtStartup_experimental_async_iterator_helpers
(
true
)
;
...
:
:
setAtStartup_experimental_iterator_sequencing
(
true
)
;
...
:
:
setAtStartup_experimental_iterator_range
(
true
)
;
...
:
:
setAtStartup_experimental_arraybuffer_immutable
(
true
)
;
...
:
:
setAtStartup_experimental_import_bytes
(
true
)
;
...
:
:
setAtStartup_experimental_promise_allkeyed
(
true
)
;
...
:
:
setAtStartup_experimental_error_stack_trace_limit
(
true
)
;
...
:
:
setAtStartup_experimental_regexp_buffer_boundaries
(
true
)
;
...
:
:
setAtStartup_experimental_temporal
(
true
)
;
...
:
:
setAtStartup_property_error_message_fix
(
false
)
;
...
:
:
setAtStartup_wasm_disable_huge_memory
(
true
)
;
...
options
.
content_process_write_protect_code
#
if
!
defined
