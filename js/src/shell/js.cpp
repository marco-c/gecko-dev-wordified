...
static
bool
MaybeRunFinalizationRegistryCleanupTasks
(
JSContext
*
cx
...
:
:
set_experimental_shadow_realms
(
true
)
;
...
:
:
setAtStartup_well_formed_unicode_strings
(
false
)
;
...
:
:
setAtStartup_experimental_arraybuffer_resizable
(
true
)
;
...
:
:
setAtStartup_experimental_sharedarraybuffer_growable
(
true
)
;
...
:
:
setAtStartup_experimental_regexp_duplicate_named_groups
(
true
)
;
...
:
:
setAtStartup_experimental_float16array
(
true
)
;
...
:
:
setAtStartup_experimental_new_set_methods
(
true
)
;
...
:
:
setAtStartup_experimental_regexp_modifiers
(
true
)
;
...
:
:
setAtStartup_experimental_uint8array_base64
(
true
)
;
...
:
:
setAtStartup_experimental_regexp_escape
(
true
)
;
...
:
:
setAtStartup_experimental_promise_try
(
true
)
;
...
:
:
setAtStartup_experimental_math_sumprecise
(
true
)
;
...
:
:
setAtStartup_experimental_upsert
(
true
)
;
...
:
:
setAtStartup_destructuring_fuse
(
false
)
;
