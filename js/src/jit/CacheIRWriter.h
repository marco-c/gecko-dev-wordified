...
;
ObjOperandId
savedScriptedGetterSetterCallee_
;
/
/
Basic
...
(
!
hasSavedScriptedGetterSetterCallee
(
)
)
;
...
;
callScriptedProxyGetByValueResult_
(
target
receiver
handler
