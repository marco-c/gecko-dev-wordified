...
SystemAllocPolicy
>
monomorphicInlineHints_
;
bool
monomorphicInlineHintsComputed_
=
false
;
/
...
static
bool
ShouldSetInliningStateFromJitHints
(
ICFallbackStub
*
fallbackStub
...
reader
.
argsForCallRegExpMatcherResult
(
)
;
/
...
reader
.
argsForCallRegExpSearcherResult
(
)
;
/
...
reader
.
argsForRegExpBuiltinExecMatchResult
(
)
;
/
...
reader
.
argsForRegExpBuiltinExecTestResult
(
)
;
/
...
reader
.
argsForGuardMultipleShapesToOffset
(
)
;
JSObject
