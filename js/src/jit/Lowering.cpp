...
(
MGuardBoundFunctionIsConstructor
*
ins
)
{
...
LIsSuspendedGeneratorAndBranch
(
ifTrue
ifFalse
useRegister
...
LStrictConstantCompareInt32AndBranch
(
ifTrue
ifFalse
useBoxAtStart
...
-
>
isStrictConstantCompareBoolean
(
)
&
&
...
-
>
toStrictConstantCompareBoolean
(
)
;
auto
...
LStrictConstantCompareBooleanAndBranch
(
ifTrue
ifFalse
useBoxAtStart
...
-
>
toIteratorsMatchAndHaveIndices
(
)
-
>
...
;
LIteratorsMatchAndHaveIndicesAndBranch
*
lir
=
new
...
:
:
visitStrictConstantCompareString
(
MStrictConstantCompareString
*
ins
)
{
...
:
:
visitStrictConstantCompareObject
(
MStrictConstantCompareObject
*
ins
)
{
...
:
:
visitBuiltinInt64ToFloatingPoint
(
...
:
:
visitWasmBuiltinTruncateToInt64
(
...
(
MFromCharCodeUndefinedIfNegative
*
ins
)
{
...
:
:
visitWasmBuiltinTruncateToInt32
(
...
(
MNewClassBodyEnvironmentObject
*
ins
)
{
...
:
:
visitLoadDynamicSlotFromOffset
(
MLoadDynamicSlotFromOffset
*
ins
)
{
...
:
:
visitGuardTypedArraySetOffset
(
MGuardTypedArraySetOffset
*
ins
)
{
...
:
:
visitTypedArraySetFromSubarray
(
MTypedArraySetFromSubarray
*
ins
)
{
...
:
:
visitObjectKeysFromIterator
(
MObjectKeysFromIterator
*
ins
)
{
...
:
:
visitLoadFixedSlotFromOffset
(
MLoadFixedSlotFromOffset
*
ins
)
{
...
LAddAndStoreSlotPreserveWrapper
(
useRegister
(
ins
...
:
:
visitStoreFixedSlotFromOffset
(
MStoreFixedSlotFromOffset
*
ins
)
{
...
:
:
visitStoreDynamicSlotFromOffset
(
MStoreDynamicSlotFromOffset
*
ins
)
{
...
:
:
visitGuardShapeListToOffset
(
MGuardShapeListToOffset
*
ins
)
{
...
:
:
visitGuardMultipleShapesToOffset
(
MGuardMultipleShapesToOffset
*
ins
)
{
...
:
:
visitLoadSlotByIteratorIndexIndexed
(
...
LLoadSlotByIteratorIndexIndexed
(
useRegister
(
ins
...
:
:
visitStoreSlotByIteratorIndexIndexed
(
...
LStoreSlotByIteratorIndexIndexed
(
useRegister
(
ins
...
:
:
visitIteratorsMatchAndHaveIndices
(
...
:
:
visitLoadIteratorElement
(
MLoadIteratorElement
*
ins
)
{
...
:
:
visitIsResumingGenerator
(
MIsResumingGenerator
*
ins
)
{
...
:
:
visitAssertResumeKindIsNext
(
MAssertResumeKindIsNext
*
ins
)
{
...
:
:
visitClearResumingGeneratorFlag
(
MClearResumingGeneratorFlag
*
ins
...
:
:
visitIsSuspendedGenerator
(
MIsSuspendedGenerator
*
ins
)
{
...
LWasmBoundsCheckInstanceField64
(
useRegister
(
lengthFromInstance
...
:
:
visitWasmLoadInstanceDataField
(
...
:
:
visitWasmLoadInstanceScratch2xI32
(
MWasmLoadInstanceScratch2xI32
*
ins
)
{
...
:
:
visitWasmStoreInstanceDataField
(
...
:
:
visitWasmStoreInstanceScratch2xI32
(
MWasmStoreInstanceScratch2xI32
*
ins
)
{
...
ifndef
JS_64BIT
LWasmStoreInstanceScratch2xI32
*
lir
=
new
...
:
:
visitLoadGetterSetterFunction
(
MLoadGetterSetterFunction
*
ins
)
{
...
(
MDateMinutesFromSecondsIntoYear
*
ins
)
{
...
(
MDateSecondsFromSecondsIntoYear
*
ins
)
{
