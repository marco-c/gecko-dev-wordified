...
-
>
isWasmGcObjectIsSubtypeOfAbstract
(
)
&
&
...
-
>
toWasmGcObjectIsSubtypeOfAbstract
(
)
;
LAllocation
...
As
in
visitWasmGcObjectIsSubtypeOfAbstract
we
know
we
do
...
LWasmGcObjectIsSubtypeOfAbstractAndBranch
(
ifTrue
ifFalse
isSubTypeOf
...
-
>
isWasmGcObjectIsSubtypeOfConcrete
(
)
&
&
...
-
>
toWasmGcObjectIsSubtypeOfConcrete
(
)
;
LAllocation
...
As
in
visitWasmGcObjectIsSubtypeOfConcrete
we
know
we
need
...
:
:
visitCharCodeAtMaybeOutOfBounds
(
...
:
:
visitCharAtMaybeOutOfBounds
(
MCharAtMaybeOutOfBounds
*
ins
)
{
...
:
:
visitWasmPostWriteBarrier
(
MWasmPostWriteBarrier
*
ins
)
{
LWasmPostWriteBarrier
*
lir
=
new
...
LWasmGcObjectIsSubtypeOfAbstract
(
object
scratch1
)
...
LWasmGcObjectIsSubtypeOfConcrete
(
object
superSuperTypeVector
scratch1
