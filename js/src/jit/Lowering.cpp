...
:
:
visitWasmExceptionDataPointer
(
MWasmExceptionDataPointer
*
ins
)
{
...
:
:
visitWasmLoadExceptionDataValue
(
MWasmLoadExceptionDataValue
*
ins
)
{
...
:
:
visitWasmStoreExceptionDataValue
(
MWasmStoreExceptionDataValue
*
ins
)
{
...
:
:
visitWasmExceptionRefsPointer
(
MWasmExceptionRefsPointer
*
ins
)
{
...
:
:
visitWasmLoadExceptionRefsValue
(
MWasmLoadExceptionRefsValue
*
ins
)
{
