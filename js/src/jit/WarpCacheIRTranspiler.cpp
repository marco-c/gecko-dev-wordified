...
bool
emitBigIntBinaryArithEffectfulResult
(
BigIntOperandId
lhsId
BigIntOperandId
...
bool
updateCallInfoForInlinedBoundCall
(
MDefinition
*
callee
...
:
:
emitGuardMultipleShapesToOffset
(
ObjOperandId
objId
uint32_t
...
:
:
emitMegamorphicLoadSlotPermissiveResult
(
ObjOperandId
objId
uint32_t
...
:
:
emitSmallObjectVariableKeyHasOwnResult
(
StringOperandId
idId
uint32_t
...
:
:
emitGuardIsResizableTypedArray
(
ObjOperandId
objId
)
...
:
:
emitLoadDynamicSlotFromOffsetResult
(
ObjOperandId
objId
Int32OperandId
...
:
:
emitGuardFunctionIsConstructor
(
ObjOperandId
funId
)
...
:
:
emitCheckWeakValueResultForFixedSlot
(
ObjOperandId
objId
uint32_t
...
:
:
emitCheckWeakValueResultForDynamicSlot
(
ObjOperandId
objId
uint32_t
...
:
:
emitStoreDynamicSlotFromOffset
(
ObjOperandId
objId
Int32OperandId
...
:
:
emitGuardIsNotUninitializedLexical
(
ValOperandId
valId
)
...
:
:
emitLoadArgumentsObjectArgHoleResult
(
ObjOperandId
objId
Int32OperandId
...
:
:
emitLoadArgumentsObjectArgExistsResult
(
ObjOperandId
objId
Int32OperandId
...
:
:
emitArrayFromArgumentsObjectResult
(
ObjOperandId
objId
uint32_t
...
:
:
emitLoadArrayBufferByteLengthInt32Result
(
ObjOperandId
objId
)
...
:
:
emitLoadArrayBufferByteLengthDoubleResult
(
ObjOperandId
objId
)
...
:
:
emitCallNativeGetElementSuperResult
(
ObjOperandId
objId
Int32OperandId
...
:
:
emitLoadTypedArrayElementExistsResult
(
ObjOperandId
objId
IntPtrOperandId
...
:
:
emitLinearizeForCodePointAccess
(
StringOperandId
strId
Int32OperandId
...
:
:
emitNewMapObjectFromIterableResult
(
uint32_t
templateObjectOffset
ValOperandId
...
:
:
emitNewSetObjectFromIterableResult
(
uint32_t
templateObjectOffset
ValOperandId
...
:
:
emitCompareDoubleSameValueResult
(
NumberOperandId
lhsId
NumberOperandId
...
:
:
emitIndirectTruncateInt32Result
(
Int32OperandId
valId
)
...
:
:
emitRegExpSearcherLastLimitResult
(
)
{
auto
...
:
:
emitIsSuspendedGeneratorResult
(
ObjOperandId
objId
)
...
:
:
emitResizableTypedArrayLengthInt32Result
(
ObjOperandId
objId
)
...
:
:
emitResizableTypedArrayLengthDoubleResult
(
ObjOperandId
objId
)
...
:
:
emitTypedArrayByteLengthInt32Result
(
ObjOperandId
objId
)
...
:
:
emitResizableDataViewByteLengthInt32Result
(
ObjOperandId
objId
)
...
:
:
emitResizableDataViewByteLengthDoubleResult
(
ObjOperandId
objId
)
...
:
:
emitGrowableSharedArrayBufferByteLengthInt32Result
(
ObjOperandId
objId
)
...
:
:
emitGrowableSharedArrayBufferByteLengthDoubleResult
(
ObjOperandId
objId
)
...
:
:
emitGuardHasAttachedArrayBuffer
(
ObjOperandId
objId
)
...
:
:
emitGuardResizableArrayBufferViewInBounds
(
ObjOperandId
objId
)
...
:
:
emitDateHoursFromSecondsIntoYearResult
(
ValOperandId
secondsIntoYearId
)
...
:
:
emitDateMinutesFromSecondsIntoYearResult
(
ValOperandId
secondsIntoYearId
)
...
:
:
emitDateSecondsFromSecondsIntoYearResult
(
ValOperandId
secondsIntoYearId
)
