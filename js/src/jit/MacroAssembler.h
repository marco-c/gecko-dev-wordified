...
inline
void
pushGeneratorResumeArgsAndFormals
(
const
Address
&
...
;
void
branchTestObjShapeListSetOffset
(
Register
obj
Register
...
;
void
extractIndexAndKindFromIteratorByIterIndex
(
Register
iterator
Register
