...
uint32_t
>
megamorphicLoadStubPermissiveOffset_
{
0
}
;
...
;
void
generateIonGenericHandleUnderflow
(
MacroAssembler
&
masm
...
;
void
generateMegamorphicLoadStubPermissive
(
MacroAssembler
&
masm
...
constexpr
size_t
MegamorphicLoadStubCacheHitGetter
=
2
;
JitCode
