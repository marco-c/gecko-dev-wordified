...
-
>
isGetElem_NativePrototypeCallNative
(
)
|
|
...
-
>
isGetElem_NativePrototypeCallScripted
(
)
)
;
...
static
bool
TryAttachNativeDoesNotExistStub
(
JSContext
*
cx
...
static
bool
TryAttachUnboxedExpandoSetPropStub
(
JSContext
*
cx
