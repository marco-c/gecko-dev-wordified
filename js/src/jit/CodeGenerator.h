...
;
void
visitLoadSlotByIteratorIndexCommon
(
Register
object
Register
...
;
void
visitStoreSlotByIteratorIndexCommon
(
Register
object
Register
...
;
using
AddressOrBaseObjectElementIndex
=
mozilla
:
:
...
static
AddressOrBaseObjectElementIndex
ToAddressOrBaseObjectElementIndex
(
Register
elements
const
...
;
void
emitIteratorHasIndicesAndBranch
(
Register
iterator
Register
...
on
the
HasSeenArrayExceedsInt32Length
fuse
.
bool
