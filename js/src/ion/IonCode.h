...
;
uint32_t
parallelInvalidatedScriptEntries_
;
/
/
Number
...
scriptEntries
size_t
parallelInvalidatedScriptEntries
)
;
static
void
...
RawScript
getAndZeroParallelInvalidatedScript
(
uint32_t
i
)
...
;
void
zeroParallelInvalidatedScripts
(
)
;
bool
