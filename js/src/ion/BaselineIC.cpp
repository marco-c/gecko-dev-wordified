...
propStub
=
toGetProp_CallListBaseWithGenerationNative
(
)
;
MarkShape
...
static
bool
TypedArrayRequiresFloatingPoint
(
JSObject
*
obj
...
static
bool
UpdateExistingGenerationalListBaseStub
(
ICGetProp_Fallback
*
stub
...
-
>
isGetProp_CallListBaseWithGenerationNative
(
)
)
{
