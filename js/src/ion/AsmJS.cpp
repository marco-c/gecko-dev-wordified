...
ParseNode
*
FunctionLastReturnStatementOrNull
(
ParseNode
*
fn
...
const
unsigned
ASM_MODULE_FUNCTION_MODULE_OBJECT_SLOT
=
0
;
JSObject
...
static
bool
CheckFunctionBodiesParallelImpl
(
ModuleCompiler
&
m
...
const
size_t
LIFO_ALLOC_PARALLEL_CHUNK_SIZE
=
1
<
<
...
state
.
maybeGetAsmJSFailedFunctionIndex
(
)
;
if
...
:
:
offsetOfAsmJSActivationStackReadOnly
(
)
;
masm
