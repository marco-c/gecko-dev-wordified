...
_
(
GetProp_CallListBaseNative
)
\
_
(
GetProp_CallListBaseWithGenerationNative
)
\
_
(
GetProp_ListBaseShadowed
)
\
_
(
...
;
class
ICGetPropCallListBaseNativeStub
:
public
ICMonitoredStub
{
...
;
class
ICGetProp_CallListBaseWithGenerationNative
:
public
ICGetPropCallListBaseNativeStub
{
...
;
class
ICGetPropCallListBaseNativeCompiler
:
public
ICStubCompiler
{
