...
;
bool
reportBailoutWarnings
(
)
;
bool
invalidateBailedOutScripts
(
)
;
ExecutionStatus
...
;
void
setAbortFlagAndRequestInterrupt
(
bool
fatal
)
...
-
>
notifyOfActiveParallelEntryScript
(
cx_
script
)
