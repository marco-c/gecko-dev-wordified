...
inline
uint32_t
NativeObjectSmallSlotSpanForTracing
(
Shape
:
:
...
:
:
smallSlotSpanFromImmutableFlags
(
shapeFlags
)
;
...
:
:
numFixedSlotsFromImmutableFlags
(
shapeFlags
)
;
...
inline
uint32_t
NumNativeObjectUsedFixedSlotsForTracing
(
NativeObject
*
obj
