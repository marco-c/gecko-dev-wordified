...
self
.
setNumUnaliasedBodyLevelLexicals
(
numUnaliasedBodyLevelLexicals
)
;
...
self
.
setAliasedBodyLevelLexicalBegin
(
aliasedBodyLevelLexicalBegin
)
;
