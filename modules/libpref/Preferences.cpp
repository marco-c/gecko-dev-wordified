...
bool
mShouldCleanupDeadNodes
=
false
;
bool
mShouldSweepWeakObservers
=
false
;
const
...
:
:
GetUserPrefsFileLastModifiedAtStartup
(
PRTime
*
aLastModified
...
#
define
REJECT_IF_PROMISE_HOLDER_EXISTS
(
rv
)
\
