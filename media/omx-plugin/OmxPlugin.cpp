...
;
void
ToVideoFrame_YUV420PackedSemiPlanar
(
VideoFrame
*
aFrame
...
;
bool
ToVideoFrame_I420ColorConverter
(
VideoFrame
*
aFrame
...
static
bool
FindPreferredDecoderAndColorFormat
(
const
sp
<
