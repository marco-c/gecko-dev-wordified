...
const
int
STUN_ERROR_BAD_REQUEST_AS_GICE
=
...
const
int
STUN_ERROR_SERVER_ERROR_AS_GICE
=
...
(
PortTest
TestHandleStunMessageAsIceInHybridMode
)
{
/
/
...
(
PortTest
TestHandleStunMessageAsGiceInHybridMode
)
{
/
/
...
(
PortTest
TestHandleStunMessageAsGiceInIceMode
)
{
/
/
...
(
PortTest
TestHandleStunMessageAsGiceBadUsername
)
{
rtc
:
...
(
PortTest
TestHandleStunMessageAsIceBadUsername
)
{
rtc
:
...
(
PortTest
TestHandleStunMessageAsIceBadMessageIntegrity
)
{
/
/
...
(
PortTest
TestHandleStunMessageAsIceBadFingerprint
)
{
/
/
