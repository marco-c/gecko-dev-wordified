...
(
HardwareTest
AbleToQueryForDevices
)
{
int
num_recording_devices
=
0
;
int
...
(
HardwareTest
GetCpuLoadReturnsErrorOnNonWindowsPlatform
)
{
int
load
...
(
HardwareTest
GetSystemCpuLoadWorksExceptOnMacAndAndroid
)
{
#
ifdef
