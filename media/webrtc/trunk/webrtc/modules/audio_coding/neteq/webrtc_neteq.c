...
int
WebRtcNetEQ_GetRecommendedBufferSize
(
void
*
inst
...
int
WebRtcNetEQ_SetPlayoutMode
(
void
*
inst
enum
WebRtcNetEQPlayoutMode
playoutMode
)
{
MainInst_t
...
int
WebRtcNetEQ_CodecDbGetSizeInfo
(
void
*
inst
...
int
WebRtcNetEQ_GetRTCPStatsNoReset
(
void
*
inst
...
int
WebRtcNetEQ_GetSpeechTimeStamp
(
void
*
inst
...
0x80
int
WebRtcNetEQ_VQmonRecOutStatistics
(
void
*
inst
uint16_t
*
validVoiceDurationMs
uint16_t
*
concealedVoiceDurationMs
uint8_t
*
concealedVoiceFlags
)
...
int
WebRtcNetEQ_VQmonGetConfiguration
(
void
*
inst
...
int
WebRtcNetEQ_VQmonGetRxStatistics
(
void
*
inst
...
/
int
WebRtcNetEQ_GetNetworkStatistics
(
void
*
inst
...
int
WebRtcNetEQ_GetRawFrameWaitingTimes
(
void
*
inst
...
*
VAD_inst
WebRtcNetEQ_VADInitFunction
initFunction
WebRtcNetEQ_VADSetmodeFunction
setmodeFunction
...
void
WebRtcNetEQ_GetProcessingActivity
(
void
*
inst
...
-
>
preemptive_expand_normal_samples
=
NetEqMainInst
-
>
