...
;
void
ProcessWithDefaultStreamParameters
(
AudioFrame
*
frame
...
;
void
TestChangingChannelsInt16Interface
(
size_t
num_channels
AudioProcessing
...
;
void
RunQuantizedVolumeDoesNotGetStuckTest
(
int
sample_rate
)
;
void
RunManualVolumeChangeIsPossibleTest
(
int
sample_rate
)
...
(
ApmTest
DelayOffsetWithLimitsIsSetProperly
)
{
/
/
...
(
ApmTest
DISABLED_EchoCancellationReportsCorrectDelays
)
{
/
/
...
(
ApmTest
QuantizedVolumeDoesNotGetStuck
)
{
for
(
...
(
ApmTest
AgcOnlyAdaptsWhenTargetSignalIsPresent
)
{
const
int
...
(
ApmTest
AllProcessingDisabledByDefault
)
{
EXPECT_FALSE
(
...
(
ApmTest
NoProcessingWhenAllComponentsDisabled
)
{
for
(
...
(
ApmTest
NoProcessingWhenAllComponentsDisabledFloat
)
{
/
/
...
(
ApmTest
IdenticalInputChannelsResultInIdenticalOutputChannels
)
{
EnableAllComponents
(
...
(
ApmTest
FloatAndIntInterfacesGiveSimilarResults
)
{
audioproc
:
...
-
>
mutable_echo_return_loss_enhancement
(
)
)
;
...
-
>
set_ns_speech_probability_average
(
ns_speech_prob_average
)
;
