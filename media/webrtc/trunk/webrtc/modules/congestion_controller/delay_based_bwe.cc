...
constexpr
size_t
kDefaultMedianSlopeWindowSize
=
20
;
constexpr
double
kDefaultMedianSlopeThresholdGain
=
4
.
0
...
const
char
kBweMedianSlopeFilterExperiment
[
]
=
"
...
;
bool
BitrateEstimateExperimentIsEnabled
(
)
{
return
...
bool
TrendlineFilterExperimentIsEnabled
(
)
{
std
...
bool
MedianSlopeFilterExperimentIsEnabled
(
)
{
std
...
bool
ReadMedianSlopeFilterExperimentParameters
(
size_t
*
window_size
...
:
in_trendline_experiment_
(
TrendlineFilterExperimentIsEnabled
(
)
)
in_median_slope_experiment_
(
MedianSlopeFilterExperimentIsEnabled
(
)
