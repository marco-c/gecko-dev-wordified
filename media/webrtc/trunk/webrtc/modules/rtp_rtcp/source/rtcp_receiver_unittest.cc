...
;
AddRrPacketMultipleReportBlocks
(
sender_ssrc
report_block_vector
)
...
void
AddXrReceiverReferenceTimeBlock
(
uint32_t
ntp_sec
uint32_t
...
(
RtcpReceiverTest
XrPacketWithZeroReportBlocksIgnored
)
{
PacketBuilder
p
...
(
RtcpReceiverTest
InjectXrReceiverReferenceTimePacket
)
{
PacketBuilder
p
...
(
RtcpReceiverTest
InjectXrDlrrPacketWithNoSubBlock
)
{
const
uint32_t
...
(
RtcpReceiverTest
InjectXrDlrrPacketWithSubBlock
)
{
const
uint32_t
...
(
RtcpReceiverTest
InjectXrDlrrPacketWithMultipleSubBlocks
)
{
const
uint32_t
...
(
RtcpReceiverTest
InjectXrPacketWithUnknownReportBlock
)
{
const
uint8_t
...
(
RtcpReceiverTest
GetLastReceivedXrReferenceTimeInfo
)
{
const
uint32_t
