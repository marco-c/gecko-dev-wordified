...
void
TriggerOveruseWithProcessingUsage
(
int
num_times
)
...
(
OveruseFrameDetectorTest
OveruseAndRecoverWithMethodDisabled
)
{
options_
.
...
(
OveruseFrameDetectorTest
CaptureJitterResetAfterFrameTimeout
)
{
EXPECT_EQ
(
...
(
OveruseFrameDetectorTest
CaptureQueueDelayResetAtResolutionSwitch
)
{
overuse_detector_
-
...
(
OveruseFrameDetectorTest
CaptureQueueDelayNoMatchingCapturedFrame
)
{
overuse_detector_
-
...
(
OveruseFrameDetectorTest
OveruseAndRecoverWithProcessingUsage
)
{
options_
.
...
(
OveruseFrameDetectorTest
TriggerOveruseWithExtendedProcessingUsage
)
{
options_
.
