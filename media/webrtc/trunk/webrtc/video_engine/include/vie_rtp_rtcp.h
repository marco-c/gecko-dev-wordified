...
#
ifndef
WEBRTC_VIDEO_ENGINE_INCLUDE_VIE_RTP_RTCP_H_
#
define
WEBRTC_VIDEO_ENGINE_INCLUDE_VIE_RTP_RTCP_H_
#
...
enum
{
KDefaultDeltaTransmitTimeSeconds
=
15
}
;
...
virtual
int
GetReceiveChannelRtcpStatistics
(
const
int
video_channel
...
virtual
int
DeregisterSendChannelRtcpStatisticsCallback
(
int
video_channel
RtcpStatisticsCallback
...
virtual
int
DeregisterReceiveChannelRtcpStatisticsCallback
(
int
video_channel
RtcpStatisticsCallback
...
virtual
int
DeregisterSendChannelRtpStatisticsCallback
(
int
video_channel
StreamDataCountersCallback
...
virtual
int
DeregisterReceiveChannelRtpStatisticsCallback
(
int
video_channel
StreamDataCountersCallback
...
virtual
int
DeregisterSendFrameCountObserver
(
int
video_channel
FrameCountObserver
