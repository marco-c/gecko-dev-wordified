...
(
HttpBaseTest
SignalsCompleteOnInterruptedSend
)
{
/
/
...
(
HttpBaseTest
SupportsReceiveViaDocumentPush
)
{
/
/
...
(
HttpBaseTest
AllowsGetDocumentStreamInResponseToHttpHeader
)
{
/
/
...
(
HttpBaseTest
AllowsGetDocumentStreamWithEmptyDocumentBody
)
{
/
/
...
(
HttpBaseTest
SignalsDocumentStreamCloseOnUnexpectedClose
)
{
/
/
