...
QueryInterface
(
IID_IWMSInternalAdminNetSource
(
LPVOID
*
)
...
bool
GetIePerConnectionProxySettings
(
const
char
*
...
.
bool
p_getProxyInfoForTypeFromDictWithKeys
(
ProxyInfo
*
proxy
...
.
bool
GetMacProxySettingsFromDictionary
(
ProxyInfo
*
proxy
