...
call
/
fake_rtp_transport_controller_send
.
h
"
#
...
void
SetupMockForSendTelephoneEvent
(
)
{
EXPECT_TRUE
...
(
AudioSendStreamTest
SendCodecAppliesAudioNetworkAdaptor
)
{
ConfigHelper
helper
...
(
AudioSendStreamTest
ReconfigureTransportCcResetsFirst
)
{
ConfigHelper
helper
