...
things
like
Java_org_webrtc_OMG_Can_This_Name_Be_Any_Longer
prescribed
by
/
/
...
j_on_buffered_amount_change_mid_
(
GetMethodID
(
jni
...
(
void
PeerConnectionFactory_nativeInitializeVideoCapturer
)
(
JNIEnv
*
...
:
IceTransportsType
JavaIceTransportsTypeToNativeType
(
JNIEnv
*
jni
...
JavaCandidateNetworkPolicyToNativeType
(
JNIEnv
*
jni
...
:
TlsCertPolicy
JavaTlsCertPolicyTypeToNativeType
(
JNIEnv
*
jni
...
static
void
JavaIceServersToJsepIceServers
(
JNIEnv
*
jni
...
;
jfieldID
j_ice_server_tls_cert_policy_id
=
GetFieldID
(
jni
...
;
jfieldID
j_audio_jitter_buffer_max_packets_id
=
GetFieldID
(
jni
...
;
jfieldID
j_audio_jitter_buffer_fast_accelerate_id
=
GetFieldID
(
jni
...
;
jfieldID
j_ice_backup_candidate_pair_ping_interval_id
=
GetFieldID
(
jni
...
;
jfieldID
j_continual_gathering_policy_id
=
GetFieldID
(
jni
...
;
jfieldID
j_presume_writable_when_fully_relayed_id
=
GetFieldID
(
jni
...
(
void
FileVideoCapturer_nativeI420ToNV21
)
(
JNIEnv
*
