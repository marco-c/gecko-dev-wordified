...
json_perf_parser
import
GetAverageRunInfoFromJSONString
from
perf_tests_helper
import
PrintPerfResult
...
_DEVICE_PERF_OUTPUT_SEARCH_PREFIX
=
(
constants
.
...
def
GenerateCoverageReportIfNeeded
(
self
)
:
