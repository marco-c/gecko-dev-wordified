...
#
ifndef
WEBRTC_AUDIO_DEVICE_AUDIO_DEVICE_ANDROID_OPENSLES_H
#
define
WEBRTC_AUDIO_DEVICE_AUDIO_DEVICE_ANDROID_OPENSLES_H
#
...
;
void
PlayerSimpleBufferQueueCallbackHandler
(
SLAndroidSimpleBufferQueueItf
queueItf
)
