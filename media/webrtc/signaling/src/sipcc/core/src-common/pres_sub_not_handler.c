...
#
define
DEFAULT_RETRY_AFTER_MILLISECS
5000
typedef
enum
{
PRES_RETRYAFTER_TIMER
=
1
}
pres_timers_e
...
static
boolean
apply_presence_state_to_matching_feature_keys
(
char
*
presentity
...
static
void
append_notification_to_pending_queue
(
ccsip_event_data_t
*
event_body_p
...
static
sll_handle_t
s_pending_notify_list
=
NULL
;
static
boolean
s_subs_hndlr_initialized
=
FALSE
;
/
...
of
the
subsmanager_handle_ev_app_subscribe
(
)
*
because
...
Function
:
pres_create_retry_after_timers
(
)
*
*
