...
CC_SUBSCRIPTIONS_REMOTECC_OPTIONSIND
=
...
typedef
struct
cc_feature_data_hold_reversion_t_
{
int
alertInterval
;
...
typedef
struct
cc_media_remote_stream_table_t_
{
cc_media_remote_track_table_t
streams
[
...
typedef
struct
cc_state_data_dialing_completedt_
{
cc_caller_id_t
caller_id
;
...
typedef
struct
cc_state_data_far_end_proceeding_t_
{
cc_caller_id_t
caller_id
;
...
typedef
struct
cc_state_data_far_end_alerting_t_
{
cc_caller_id_t
caller_id
;
...
typedef
struct
cc_state_data_call_received_t_
{
cc_caller_id_t
caller_id
;
...
typedef
struct
cc_service_data_get_facility_by_line_
{
line_t
line
;
