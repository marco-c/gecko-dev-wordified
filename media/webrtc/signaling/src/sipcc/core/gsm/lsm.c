...
/
void
lsm_display_control_ringin_call
(
callid_t
call_id
line_t
...
>
flags
LSM_FLAGS_CALL_PRIORITY_URGENT
)
;
}
}
...
void
lsm_remove_lcb_prevent_ringing
(
callid_t
call_id
)
...
-
>
local_dynamic_payload_type_value
=
=
RTP_NONE
)
...
src_addr
port
FSM_NEGOTIATED_CRYPTO_ALGORITHM_ID
(
media
)
FSM_NEGOTIATED_CRYPTO_RX_KEY
(
media
)
&
...
;
lsm_util_tone_start_with_speaker_as_backup
(
tone
VCM_ALERT_INFO_OFF
lsm_get_ms_ui_call_handle
...
.
See
gsmsdp_get_media_cap_entry_by_index
.
*
/
dcb
...
Function
:
lsm_get_all_used_instances_cnt
*
*
Description
:
...
#
define
ROLLOVER_ACROSS_SAME_DN
1
#
define
ROLLOVER_NEXT_AVAILABLE_LINE
2
/
*
*
...
Function
:
lsm_is_line_available_for_outgoing_call
*
*
param
line
...
Function
:
lsm_start_multipart_tone_timer
*
Parameters
:
Tone
...
Function
:
lsm_start_continuous_tone_timer
*
Parameters
:
Tone
...
/
void
lsm_tone_duration_tmr_callback
(
void
*
data
...
config_get_line_value
(
CFGID_LINE_RING_SETTING_ACTIVE
&
ringSettingActive
sizeof
(
...
config_get_value
(
CFGID_LINE_MESSAGE_WAITING_AMWI
+
lcb
-
>
...
*
in
fsmdef_init_local_sdp
.
*
/
GSMSDP_FOR_ALL_MEDIA
(
media
dcb
)
...
-
>
placed_call_update_required
)
{
lsm_update_placed_callinfo
(
dcb
)
;
...
;
fsmutil_set_shown_calls_ci_element
(
dcb
-
>
...
config_get_value
(
CFGID_RING_SETTING_BUSY_POLICY
&
ringSettingBusyStationPolicy
sizeof
(
...
config_get_value
(
CFGID_CALL_WAITING_SILENT_PERIOD
&
callWaitingDelay
sizeof
(
...
/
void
lsm_ui_display_notify_str_index
(
int
str_index
)
...
Function
:
lsm_downgrade_monrec_tone_action
*
*
Parameters
:
