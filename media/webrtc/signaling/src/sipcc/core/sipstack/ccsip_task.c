...
#
define
MAX_DEPTH_OF_GSM_MSGQ_TO_ALLOW_NEW_INCOMING_CALL
60
/
*
Internal
...
(
sipHeaderUserAgent
CCSIP_SIP_COMMUNICATOR_USER_AGENT
sizeof
(
sipHeaderUserAgent
)
...
(
sipPhoneModelNumber
PHONE_MODEL_NUMBER_COMMUNICATOR
SIP_PHONE_MODEL_NUMBER_LEN
)
;
#
...
retxMessageType
=
sip_platform_msg_timer_messageType_get
(
sip_sm_event
.
ccb
...
int
SIPTaskRetransmitPreviousResponse
(
sipMessage_t
*
pSipMessage
