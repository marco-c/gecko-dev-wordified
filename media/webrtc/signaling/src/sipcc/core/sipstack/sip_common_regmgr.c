...
extern
void
sip_platform_handle_service_control_notify
(
sipServiceControl_t
*
scp
...
extern
void
ui_update_registration_state_all_lines
(
boolean
registered
)
...
;
void
sip_regmgr_fallback_generic_timer_stop
(
cprTimer_t
timer
)
...
static
void
sip_regmgr_generic_timer_start_failure
(
fallback_ccb_t
*
fallback_ccb
...
static
void
sip_regmgr_generic_message_post_failure
(
fallback_ccb_t
*
fallback_ccb
...
sip_platform_register_expires_timer_stop
(
line_ccb
-
>
...
sip_platform_msg_timer_update_destination
(
line_ccb
-
>
...
sip_platform_standby_keepalive_timer_start
(
timeout
*
1000
...
to
UDP
CC_Config_setIntValue
(
CFGID_TRANSPORT_LAYER_PROT
2
)
;
CCSIP_DEBUG_ERROR
...
:
Replaces
SIPTaskDisconnectFromSipProxies
*
*
RETURNS
:
...
sip_platform_notify_timer_start
(
5000
)
;
...
sip_platform_register_expires_timer_start
(
ccb
-
>
