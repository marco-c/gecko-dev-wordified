...
*
E_CC_FEATURE_ACK
ccsip_handle_recvupdatenewmedia_ccfeatureackpending_ev_cc_feature_ack
*
/
{
E_CC_FEATURE_ACK
...
/
*
H_RECVMIDCALLINVITE__SIPACKPENDING_EV_SIP_ACK
*
/
ccsip_handle_recvmidcallinvite_sipackpending_ev_sip_ack
/
...
and
2000ms
sip_platform_glare_avoidance_timer_start
(
cpr_rand
(
)
