...
;
void
sip_regmgr_ev_in_fallback_any_response
(
ccsipCCB_t
*
ccb
...
;
void
sip_regmgr_stability_timeout_expire
(
void
*
data
...
;
void
sip_regmgr_ev_token_wait_tmr_wait
(
ccsipCCB_t
*
ccb
