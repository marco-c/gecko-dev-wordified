...
{
int
numRawFramesInserted
;
int
numFramesRenderedSuccessfully
;
int
numFramesRenderedWrongly
;
}
;
VideoTestStats
...
(
TransportConduitTest
DISABLED_TestDummyAudioWithTransport
)
{
TestDummyAudioAndTransport
(
...
(
TransportConduitTest
DISABLED_TestDummyVideoWithTransport
)
{
TestDummyVideoAndTransport
(
