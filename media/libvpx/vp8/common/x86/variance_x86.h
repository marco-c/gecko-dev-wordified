...
prototype_ssimpf
(
vp8_ssim_parms_8x8_sse2
)
;
extern
prototype_ssimpf
(
vp8_ssim_parms_16x16_sse2
)
;
#
if
...
;
extern
prototype_sad_multi_dif_address
(
