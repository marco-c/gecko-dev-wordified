...
;
int
num_spatial_layers_nonzero_rate
=
0
;
cpi
...
static
void
set_flags_and_fb_idx_bypass_via_set_ref_frame_config
(
VP9_COMP
*
const
...
void
vp9_svc_check_spatial_layer_sync
(
VP9_COMP
*
const
...
void
vp9_svc_update_ref_frame_buffer_idx
(
VP9_COMP
*
const
...
static
void
vp9_svc_update_ref_frame_bypass_mode
(
VP9_COMP
*
const
