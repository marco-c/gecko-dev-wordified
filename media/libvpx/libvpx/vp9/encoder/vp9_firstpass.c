...
static
int
fp_highbd_estimate_point_noise
(
uint8_t
*
src_ptr
...
static
void
accumulate_floating_point_stats
(
VP9_COMP
*
cpi
...
;
double
gf_interval_bias_bits_normalize_factor
=
(
double
)
...
INLINE
void
gf_group_set_inter_normal_frame
(
GF_GROUP
*
gf_group
...
static
RANGE
get_active_gf_inverval_range_simple
(
int
min_gf_interval
int
...
#
define
DEFAULT_SCAN_FRAMES_FOR_KF_BOOST
32
#
define
...
-
>
key_frame_section_intra_rating
=
calculate_section_intra_ratio
(
start_position
...
coding_frame_count
=
vp9_get_gop_coding_frame_count
(
&
cpi
-
