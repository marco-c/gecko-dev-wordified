...
#
ifndef
VPX_VP9_ENCODER_VP9_ENCODER_H_
#
define
VPX_VP9_ENCODER_VP9_ENCODER_H_
#
...
INLINE
int
gop_command_coding_frame_count
(
const
GOP_COMMAND
*
...
INLINE
void
encode_command_set_gop_command
(
ENCODE_COMMAND
*
encode_command
...
INLINE
void
encode_command_set_external_quantize_index
(
ENCODE_COMMAND
*
encode_command
...
INLINE
void
encode_command_reset_external_quantize_index
(
ENCODE_COMMAND
*
encode_command
...
INLINE
void
encode_command_set_target_frame_bits
(
ENCODE_COMMAND
*
encode_command
...
INLINE
void
encode_command_reset_target_frame_bits
(
ENCODE_COMMAND
*
encode_command
