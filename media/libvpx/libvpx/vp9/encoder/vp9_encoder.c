...
;
free_motion_vector_info
(
cpi
)
;
free_fp_motion_vector_info
(
cpi
)
;
...
vpx_highbd_sad_skip_16x8x4d_bits8
)
HIGHBD_BFP
(
BLOCK_8X16
vpx_highbd_sad8x16_bits8
vpx_highbd_sad_skip_8x16_bits8
...
vpx_highbd_sad_skip_8x16x4d_bits8
)
HIGHBD_BFP
(
BLOCK_8X8
vpx_highbd_sad8x8_bits8
vpx_highbd_sad_skip_8x8_bits8
...
vpx_highbd_sad_skip_8x8x4d_bits8
)
HIGHBD_BFP
(
BLOCK_8X4
vpx_highbd_sad8x4_bits8
vpx_highbd_sad_skip_8x4_bits8
...
vpx_highbd_sad_skip_8x4x4d_bits8
)
HIGHBD_BFP
(
BLOCK_4X8
...
vpx_highbd_sad_skip_4x8x4d_bits8
)
HIGHBD_BFP
(
BLOCK_4X4
vpx_highbd_sad4x4_bits8
vpx_highbd_sad_skip_4x4_bits8
...
vpx_highbd_sad_skip_4x4x4d_bits8
)
break
;
case
...
vpx_highbd_sad_skip_4x8x4d_bits10
)
HIGHBD_BFP
(
BLOCK_4X4
vpx_highbd_sad4x4_bits10
vpx_highbd_sad_skip_4x4_bits10
...
vpx_highbd_sad_skip_4x4x4d_bits10
)
break
;
default
...
void
vp9_update_compressor_with_img_fmt
(
VP9_COMP
*
cpi
...
-
>
compute_frame_low_motion_onepass
=
1
;
cpi
...
;
motion_vector_info_init
(
cpi
)
;
fp_motion_vector_info_init
(
cpi
)
;
...
static
void
output_frame_level_debug_stats
(
VP9_COMP
*
cpi
...
-
>
disable_scene_detection_rtc_ratectrl
&
&
(
cpi
...
;
vp9_svc_assert_constraints_pattern
(
cpi
)
;
...
.
int
ext_rc_use_default_q
=
1
;
const
int
orig_rc_max_frame_bandwidth
=
rc
-
>
...
encode_command
.
use_external_target_frame_bits
)
{
q
=
...
static
void
update_encode_frame_result_basic
(
FRAME_UPDATE_TYPE
update_type
int
