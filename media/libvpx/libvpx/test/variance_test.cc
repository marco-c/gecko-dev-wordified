...
4
&
vpx_highbd_12_get16x16var_sse2
12
)
GetVarianceParams
(
...
4
&
vpx_highbd_10_get16x16var_sse2
10
)
GetVarianceParams
(
...
4
&
vpx_highbd_8_mse16x16_neon_dotprod
VPX_BITS_8
)
MseParams
(
...
3
&
vpx_highbd_8_mse16x8_neon_dotprod
VPX_BITS_8
)
MseParams
(
...
4
&
vpx_highbd_8_mse8x16_neon_dotprod
VPX_BITS_8
)
MseParams
(
...
3
&
vpx_highbd_8_mse8x8_neon_dotprod
VPX_BITS_8
)
)
)
...
6
&
vpx_highbd_12_variance64x64_neon
12
)
VarianceParams
(
...
5
&
vpx_highbd_12_variance64x32_neon
12
)
VarianceParams
(
...
6
&
vpx_highbd_12_variance32x64_neon
12
)
VarianceParams
(
...
5
&
vpx_highbd_12_variance32x32_neon
12
)
VarianceParams
(
...
4
&
vpx_highbd_12_variance32x16_neon
12
)
VarianceParams
(
...
5
&
vpx_highbd_12_variance16x32_neon
12
)
VarianceParams
(
...
4
&
vpx_highbd_12_variance16x16_neon
12
)
VarianceParams
(
...
4
&
vpx_highbd_12_variance8x16_neon
12
)
VarianceParams
(
...
3
&
vpx_highbd_12_variance8x8_neon
12
)
VarianceParams
(
...
2
&
vpx_highbd_12_variance8x4_neon
12
)
VarianceParams
(
...
3
&
vpx_highbd_12_variance4x8_neon
12
)
VarianceParams
(
...
2
&
vpx_highbd_12_variance4x4_neon
12
)
VarianceParams
(
...
6
&
vpx_highbd_10_variance64x64_neon
10
)
VarianceParams
(
...
5
&
vpx_highbd_10_variance64x32_neon
10
)
VarianceParams
(
...
6
&
vpx_highbd_10_variance32x64_neon
10
)
VarianceParams
(
...
5
&
vpx_highbd_10_variance32x32_neon
10
)
VarianceParams
(
...
4
&
vpx_highbd_10_variance32x16_neon
10
)
VarianceParams
(
...
5
&
vpx_highbd_10_variance16x32_neon
10
)
VarianceParams
(
...
4
&
vpx_highbd_10_variance16x16_neon
10
)
VarianceParams
(
...
3
&
vpx_highbd_10_variance16x8_neon
10
)
VarianceParams
(
...
4
&
vpx_highbd_10_variance8x16_neon
10
)
VarianceParams
(
...
3
&
vpx_highbd_10_variance8x8_neon
10
)
VarianceParams
(
...
2
&
vpx_highbd_10_variance8x4_neon
10
)
VarianceParams
(
...
3
&
vpx_highbd_10_variance4x8_neon
10
)
VarianceParams
(
...
6
&
vpx_highbd_8_variance64x64_neon
8
)
VarianceParams
(
...
5
&
vpx_highbd_8_variance64x32_neon
8
)
VarianceParams
(
...
6
&
vpx_highbd_8_variance32x64_neon
8
)
VarianceParams
(
...
5
&
vpx_highbd_8_variance32x32_neon
8
)
VarianceParams
(
...
4
&
vpx_highbd_8_variance32x16_neon
8
)
VarianceParams
(
...
4
&
vpx_highbd_8_variance16x16_neon
8
)
VarianceParams
(
...
3
&
vpx_highbd_8_variance16x8_neon
8
)
VarianceParams
(
...
4
&
vpx_highbd_8_variance8x16_neon
8
)
VarianceParams
(
...
4
&
vpx_highbd_12_get16x16var_neon
12
)
GetVarianceParams
(
...
4
&
vpx_highbd_10_get16x16var_neon
10
)
GetVarianceParams
(
...
6
&
vpx_highbd_12_variance64x64_sve
12
)
VarianceParams
(
...
5
&
vpx_highbd_12_variance64x32_sve
12
)
VarianceParams
(
...
6
&
vpx_highbd_12_variance32x64_sve
12
)
VarianceParams
(
...
5
&
vpx_highbd_12_variance32x32_sve
12
)
VarianceParams
(
...
4
&
vpx_highbd_12_variance32x16_sve
12
)
VarianceParams
(
...
5
&
vpx_highbd_12_variance16x32_sve
12
)
VarianceParams
(
...
4
&
vpx_highbd_12_variance16x16_sve
12
)
VarianceParams
(
...
3
&
vpx_highbd_12_variance16x8_sve
12
)
VarianceParams
(
...
4
&
vpx_highbd_12_variance8x16_sve
12
)
VarianceParams
(
...
6
&
vpx_highbd_10_variance64x64_sve
10
)
VarianceParams
(
...
5
&
vpx_highbd_10_variance64x32_sve
10
)
VarianceParams
(
...
6
&
vpx_highbd_10_variance32x64_sve
10
)
VarianceParams
(
...
5
&
vpx_highbd_10_variance32x32_sve
10
)
VarianceParams
(
...
4
&
vpx_highbd_10_variance32x16_sve
10
)
VarianceParams
(
...
5
&
vpx_highbd_10_variance16x32_sve
10
)
VarianceParams
(
...
4
&
vpx_highbd_10_variance16x16_sve
10
)
VarianceParams
(
...
3
&
vpx_highbd_10_variance16x8_sve
10
)
VarianceParams
(
...
4
&
vpx_highbd_10_variance8x16_sve
10
)
VarianceParams
(
...
6
&
vpx_highbd_8_variance64x64_sve
8
)
VarianceParams
(
...
5
&
vpx_highbd_8_variance64x32_sve
8
)
VarianceParams
(
...
6
&
vpx_highbd_8_variance32x64_sve
8
)
VarianceParams
(
...
5
&
vpx_highbd_8_variance32x32_sve
8
)
VarianceParams
(
...
4
&
vpx_highbd_8_variance32x16_sve
8
)
VarianceParams
(
...
5
&
vpx_highbd_8_variance16x32_sve
8
)
VarianceParams
(
...
4
&
vpx_highbd_8_variance16x16_sve
8
)
VarianceParams
(
...
3
&
vpx_sub_pixel_variance16x8_msa
0
)
SubpelVarianceParams
(
...
6
&
vpx_sub_pixel_variance64x64_mmi
0
)
SubpelVarianceParams
(
...
5
&
vpx_sub_pixel_variance64x32_mmi
0
)
SubpelVarianceParams
(
...
6
&
vpx_sub_pixel_variance32x64_mmi
0
)
SubpelVarianceParams
(
...
5
&
vpx_sub_pixel_variance32x32_mmi
0
)
SubpelVarianceParams
(
...
4
&
vpx_sub_pixel_variance32x16_mmi
0
)
SubpelVarianceParams
(
...
5
&
vpx_sub_pixel_variance16x32_mmi
0
)
SubpelVarianceParams
(
...
4
&
vpx_sub_pixel_variance16x16_mmi
0
)
SubpelVarianceParams
(
...
3
&
vpx_sub_pixel_variance16x8_mmi
0
)
SubpelVarianceParams
(
...
4
&
vpx_sub_pixel_variance8x16_mmi
0
)
SubpelVarianceParams
(
...
6
&
vpx_sub_pixel_avg_variance64x64_mmi
0
)
SubpelAvgVarianceParams
(
...
5
&
vpx_sub_pixel_avg_variance64x32_mmi
0
)
SubpelAvgVarianceParams
(
...
6
&
vpx_sub_pixel_avg_variance32x64_mmi
0
)
SubpelAvgVarianceParams
(
...
5
&
vpx_sub_pixel_avg_variance32x32_mmi
0
)
SubpelAvgVarianceParams
(
...
4
&
vpx_sub_pixel_avg_variance32x16_mmi
0
)
SubpelAvgVarianceParams
(
...
5
&
vpx_sub_pixel_avg_variance16x32_mmi
0
)
SubpelAvgVarianceParams
(
...
4
&
vpx_sub_pixel_avg_variance16x16_mmi
0
)
SubpelAvgVarianceParams
(
...
3
&
vpx_sub_pixel_avg_variance16x8_mmi
0
)
SubpelAvgVarianceParams
(
...
4
&
vpx_sub_pixel_avg_variance8x16_mmi
0
)
SubpelAvgVarianceParams
(
...
3
&
vpx_sub_pixel_avg_variance8x8_mmi
0
)
SubpelAvgVarianceParams
(
...
2
&
vpx_sub_pixel_avg_variance8x4_mmi
0
)
SubpelAvgVarianceParams
(
...
3
&
vpx_sub_pixel_avg_variance4x8_mmi
0
)
SubpelAvgVarianceParams
(
...
2
&
vpx_sub_pixel_avg_variance4x4_mmi
0
)
)
)
