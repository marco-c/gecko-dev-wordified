...
NS_LITERAL_CSTRING
(
NC_RDF_USESYSTEMDEFAULT
)
getter_AddRefs
(
kNC_UseSystemDefault
)
)
;
rdf
...
:
:
FillMIMEExtensionProperties
(
nsIRDFResource
*
aContentTypeNodeResource
nsIRDFService
*
aRDFService
nsIMIMEInfo
...
:
:
FillMIMEInfoForExtensionFromDS
(
const
nsACString
&
