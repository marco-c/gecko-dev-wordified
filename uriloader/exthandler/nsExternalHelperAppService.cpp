...
:
:
network_protocol_handler_prompt_without_user_activation
(
)
)
{
...
:
:
MaybeConsumeUserActivationForExternalScheme
(
mozilla
:
:
...
:
:
browser_download_enableDeletePrivate
(
)
&
&
...
:
:
browser_download_deletePrivate
(
)
)
{
