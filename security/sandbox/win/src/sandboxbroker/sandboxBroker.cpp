...
static
void
AddLLVMProfilePathDirectoryToPolicy
(
sandbox
:
:
...
:
:
security_sandbox_cig_prespawn_enabled
(
)
)
{
...
:
:
security_sandbox_content_close_ksecdd_handle
(
)
)
{
...
:
:
security_sandbox_chrome_pipe_rule_enabled
(
)
)
{
...
:
:
security_sandbox_gpu_extension_point_disable
(
)
)
{
...
:
:
security_sandbox_gmp_acg_enabled
(
)
)
{
