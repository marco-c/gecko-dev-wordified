...
*
RemoveFontMemResourceExFunction
;
/
/
APIs
...
bool
CheckWin10ImageLoadNoRemotePolicy
(
)
{
...
-
void
TestWin8ExtensionPointHookWrapper
(
bool
is_success_test
bool
...
bool
CheckWin10ImageLoadNoLowLabelPolicy
(
)
{
PROCESS_MITIGATION_IMAGE_LOAD_POLICY
...
NTSTATUS
WINAPI
GetSuggestedOPMProtectedOutputArraySizeTest
(
PUNICODE_STRING
device_name
DWORD
...
NTSTATUS
WINAPI
GetCertificateSizeByHandleTest
(
OPM_PROTECTED_OUTPUT_HANDLE
protected_output
DXGKMDT_CERTIFICATE_TYPE
...
NTSTATUS
WINAPI
ConfigureOPMProtectedOutputTest
(
OPM_PROTECTED_OUTPUT_HANDLE
protected_output
const
...
NTSTATUS
WINAPI
SetOPMSigningKeyAndSequenceNumbersTest
(
OPM_PROTECTED_OUTPUT_HANDLE
protected_output
const
...
bool
RunTestsOnVideoOutputConfigure
(
uintptr_t
monitor_index
IOPMVideoOutput
...
bool
RunTestsOnVideoOutputFinishInitialization
(
uintptr_t
monitor_index
IOPMVideoOutput
...
bool
RunTestsOnVideoOutputStartInitialization
(
uintptr_t
monitor_index
IOPMVideoOutput
...
bool
RunTestsOnVideoOutputGetInformation
(
uintptr_t
monitor_index
IOPMVideoOutput
...
SBOX_TESTS_COMMAND
int
CheckWin8ExtensionPointSetting
(
int
argc
wchar_t
...
(
ProcessMitigationsTest
CheckWin8ExtensionPointPolicySuccess
)
{
if
(
...
(
ProcessMitigationsTest
DISABLED_CheckWin8ExtensionPoint_Hook_Success
)
{
if
(
...
(
ProcessMitigationsTest
DISABLED_CheckWin8ExtensionPoint_Hook_Failure
)
{
if
(
...
(
ProcessMitigationsTest
DISABLED_CheckWin8ExtensionPoint_AppInit_Success
)
{
if
(
...
(
ProcessMitigationsTest
DISABLED_CheckWin8ExtensionPoint_AppInit_Failure
)
{
if
(
...
setting
the
MITIGATION_NON_SYSTEM_FONTS_DISABLE
/
/
mitigation
enables
...
(
ProcessMitigationsTest
CheckWin10NonSystemFontLockDownPolicySuccess
)
{
if
(
...
(
ProcessMitigationsTest
CheckWin10NonSystemFontLockDownLoadSuccess
)
{
if
(
...
(
ProcessMitigationsTest
CheckWin10NonSystemFontLockDownLoadFailure
)
{
if
(
...
(
ProcessMitigationsTest
CheckWin10ImageLoadNoRemotePolicySuccess
)
{
if
(
...
(
ProcessMitigationsTest
DISABLED_CheckWin10ImageLoadNoRemoteSuccess
)
{
if
(
...
(
ProcessMitigationsTest
DISABLED_CheckWin10ImageLoadNoRemoteFailure
)
{
if
(
...
(
ProcessMitigationsTest
CheckWin10ImageLoadNoLowLabelPolicySuccess
)
{
if
(
...
(
ProcessMitigationsTest
CheckWin10ImageLoadNoLowLabelSuccess
)
{
if
(
...
(
ProcessMitigationsTest
CheckWin10ImageLoadNoLowLabelFailure
)
{
if
(
