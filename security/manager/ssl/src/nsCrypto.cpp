...
#
define
JS_OK_DEL_EXTERNAL_MOD
2
#
define
JS_OK_DEL_INTERNAL_MOD
1
#
define
JS_ERR_INTERNAL
...
#
define
JS_ERR_INCORRECT_NUM_OF_ARGUMENTS
-
3
#
define
...
#
define
JS_ERR_BAD_CIPHER_ENABLE_FLAGS
-
9
#
define
JS_ERR_ADD_DUPLICATE_MOD
-
10
/
*
...
static
nsresult
cryptojs_GetFunctionObjectPrincipal
(
JSContext
*
cx
...
FUNCTION
:
cryptojs_ReadArgsAndGenerateKey
*
-
-
-
...
;
PK11SymKeyCleaner
subject_and_secret_and_issuer_cleaner
(
subject_and_secret_and_issuer
)
;
...
;
PK11SymKeyCleaner
sha1_of_subject_and_secret_and_issuer_cleaner
(
sha1_of_subject_and_secret_and_issuer
)
;
