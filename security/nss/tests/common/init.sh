...
echo
"
nss123456789012345678901234567890123456789012345678901234567890_
"
>
{
LONGPWFILE
...
/
CA_iopr
R_IOPR_SSL_SERVERDIR
=
.
.
/
server_ssl_iopr
R_IOPR_SSL_CLIENTDIR
=
.
.
/
client_ssl_iopr
R_IOPR_OCSP_CLIENTDIR
=
.
.
/
