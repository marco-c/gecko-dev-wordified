...
;
struct
Pkcs11CompressedECKeyTestParams
{
DataBuffer
compressedKey
;
...
(
Pk11KeyImportTestEC
CompressedPointWrongSign
)
{
DataBuffer
spki
(
kP256CompressedSpkiWrongSign
sizeof
(
kP256CompressedSpkiWrongSign
)
...
(
Pk11KeyImportTestEC
CompressedPointWrongLen
)
{
DataBuffer
spki
(
kP256CompressedSpkiWrongPointLength
sizeof
(
kP256CompressedSpkiWrongPointLength
)
...
(
Pk11KeyImportTestEC
CompressedPointNotOnCurve
)
{
DataBuffer
spki
(
kP256CompressedSpkiNotOnCurve
sizeof
(
kP256CompressedSpkiNotOnCurve
)
