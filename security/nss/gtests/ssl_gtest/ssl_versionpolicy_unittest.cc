...
bool
IsValidInputForVersionRangeSet
(
SSLVersionRange
*
expectedEffectiveRange
)
{
if
(
...
(
TestPolicyVersionRange
TestAllTLSVersionsAndPolicyCombinations
)
{
ASSERT_TRUE
(
