...
void
ConnectWithReplacementVersionList
(
uint16_t
version
)
...
(
TlsExtensionTest12Plus
SignatureAlgorithmsTrailingData
)
{
/
/
...
(
TlsExtensionTest13Stream
SignatureAlgorithmsPrecedingGarbage
)
{
/
/
...
(
TlsExtensionTestPre13
RenegotiationInfoExtensionEmpty
)
{
DataBuffer
extension
...
(
TlsExtensionTest12
SignatureAlgorithmConfiguration
)
{
const
SSLSignatureScheme
...
(
TlsExtensionTest13Stream
AddServerSignatureAlgorithmsOnResumption
)
{
SetupForResume
(
...
(
TlsConnectTls13
TestTls13PskInvalidBinderValue
)
{
ScopedPK11SlotInfo
slot
...
(
TlsExtensionTest13
RemoveTls13FromVersionListBothV12
)
{
client_
-
...
(
TlsBogusExtensionTest13
AddBogusExtensionEncryptedExtensions
)
{
Run
(
...
(
TlsBogusExtensionTest13
AddBogusExtensionCertificateRequest
)
{
server_
-
...
(
TlsBogusExtensionTest13
AddBogusExtensionHelloRetryRequest
)
{
static
const
...
(
TlsDisallowedExtensionTest13
AddVersionExtensionCertificate
)
{
Run
(
...
(
TlsDisallowedExtensionTest13
AddVersionExtensionCertificateRequest
)
{
server_
-
...
(
TlsConnectGeneric
ClientHelloExtensionPermutation
)
{
EnsureTlsSetup
(
...
ClientHelloExtensionPermutationWithPSK
)
{
EnsureTlsSetup
(
...
(
TlsConnectStreamTls13
ClientHelloCertAuthXtnToleration
)
{
EnsureTlsSetup
(
...
INSTANTIATE_TEST_SUITE_P
(
DisallowedUnadvertisedExtension13
TlsDisallowedUnadvertisedExtensionTest13
:
:
testing
