...
unsigned
int
des3_bytes_encrypted
;
unsigned
int
des3_bytes_decrypted
;
SECStatus
des3_status
;
...
static
SECStatus
freebl_fips_DH_PowerUpSelfTest
(
void
)
{
...
static
SECStatus
freebl_fipsSoftwareIntegrityTest
(
const
char
*
