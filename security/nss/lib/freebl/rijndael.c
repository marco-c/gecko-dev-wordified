...
#
define
freeblCipher_native_aes_ecb_worker
(
encrypt
keysize
)
...
16
?
freeblCipher_intel_aes_encrypt_ecb_128
\
:
(
keysize
...
24
?
freeblCipher_intel_aes_encrypt_ecb_192
\
:
...
16
?
freeblCipher_intel_aes_decrypt_ecb_128
\
:
(
keysize
...
24
?
freeblCipher_intel_aes_decrypt_ecb_192
\
:
...
#
define
freeblCipher_native_aes_cbc_worker
(
encrypt
keysize
)
...
16
?
freeblCipher_intel_aes_encrypt_cbc_128
\
:
(
keysize
...
24
?
freeblCipher_intel_aes_encrypt_cbc_192
\
:
...
16
?
freeblCipher_intel_aes_decrypt_cbc_128
\
:
(
keysize
...
24
?
freeblCipher_intel_aes_decrypt_cbc_192
\
:
...
16
?
freeblCipher_arm_aes_encrypt_ecb_128
\
:
(
keysize
...
24
?
freeblCipher_arm_aes_encrypt_ecb_192
\
:
...
16
?
freeblCipher_arm_aes_decrypt_ecb_128
\
:
(
keysize
...
24
?
freeblCipher_arm_aes_decrypt_ecb_192
\
:
...
16
?
freeblCipher_arm_aes_encrypt_cbc_128
\
:
(
keysize
...
24
?
freeblCipher_arm_aes_encrypt_cbc_192
\
:
...
16
?
freeblCipher_arm_aes_decrypt_cbc_128
\
:
(
keysize
...
24
?
freeblCipher_arm_aes_decrypt_cbc_192
\
:
...
encrypt
?
freeblCipher_rijndael_encryptCBC
:
freeblCipher_rijndael_decryptCBC
;
}
}
else
...
encrypt
?
freeblCipher_rijndael_encryptECB
:
freeblCipher_rijndael_decryptECB
;
}
}
PORT_Assert
...
encrypt
?
freeblCipher_CTS_EncryptUpdate
:
freeblCipher_CTS_DecryptUpdate
;
cx
-
>
destroy
=
freeblDestroy_CTS_DestroyContext
;
cx
-
>
...
encrypt
?
freeblCipher_intel_AES_GCM_EncryptUpdate
:
...
encrypt
?
freeblAead_intel_AES_GCM_EncryptAEAD
:
...
destroy
=
freeblDestroy_intel_AES_GCM_DestroyContext
;
cx
-
>
...
encrypt
?
freeblCipher_ppc_AES_GCM_EncryptUpdate
:
...
encrypt
?
freeblAead_ppc_AES_GCM_EncryptAEAD
:
...
destroy
=
freeblDestroy_ppc_AES_GCM_DestroyContext
;
cx
-
>
...
encrypt
?
freeblCipher_GCM_EncryptUpdate
:
...
destroy
=
freeblDestroy_GCM_DestroyContext
;
cx
-
>
...
worker
=
freeblCipher_CTR_Update_HW_AES
;
}
else
#
...
destroy
=
freeblDestroy_CTR_DestroyContext
;
cx
-
>
