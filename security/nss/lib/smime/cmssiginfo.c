...
version
=
NSS_CMS_SIGNER_INFO_VERSION_SUBJKEY
;
(
void
)
...
static
SECOidTag
NSS_CMSSignerInfo_GetSignatureAlgorithmOidTag
(
KeyType
keyType
SECOidTag
...
have
a
SMIME_ENCRYPTION_KEY_PREFERENCE
attribute
!
*
/
