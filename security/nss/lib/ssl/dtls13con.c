...
8
(
MASK_SEQUENCE_NUMBER_SHORT
)
or
16
bits
(
MASK_SEQUENCE_NUMBER_LONG
)
of
the
record
...
.
The
dtls13_maybeProcessKeyUpdateAck
function
is
called
when
...
/
SECStatus
dtls13_EnqueueKeyUpdateMessage
(
sslSocket
*
ss
