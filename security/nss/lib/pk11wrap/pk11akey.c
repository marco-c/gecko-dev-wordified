...
KeyType
pk11_getKeyTypeFromPKCS11KeyType
(
CK_KEY_TYPE
pk11KeyType
)
...
0
;
SECKEYPRIVATEKEY_SET_TEMP
(
privKey
isTemp
)
;
SECKEYPRIVATEKEY_SET_OWNED
(
privKey
isOwner
)
