...
PKIX_ERROR
(
PKIX_CERTNOTALLOWEDTOSIGNCERTIFICATES
)
;
}
else
...
PKIX_ERROR
(
PKIX_CERTSELECTORMATCHCERTVERSIONFAILED
)
;
}
}
...
PKIX_ERROR
(
PKIX_CERTSELECTORMATCHCERTISSUERFAILED
)
;
}
}
...
PKIX_ERROR
(
PKIX_CERTSELECTORMATCHCERTSERIALNUMFAILED
)
;
}
}
...
PKIX_ERROR
(
PKIX_CERTSELECTORMATCHCERTOBJECTFAILED
)
;
}
}
