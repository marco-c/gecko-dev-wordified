...
t
\
tCERT_DecodeCertificatePoliciesExtension
)
.
\
n
...
PKIX_ERROR
(
PKIX_CERTDECODECERTIFICATEPOLICIESEXTENSIONFAILED
)
;
}
/
...
PKIX_ERROR
(
PKIX_CERTDECODEPOLICYMAPPINGSEXTENSIONFAILED
)
;
}
PKIX_NULLCHECK_ONE
...
PKIX_ERROR
(
PKIX_CERTDECODEINHIBITANYEXTENSIONFAILED
)
;
}
}
...
PKIX_ERROR
(
PKIX_CERTDECODEALTNAMEEXTENSIONFAILED
)
;
}
cert
...
PKIX_ERROR
(
PKIX_CERTDECODEDERCERTIFICATEFAILED
)
;
}
PKIX_CHECK
...
PKIX_ERROR
(
PKIX_VERSIONVALUEMUSTBEV1V2ORV3
)
;
}
*
...
PKIX_ERROR
(
PKIX_SECOIDCOPYALGORITHMIDFAILED
)
;
}
/
...
PKIX_ERROR
(
PKIX_CERTDECODEOIDSEQUENCEFAILED
)
;
}
PORT_Free
...
PKIX_ERROR
(
PKIX_SECKEYEXTRACTPUBLICKEYFAILED
)
;
}
PKIX_CERT_DEBUG
...
PKIX_ERROR
(
PKIX_SIGNATUREDIDNOTVERIFYWITHTHEPUBLICKEY
)
;
}
if
...
PKIX_ERROR
(
PKIX_CERTCHECKCERTVALIDTIMESFAILED
)
;
}
cleanup
...
PKIX_ERROR
(
PKIX_DERDECODETIMECHOICEFAILED
)
;
}
PKIX_CHECK
...
PKIX_ERROR
(
PKIX_DECIPHERONLYKEYUSAGENOTSUPPORTED
)
;
}
status
...
PKIX_ERROR
(
PKIX_CERTFAILEDNAMECONSTRAINTSCHECKING
)
;
}
}
