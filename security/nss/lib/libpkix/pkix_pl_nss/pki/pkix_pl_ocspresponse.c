...
if
(
ocsp_CertIsOCSPDefaultResponder
(
response
-
>
...
rv
=
ocsp_GetVerifiedSingleResponseForCertID
(
response
-
>
...
{
cert_RememberOCSPProcessingFailure
(
cid
-
>
