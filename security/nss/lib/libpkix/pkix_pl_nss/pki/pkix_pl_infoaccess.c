...
PKIX_ERROR
(
PKIX_LOCATIONSTRINGNOTPROPERLYTERMINATED
)
;
}
/
...
PKIX_ERROR
(
PKIX_GENERALNAMESTRINGMISSINGLOCATIONTYPE
)
;
}
/
...
PKIX_ERROR
(
PKIX_GENERALNAMESTRINGMISSINGDOUBLESLASH
)
;
}
/
...
PKIX_ERROR
(
PKIX_GENERALNAMESTRINGMISSINGSERVERSITE
)
;
}
len
...
PKIX_ERROR
(
PKIX_NOTENOUGHNAMECOMPONENTSINGENERALNAME
)
;
}
/
