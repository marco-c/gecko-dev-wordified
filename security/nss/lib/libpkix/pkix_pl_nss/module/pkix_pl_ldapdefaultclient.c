...
PKIX_ERROR
(
PKIX_CANTDECODEBINDRESPONSEFROMSERVER
)
;
}
cleanup
...
PKIX_ERROR
(
PKIX_CANTDECODESEARCHRESPONSEFROMSERVER
)
;
}
PKIX_CHECK
...
PKIX_ERROR
(
PKIX_UNEXPECTEDRESULTCODEINRESPONSE
)
;
}
client
...
PKIX_ERROR
(
PKIX_SEARCHRESPONSEPACKETOFUNKNOWNTYPE
)
;
}
}
...
PKIX_ERROR
(
PKIX_LDAPDEFAULTCLIENTINILLEGALSTATE
)
;
}
PKIX_DECREF
...
*
Registers
PKIX_PL_LDAPDEFAULTCLIENT_TYPE
and
its
related
*
...
PKIX_ERROR
(
PKIX_LDAPCERTSTOREINILLEGALSTATE
)
;
}
}
