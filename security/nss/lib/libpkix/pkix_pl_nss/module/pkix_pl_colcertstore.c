...
PKIX_ERROR
(
PKIX_UNABLETOREADDERFROMCERTFILE
)
;
}
}
...
PKIX_ERROR
(
PKIX_UNABLETOREADDERFROMCRLFILE
)
;
}
}
...
PKIX_ERROR
(
PKIX_CANNOTOPENCOLLECTIONCERTSTORECONTEXTDIRECTORY
)
;
}
PKIX_COLLECTIONCERTSTORECONTEXT_DEBUG
...
PKIX_ERROR
(
PKIX_COLLECTIONCERTSTOREPOPULATECERTFAILED
)
;
}
PKIX_CHECK
...
*
Registers
PKIX_PL_COLLECTIONCERTSTORECONTEXT_TYPE
and
its
related
*
