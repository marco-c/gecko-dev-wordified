...
overwritten
in
HttpDefaultClient_RequestCreate
*
function
.
Default
...
PKIX_ERROR
(
PKIX_UNEXPECTEDERRORINESTABLISHINGCONNECTION
)
;
}
*
...
freeBuffSize
<
HTTP_MIN_AVAILABLE_BUFFER_SIZE
)
{
/
*
...
PKIX_ERROR
(
PKIX_HTTPDEFAULTCLIENTINILLEGALSTATE
)
;
}
}
...
PKIX_ERROR
(
PKIX_UNRECOGNIZEDPROTOCOLREQUESTED
)
;
}
if
...
PKIX_ERROR
(
PKIX_UNRECOGNIZEDREQUESTMETHOD
)
;
}
if
