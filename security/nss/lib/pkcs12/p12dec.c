...
destroyed
using
SEC_PKCS12DestroyPFX
*
/
static
SEC_PKCS12PFXItem
*
sec_pkcs12_decode_pfx
(
SECItem
*
der_pfx
...
key
=
sec_pkcs12_generate_key_from_password
(
algorithm
&
pfx
...
static
SECStatus
sec_pkcs12_convert_old_auth_safe
(
...
bag
=
sec_pkcs12_create_external_bag
(
baggage
)
;
...
SEC_PKCS12AuthenticatedSafe
*
sec_pkcs12_decode_authenticated_safe
(
SEC_PKCS12PFXItem
*
pfx
...
static
PRBool
sec_pkcs12_validate_encrypted_safe
(
SEC_PKCS12AuthenticatedSafe
*
asafe
...
theTemplate
=
SEC_PKCS12SafeContentsTemplate_OLD
;
}
rv
=
