...
/
PRUint8
rc2_computed_ciphertext
[
FIPS_RC2_ENCRYPT_LENGTH
]
;
PRUint8
rc2_computed_plaintext
[
FIPS_RC2_DECRYPT_LENGTH
]
;
...
/
PRUint8
rc4_computed_ciphertext
[
FIPS_RC4_ENCRYPT_LENGTH
]
;
PRUint8
rc4_computed_plaintext
[
FIPS_RC4_DECRYPT_LENGTH
]
;
...
/
PRUint8
des_computed_ciphertext
[
FIPS_DES_ENCRYPT_LENGTH
]
;
PRUint8
des_computed_plaintext
[
FIPS_DES_DECRYPT_LENGTH
]
;
...
static
SECStatus
sftk_fips_RSA_PowerUpSigSelfTest
(
HASH_HashType
shaAlg
NSSLOWKEYPublicKey
...
const
PRUint8
ecdsa_known_P256_EncodedParams
[
]
=
{
...
const
PRUint8
ecdsa_known_K283_EncodedParams
[
]
=
{
...
static
CK_RV
sftk_fipsSoftwareIntegrityTest
(
void
)
{
