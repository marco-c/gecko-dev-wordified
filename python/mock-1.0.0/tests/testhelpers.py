...
def
test_any_mock_calls_comparison_order
(
self
)
:
...
def
test_signature_old_style_class
(
self
)
:
...
def
test_old_style_class_with_no_init
(
self
)
:
...
def
test_args_list_contains_call_list
(
self
)
:
