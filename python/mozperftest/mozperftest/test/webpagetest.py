...
self
.
create_and_run_wpt_threaded_tests
(
test_list
metadata
)
...
wpt_test_request_link
=
self
.
create_wpt_request_link
(
options
website
)
        
send_wpt_test_request
=
self
.
request_with_timeout
...
self
.
confirm_correct_browser_and_location
(
