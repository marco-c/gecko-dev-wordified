...
setting
'
MACH_HIDE_DEV_DRIVE_SUGGESTION
=
1
'
in
...
ignore_hgrc_state_dir_mismatch
=
os
.
environ
...
"
or
_macos_is_running_under_rosetta
(
)
:
...
self
.
_add_microsoft_defender_antivirus_exclusions
(
checkout_root
state_dir
)
...
def
extract_windows_version_number
(
raw_ver_output
)
:
...
def
_check_default_mozconfig_mismatch
(
...
blob
/
eaeb5b51c389866f207c52f1546389a336914e07
/
Documentation
/
config
...
def
jj_config_key_list_value_missing
(
jj_str
:
str
