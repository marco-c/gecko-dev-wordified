...
if
(
GetHasScreenAreaOverride
(
)
&
&
GetScreenWidthOverride
(
)
=
=
...
{
return
GetServiceWorkersDisabledByPolicy
(
)
;
}
...
-
>
GetAnimationsPlayBackRateMultiplier
(
)
;
}
...
FieldIndex
<
IDX_ServiceWorkersDisabledByPolicy
>
bool
ContentParent
*
...
FieldIndex
<
IDX_PrefersReducedMotionOverride
>
dom
:
:
...
FieldIndex
<
IDX_AnimationsPlayBackRateMultiplier
>
double
&
ContentParent
...
FieldIndex
<
IDX_OnePermittedSandboxedNavigatorId
>
const
uint64_t
&
...
FieldIndex
<
IDX_ForceEnableTrackingProtection
>
const
bool
&
...
FieldIndex
<
IDX_AndroidAppLinkLoadIdentifier
>
const
Maybe
<
