...
;
void
SetNeedsCompletelyLoadedDocument
(
bool
...
.
bool
GetIsCaptivePortalTab
(
)
const
;
void
SetIsCaptivePortalTab
(
bool
aIsCaptivePortalTab
)
;
void
ProhibitInitialAboutBlankHandling
(
)
{
...
bool
IsInitialAboutBlankHandlingProhibited
(
)
{
return
...
void
SetIsResumingInterceptedNavigation
(
bool
aIsResumingInterceptedNavigation
)
{
mIsResumingInterceptedNavigation
=
aIsResumingInterceptedNavigation
;
}
...
bool
HasComputedNamedTargetBrowsingContext
(
)
const
{
return
mHasComputedNamedTargetBrowsingContext
;
}
void
SetHasComputedNamedTargetBrowsingContext
(
bool
aValue
)
...
:
ClassificationFlags
mTriggeringClassificationFlags
;
/
/
The
...
.
bool
mNeedsCompletelyLoadedDocument
;
/
/
If
