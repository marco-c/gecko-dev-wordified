...
constexpr
uint64_t
kBrowsingContextGroupIdTotalBits
=
53
;
static
constexpr
uint64_t
kBrowsingContextGroupIdProcessBits
=
22
;
static
...
static
uint64_t
GenerateBrowsingContextGroupId
(
uint64_t
aFlags
)
...
static
uint64_t
GetBrowsingContextGroupIdFlags
(
uint64_t
aId
)
