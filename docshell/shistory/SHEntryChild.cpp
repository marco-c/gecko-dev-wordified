...
-
>
SendNotifyListenersContentViewerEvicted
(
aNumEvicted
)
;
...
(
!
SendGetStoragePrincipalToInherit
(
&
storagePrincipalToInherit
)
...
{
return
SendSetStoragePrincipalToInherit
(
aStoragePrincipalToInherit
)
?
...
{
return
SendGetScrollRestorationIsManual
(
aIsManual
)
?
...
{
return
SendSetScrollRestorationIsManual
(
aIsManual
)
?
...
child
;
SendGetChildSHEntryIfHasNoDynamicallyAddedChild
(
aChildOffset
&
child
...
<
<
SendSyncTreesForSubframeNavigation
(
static_cast
<
SHEntryChild
