...
.
#
assertParentProcessScriptAccess
(
context
)
;
...
#
getBrowsingContextIdByInnerWindowId
(
innerWindowId
)
{
...
{
const
workerBrowsingContextIds
=
this
.
#
getWorkerBrowsingContexts
(
workerData
)
;
...
#
hasEventSubscriptionToContextCreated
(
browsingContext
)
{
