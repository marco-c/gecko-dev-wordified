...
;
class
SeerPredictionRunner
;
struct
SeerTelemetryAccumulators
;
class
SeerDNSListener
;
...
friend
class
SeerCommitTimerInitEvent
;
friend
class
SeerNewTransactionEvent
;
friend
class
SeerCleanupEvent
...
friend
class
SeerPrepareForDnsTestEvent
;
void
PrepareForDnsTestInternal
(
int64_t
timestamp
const
