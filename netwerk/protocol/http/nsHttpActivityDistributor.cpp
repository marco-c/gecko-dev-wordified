...
-
>
SendOnHttpActivityDistributorActivated
(
true
)
;
...
-
>
SendOnHttpActivityDistributorObserveProxyResponse
(
aObserveProxyResponse
)
;
...
-
>
SendOnHttpActivityDistributorObserveConnection
(
aObserveConnection
)
;
