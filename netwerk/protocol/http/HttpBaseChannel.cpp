...
static
OpaqueResponseFilterFetch
ConfiguredFilterFetchResponseBehaviour
(
)
{
uint32_t
...
{
StoreIsUserAgentHeaderOutdated
(
aValue
)
;
...
aChannel
"
BlockJsonModuleWithWrongMimeType
"
aURI
contentType
Report
...
-
>
SetAllRedirectsSameOriginIgnoringInternal
(
config
.
timedChannelInfo
...
:
:
network_http_origin_useTriggeringPrincipal
(
)
)
{
