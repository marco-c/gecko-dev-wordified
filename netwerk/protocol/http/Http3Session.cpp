...
:
:
network_http_http3_use_nspr_for_io
(
)
|
|
...
:
:
network_trr_idle_timeout_for_http3_conn
(
)
:
StaticPrefs
:
:
network_http_http3_idle_timeout
(
)
;
/
...
:
:
network_trr_fast_pto_for_http3_conn
(
)
:
0
...
aError
.
transport_internal_error_other
.
_0
=
=
...
:
:
network_http_http3_0rtt_timeout
(
)
;
if
...
:
:
network_http_http3_fallback_to_h2_on_error
(
)
)
{
...
const
uint32_t
HTTP3_TELEMETRY_TRANSPORT_UNKNOWN
=
17
;
const
uint32_t
HTTP3_TELEMETRY_TRANSPORT_CRYPTO_UNKNOWN
=
18
;
/
...
uint64_t
GetTransportErrorCodeForTelemetry
(
nsCString
&
key
...
const
uint32_t
HTTP3_TELEMETRY_APP_UNKNOWN_1
=
17
;
const
uint32_t
HTTP3_TELEMETRY_APP_START
=
18
;
/
...
const
uint32_t
HTTP3_TELEMETRY_APP_QPACK_START
=
38
;
/
...
const
uint32_t
HTTP3_TELEMETRY_APP_UNKNOWN_3
=
41
;
uint64_t
GetAppErrorCodeForTelemetry
(
uint64_t
error
)
