...
static
OpaqueResponseMediaException
ConfiguredMediaExceptionsStrategy
(
)
{
uint32_t
...
static
bool
IsOpaqueSafeListedSpecBreakingMIMEType
(
const
nsACString
&
...
:
:
EnsureOpaqueResponseIsAllowedAfterJavaScriptValidation
(
HttpBaseChannel
*
aChannel
