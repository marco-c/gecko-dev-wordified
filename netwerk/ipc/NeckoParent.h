...
*
AllocPCacheEntryWriteHandleParent
(
PHttpChannelParent
*
channel
...
;
bool
DeallocPCacheEntryWriteHandleParent
(
PCacheEntryWriteHandleParent
*
aActor
...
:
IPCResult
RecvGetMozNewTabWallpaperStream
(
nsIURI
*
aURI
...
&
aLoadInfoArgs
GetMozNewTabWallpaperStreamResolver
&
&
aResolve
)
