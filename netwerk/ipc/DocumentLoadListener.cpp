...
-
>
SetActivatedFromNavigationalPrefetch
(
true
)
;
...
:
:
privacy_containers_switchDuringNavigation_enabled
(
)
)
{
...
set
the
granularFingerprintingProtection
field
when
opening
http
...
:
:
dom_location_ancestorOrigins_enabled
(
)
)
{
...
-
>
SetServiceWorkersDisabledByPolicy
(
dom
:
:
...
;
bool
hasOriginAgentCluster
=
StaticPrefs
:
:
dom_origin_agent_cluster_default
(
)
&
&
