...
:
IPCResult
RecvClearPrivateBrowsingSessionCache
(
ClearPrivateBrowsingSessionCacheResolver
&
&
aResolve
)
...
:
IPCResult
RecvGetSSLTokensCacheData
(
GetSSLTokensCacheDataResolver
&
&
aResolve
)
...
:
IPCResult
RecvFlushSSLTokensCache
(
FlushSSLTokensCacheResolver
&
&
aResolver
)
