...
static
bool
allocate_and_populate_compressed_texture
(
const
GrSurfaceDesc
&
...
RenderbufferStorageMultisampleES2EXT
(
GR_GL_RENDERBUFFER
sampleCount
format
...
.
int
firstWorkingStencilFormatIndex
=
-
1
;
...
GR_GL_EFFECTIVE_RASTER_SAMPLES
effectiveSampleCnt
)
;
}
