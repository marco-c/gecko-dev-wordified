...
#
define
SKC_RENDER_SCANLINE_VECTOR_EXPAND_I_LAST
0
#
elif
(
...
#
ifdef
SKC_RENDER_TILE_COVER_VECTOR
struct
{
SKC_RENDER_TILE_COVER_VECTOR
c
[
SKC_RENDER_TILE_COVER_VECTOR_COUNT
]
;
}
vN
...
#
ifdef
SKC_RENDER_TILE_COLOR_INTERLEAVED
union
{
SKC_RENDER_TILE_COLOR_INTERLEAVED
rgba
...
#
define
SKC_RENDER_FILL_MAX_AREA_RCP_F32
(
SKC_RENDER_TILE_COVER
)
(
...
#
ifndef
SKC_RENDER_GRADIENT_IS_GLOBAL
#
define
SKC_RENDER_GRADIENT_SPACE
__local
#
else
#
...
static
void
skc_tile_color_fill_gradient_linear_nonvertical
(
__local
union
skc_subgroup_smem
...
/
/
PXL_STYLING_GRADIENT_TYPE_LINEAR_REFLECTING
/
/
/
/
...
opencl_unroll_hint
(
SKC_RENDER_TILE_COVER_VECTOR_COUNTN
)
)
)
for
...
=
SKC_RENDER_TILE_COVER_VECTOR_ONE
;
#
endif
}
...
#
define
SKC_SURFACE_IS_BUFFER
#
ifdef
SKC_SURFACE_IS_BUFFER
static
void
skc_surface_composite_u8_rgba
(
__global
...
#
ifndef
SKC_TARGET_ARCH_COALESCED_LOAD_TTCK
skc_ttck_t
ttck
=
ttck_keys
