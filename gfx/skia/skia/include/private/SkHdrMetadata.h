...
of
the
GainCurveControlPointX
GainCurveControlPointY
and
/
/
GainCurveControlPointM
metadata
items
.
struct
...
/
The
GainApplicationSpaceColorPrimaries
metadata
item
.
SkColorSpacePrimaries
