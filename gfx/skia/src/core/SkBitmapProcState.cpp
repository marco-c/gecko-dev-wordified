...
:
SampleProc16
gSkBitmapProcStateSample16_neon
[
]
;
extern
...
SK_ARM_NEON_WRAP
(
Clamp_S16_D16_filter_DX_shaderproc
)
;
}
else
...
SK_ARM_NEON_WRAP
(
Repeat_S16_D16_filter_DX_shaderproc
)
;
}
}
