...
fFlags
&
kRenderTarget_GrPlatformTextureFlag
)
{
GrGLRenderTarget
:
...
GrStencilSettings
&
winding_nv_path_stencil_settings
(
)
{
...
GrStencilSettings
&
even_odd_nv_path_stencil_settings
(
)
{
GR_STATIC_CONST_SAME_STENCIL_STRUCT
