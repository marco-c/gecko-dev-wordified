...
OVR_PFN
*
pfn_ovr_ResetBackOfHeadTracking
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_ResetMulticameraTracking
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_CreateSwapTextureSetD3D11
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_CreateMirrorTextureD3D11
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_CreateSwapTextureSetGL
)
(
ovrSession
session
