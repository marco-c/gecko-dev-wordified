...
=
0x0010
ovrControllerType_Object0
=
0x0100
ovrControllerType_Object1
=
0x0200
ovrControllerType_Object2
=
0x0400
ovrControllerType_Object3
=
0x0800
...
=
0x0010
ovrTrackedDevice_Object1
=
0x0020
ovrTrackedDevice_Object2
=
0x0040
ovrTrackedDevice_Object3
=
0x0080
...
OVR_PFN
*
pfn_ovr_RecenterTrackingOrigin
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_ClearShouldRecenterFlag
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_SetControllerVibration
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_SubmitControllerVibration
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetControllerVibrationState
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_SetBoundaryLookAndFeel
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_ResetBoundaryLookAndFeel
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_RequestBoundaryVisible
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetTextureSwapChainLength
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetTextureSwapChainCurrentIndex
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetTextureSwapChainDesc
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_CommitTextureSwapChain
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_DestroyTextureSwapChain
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetPredictedDisplayTime
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_SetExternalCameraProperties
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_CreateTextureSwapChainDX
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetTextureSwapChainBufferDX
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetMirrorTextureBufferDX
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_CreateTextureSwapChainGL
)
(
ovrSession
session
...
OVR_PFN
*
pfn_ovr_GetMirrorTextureBufferGL
)
(
ovrSession
session
