...
:
:
TSurfaceDescriptorShmem
:
case
SurfaceDescriptor
:
:
TSurfaceDescriptorMemory
:
{
result
=
...
:
:
CreateDrawTargetForD3D10Texture
(
mTexture
mFormat
)
