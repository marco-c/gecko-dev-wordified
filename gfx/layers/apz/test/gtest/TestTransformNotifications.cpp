...
"
class
APZCTransformNotificationTester
:
public
APZCTreeManagerTester
{
...
(
APZCTransformNotificationTester
PanWithMomentumTransformNotifications
)
{
SetupBasicTest
(
...
(
APZCTransformNotificationTester
PanOverscrollTransformNotifications
)
{
SCOPED_GFX_PREF_BOOL
(
