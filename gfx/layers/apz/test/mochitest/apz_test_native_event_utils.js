...
{
promiseNativeMouseMoveAndWaitForMoveEvent
(
aTarget
aX
aY
...
.
function
promiseNativeMouseClickWithAPZ
(
aParams
)
{
...
.
function
synthesizeNativeMouseClickWithAPZAndWaitForClickEvent
(
aParams
aCallback
=
...
synthesizeNativeMouseClickWithAPZAndWaitForClickEvent
function
promiseNativeMouseClickWithAPZAndClickEvent
(
aParams
)
{
...
Note
:
helper_scrollbar_snap_bug1501062
.
html
contains
a
...
/
await
myIndicationThatDragHadAnEffect
;
/
/
await
