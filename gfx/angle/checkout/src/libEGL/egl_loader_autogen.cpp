...
;
PFNEGLUNLOCKVULKANQUEUEANGLEPROC
l_EGL_UnlockVulkanQueueANGLE
;
PFNEGLACQUIREEXTERNALCONTEXTANGLEPROC
l_EGL_AcquireExternalContextANGLE
;
PFNEGLRELEASEEXTERNALCONTEXTANGLEPROC
l_EGL_ReleaseExternalContextANGLE
;
...
;
PFNEGLSETVALIDATIONENABLEDANGLEPROC
l_EGL_SetValidationEnabledANGLE
;
...
l_EGL_WaitUntilWorkScheduledANGLE
;
