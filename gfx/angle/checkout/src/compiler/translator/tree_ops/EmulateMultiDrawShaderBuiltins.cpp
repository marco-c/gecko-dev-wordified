...
;
class
AddBaseVertexToGLVertexIDTraverser
:
public
TIntermTraverser
{
...
TVariable
*
getGLBaseVertexBuiltinVariable
(
)
{
return
...
TVariable
*
getGLBaseInstanceBuiltinVariable
(
)
{
return
