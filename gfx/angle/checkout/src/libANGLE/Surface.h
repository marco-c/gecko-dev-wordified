...
;
bool
isCurrentOnAnyContext
(
)
const
{
return
mIsCurrentOnAnyContext
;
}
gl
:
...
{
return
mBufferAgeQueriedSinceLastSwap
;
}
void
setDamageRegion
...
buffer
EGLenum
mRequestedSwapBehavior
;
EGLint
mRequestedSwapInterval
;
EGLint
mOrientation
;
