...
:
:
kFramebufferIncompleteUnsupportedSeparateDepthStencilBuffers
)
;
}
/
...
:
:
kFramebufferIncompleteUnsupportedNonUniqueAttachments
)
;
}
}
...
:
:
kFramebufferIncompleteUnsupportedMissmatchedDimensions
)
;
}
return
