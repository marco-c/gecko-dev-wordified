...
#
ifndef
LIBANGLE_RENDERER_D3D_PROGRAMD3D_H_
#
define
LIBANGLE_RENDERER_D3D_PROGRAMD3D_H_
#
...
;
bool
areVertexUniformsDirty
(
)
const
{
return
mVertexUniformsDirty
;
}
bool
areFragmentUniformsDirty
(
)
const
{
...
bool
areComputeUniformsDirty
(
)
const
{
return
mComputeUniformsDirty
;
}
const
std
...
;
class
GetVertexExecutableTask
;
class
GetPixelExecutableTask
;
class
GetGeometryExecutableTask
;
class
VertexExecutable
{
...
;
void
defineArrayOfStructsUniformFields
(
GLenum
shaderType
const
...
;
void
updateCachedOutputLayoutFromShader
(
)
;
void
