...
;
AttributesMask
getVertexArraysAttributeMask
(
)
const
;
AttributesMask
getActiveAttributesMask
(
)
const
;
bool
shouldHandleDirtyProgram
(
)
;
void
...
DirtyGles1Type
{
DIRTY_GLES1_TEXTURE_UNIT_ENABLE
=
0
