...
framebuffer
is
FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE
or
the
number
of
...
MultisampleArrayExtensionRequired
)
;
return
false
...
return
kErrorStencilReferenceMaskOrMismatch
;
}
}
}
...
.
return
kErrorDrawFramebufferIncomplete
;
}
if
(
...
error
return
kErrorVertexArrayNoBufferPointer
;
}
}
/
...
{
return
kErrorNoActiveGraphicsShaderStage
;
}
if
(
...
{
return
kErrorMultiviewTransformFeedback
;
}
if
(
...
{
return
kErrorUniformBufferBoundForTransformFeedback
;
}
}
/
...
{
return
kErrorTransformFeedbackBufferDoubleBound
;
}
/
/
...
{
return
kErrorVertexShaderTypeMismatch
;
}
/
/
...
{
return
kErrorVertexBufferBoundForTransformFeedback
;
}
}
}
...
InvalidMultisampledFramebufferOperation
)
;
return
false
...
TextureWidthOrHeightOutOfRange
)
;
return
false
...
UnsizedInternalFormatUnsupported
)
;
return
false
