...
;
case
GL_PROGRAM_CACHE_ENABLED_ANGLE
:
return
mProgramBinaryCacheEnabled
;
...
:
:
setGenericAtomicCounterBufferBinding
(
const
Context
*
...
:
:
setIndexedAtomicCounterBufferBinding
(
const
Context
*
...
:
:
setGenericShaderStorageBufferBinding
(
const
Context
*
...
:
:
setIndexedShaderStorageBufferBinding
(
const
Context
*
...
;
case
GL_COVERAGE_MODULATION_CHROMIUM
:
params
[
0
