...
mSampleAlphaToCoverageEnabled
(
false
)
mSampleCoverageEnabled
(
false
)
...
mProgramTexturesAndSamplersDirty
(
true
)
{
...
calls
.
setTextureCubemapSeamlessEnabled
(
context
-
>
...
{
updateProgramTextureAndSamplerBindings
(
context
)
;
...
;
applyViewportOffsetsAndSetScissors
(
scissor
*
drawFramebuffer
...
;
applyViewportOffsetsAndSetViewports
(
viewport
*
drawFramebuffer
...
:
:
DIRTY_BIT_SAMPLE_MASK_WORD_MAX
)
{
GLuint
maskNumber
