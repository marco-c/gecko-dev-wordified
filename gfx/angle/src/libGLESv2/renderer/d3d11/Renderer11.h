...
#
ifndef
LIBGLESV2_RENDERER_RENDERER11_H_
#
define
LIBGLESV2_RENDERER_RENDERER11_H_
#
...
virtual
int
getMaxRecommendedElementsIndices
(
)
const
;
virtual
int
getMaxRecommendedElementsVertices
(
)
const
;
...
static
void
invalidateRenderbufferSwizzles
(
gl
:
:
