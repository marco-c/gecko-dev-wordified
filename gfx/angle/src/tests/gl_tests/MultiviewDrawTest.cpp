...
Vector2
>
ConvertPixelCoordinatesToClipSpace
(
const
std
:
...
GLuint
drawAndRetrieveOcclusionQueryResult
(
GLuint
program
)
...
(
MultiviewDrawValidationTest
NumViewsMismatchForNonMultiviewProgram
)
{
if
(
...
(
MultiviewRenderTest
ProgramRelinkUpdatesAttribDivisor
)
{
if
(
...
(
MultiviewSideBySideRenderTest
ViewportOffsetsAppliedBugCoverage
)
{
if
(
