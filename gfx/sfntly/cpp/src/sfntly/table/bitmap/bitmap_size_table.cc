...
:
:
kBitmapSizeTable_indexSubTableArrayOffset
)
;
}
int32_t
...
:
:
kBitmapSizeTable_indexTableSize
)
;
}
int32_t
...
:
:
kBitmapSizeTable_startGlyphIndex
)
;
}
int32_t
...
:
:
kBitmapSizeTable_endGlyphIndex
)
;
}
int32_t
...
:
:
kBitmapSizeTable_numberOfIndexSubTables
)
;
}
IndexSubTable
