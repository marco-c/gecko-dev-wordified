...
;
bool
mSupportsHardwareOverlayRGB10A2
=
false
;
bool
mSupportsHardwareOverlayRGBA16F
=
false
;
DXGI_FORMAT
...
;
bool
SupportsHardwareOverlayRGB10A2
(
)
;
bool
SupportsHardwareOverlayRGBA16F
(
)
;
DXGI_FORMAT
...
>
>
mAvailableTextureHolders
;
UniquePtr
<
TextureHolder
>
mCurrentTextureHolder
;
UniquePtr
<
TextureHolder
>
mPresentingTextureHolder
;
}
;
class
...
.
bool
mFailedVideoProcessorBltYUVHLGToRGBPQ
=
false
;
/
...
ID3D11Buffer
>
mShaderBltIndexBuffer
;
RefPtr
<
ID3D11Buffer
>
mShaderBltVertexBuffer
;
RefPtr
<
ID3D11InputLayout
>
mShaderBltInputLayout
;
RefPtr
<
ID3D11RasterizerState
>
mShaderBltRasterizerState
;
RefPtr
<
ID3D11BlendState
>
mShaderBltBlendState
;
RefPtr
<
ID3D11Buffer
>
mShaderBltConstantBuffer
;
RefPtr
<
ID3D11SamplerState
