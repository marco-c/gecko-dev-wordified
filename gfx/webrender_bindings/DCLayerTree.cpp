...
static
void
AddProfileMarkerForNvidiaVpSuperResolutionInfo
(
ID3D11VideoContext
*
aVideoContext
...
static
bool
GetNvidiaRTXVideoTrueHDRSupported
(
ID3D11VideoContext
*
aVideoContext
...
:
:
gfx_webrender_dcomp_video_check_slow_present
(
)
)
{
...
:
:
gfx_webrender_dcomp_color_manage_with_filters
(
)
)
return
...
:
:
gfx_webrender_swap_chain_allow_tearing_AtStartup
(
)
)
{
...
ID3D11ClassInstance
*
savedVertexShaderClassInstances
[
D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT
]
=
...
:
:
gfx_color_management_hdr_yuv_to_rgb_video_shader_always
(
)
)
{
