...
static
bool
FontconfigUnparseOmitsStringEscapes
(
)
{
static
...
FcPattern
>
MaybeEscapeFamilyForBrokenUnparse
(
FcPattern
*
aPattern
...
:
:
gfx_font_rendering_fontconfig_skip_legacy_fonts
(
)
)
{
