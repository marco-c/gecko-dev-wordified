...
static
glitz_gl_float_t
_glitz_gl_version_string_to_float
(
const
char
*
...
static
void
_glitz_gl_proc_address_lookup
(
glitz_backend_t
*
backend
glitz_get_proc_address_proc_t
get_proc_address
void
*
closure
...
=
(
glitz_gl_delete_renderbuffers_t
)
get_proc_address
(
"
...
=
(
glitz_gl_renderbuffer_storage_t
)
get_proc_address
(
"
...
get_integer_v
(
GLITZ_GL_MAX_RECTANGLE_TEXTURE_SIZE
&
backend
-
>
...
push_attrib
(
GLITZ_GL_TRANSFORM_BIT
|
GLITZ_GL_VIEWPORT_BIT
)
;
gl
-
...
hint
(
GLITZ_GL_PERSPECTIVE_CORRECTION_HINT
GLITZ_GL_FASTEST
)
;
gl
