...
static
int
_compare_cairo_edge_by_current_x_slope
(
const
void
*
...
#
define
CAIRO_TRAPS_USE_NEW_INTERSECTION_CODE
0
#
if
CAIRO_TRAPS_USE_NEW_INTERSECTION_CODE
...
/
cairo_status_t
_cairo_traps_tessellate_polygon
(
cairo_traps_t
*
traps
