...
#
ifndef
CAIRO_SCALED_FONT_SUBSETS_PRIVATE_H
#
define
CAIRO_SCALED_FONT_SUBSETS_PRIVATE_H
#
...
(
int
max_glyphs_unscaled_per_subset
int
max_glyphs_scaled_per_subset
)
;
/
*
