...
#
define
CAIRO_SURFACE_RENDER_HAS_EXTENDED_REPEAT
(
surface
)
CAIRO_SURFACE_RENDER_AT_LEAST
...
#
define
CAIRO_SURFACE_RENDER_HAS_GRADIENTS
(
surface
)
CAIRO_SURFACE_RENDER_AT_LEAST
...
#
define
CAIRO_SURFACE_RENDER_HAS_PDF_OPERATORS
(
surface
)
CAIRO_SURFACE_RENDER_AT_LEAST
...
display
(
cairo_xlib_notify_resource_func
)
XFreePixmap
surface
-
...
_cairo_xlib_remove_close_display_hook
(
display
&
surface
...
inline
uint32_t
_pseudocolor_from_rgb888_dither
(
...
status
=
_cairo_xlib_screen_get_visual_info
(
display
surface
-
...
static
void
_cairo_xlib_surface_set_picture_clip_rects
(
cairo_xlib_display_t
*
display
...
static
void
_cairo_xlib_surface_set_precision
(
cairo_xlib_display_t
*
display
...
static
cairo_int_status_t
_cairo_xlib_surface_acquire_pattern_surface
(
cairo_xlib_display_t
*
display
...
static
cairo_int_status_t
_cairo_xlib_surface_acquire_pattern_surfaces
(
cairo_xlib_display_t
*
display
...
=
*
_cairo_xlib_screen_get_font_options
(
surface
-
>
...
_cairo_xlib_display_get_xrender_version
(
display
&
surface
...
_cairo_xlib_surface_detach_display
;
_cairo_xlib_add_close_display_hook
(
display
&
surface
...
typedef
struct
_cairo_xlib_font_glyphset_free_glyphs
{
GlyphSet
glyphset
;
...
cairo_xlib_font_glyphset_info_t
*
_cairo_xlib_scaled_glyph_get_glyphset_info
(
cairo_scaled_glyph_t
*
scaled_glyph
...
static
void
_cairo_xlib_scaled_glyph_set_glyphset_info
(
cairo_scaled_glyph_t
*
scaled_glyph
...
static
int
_cairo_xlib_get_glyphset_index_for_format
(
cairo_format_t
format
)
...
cairo_xlib_font_glyphset_info_t
*
_cairo_xlib_scaled_font_get_glyphset_info_for_format
(
cairo_scaled_font_t
*
scaled_font
...
between
*
_cairo_xlib_surface_emit_glyphs
and
_emit_glyph_chunks
*
/
...
cairo_scaled_font_t
*
_cairo_xlib_get_grayscale_font
(
cairo_xlib_display_t
*
display
