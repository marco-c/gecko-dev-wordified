...
static
cairo_bool_t
_cairo_gl_get_image_format_and_type_gles2
(
...
static
cairo_bool_t
_cairo_gl_get_image_format_and_type_gl
(
pixman_format_code_t
pixman_format
GLenum
...
static
cairo_status_t
_cairo_gl_surface_extract_image_data
(
...
static
void
_cairo_gl_surface_embedded_operand_init
(
cairo_gl_surface_t
*
surface
...
if
(
_cairo_gl_device_requires_power_of_two_textures
(
surface
-
>
...
static
cairo_bool_t
_cairo_gl_surface_size_valid_for_context
(
cairo_gl_context_t
*
ctx
...
cairo_surface_t
*
_cairo_gl_surface_create_scratch_for_texture
(
cairo_gl_context_t
*
ctx
...
cairo_surface_t
*
_cairo_gl_surface_create_scratch_for_caching
(
cairo_gl_context_t
*
ctx
...
static
cairo_int_status_t
_cairo_gl_surface_fill_alpha_channel
(
cairo_gl_surface_t
*
dst
...
CLEANUP
;
_cairo_gl_composite_set_solid_source
(
&
setup
CAIRO_COLOR_BLACK
...
status
=
_cairo_gl_surface_resolve_multisampling
(
dst
)
;
...
_cairo_gl_context_destroy_operand
(
ctx
CAIRO_GL_TEX_SOURCE
)
