...
typedef
struct
_cairo_cogl_texture_attributes
{
/
*
nabbed
...
typedef
struct
_cairo_cogl_journal_clip_entry
{
cairo_cogl_journal_entry_t
base
;
...
typedef
struct
_cairo_cogl_journal_rect_entry
{
cairo_cogl_journal_entry_t
base
;
...
typedef
struct
_cairo_cogl_journal_prim_entry
{
cairo_cogl_journal_entry_t
base
;
...
static
cairo_status_t
_cairo_cogl_surface_ensure_framebuffer
(
cairo_cogl_surface_t
*
surface
...
static
void
_cairo_cogl_journal_log_primitive
(
cairo_cogl_surface_t
*
surface
...
static
void
_cairo_cogl_journal_log_rectangle
(
cairo_cogl_surface_t
*
surface
...
static
cairo_int_status_t
_cairo_cogl_get_untransformed_path
(
cairo_path_fixed_t
*
copy
...
static
cairo_bool_t
_cairo_cogl_stroke_style_equal
(
const
cairo_stroke_style_t
*
...
static
cairo_int_status_t
_cairo_cogl_stroke_to_primitive
(
cairo_cogl_surface_t
*
surface
...
static
void
_cairo_cogl_set_path_prim_clip
(
cairo_cogl_surface_t
*
surface
...
CoglPipeline
*
_cairo_cogl_setup_unbounded_area_pipeline
(
cairo_cogl_surface_t
*
surface
...
static
void
_cairo_cogl_post_unbounded_render
(
cairo_cogl_surface_t
*
surface
...
get_components_from_cairo_content
(
cairo_content_t
content
)
...
static
CoglPixelFormat
get_cogl_format_from_cairo_format
(
cairo_format_t
cairo_format
)
...
static
cairo_format_t
get_cairo_format_from_cogl_format
(
CoglPixelFormat
format
)
...
static
cairo_status_t
_cairo_cogl_surface_read_rect_to_image_surface
(
cairo_cogl_surface_t
*
surface
...
CoglTexture
*
_cairo_cogl_acquire_cogl_surface_texture
(
cairo_cogl_surface_t
*
reference_surface
...
CoglTexture
*
_cairo_cogl_acquire_recording_surface_texture
(
cairo_cogl_surface_t
*
reference_surface
...
CoglTexture
*
_cairo_cogl_acquire_generic_surface_texture
(
cairo_cogl_surface_t
*
reference_surface
...
CoglTexture
*
_cairo_cogl_acquire_pattern_texture
(
const
cairo_pattern_t
*
...
static
void
set_layer_texture_with_attributes
(
CoglPipeline
*
pipeline
...
static
void
get_source_mask_operator_destination_pipelines
(
cairo_cogl_pipeline_t
*
*
...
CoglPrimitive
*
_cairo_cogl_rectangle_new_p2t2t2
(
CoglContext
*
cogl_context
