...
;
void
fbFetchTransformed64_accessors
(
bits_image_t
*
int
...
;
void
fbStoreExternalAlpha64_accessors
(
bits_image_t
*
int
...
;
void
fbFetchExternalAlpha64_accessors
(
bits_image_t
*
int
