...
(
"
MOZILLA_XPRINT_DISABLE_BROKEN_XFREE86_WARNING
"
)
!
=
...
(
"
MOZILLA_XPRINT_EXPERIMENTAL_SYNCHRONIZE
"
)
!
=
...
#
ifdef
XPRINT_DEBUG_SOMETIMES_USEFULL
dumpXpAttributes
(
mPDisplay
mPContext
...
:
Need
NS_ConvertUCS2ToLocalEncoding
(
)
and
*
NS_ConvertLocalEncodingToUCS2
(
)
"
)
...
we
enable
XPRINT_SERVER_SIDE_ALPHA_COMPOSING
*
we
have
to
...
PRInt32
srcimg_bytes_per_line
=
row_bytes
;
PRInt32
dstimg_bytes_per_line
=
ROUNDUP
(
(
