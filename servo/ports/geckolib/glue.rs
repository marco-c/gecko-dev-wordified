...
fn
check_element_and_eager_pseudos
(
element
:
&
...
;
let
origins_in_which_rules_changed
=
document_data
.
stylist
...
changed
:
Servo_StyleSet_StyleRuleChanged
}
#
[
no_mangle
...
changed
:
Servo_StyleSet_ImportRuleChanged
}
impl_basic_rule_funcs_without_getter
!
{
...
getter
:
Servo_CssRules_GetKeyframesRuleAt
debug
:
...
changed
:
Servo_StyleSet_KeyframesRuleChanged
}
impl_group_rule_funcs
!
{
...
changed
:
Servo_StyleSet_MediaRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetMarginRuleAt
debug
:
...
changed
:
Servo_StyleSet_MarginRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetCustomMediaRuleAt
debug
:
...
changed
:
Servo_StyleSet_CustomMediaRuleChanged
}
impl_basic_rule_funcs
!
{
...
changed
:
Servo_StyleSet_PageRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetPropertyRuleAt
debug
:
...
changed
:
Servo_StyleSet_PropertyRuleChanged
}
impl_group_rule_funcs
!
{
...
changed
:
Servo_StyleSet_SupportsRuleChanged
}
impl_group_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetContainerRuleAt
debug
:
...
changed
:
Servo_StyleSet_ContainerRuleChanged
}
impl_group_rule_funcs
!
{
...
get_rules
:
Servo_LayerBlockRule_GetRules
getter
:
Servo_CssRules_GetLayerBlockRuleAt
debug
:
Servo_LayerBlockRule_Debug
to_css
:
Servo_LayerBlockRule_GetCssText
changed
:
Servo_StyleSet_LayerBlockRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetLayerStatementRuleAt
debug
:
Servo_LayerStatementRule_Debug
to_css
:
Servo_LayerStatementRule_GetCssText
changed
:
Servo_StyleSet_LayerStatementRuleChanged
}
impl_group_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetDocumentRuleAt
debug
:
...
changed
:
Servo_StyleSet_DocumentRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetFontFeatureValuesRuleAt
debug
:
...
changed
:
Servo_StyleSet_FontFeatureValuesRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetFontPaletteValuesRuleAt
debug
:
...
changed
:
Servo_StyleSet_FontPaletteValuesRuleChanged
}
impl_basic_rule_funcs
!
{
...
changed
:
Servo_StyleSet_FontFaceRuleChanged
}
impl_basic_rule_funcs
!
{
...
changed
:
Servo_StyleSet_CounterStyleRuleChanged
}
impl_group_rule_funcs
!
{
...
changed
:
Servo_StyleSet_ScopeRuleChanged
}
impl_group_rule_funcs
!
{
...
get_rules
:
Servo_StartingStyleRule_GetRules
getter
:
Servo_CssRules_GetStartingStyleRuleAt
debug
:
Servo_StartingStyleRule_Debug
to_css
:
Servo_StartingStyleRule_GetCssText
changed
:
Servo_StyleSet_StartingStyleRuleChanged
}
impl_group_rule_funcs
!
{
...
get_rules
:
Servo_AppearanceBaseRule_GetRules
getter
:
Servo_CssRules_GetAppearanceBaseRuleAt
debug
:
Servo_AppearanceBaseRule_Debug
to_css
:
Servo_AppearanceBaseRule_GetCssText
changed
:
Servo_StyleSet_AppearanceBaseRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetPositionTryRuleAt
debug
:
...
changed
:
Servo_StyleSet_PositionTryRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetNestedDeclarationsRuleAt
debug
:
...
changed
:
Servo_StyleSet_NestedDeclarationsRuleChanged
}
impl_basic_rule_funcs
!
{
...
getter
:
Servo_CssRules_GetViewTransitionRuleAt
debug
:
Servo_ViewTransitionRule_Debug
to_css
:
Servo_ViewTransitionRule_GetCssText
changed
:
Servo_StyleSet_ViewTransitionRuleChanged
}
#
[
no_mangle
...
"
fn
Servo_StyleRule_GetSelectorList
(
rules
:
&
...
"
fn
Servo_StyleRule_GetSelectorDataAtIndex
(
rules
:
&
...
fn
desugared_selector_list_with_scope
(
quirks_mode
:
QuirksMode
...
"
fn
Servo_StyleRule_GetScopeRootFor
(
rules
:
&
...
"
fn
Servo_SelectorList_QueryAllWithScope
(
node
:
&
...
"
fn
Servo_ImportRule_GetSupportsText
(
rule
:
&
...
macro_rules
!
simple_font_descriptor_getter_impl
{
(
rule
:
...
fn
get_functional_pseudo_parameter_atom
(
...
"
fn
Servo_SerializeTimelineRangeName
(
range_name
:
specified
...
"
fn
Servo_DeclarationBlock_SanitizeForCanvas
(
declarations
:
&
...
"
fn
Servo_MediaList_IsViewportDependent
(
list
:
&
...
fn
simulate_compute_values_failure
(
property
:
&
...
let
mut
properties_set_at_current_offset
=
PropertyDeclarationIdSet
:
:
...
let
mut
has_complete_initial_keyframe
=
false
;
let
mut
has_complete_final_keyframe
=
false
;
let
...
;
let
get_timing_func_and_composition
=
|
step
:
...
:
:
Gecko_GetOrCreateKeyframeWithRangeName
(
&
mut
keyframes_with_range_names
...
:
:
element_container_dependency_kind
(
element
local_name
&
...
fn
inherit_relative_selector_search_direction
(
parent
:
Option
...
pub
enum
RelativeSelectorNthEdgeInvalidateFor
{
First
Last
}
...
"
fn
Servo_ComputedValues_GetPropertyTypedValueList
(
style
:
&
...
fn
process_relative_selector_invalidations
(
element
:
&
...
"
fn
Servo_ResolveCalcLengthPercentage
(
calc
:
&
...
"
fn
Servo_FontStretch_SerializeKeyword
(
s
:
&
...
"
fn
Servo_FontFamilyList_WithNames
(
names
:
&
...
"
fn
Servo_LayerStatementRule_GetNameCount
(
rule
:
&
...
"
fn
Servo_LayerStatementRule_GetNameAt
(
rule
:
&
...
"
fn
Servo_ViewTransitionRule_GetNavigation
(
rule
:
&
...
"
fn
Servo_ParseLengthWithoutStyleContext
(
len
:
&
...
;
let
is_previous_byte_carriage_return
=
last_byte
=
=
...
false
"
ResolvePositionAreaSelfAlignment
called
on
{
:
