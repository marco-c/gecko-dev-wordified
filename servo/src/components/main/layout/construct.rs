...
TableColumn
Box
TableColumnBoxConstructionItem
(
Box
)
}
...
pub
fn
build_specific_box_info_for_node
(
&
mut
self
...
fn
flush_inline_boxes_to_flow_or_list
(
&
mut
self
...
.
fn
flush_inline_boxes_to_flow_or_list_if_necessary
(
&
mut
self
...
self
.
set_inline_info_for_inline_child
(
&
total
node
