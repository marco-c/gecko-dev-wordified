...
.
fn
collect_static_b_offsets_from_kids
(
&
mut
self
...
assign_block
-
size_for_inorder_child_if_necessary
call
because
clearance
on
...
let
mut
inline_end_floats_impact_child
=
self
.
base
