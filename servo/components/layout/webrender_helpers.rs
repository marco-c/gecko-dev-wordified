...
mut
WebRenderFrameBuilder
_force_positioned_stacking_level
:
bool
)
{
...
{
let
inner_webrender_stacking_context_id
=
inner_stacking_context_id
.
convert_to_webrender
...
api
.
next_display_list_id
(
)
;
stacking_context
.
has_stacking_contexts
=
stacking_context
.
has_stacking_contexts
...
trait
WebRenderStackingContextIdConverter
{
fn
convert_to_webrender
(
...
trait
WebRenderFragmentTypeConverter
{
fn
convert_to_webrender
(
