...
trait
ConvertStackingContextFromWebRender
{
fn
from_webrender
(
...
trait
ConvertFragmentTypeFromWebRender
{
fn
from_webrender
(
...
;
let
compositor_proxy_for_memory_reporter
=
state
.
sender
...
{
let
compositor_proxy_for_webrender
=
compositor
.
channel_to_self
...
self
.
create_root_layer_for_pipeline_and_size
(
&
frame_tree
.
...
self
.
composite_if_necessary_if_not_using_webrender
(
CompositingReason
:
:
...
self
.
create_root_layer_for_subpage_if_necessary
(
properties
existing_layer
.
...
fn
schedule_delayed_composite_if_necessary
(
&
mut
self
...
self
.
dispatch_mouse_window_event_class
(
mouse_window_event
)
;
...
self
.
dispatch_mouse_window_move_event_class
(
cursor
)
;
...
.
fn
send_updated_display_ports_to_layout
(
&
mut
self
...
fn
fill_paint_request_with_cached_layer_buffers
(
&
mut
self
...
.
fn
does_layer_have_outstanding_paint_messages
(
&
self
layer
...
self
.
start_scrolling_bounce_if_necessary
(
)
;
self
