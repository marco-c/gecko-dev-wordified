...
fn
create_or_update_child_pipeline
(
&
mut
self
...
self
.
create_compositor_layer_for_iframe_if_necessary
(
pipeline_id
)
;
...
self
.
handle_evicted_frames_for_load_navigation
(
next_frame_tree
frame_change
.
...
fn
find_child_parent_pair_in_frame_tree
(
&
self
frame_tree
