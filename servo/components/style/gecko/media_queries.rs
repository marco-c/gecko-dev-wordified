...
:
:
nsMediaFeature_RequirementFlags_eHasWebkitPrefix
)
!
=
0
...
:
:
nsMediaFeature_RequirementFlags_eUserAgentAndChromeOnly
;
}
let
result
...
:
:
nsMediaFeature_RequirementFlags_eWebkitDevicePixelRatioPrefEnabled
;
}
}
let
