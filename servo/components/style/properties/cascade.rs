...
cascade
.
apply_custom_and_prioritary_properties
(
&
mut
context
...
:
:
new_for_custom_properties_only
(
stylist
)
decls
...
:
DeclarationsToApplyUnlessOverriden
may_have_custom_property_cycles
:
bool
...
self
.
recompute_font_size_for_zoom_change
(
&
mut
context
...
self
.
recompute_zoom_dependent_inherited_lengths
(
context
)
;
...
self
.
finish_cascade_custom_properties
(
context
)
;
