...
pub
fn
copy_font_feature_settings_from
(
&
mut
self
...
pub
fn
copy_font_variation_settings_from
(
&
mut
self
...
(
adjusted_size
adjusted_unconstrained_size
)
=
self
.
calculate_script_level_size
(
parent
device
)
...
pub
fn
copy_font_variant_alternates_from
(
&
mut
self
...
=
"
impl_copy_animation_or_transition_value
(
type
ident
gecko_ffi_name
...
=
"
impl_animation_or_transition_count
(
type
ident
gecko_ffi_name
...
=
"
impl_animation_or_transition_time_value
(
type
ident
gecko_ffi_name
...
=
"
impl_animation_or_transition_timing_function
(
type
)
"
...
pub
fn
copy_scroll_snap_coordinate_from
(
&
mut
self
...
Some
(
convert_shared_list_to_operations
(
%
s
)
...
mMask
"
copy_simple_image_array_property
(
name
shorthand
image_layers_field
...
=
"
impl_simple_image_array_property
(
name
shorthand
layer_field_name
...
=
"
impl_common_image_layer_properties
(
shorthand
)
"
...
:
:
Gecko_CounterStyle_IsSingleString
;
use
gecko_bindings
:
...
>
fn
clear_text_emphasis_style_if_string
(
&
mut
self
...
fn
clear_overflow_sides_if_string
(
&
mut
self
...
pub
fn
copy__moz_context_properties_from
(
&
mut
self
