...
#
define
NS_TEST_NONCASTABLE_INTERFACE_IID
\
{
0x7c9f8ee2
0xc9bf
...
uint32_t
const
TestInterfaceOrOnlyForUseInConstructor
&
ErrorResult
&
)
...
;
uint16_t
ReadonlyUnsignedShort
(
)
;
uint16_t
WritableUnsignedShort
(
)
;
void
...
;
uint32_t
ReadonlyUnsignedLong
(
)
;
uint32_t
WritableUnsignedLong
(
)
;
void
SetWritableUnsignedLong
(
uint32_t
)
;
...
;
uint64_t
ReadonlyUnsignedLongLong
(
)
;
uint64_t
WritableUnsignedLongLong
(
)
;
void
...
;
void
ReceiveNullableNonWrapperCacheInterfaceSequence
(
nsTArray
<
nsRefPtr
...
;
void
PassOptionalExternalWithDefault
(
TestExternalInterface
*
)
...
;
void
PassOptionalNonNullCallbackInterface
(
const
Optional
<
...
;
void
PassOptionalNullableSequenceOfNullableInts
(
const
Optional
<
...
;
void
ReceiveCastableObjectNullableSequence
(
Nullable
<
nsTArray
...
;
void
ReceiveNullableCastableObjectNullableSequence
(
Nullable
<
nsTArray
...
;
void
PassNullableCastableObjectSequence
(
const
Sequence
<
...
;
void
PassCastableObjectNullableSequence
(
const
Nullable
<
...
;
void
PassNullableCastableObjectNullableSequence
(
const
Nullable
<
...
;
void
PassOptionalStringWithDefaultValue
(
const
nsAString
&
...
;
void
PassOptionalNullableUnionWithDefaultValue
(
JSContext
*
const
...
/
void
PassUnionWithInterfaces
(
const
TestInterfaceOrTestExternalInterface
&
arg
)
;
...
/
void
PassUnionWithInterfacesAndNullable
(
const
TestInterfaceOrNullOrTestExternalInterface
&
arg
)
;
void
PassUnionWithArrayBuffer
(
const
ArrayBufferOrLong
&
...
;
bool
ImplementedParentProperty
(
)
;
void
SetImplementedParentProperty
(
bool
)
;
void
ImplementedParentMethod
(
)
;
bool
...
;
void
SetIndirectlyImplementedProperty
(
bool
)
;
