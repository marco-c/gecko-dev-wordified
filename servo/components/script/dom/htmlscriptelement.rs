...
.
fn
dispatch_before_script_execute_event
(
self
)
-
...
.
fn
dispatch_after_script_execute_event
(
self
)
;
...
trait
PrivateHTMLScriptElementHelpers
{
fn
dispatch_event
(
