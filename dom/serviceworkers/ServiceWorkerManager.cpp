...
-
>
GetNumberOfAttemptedActivations
(
)
;
aData
...
testing
.
persistTemporaryInstalledAddons
is
set
/
/
...
:
:
DetermineLifetimeForServiceWorker
(
const
ServiceWorkerDescriptor
&
...
such
that
NotifyListenersOnQuotaCheckFinish
(
)
can
notify
