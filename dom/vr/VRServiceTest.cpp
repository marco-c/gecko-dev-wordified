...
-
>
SendSetSensorStateToMockDisplay
(
mDeviceID
mSensorState
)
...
-
>
SendSetDisplayInfoToMockDisplay
(
mDeviceID
mDisplayInfo
)
...
-
>
SendNewButtonEventToMockController
(
mDeviceID
aButton
aPressed
...
-
>
SendNewAxisMoveEventToMockController
(
mDeviceID
aAxis
aValue
...
-
>
SendNewPoseMoveToMockController
(
mDeviceID
poseState
)
