...
-
>
ChooseVulkanPixelFormatFromContext
(
aCodecContext
(
const
...
PrepareVulkanDrmModifiersForSwFormat
(
frames_ctx
-
>
...
:
YUVColorSpace
TransferAVColorSpaceToColorSpace
(
const
AVColorSpace
aSpace
...
static
bool
IsColorFormatSupportedForUsingCustomizedBuffer
(
const
AVPixelFormat
&
...
static
uint32_t
AVChromaLocationToWPChromaLocation
(
uint32_t
aAVChromaLocation
)
...
height
;
SetChromaPlaneGeometryFromAVFormat
(
b
static_cast
<
...
static
void
FillDRMDescriptorYUVSingleObject
(
uint32_t
aFormat
int
