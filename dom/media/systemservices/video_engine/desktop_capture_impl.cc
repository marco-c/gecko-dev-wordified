...
:
:
media_webrtc_capture_screen_allow_wgc
(
)
)
{
...
:
:
media_webrtc_capture_wgc_allow_zero_hertz
(
)
)
;
...
:
:
media_webrtc_capture_window_allow_wgc
(
)
)
{
...
DesktopCapturer
>
CreateDesktopCapturerAndThread
(
CaptureDeviceType
aDeviceType
DesktopCapturer
