...
.
struct
NotReallyMovableButLetsPretendItIsRTCStatsCollection
:
public
RTCStatsCollection
{
...
mBundlePolicy
mCertificatesProvided
mIceServers
mIceTransportPolicy
mPeerIdentityProvided
mSdpSemantics
)
;
DEFINE_IPC_SERIALIZER_WITH_FIELDS
...
static
void
WriteRTCReceivedRtpStreamStats
(
Message
*
aMsg
