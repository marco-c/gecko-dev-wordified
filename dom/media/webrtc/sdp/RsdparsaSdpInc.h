...
enum
class
RustSdpAttributeFingerprintHashAlgorithm
:
uint16_t
{
kSha1
...
enum
class
RustSdpAttributeDtlsMessageType
:
uint8_t
{
kClient
...
enum
class
RustSdpAttributeSsrcGroupSemantic
{
kRustDup
kRustFid
kRustFec
...
;
struct
RustSdpAttributeImageAttrSetVec
;
struct
...
;
struct
RustSdpAttributeSimulcastIdVec
;
struct
...
;
struct
RustSdpAttributeSimulcastVersionVec
;
struct
...
;
size_t
sdp_simulcast_get_version_count
(
const
RustSdpAttributeSimulcastVersionVec
*
