...
void
SetExpectedRemoteCandidateAddr
(
const
std
:
...
void
DumpAndCheckActiveCandidates_s
(
)
{
std
...
void
AssertRegularlyNominatedAndSelectedPair
(
size_t
stream_index
uint64_t
...
bool
CandidatePairsPriorityDescending
(
const
std
:
...
void
UseFakeStunUdpServerWithResponse
(
const
std
:
...
void
UseFakeStunTcpServerWithResponse
(
const
std
:
...
{
nr_interface_prioritizer_destroy
(
&
prioritizer_
)
...
r
=
nr_interface_prioritizer_sort_preference
(
prioritizer_
)
;
...
r
=
nr_interface_prioritizer_get_priority
(
prioritizer_
key1
.
...
(
WebRtcIceGatherTest
TestGatherStunServerIpAddressNoHost
)
{
if
(
...
(
WebRtcIceGatherTest
DISABLED_TestGatherDNSStunServerIpAddressTcp
)
{
if
(
...
(
WebRtcIceGatherTest
DISABLED_TestGatherDNSStunServerHostnameTcp
)
{
NrIceCtx
:
...
(
WebRtcIceGatherTest
DISABLED_TestGatherDNSStunBogusHostnameTcp
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestConnectRestartIceThenAbort
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestConnectIceRestartRoleConflict
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestConnectIceLitePassiveOfferer
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestConnectIceLiteServerReflexiveCandidate
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestConnectIceLitePeerReflexiveCandidate
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestConnectIceLiteTwoComponents
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestTrickleIceLitePassiveOfferer
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestConnectSymmetricNatAndNoNat
)
{
{
NrIceCtx
...
(
WebRtcIceConnectTest
TestNetworkForcedOfflineAndRecovery
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestNetworkOnlineDoesntChangeState
)
{
NrIceCtx
:
...
(
WebRtcIceConnectTest
TestNetworkOnlineTriggersConsent
)
{
NrIceCtx
:
...
(
WebRtcIcePacketFilterTest
TestRecvStunBindingRequestWithoutAPendingId
)
{
nr_stun_message
*
...
(
WebRtcIcePacketFilterTest
TestRecvStunPacketWithPendingIdTcpFramed
)
{
nr_stun_message
*
...
(
WebRtcIcePacketFilterTest
TestRecvDataPacketWithAPendingAddress
)
{
nr_stun_message
*
