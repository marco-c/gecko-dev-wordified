...
;
void
ClearStoragesForOriginInternal
(
const
nsACString
&
...
to
preserve
SessionStorageCaches
for
the
other
SessionStorageManagers
.
*
/
class
...
via
a
PropagateBackgroundSessionStorageManager
message
the
/
/
