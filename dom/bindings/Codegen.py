...
def
_auto_profiler_label
(
self
)
:
        
profiler_label_and_jscontext
=
self
.
profiler_label_and_jscontext
...
def
MakeJSImplClearCachedValueNativeName
(
member
)
:
...
class
CGGenericPromiseReturningMethod
(
CGAbstractBindingMethod
)
:
...
class
CGGenericPromiseReturningGetter
(
CGAbstractBindingMethod
)
:
...
class
CGDOMJSProxyHandler_getPrototypeIfOrdinary
(
ClassMethod
)
:
...
append
(
CGJSImplClearCachedValueMethod
(
descriptor
m
)
...
class
CGMayResolveAsSystemBindingName
(
CGAbstractMethod
)
:
