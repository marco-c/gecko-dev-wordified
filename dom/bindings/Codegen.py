...
class
CGConstructorEnabledChromeOnly
(
CGAbstractMethod
)
:
...
"
class
CGDOMJSProxyHandler_CGDOMJSProxyHandler
(
ClassConstructor
)
:
...
class
CGDOMJSProxyHandler_getElementIfPresent
(
ClassMethod
)
:
