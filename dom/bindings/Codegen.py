...
def
getReflectedHTMLAttributesIface
(
descriptor
)
:
...
=
CGCycleCollectionTraverseForOwningUnionMethod
(
t
)
...
=
CGCycleCollectionUnlinkForOwningUnionMethod
(
t
)
...
ctorName
=
GetConstructorNameForReporting
(
self
.
descriptor
...
bool
sLegacyFactoryFunctionNativePropertiesInited
=
true
;
...
def
computeGlobalNamesFromExposureSet
(
exposureSet
)
:
...
prefableWithoutDisablersTemplate
=
"
{
nullptr
...
class
CGGetNamedPropertiesObjectMethod
(
CGAbstractStaticMethod
)
:
...
append
(
CGObservableArraySetterGenerator
(
descriptor
idlNode
)
...
class
CGTemplateForSpecializedGetter
(
CGSpecializedGetterCommon
)
:
...
class
CGTemplateForSpecializedSetter
(
CGSpecializedSetterCommon
)
:
...
def
findAncestorWithInstrumentedProps
(
desc
)
:
...
class
CGDOMJSProxyHandler_finalizeInBackground
(
ClassMethod
)
:
...
class
CGDOMJSProxyHandler_objectMoved
(
ClassMethod
)
:
...
class
CGDOMJSProxyHandler_isCallable
(
ClassMethod
)
:
...
class
CGDOMJSProxyHandler_canNurseryAllocate
(
ClassMethod
)
:
...
append
(
CGMaplikeOrSetlikeHelperGenerator
(
descriptor
m
)
...
CGObservableArrayProxyHandlerGenerator
(
descriptor
m
)
...
append
(
CGObservableArrayHelperGenerator
(
descriptor
m
)
...
class
CGRegisterWorkerDebuggerBindings
(
CGAbstractMethod
)
:
...
def
dependencySortDictionariesAndUnionsAndCallbacks
(
types
)
:
...
getDependencies
(
unionTypeOrDictionaryOrCallback
)
:
...
def
descriptorNeedsNonSystemPrincipal
(
d
)
:
...
_deps
class
CGExampleObservableArrayCallback
(
CGNativeMember
)
:
...
name
def
getMaplikeOrSetlikeErrorReturn
(
helperImpl
)
:
...
class
CGObservableArrayProxyHandler_OnDeleteItem
(
