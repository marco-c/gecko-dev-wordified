...
?
>
getSequenceOfNullableInterfaces
(
)
;
sequence
...
>
?
getNullableSequenceOfNullableInterfaces
(
)
;
sequence
...
TestCallbackInterface
>
getSequenceOfCallbackInterfaces
(
)
;
sequence
...
>
?
getNullableSequenceOfNullableCallbackInterfaces
(
)
;
record
...
callback
interface
TestSingleOperationCallbackInterface
{
TestInterface
doSomething
(
...
/
undefined
passUnionWithFrozenArrayOfUnions
(
(
DOMString
or
...
eventInitOrLongWithDefaultValue3
=
5
;
(
...
eventInitOrLongWithDefaultValue4
=
5
;
(
...
?
nullableEventInitOrLongWithDefaultValue
=
null
;
(
...
?
nullableEventInitOrLongWithDefaultValue2
=
null
;
(
...
?
nullableEventInitOrLongWithDefaultValue3
=
5
;
(
...
?
nullableEventInitOrLongWithDefaultValue4
=
5
;
(
...
objectSequenceOrLongWithDefaultValue1
=
1
;
(
...
objectSequenceOrLongWithDefaultValue2
=
[
]
;
...
?
nullableObjectSequenceOrLongWithDefaultValue1
=
1
;
(
...
?
nullableObjectSequenceOrLongWithDefaultValue2
=
[
]
;
...
>
?
nullableUSVStringRecordWithDefault
=
null
;
record
...
>
?
nullableByteStringRecordWithDefault
=
null
;
record
...
>
?
nullableUTF8StringRecordWithDefault
=
null
;
required
...
long
chromeOnlyFuncControlledMember
;
/
/
We
...
long
chromeOnlyFuncAndPrefControlledMember
;
}
;
dictionary
