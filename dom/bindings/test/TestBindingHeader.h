...
;
void
UnsafePrerenderMethod
(
)
;
int32_t
UnsafePrerenderWritable
(
)
;
void
SetUnsafePrerenderWritable
(
int32_t
)
;
int32_t
UnsafePrerenderReadonly
(
)
;
int16_t
...
;
float
WritableUnrestrictedFloat
(
)
const
;
void
SetWritableUnrestrictedFloat
(
float
)
;
...
float
>
GetWritableNullableFloat
(
)
const
;
void
SetWritableNullableFloat
(
const
Nullable
<
...
float
>
GetWritableNullableUnrestrictedFloat
(
)
const
;
...
;
double
WritableUnrestrictedDouble
(
)
const
;
void
SetWritableUnrestrictedDouble
(
double
)
;
...
double
>
GetWritableNullableDouble
(
)
const
;
void
SetWritableNullableDouble
(
const
Nullable
<
...
double
>
GetWritableNullableUnrestrictedDouble
(
)
const
;
void
SetWritableNullableUnrestrictedDouble
(
const
Nullable
<
...
;
void
GetReadonlySequenceOfDictionaries
(
JSContext
*
nsTArray
...
;
void
GetReadonlyNullableSequenceOfDictionaries
(
JSContext
*
Nullable
...
;
void
GetReadonlyFrozenNullableSequence
(
JSContext
*
Nullable
...
;
void
ReceiveNullableCallbackObjectSequence
(
nsTArray
<
RefPtr
...
;
void
PassOptionalNullableSequenceWithDefaultValue2
(
const
Nullable
<
...
;
void
PassNullableExternalInterfaceSequence
(
const
Sequence
<
...
;
void
PassSequenceOfSequencesOfSequences
(
const
Sequence
<
...
;
void
ReceiveSequenceOfSequencesOfSequences
(
nsTArray
<
nsTArray
...
;
void
PassSequenceOfNullableArrayBuffers
(
const
Sequence
<
...
;
void
PassVariadicNullableTypedArray
(
const
Sequence
<
...
;
void
PassOptionalNullableByteStringWithDefaultValue
(
const
nsCString
&
...
;
void
PassOptionalUTF8StringWithDefaultValue
(
const
nsACString
&
...
;
void
PassOptionalNullableUTF8String
(
const
Optional
<
...
;
void
PassOptionalNullableUTF8StringWithDefaultValue
(
const
nsACString
&
...
;
void
PassOptionalUSVSWithDefaultValue
(
const
nsAString
&
...
;
void
PassOptionalNullableUSVSWithDefaultValue
(
const
nsAString
&
...
;
void
PassOptionalJSStringWithDefaultValue
(
JSContext
*
JS
...
;
void
PassNullableTreatAsNullCallback
(
...
;
void
PassOptionalNullableTreatAsNullCallback
(
const
Optional
<
...
;
void
PassOptionalNullableTreatAsNullCallbackWithDefaultValue
(
TestTreatAsNullCallback
*
)
...
;
void
SetNullableTreatAsNullCallback
(
TestTreatAsNullCallback
*
)
...
&
TestCallbackInterfaceConstruction
&
...
;
void
PassOptionalNullableSequenceOfAny
(
JSContext
*
const
...
;
void
PassSequenceOfNullableSequenceOfAny
(
JSContext
*
const
...
;
void
PassOptionalNullableSequenceOfNullableSequenceOfAny
(
JSContext
*
const
...
(
const
ImageDataSequenceSequenceOrLong
&
)
;
void
...
(
const
ImageDataOrNullSequenceSequenceOrLong
&
)
;
void
...
void
PassUnionWithTypedArraysOrNull
(
const
ArrayBufferViewOrArrayBufferOrNull
&
aArg
)
{
...
;
void
PassNullableUnionWithDefaultValue1
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue2
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue7
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue9
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue10
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue11
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue13
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue14
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue16
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue17
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue22
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue23
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue25
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue26
(
const
Nullable
<
...
;
void
PassNullableUnionWithDefaultValue28
(
const
Nullable
<
...
;
void
PassUnionWithSequenceOfUnions
(
const
StringOrOnlyForUseInInnerUnionOrCanvasPatternSequence
&
arg
)
;
void
PassUnionWithRecordOfUnions
(
const
LongSequenceOrStringOnlyForUseInInnerUnionOrLongSequenceRecord
&
arg
)
;
...
;
void
ReceiveUnionWithNullableUndefined
(
...
;
void
ReceiveUnionWithUndefinedAndNullable
(
...
;
void
ReceiveNullableUnionWithUndefined
(
Nullable
<
OwningUndefinedOrCanvasPattern
...
;
void
GetWritableUnionContainingNull
(
OwningCanvasPatternOrNullOrCanvasGradient
&
)
...
(
const
CanvasPatternOrNullOrCanvasGradient
&
)
;
void
GetWritableNullableUnion
(
Nullable
<
OwningCanvasPatternOrCanvasGradient
...
;
void
GetWritableUnionWithNullableUndefined
(
OwningUndefinedOrNullOrCanvasPattern
&
)
;
void
SetWritableUnionWithNullableUndefined
(
const
UndefinedOrNullOrCanvasPattern
&
)
;
void
GetWritableUnionWithUndefinedAndNullable
(
OwningUndefinedOrCanvasPatternOrNull
&
)
;
void
SetWritableUnionWithUndefinedAndNullable
(
const
UndefinedOrCanvasPatternOrNull
&
)
;
void
GetWritableNullableUnionWithUndefined
(
Nullable
<
OwningUndefinedOrCanvasPattern
...
;
void
SetWritableNullableUnionWithUndefined
(
const
Nullable
<
...
types
void
OnDeleteBooleanObservableArray
(
bool
uint32_t
ErrorResult
...
;
void
OnDeleteInterfaceObservableArray
(
TestInterface
*
uint32_t
...
;
void
OnDeleteNullableObservableArray
(
const
Nullable
<
...
;
void
GetReadonlyFrozenNullableDictionary
(
JSContext
*
Nullable
...
bool
ConditionalOnSecureContext1
(
)
;
bool
ConditionalOnSecureContext2
(
)
;
bool
ConditionalOnSecureContext3
(
)
;
bool
ConditionalOnSecureContext4
(
)
;
void
ConditionalOnSecureContext5
(
)
;
void
...
;
void
ConditionalOnSecureContext7
(
)
;
void
ConditionalOnSecureContext8
(
)
;
bool
...
;
void
NeedsNonSystemSubjectPrincipalMethod
(
nsIPrincipal
*
)
;
bool
NeedsNonSystemSubjectPrincipalAttr
(
nsIPrincipal
*
)
;
void
SetNeedsNonSystemSubjectPrincipalAttr
(
bool
nsIPrincipal
*
...
int8_t
>
GetEnforcedNullableByte
(
)
const
;
void
SetClampedNullableByte
(
const
Nullable
<
...
AllowShared
void
SetAllowSharedArrayBufferViewTypedef
(
const
ArrayBufferView
&
...
;
void
GetAllowSharedArrayBufferViewTypedef
(
JSContext
*
JS
...
;
void
SetAllowSharedNullableArrayBufferView
(
const
Nullable
<
...
;
void
GetAllowSharedNullableArrayBufferView
(
JSContext
*
JS
...
;
void
SetAllowSharedNullableArrayBuffer
(
const
Nullable
<
...
;
void
GetAllowSharedNullableArrayBuffer
(
JSContext
*
JS
...
;
void
PassAllowSharedArrayBufferViewTypedef
(
const
ArrayBufferView
&
...
;
void
PassAllowSharedArrayBufferView
(
const
ArrayBufferView
&
...
;
void
PassAllowSharedNullableArrayBufferView
(
const
Nullable
<
...
;
void
PassAllowSharedNullableArrayBuffer
(
const
Nullable
<
...
;
void
PassUnionAllowSharedArrayBuffer
(
const
StringOrMaybeSharedArrayBuffer
&
foo
)
;
...
;
void
SetAllowLargeNullableArrayBufferView
(
const
Nullable
<
...
;
void
GetAllowLargeNullableArrayBufferView
(
JSContext
*
JS
...
;
void
SetAllowLargeNullableArrayBuffer
(
const
Nullable
<
...
;
void
GetAllowLargeNullableArrayBuffer
(
JSContext
*
JS
...
;
void
PassAllowLargeNullableArrayBufferView
(
const
Nullable
<
...
;
void
PassAllowLargeNullableArrayBuffer
(
const
Nullable
<
...
;
void
PassUnionAllowLargeArrayBuffer
(
const
StringOrAllowLargeArrayBuffer
&
foo
)
;
void
SetAllowSharedAllowLargeArrayBufferView
(
const
ArrayBufferView
&
...
;
void
GetAllowSharedAllowLargeArrayBufferView
(
JSContext
*
JS
...
;
void
PassAllowSharedAllowLargeArrayBufferView
(
const
ArrayBufferView
&
...
;
void
SetReflectedHTMLAttributeReturningFrozenArray
(
const
Nullable
<
