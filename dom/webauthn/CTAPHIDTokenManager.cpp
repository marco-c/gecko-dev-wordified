...
nsIThread
*
gPCTAPBackgroundThread
;
static
void
ctap1_register_callback
(
uint64_t
aTransactionId
rust_u2f_result
...
-
>
Ctap2GetNumberOfSignAssertions
(
num_of_results
)
)
