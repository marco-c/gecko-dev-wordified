...
#
define
ASSERT_NETWORK_SELECTION_MODE_EQUALITY
(
webidlState
xpidlState
)
...
#
define
ASSERT_MOBILE_RADIO_STATE_EQUALITY
(
webidlState
xpidlState
)
...
(
Gsm
PREFERRED_NETWORK_TYPE_GSM_ONLY
)
;
ASSERT_PREFERRED_NETWORK_TYPE_EQUALITY
(
...
(
Cdma
PREFERRED_NETWORK_TYPE_CDMA_ONLY
)
;
ASSERT_PREFERRED_NETWORK_TYPE_EQUALITY
(
Evdo
PREFERRED_NETWORK_TYPE_EVDO_ONLY
)
;
ASSERT_PREFERRED_NETWORK_TYPE_EQUALITY
(
Wcdma_gsm_cdma_evdo
PREFERRED_NETWORK_TYPE_WCDMA_GSM_CDMA_EVDO
)
;
ASSERT_PREFERRED_NETWORK_TYPE_EQUALITY
(
...
PREFERRED_NETWORK_TYPE_LTE_WCDMA_GSM_CDMA_EVDO
)
;
ASSERT_PREFERRED_NETWORK_TYPE_EQUALITY
(
Lte
PREFERRED_NETWORK_TYPE_LTE_ONLY
)
;
#
undef
...
#
define
ASSERT_MOBILE_NETWORK_TYPE_EQUALITY
(
webidlState
xpidlState
)
...
(
Gsm
MOBILE_NETWORK_TYPE_GSM
)
;
ASSERT_MOBILE_NETWORK_TYPE_EQUALITY
(
Wcdma
MOBILE_NETWORK_TYPE_WCDMA
)
;
ASSERT_MOBILE_NETWORK_TYPE_EQUALITY
(
Cdma
MOBILE_NETWORK_TYPE_CDMA
)
;
ASSERT_MOBILE_NETWORK_TYPE_EQUALITY
(
Evdo
MOBILE_NETWORK_TYPE_EVDO
)
;
ASSERT_MOBILE_NETWORK_TYPE_EQUALITY
(
Lte
MOBILE_NETWORK_TYPE_LTE
)
;
#
undef
