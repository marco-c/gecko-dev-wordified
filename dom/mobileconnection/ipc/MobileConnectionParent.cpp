...
:
:
RecvPMobileConnectionRequestConstructor
(
...
:
:
TSetPreferredNetworkTypeRequest
:
return
actor
-
...
aRequest
.
get_SetPreferredNetworkTypeRequest
(
)
)
;
...
:
:
TGetPreferredNetworkTypeRequest
:
return
actor
-
...
aRequest
.
get_GetPreferredNetworkTypeRequest
(
)
)
;
...
aRequest
.
get_SetRoamingPreferenceRequest
(
)
)
;
...
aRequest
.
get_GetRoamingPreferenceRequest
(
)
)
;
...
aRequest
.
get_GetVoicePrivacyModeRequest
(
)
)
;
...
:
:
TChangeCallBarringPasswordRequest
:
return
actor
-
...
:
:
TSetCallingLineIdRestrictionRequest
:
return
actor
-
...
:
:
TGetCallingLineIdRestrictionRequest
:
return
actor
-
...
aRequest
.
get_GetCallingLineIdRestrictionRequest
(
)
)
;
...
aRequest
.
get_ExitEmergencyCbModeRequest
(
)
)
;
...
:
:
DeallocPMobileConnectionRequestParent
(
)
.
actor
...
;
return
SendNotifyEmergencyCbModeChanged
(
aActive
aTimeoutMs
)
...
;
return
SendNotifyLastHomeNetworkChanged
(
network
)
?
...
;
return
SendNotifyNetworkSelectionModeChanged
(
mode
)
?
