...
RangeBoundary
&
otherSideExistingBoundaryInDOM
=
aIsSetStart
?
aRange
...
(
ResetCommonAncestorIfInAnySelection
:
:
No
)
...
:
:
dom_range_cut_contents_use_flat_tree
(
)
;
const
