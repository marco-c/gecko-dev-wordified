...
:
:
GetPhysicalMillimeterInCSSPixels
(
float
*
aPhysicalMillimeter
...
uint32_t
*
aOutVerticalScrollbarWidth
uint32_t
*
aOutHorizontalScrollbarHeight
)
{
ScrollContainerFrame
*
...
;
case
NATIVE_MOUSE_MESSAGE_ENTER_WINDOW
:
message
=
nsIWidget
...
:
:
GetIsInputTaskManagerSuspended
(
bool
*
aResult
...
:
:
GetNodeObservedByIMEContentObserver
(
nsINode
*
*
...
aAdditionalFlags
&
CONTENT_COMMAND_FLAG_PREVENT_SET_SELECTION
)
;
}
else
...
/
CSSRect
textFrameBoundsRelativeToRootScroller
;
/
*
the
...
-
>
SendCheckAndClearWRDidRasterize
(
widget
-
>
...
:
:
GetRefreshDriverHasPendingTick
(
bool
*
aResult
...
:
:
GetEffectivelyThrottlesFrameRequests
(
bool
*
aResult
