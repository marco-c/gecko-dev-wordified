...
nsPoint
&
lastOverWindowMouseLocation
=
presShell
-
>
GetLastOverWindowMouseLocation
(
)
;
if
...
const
CSSPoint
lastOverWindowMouseLocationInCSSPixels
=
CSSPoint
:
:
