...
static
bool
IsDoctypeOrHasFollowingDoctype
(
nsINode
*
aNode
...
-
>
MayHavePointerRawUpdateEventListener
(
)
)
{
...
-
>
SetMayHaveContainerTimingAttributes
(
)
;
}
...
we
check
SuppressedNotifyingDevToolsOfNodeRemovals
(
)
here
too
