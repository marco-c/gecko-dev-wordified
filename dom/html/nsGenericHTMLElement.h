...
{
class
BooleanOrUnrestrictedDoubleOrString
;
class
EditContext
;
...
static
void
SyncSpellCheckerStateOfExtantEditorsOnSubtree
(
nsIContent
&
)
...
;
bool
IsAutocapitalizeOrAutocorrectInheriting
(
)
const
;
...
Element
*
GetPopoverTargetElementForBindings
(
)
const
;
...
;
void
SetPopoverTargetElementForBindings
(
mozilla
:
:
