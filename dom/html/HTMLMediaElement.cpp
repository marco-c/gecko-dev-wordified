...
const
bool
isDurationLessThanTimeThresholdAndMediaPlayedToTheEnd
=
Duration
(
)
...
%
p
PLAYED_TIME_AFTER_AUTOPLAY_BLOCKED
=
%
f
isVideo
...
:
:
LABELS_MEDIA_PLAYED_TIME_AFTER_AUTOPLAY_BLOCKED
:
:
VPlayedMoreThan7s
)
