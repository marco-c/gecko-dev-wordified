...
return
new
ClientWebGLExtensionBlendMinMax
(
*
this
)
...
return
new
ClientWebGLExtensionEXTColorBufferFloat
(
*
this
)
...
return
new
ClientWebGLExtensionColorBufferHalfFloat
(
*
this
)
...
return
new
ClientWebGLExtensionFloatBlend
(
*
this
)
...
return
new
ClientWebGLExtensionShaderTextureLod
(
*
this
)
...
return
new
ClientWebGLExtensionTextureFilterAnisotropic
(
*
this
)
...
return
new
ClientWebGLExtensionTextureNorm16
(
*
this
)
...
return
new
ClientWebGLExtensionElementIndexUint
(
*
this
)
...
return
new
ClientWebGLExtensionFBORenderMipmap
(
*
this
)
...
return
new
ClientWebGLExtensionStandardDerivatives
(
*
this
)
...
return
new
ClientWebGLExtensionTextureFloat
(
*
this
)
...
return
new
ClientWebGLExtensionTextureFloatLinear
(
*
this
)
...
return
new
ClientWebGLExtensionTextureHalfFloat
(
*
this
)
...
return
new
ClientWebGLExtensionTextureHalfFloatLinear
(
*
this
)
...
return
new
ClientWebGLExtensionColorBufferFloat
(
*
this
)
...
return
new
ClientWebGLExtensionDebugRendererInfo
(
*
this
)
...
return
new
ClientWebGLExtensionDepthTexture
(
*
this
)
