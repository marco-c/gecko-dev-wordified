...
bool
SubscriptionPrincipalMatchesScope
(
nsIPrincipal
*
aPrincipal
...
&
aScopeURL
GetSubscriptionsRequestResolver
&
&
aResolver
)
...
:
:
RecvSubscribeOrUnsubscribeRequest
(
const
PrincipalInfo
&
...
bool
aSubscription
SubscribeOrUnsubscribeRequestResolver
&
&
aResolver
)
