...
#
define
BLUETOOTH_HID_STATUS_CHANGED_ID
"
bluetooth
-
hid
...
;
enum
BluetoothAvrcpPlayerRepeatValue
{
AVRCP_PLAYER_VAL_OFF_REPEAT
=
0x01
AVRCP_PLAYER_VAL_SINGLE_REPEAT
=
0x02
AVRCP_PLAYER_VAL_ALL_REPEAT
=
0x03
AVRCP_PLAYER_VAL_GROUP_REPEAT
=
0x04
}
;
...
=
0x01
AVRCP_PLAYER_VAL_ALL_SHUFFLE
=
0x02
AVRCP_PLAYER_VAL_GROUP_SHUFFLE
=
0x03
}
;
...
#
define
BLUETOOTH_EMPTY_GATT_CHAR_PROP
static_cast
<
BluetoothGattCharProp
>
...
/
enum
BluetoothGattAttrPermBit
{
GATT_ATTR_PERM_BIT_READ
=
(
1
<
...
GATT_ATTR_PERM_BIT_READ_ENCRYPTED
=
(
1
<
...
GATT_ATTR_PERM_BIT_READ_ENCRYPTED_MITM
=
(
1
<
...
GATT_ATTR_PERM_BIT_WRITE_ENCRYPTED
=
(
1
<
...
GATT_ATTR_PERM_BIT_WRITE_ENCRYPTED_MITM
=
(
1
<
...
GATT_ATTR_PERM_BIT_WRITE_SIGNED
=
(
1
<
...
GATT_ATTR_PERM_BIT_WRITE_SIGNED_MITM
=
(
1
<
