...
:
:
TGattClientStartNotificationsRequest
:
return
actor
-
...
aRequest
.
get_GattClientStartNotificationsRequest
(
)
)
;
...
:
:
TGattClientStopNotificationsRequest
:
return
actor
-
...
aRequest
.
get_GattClientStopNotificationsRequest
(
)
)
;
...
:
:
TGattClientReadCharacteristicValueRequest
:
return
actor
-
...
aRequest
.
get_GattClientReadCharacteristicValueRequest
(
)
)
;
...
:
:
TGattClientWriteCharacteristicValueRequest
:
return
actor
-
...
aRequest
.
get_GattClientWriteCharacteristicValueRequest
(
)
)
;
...
:
:
TGattClientReadDescriptorValueRequest
:
return
actor
-
...
aRequest
.
get_GattClientReadDescriptorValueRequest
(
)
)
;
...
:
:
TGattClientWriteDescriptorValueRequest
:
return
actor
-
...
aRequest
.
get_GattClientWriteDescriptorValueRequest
(
)
)
;
...
:
:
TGattServerConnectPeripheralRequest
:
return
actor
-
...
aRequest
.
get_GattServerConnectPeripheralRequest
(
)
)
;
...
:
:
TGattServerDisconnectPeripheralRequest
:
return
actor
-
...
aRequest
.
get_GattServerDisconnectPeripheralRequest
(
)
)
;
