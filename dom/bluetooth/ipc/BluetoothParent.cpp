...
:
:
TReplyToMessagesListingRequest
:
return
actor
-
...
aRequest
.
get_ReplyToMessagesListingRequest
(
)
)
;
...
:
:
TReplyToSetMessageStatusRequest
:
return
actor
-
...
aRequest
.
get_ReplyToMessageUpdateRequest
(
)
)
;
...
aRequest
.
get_GattServerAddServiceRequest
(
)
)
;
...
:
:
TGattServerAddIncludedServiceRequest
:
return
actor
-
...
aRequest
.
get_GattServerAddIncludedServiceRequest
(
)
)
;
...
:
:
TGattServerAddCharacteristicRequest
:
return
actor
-
...
:
:
TGattServerAddDescriptorRequest
:
return
actor
-
...
aRequest
.
get_GattServerAddDescriptorRequest
(
)
)
;
...
:
:
TGattServerRemoveServiceRequest
:
return
actor
-
...
aRequest
.
get_GattServerRemoveServiceRequest
(
)
)
;
...
:
:
TGattServerStartServiceRequest
:
return
actor
-
...
aRequest
.
get_GattServerStartServiceRequest
(
)
)
;
...
:
:
TGattServerSendResponseRequest
:
return
actor
-
...
aRequest
.
get_GattServerSendResponseRequest
(
)
)
;
...
:
:
TGattServerSendIndicationRequest
:
return
actor
-
...
aRequest
.
get_GattServerSendIndicationRequest
(
)
)
;
