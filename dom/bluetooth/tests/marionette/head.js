...
/
function
waitForAdapterAttributeChanged
(
aAdapter
aAttrName
aExpectedValue
...
/
function
verifyDevicePairedUnpairedEvent
(
aAdapter
aDeviceEvent
)
...
/
function
addEventHandlerForPairingRequest
(
aAdapter
aSpecifiedBdAddress
)
