...
:
:
ClientDeregisterNotificationCmd
(
int
aClientIf
const
...
:
:
ClientDeregisterNotificationRsp
(
const
DaemonSocketPDUHeader
&
...
:
:
ClientNotificationHandlerWrapper
final
{
public
:
...
:
:
ServerNotificationHandlerWrapper
final
{
public
:
...
:
:
ServerRequestExecuteWriteInitOp
final
:
private
PDUInitOp
...
BluetoothDaemonGattServerInterface
:
:
BluetoothDaemonGattServerInterface
(
