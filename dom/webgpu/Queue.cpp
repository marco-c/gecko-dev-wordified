...
struct
ExternalTextureWorkDoneHandler
:
dom
:
:
...
:
:
wgpu_client_on_submitted_work_done
(
mBridge
-
>
...
:
:
wgpu_queue_write_buffer_inline
(
mBridge
-
>
...
:
:
wgpu_queue_write_buffer_via_shmem
(
mBridge
-
>
...
:
:
wgpu_queue_write_texture_via_shmem
(
mBridge
-
>
