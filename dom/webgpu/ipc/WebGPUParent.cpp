...
:
:
wgpu_server_texture_view_destroy
(
mContext
aSelfId
)
...
:
:
RecvCommandEncoderCopyBufferToBuffer
(
RawId
aSelfId
RawId
...
:
:
RecvCommandEncoderCopyBufferToTexture
(
RawId
aSelfId
WGPUBufferCopyView
...
:
:
RecvCommandEncoderCopyTextureToBuffer
(
RawId
aSelfId
WGPUTextureCopyView
...
:
:
RecvCommandEncoderCopyTextureToTexture
(
RawId
aSelfId
WGPUTextureCopyView
...
:
:
RecvCommandEncoderRunRenderPass
(
RawId
aSelfId
Shmem
...
:
:
RecvDeviceCreateBindGroupLayout
(
RawId
aSelfId
const
...
:
:
wgpu_server_bind_group_layout_destroy
(
mContext
aSelfId
)
...
:
:
RecvDeviceCreatePipelineLayout
(
RawId
aSelfId
const
...
:
:
wgpu_server_pipeline_layout_destroy
(
mContext
aSelfId
)
...
:
:
wgpu_server_bind_group_destroy
(
mContext
aSelfId
)
...
:
:
wgpu_server_shader_module_destroy
(
mContext
aSelfId
)
...
:
:
RecvDeviceCreateComputePipeline
(
RawId
aSelfId
const
...
:
:
wgpu_server_device_create_compute_pipeline
(
mContext
aSelfId
&
...
:
:
wgpu_server_compute_pipeline_destroy
(
mContext
aSelfId
)
...
:
:
RecvDeviceCreateRenderPipeline
(
RawId
aSelfId
const
...
:
:
wgpu_server_device_create_render_pipeline
(
mContext
aSelfId
&
...
:
:
wgpu_server_render_pipeline_destroy
(
mContext
aSelfId
)
