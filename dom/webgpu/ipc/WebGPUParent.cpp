...
lim
.
mMaxDynamicUniformBuffersPerPipelineLayout
;
desc
.
limits
...
lim
.
mMaxDynamicStorageBuffersPerPipelineLayout
;
desc
.
limits
...
lim
.
mMaxSampledTexturesPerShaderStage
;
desc
.
limits
...
lim
.
mMaxStorageBuffersPerShaderStage
;
desc
.
limits
...
lim
.
mMaxStorageTexturesPerShaderStage
;
desc
.
limits
...
lim
.
mMaxUniformBuffersPerShaderStage
;
desc
.
limits
...
:
:
wgpu_server_fill_default_limits
(
&
desc
.
