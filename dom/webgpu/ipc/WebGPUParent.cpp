...
WGPUVkImageHandle
*
wgpu_server_get_vk_image_handle
(
WGPUWebGPUParentPtr
aParent
WGPUTextureId
...
WGPUExternalTextureSourceId
*
aExternalTextureSourceIds
uintptr_t
aExternalTextureSourceIdsLength
)
{
auto
*
...
WGPURemoteTextureOwnerId
aRemoteTextureOwnerId
WGPURemoteTextureTxnType
aTxnType
WGPURemoteTextureTxnId
aTxnId
)
{
auto
...
:
:
WGPUErrorBufferType_Validation
:
ty
=
dom
...
:
:
WGPUErrorBufferType_OutOfMemory
:
ty
=
dom
...
:
:
WGPUErrorBufferType_DeviceLost
:
return
{
}
...
;
bool
mReadbackSnapshotCallbackCalled
=
false
;
PresentationData
...
:
:
RecvCreateExternalTextureSource
(
RawId
aDeviceId
RawId
