...
{
mWaitingCanvasRendererInitialized
=
true
;
}
...
(
obj
eUseCounter_custom_WebgpuRenderOutput
)
;
}
}
...
:
:
wgpu_client_make_command_encoder_id
(
mChild
-
>
...
:
:
wgpu_client_make_command_buffer_id
(
mChild
-
>
...
:
:
wgpu_client_free_command_buffer_id
(
mChild
-
>
