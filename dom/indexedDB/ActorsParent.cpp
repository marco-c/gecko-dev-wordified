...
=
=
ASSERT_UNREACHABLE_UNLESS_FUZZING
#
ifdef
DEBUG
#
...
;
class
ObjectStoreGetAllRecordsRequestOp
final
:
public
NormalTransactionOp
...
;
bool
mOpenStorageForAllRepositoriesFailed
;
State
mState
;
...
rev
/
8332a06d47ce7d66623d807068b3410061cd29d3
/
dom
/
indexedDB
...
:
:
TObjectStoreGetAllRecordsParams
:
{
const
ObjectStoreGetAllRecordsParams
&
params
=
aParams
.
get_ObjectStoreGetAllRecordsParams
(
)
;
const
...
:
:
TIndexGetAllRecordsParams
:
{
const
IndexGetAllRecordsParams
&
params
=
aParams
.
get_IndexGetAllRecordsParams
(
)
;
const
...
aResponse
=
ObjectStoreGetAllRecordsResponse
(
)
;
*
...
aResponse
.
get_ObjectStoreGetAllRecordsResponse
(
)
;
for
...
aResponse
.
get_IndexGetAllRecordsResponse
(
)
;
for
