...
/
/
mPendingToRemoveLastOverEventTarget
we
will
dispatch
"
...
/
/
ClearLastDialogPointerdownTarget
instead
.
if
(
...
/
/
pointerevent_attributes_nohover_pointers
.
html
even
though
...
LayoutDeviceIntPoint
>
GetWindowClientSizeAndCenterPoint
(
nsIWidget
*
aWidget
...
/
/
previous_mousemove_mRefPoint
-
current_mousemove_mRefPoint
.
/
/
/
...
:
:
dom_pointer_lock_reset_to_center_from_parent_enabled
(
)
)
{
