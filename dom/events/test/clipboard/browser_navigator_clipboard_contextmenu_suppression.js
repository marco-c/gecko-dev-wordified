...
function
testPasteContextMenuSuppression
(
aWriteFun
aMsg
)
...
async
function
test_context_menu_suppression_sameorigin
(
)
{
await
...
async
function
test_context_menu_suppression_crossorigin
(
)
{
await
...
async
function
test_context_menu_suppression_multiple
(
)
{
await
...
async
function
test_context_menu_suppression_image
(
)
{
await
...
;
base64
iVBORw0KGgoAAAANSUhEUgAAAD4AAABHCAIAAADQjmMaAA
"
+
"
...
+
"
VudABDcmVhdGVkIHdpdGggR0lNUFeBDhcAAABPSURBVGje7c4BDQAACAOga
/
/
OmuMbJG
"
...
async
function
test_context_menu_suppression_paste_event
(
)
{
await
