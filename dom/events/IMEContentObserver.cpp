...
const
int32_t
startIndexOfIMEContentObserverPrefix
=
name
.
Find
...
"
"
ComputeFlatTextRangeExcludingInsertingNewContent
(
)
failed
"
...
const
bool
allowToNotifyIMEOfPositionChange
=
observer
-
>
...
int32_t
>
newLastContentComparedWithCachedFirstContent
=
nsContentUtils
:
:
...
int32_t
>
newFirstContentComparedWithCachedLastContent
=
mLast
-
>
