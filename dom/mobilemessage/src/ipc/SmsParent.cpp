...
static
bool
GetParamsFromSendMmsMessageRequest
(
JSContext
*
aCx
...
aRequest
.
get_GetSegmentInfoForTextRequest
(
)
)
;
...
aRequest
.
get_CreateMessageCursorRequest
(
)
)
;
