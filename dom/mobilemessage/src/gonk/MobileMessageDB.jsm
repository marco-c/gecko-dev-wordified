...
;
const
DISABLE_MMS_GROUPING_FOR_RECEIVING
=
true
;
const
...
(
function
createUpdateThreadAndParticipant
(
ix
)
{
...
MMS
.
DOM_READ_STATUS_PENDING
:
MMS
.
DOM_READ_STATUS_NOT_APPLICABLE
;
element
.
readTimestamp
...
.
function
getThreadParticipantsFromMessageRecord
(
aMessageRecord
)
{
...
RIL
.
PDU_PID_REPLACE_SHORT_MESSAGE_TYPE_1
&
&
aMessageRecord
.
...
RIL
.
PDU_PID_REPLACE_SHORT_MESSAGE_TYPE_7
)
|
|
aMessageRecord
