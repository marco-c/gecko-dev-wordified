...
(
"
ril_worker_telephony_request_queue
.
js
"
)
...
;
let
RILQUIRKS_SIM_APP_STATE_EXTRA_FIELDS
;
/
/
Needed
...
device
let
RILQUIRKS_EXTRA_UINT32_2ND_CALL
;
/
/
On
...
this
.
pendingToReportSmsMemoryStatus
=
false
;
this
...
errorMsg
=
GECKO_ERROR_REQUEST_NOT_SUPPORTED
;
this
.
sendChromeMessage
...
newParcel
(
REQUEST_SIM_TRANSMIT_APDU_CHANNEL
options
)
;
Buf
...
facility
=
CALL_BARRING_PROGRAM_TO_FACILITY
[
options
.
program
...
writeHexOctet
(
COMPREHENSIONTLV_TAG_HELP_REQUEST
|
COMPREHENSIONTLV_FLAG_CR
)
;
...
writeHexOctet
(
COMPREHENSIONTLV_TAG_TRANSACTION_ID
|
COMPREHENSIONTLV_FLAG_CR
)
;
...
=
=
NETWORK_CREG_STATE_REGISTERED_HOME
|
|
regState
=
=
NETWORK_CREG_STATE_REGISTERED_ROAMING
;
curState
.
roaming
...
{
case
SUPP_SVC_NOTIFICATION_CODE2_PUT_ON_HOLD
:
case
...
{
case
NETWORK_CREG_TECH_GPRS
:
case
NETWORK_CREG_TECH_EDGE
:
case
NETWORK_CREG_TECH_UMTS
:
case
NETWORK_CREG_TECH_HSDPA
:
case
NETWORK_CREG_TECH_HSUPA
:
case
NETWORK_CREG_TECH_HSPA
:
case
NETWORK_CREG_TECH_LTE
:
case
NETWORK_CREG_TECH_HSPAP
:
case
NETWORK_CREG_TECH_GSM
:
case
NETWORK_CREG_TECH_DCHSPAP_1
:
case
NETWORK_CREG_TECH_DCHSPAP_2
:
return
true
;
...
newParcel
(
REQUEST_STK_SEND_ENVELOPE_WITH_STATUS
options
)
;
Buf
...
newParcel
(
REQUEST_ACKNOWLEDGE_INCOMING_GSM_SMS_WITH_PDU
)
;
/
/
...
=
=
GECKO_ERROR_SMS_SEND_FAIL_RETRY
&
&
options
.
...
:
case
CB_GSM_GEOGRAPHICAL_SCOPE_CELL_WIDE
:
hash
+
=
...
=
=
ICC_STATUS_NORMAL_ENDING_WITH_EXTRA
&
&
options
.
...
selectionMode
=
GECKO_NETWORK_SELECTION_AUTOMATIC
;
break
;
case
...
selectionMode
=
GECKO_NETWORK_SELECTION_MANUAL
;
break
;
default
...
prototype
[
REQUEST_CDMA_GET_SUBSCRIPTION_SOURCE
]
=
null
;
...
prototype
[
REQUEST_SET_INITIAL_ATTACH_APN
]
=
null
;
...
prototype
[
REQUEST_SIM_TRANSMIT_APDU_BASIC
]
=
null
;
...
prototype
[
UNSOLICITED_RESPONSE_VOICE_NETWORK_STATE_CHANGED
]
=
function
UNSOLICITED_RESPONSE_VOICE_NETWORK_STATE_CHANGED
...
status
=
CDMA_OTA_PROVISION_STATUS_TO_GECKO
[
this
.
context
...
prototype
[
UNSOLICITED_CDMA_SUBSCRIPTION_SOURCE_CHANGED
]
=
null
;
...
prototype
[
UNSOLICITED_EXIT_EMERGENCY_CALLBACK_MODE
]
=
function
UNSOLICITED_EXIT_EMERGENCY_CALLBACK_MODE
...
prototype
[
UNSOLICITED_RESPONSE_IMS_NETWORK_STATE_CHANGED
]
=
null
;
...
prototype
[
UNSOLICITED_UICC_SUBSCRIPTION_STATUS_CHANGED
]
=
null
;
...
prototype
[
UNSOLICITED_SRVCC_STATE_NOTIFY
]
=
null
;
...
prototype
[
UNSOLICITED_HARDWARE_CONFIG_CHANGED
]
=
null
;
...
prototype
[
UNSOLICITED_DC_RT_INFO_CHANGED
]
=
null
;
...
case
PDU_IEI_APPLICATION_PORT_ADDRESSING_SCHEME_8BIT
:
{
let
dstp
...
case
PDU_IEI_APPLICATION_PORT_ADDRESSING_SCHEME_16BIT
:
{
let
dstp
...
case
PDU_IEI_CONCATENATED_SHORT_MESSAGES_16BIT
:
{
let
ref
...
dcs
&
PDU_DCS_MWI_ACTIVE_BITS
)
=
=
PDU_DCS_MWI_ACTIVE_VALUE
;
/
/
If
...
dcs
&
PDU_DCS_MWI_TYPE_BITS
)
{
case
PDU_DCS_MWI_TYPE_VOICEMAIL
:
let
mwi
=
...
>
=
CB_MESSAGE_SIZE_UMTS_MIN
&
&
pduLength
<
=
CB_MESSAGE_SIZE_UMTS_MAX
)
{
msg
.
...
writeInt
(
PDU_CDMA_MSG_TELESERIVCIE_ID_WEMT
)
;
}
else
...
writeInt
(
PDU_CDMA_MSG_TELESERIVCIE_ID_SMS
)
;
}
this
...
numberType
=
PDU_CDMA_MSG_ADDR_NUMBER_TYPE_UNKNOWN
;
result
.
numberPlan
...
digitMode
=
PDU_CDMA_MSG_ADDR_DIGIT_MODE_DTMF
;
result
.
numberMode
...
digitMode
=
PDU_CDMA_MSG_ADDR_DIGIT_MODE_ASCII
;
result
.
numberMode
=
PDU_CDMA_MSG_ADDR_NUMBER_MODE_ASCII
;
result
.
address
...
message
[
PDU_CDMA_MSG_USER_DATA_MSG_STATUS
]
;
[
message
...
;
case
PDU_CDMA_MSG_USERDATA_CALLBACK_NUMBER
:
message
[
id
...
:
case
PDU_CDMA_MSG_CODING_LATIN_HEBREW
:
case
PDU_CDMA_MSG_CODING_LATIN
:
return
PDU_DCS_MSG_CODING_8BITS_ALPHABET
;
...
{
case
PDU_CDMA_MSG_CODING_IS_91_TYPE_SMS
:
case
PDU_CDMA_MSG_CODING_IS_91_TYPE_SMS_FULL
:
case
...
;
case
PDU_CDMA_MSG_CODING_IS_91_TYPE_CLI
:
let
addrInfo
=
...
numberPlan
=
PDU_CDMA_MSG_ADDR_NUMBER_PLAN_UNKNOWN
;
addrInfo
.
addrLength
...
/
case
PDU_CDMA_INFO_REC_TYPE_DISPLAY
:
case
PDU_CDMA_INFO_REC_TYPE_EXTENDED_DISPLAY
:
record
.
display
...
;
case
PDU_CDMA_INFO_REC_TYPE_CALLED_PARTY_NUMBER
:
record
.
calledNumber
...
;
case
PDU_CDMA_INFO_REC_TYPE_LINE_CONTROL
:
record
.
lineControl
...
;
case
PDU_CDMA_INFO_REC_TYPE_T53_CLIR
:
record
.
clirCause
...
;
case
PDU_CDMA_INFO_REC_TYPE_T53_RELEASE
:
/
/
Fall
...
writeHexOctet
(
COMPREHENSIONTLV_TAG_DATE_TIME_ZONE
)
;
GsmPDUHelper
.
...
>
=
ICC_PHASE_2_PROFILE_DOWNLOAD_REQUIRED
)
{
this
.
