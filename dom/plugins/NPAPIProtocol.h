...
child
(
ChildToParentMsg_Reply
.
.
.
)
enum
NPAPI_ParentToChildMsgType
{
NPAPI_ParentToChildStart
=
NPAPI_ParentToChildMsgStart
<
<
12
NPAPI_ParentToChildPreStart
=
(
NPAPI_ParentToChildMsgStart
<
...
;
class
NPAPI_ParentToChildMsg_NPP_New
:
public
IPC
:
...
parent
enum
NPAPI_ChildToParentMsgType
{
NPAPI_ChildToParentStart
=
NPAPI_ChildToParentMsgStart
<
<
12
NPAPI_ChildToParentPreStart
=
(
NPAPI_ChildToParentMsgStart
<
...
;
class
NPAPI_ChildToParentMsg_Reply_NP_Initialize
:
public
IPC
:
...
;
class
NPAPI_ChildToParentMsg_Reply_NPP_New
:
public
IPC
:
