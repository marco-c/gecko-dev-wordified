...
to
wait
RecvOnKeyEventHandledBeforePlugin
(
)
/
/
...
not
send
WM_IME_COMPOSITION_START
or
/
/
WM_IME_COMPSOITION_END
properly
.
So
we
...
/
/
test_invalidate_during_plugin_paint
test
nsIntRect
rect
=
