...
uint32_t
aTextSampleTargetCodeUnits
RequestDocumentLanguageMetadataResolver
&
&
aResolver
)
...
-
>
CanCollectDocumentLanguageMetadata
(
)
)
{
...
:
:
dom_document_language_metadata_load_timeout_ms
(
)
;
if
...
:
:
dom_document_language_metadata_retry_delay_base_ms
(
)
*
mRetryCount
...
:
:
dom_document_language_metadata_max_retries
(
)
;
return
...
;
SendUpdatePrincipalPartitioning
(
!
aDocument
-
...
:
:
RecvRequestDocumentLanguageMetadata
(
uint32_t
aTextSampleMinCodeUnits
uint32_t
...
:
:
RecvNotifyAudioSessionStateChanged
(
const
AudioSessionState
&
...
:
:
RecvGetModelContextTools
(
GetModelContextToolsResolver
&
&
aResolver
)
...
>
aInput
InvokeModelContextToolResolver
&
&
aResolver
)
