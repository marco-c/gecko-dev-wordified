...
to
the
backgroundClipboardContentAnalysis
thread
.
mClipboardContentAnalysisThread
-
...
GetAndLogPrincipalValidationFailure
(
nsIPrincipal
*
aPrincipal
...
:
:
telemetry_fog_enable_fog_transport
(
)
?
"
...
<
typename
GetClipboardDataFunction
>
nsresult
ContentParent
:
:
GetClipboardDataInternal
(
nsTArray
<
nsCString
...
:
:
RecvDropParentProcessChannelHandle
(
const
nsID
&
...
:
:
RecvUpdateScriptCacheEverHitTelemetry
(
const
uint64_t
&
...
:
:
RecvReleaseHWInferenceConnection
(
)
{
if
...
-
>
TransmitBrowserPermissionsForPrincipal
(
this
principal
browserId
...
-
>
set_androidAppLinkToNavigationStart
(
static_cast
<
uint32_t
...
:
:
RecvSynchronizeNavigationAPIState
(
const
MaybeDiscarded
<
...
:
:
RecvSetReferrerPolicyForEmbedderFrame
(
const
MaybeDiscardedBrowsingContext
&
