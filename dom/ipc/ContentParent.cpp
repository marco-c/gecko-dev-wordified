...
:
mReceivedFilePathUpdate
(
false
)
mReceivedFileSystemUpdate
(
false
)
{
...
;
nsString
mFilePathUpdateStoageType
;
nsString
mFilePathUpdateStorageName
;
nsString
mFilePathUpdatePath
;
nsCString
mFilePathUpdateReason
;
bool
mReceivedFileSystemUpdate
;
nsString
mFileSystemUpdateFsName
;
nsString
mFileSystemUpdateMountPount
;
int32_t
mFileSystemUpdateState
;
int32_t
mFileSystemUpdateMountGeneration
;
bool
mFileSystemUpdateIsMediaPresent
;
bool
mFileSystemUpdateIsSharing
;
bool
mFileSystemUpdateIsFormatting
;
bool
mFileSystemUpdateIsFake
;
}
;
#
...
:
:
AllocPSharedBufferManagerParent
(
mozilla
:
:
...
ref
in
DeallocPMobileConnectionParent
(
)
.
parent
...
:
:
RecvSpeakerManagerGetSpeakerStatus
(
bool
*
aValue
...
:
:
RecvSpeakerManagerForceSpeaker
(
const
bool
&
