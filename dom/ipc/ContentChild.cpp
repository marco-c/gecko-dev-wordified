...
:
:
fission_processPrivateWindowSiteNames
(
)
)
)
...
nsIOpenWindowInfo
>
openWindowInfoInitialPrincipal
;
/
/
Init
...
(
CollectScrollingMetricsResolver
&
&
aResolver
)
...
:
:
RecvSimpleURIUnknownRemoteSchemes
(
nsTArray
<
nsCString
...
-
>
ClearBrowserPermissionsFromIPC
(
aBrowserId
aActionFilter
)
...
:
:
AllocPURLClassifierLocalByNameChild
(
nsIURI
*
aUri
...
:
:
DeallocPURLClassifierLocalByNameChild
(
PURLClassifierLocalByNameChild
*
aActor
...
:
:
RecvUpdateMediaSessionInterrupt
(
const
MaybeDiscarded
<
...
:
:
RecvDestroyBrowsingContextGroup
(
uint64_t
aGroupId
)
...
&
aLoadState
DispatchBeforeUnloadToSubtreeResolver
&
&
aResolver
)
...
:
:
RecvDispatchNavigateToTraversable
(
const
MaybeDiscarded
<
...
&
aLoadState
DispatchNavigateToTraversableResolver
&
&
aResolver
)
...
threads
;
Servo_ThreadPool_GetThreadHandles
(
&
threads
)
