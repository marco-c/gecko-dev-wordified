...
in
*
onnxruntime_run_options_config_keys
.
h
*
*
...
dedicated
*
SessionOptionsAppendExecutionProvider_
<
provider
name
>
...
use
*
SessionOptionsAppendExecutionProvider_oneDNN
above
to
access
the
