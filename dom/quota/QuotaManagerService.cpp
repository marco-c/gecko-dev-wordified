...
;
using
BoolResponsePromiseResolveOrRejectCallback
=
ResponsePromiseResolveOrRejectCallback
<
Request
...
;
using
UInt64ResponsePromiseResolveOrRejectCallback
=
ResponsePromiseResolveOrRejectCallback
<
Request
...
;
using
CStringArrayResponsePromiseResolveOrRejectCallback
=
ResponsePromiseResolveOrRejectCallback
<
Request
...
;
using
UsageInfoResponsePromiseResolveOrRejectCallback
=
ResponsePromiseResolveOrRejectCallback
<
UsageRequest
...
-
>
SendPersistentStorageInitialized
(
)
-
>
...
-
>
SendPersistentOriginInitialized
(
principalInfo
)
-
...
-
>
SendTemporaryOriginInitialized
(
persistenceType
principalInfo
)
...
-
>
SendInitializePersistentStorage
(
)
-
>
...
-
>
SendInitializeAllTemporaryOrigins
(
)
-
>
...
-
>
SendInitializePersistentOrigin
(
principalInfo
)
-
...
>
usageRequestParentEndpoint
=
mBackgroundActor
-
>
OpenPQuotaUsageRequestEndpoint
(
usageRequestChild
)
;
...
-
>
SendSetThumbnailPrivateIdentityId
(
aThumbnailPrivateIdentityId
)
;
