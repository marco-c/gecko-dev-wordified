...
TEST
(
QuotaCommon_WarnIfFileIsUnknown
Basics
)
{
nsCOMPtr
...
(
QuotaCommon_Try
Failure_CustomErr_CustomLambda
)
{
#
define
...
(
QuotaCommon_Try
Failure_WithCleanupAndPredicate
)
{
auto
predicate
...
{
bool
nestedTry1DidNotReturn
=
false
;
bool
nestedTry2DidNotReturn
=
false
;
bool
...
(
QuotaCommon_Try
NestingMadness_Multiple_Failure2
)
{
bool
nestedTry1DidNotReturn
...
TEST
(
QuotaCommon_TryInspect
Success
)
{
bool
tryInspectDidNotReturn
=
false
;
nsresult
...
TEST
(
QuotaCommon_WarnOnlyTry
Success
)
{
bool
warnOnlyTryDidNotReturn
=
false
;
const
...
(
QuotaCommon_OrElseWarnIf
Failure_PredicateReturnsTrue_MappedToSuccess
)
{
bool
predicateRun
...
(
QuotaCommon_OrElseWarnIf
Failure_PredicateReturnsTrue_MappedToError
)
{
bool
predicateRun
...
TEST
(
QuotaCommon_CollectEachInRange
Success
)
{
size_t
...
TEST
(
QuotaCommon_CallWithDelayedRetriesIfAccessDenied
NoFailures
)
{
uint32_t
...
TEST
(
QuotaCommon_MakeSourceFileRelativePath
ThisSourceFile
)
{
static
...
constexpr
auto
domQuotaSourceFileRelativePath
=
"
dom
/
...
(
QuotaCommon_MakeSourceFileRelativePath
DomIndexedDBSourceFile
)
{
static
constexpr
auto
domIndexedDBSourceFileRelativePath
=
"
dom
/
...
constexpr
auto
mozillaDomSourceFileRelativePath
=
"
mozilla
/
...
constexpr
auto
domLocalstorageSourceFileRelativePath
=
"
dom
/
...
TEST
(
QuotaCommon_NormalizedSourcePath
BackslashesNormalized
)
{
static
constexpr
