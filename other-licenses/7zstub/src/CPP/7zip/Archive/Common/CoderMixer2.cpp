...
QueryInterface
(
IID_ICompressGetInStreamProcessedSize2
(
void
*
*
...
:
:
Is_UnpackSize_Correct_for_Coder
(
UInt32
coderIndex
)
...
:
:
Is_PackSize_Correct_for_Stream
(
UInt32
streamIndex
)
