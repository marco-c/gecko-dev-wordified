...
>
_folderArchiveExtractCallback2
;
FString
_dirPathPrefix
;
...
;
bool
_keepAndReplaceEmptyDirPrefixes
;
/
/
replace
...
overwriteMode
bool
keepAndReplaceEmptyDirPrefixes
)
{
_multiArchives
=
