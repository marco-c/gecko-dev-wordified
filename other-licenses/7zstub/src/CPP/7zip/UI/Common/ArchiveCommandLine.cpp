...
namespace
NRecursedPostCharIndex
{
enum
EEnum
{
kWildcardRecursionOnly
=
0
kNoRecursion
=
...
const
char
kSomeCludeAfterRecursedPostStringMinSize
=
2
;
/
...
const
int
kUpdatePairStateNotSupportedActions
[
]
=
{
