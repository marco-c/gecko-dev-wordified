...
:
return
SA_STREAM_TYPE_SYSTEM
;
case
AUDIO_CHANNEL_CONTENT
:
return
SA_STREAM_TYPE_MUSIC
;
case
AUDIO_CHANNEL_NOTIFICATION
:
return
SA_STREAM_TYPE_NOTIFICATION
;
case
AUDIO_CHANNEL_ALARM
:
return
SA_STREAM_TYPE_ALARM
;
case
AUDIO_CHANNEL_TELEPHONY
:
return
SA_STREAM_TYPE_VOICE_CALL
;
case
AUDIO_CHANNEL_PUBLICNOTIFICATION
:
return
SA_STREAM_TYPE_ENFORCED_AUDIBLE
;
default
:
NS_ERROR
