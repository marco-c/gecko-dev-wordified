...
do_GetService
(
IPEERCONNECTION_MANAGER_CONTRACTID
)
;
if
(
...
:
:
ClearPendingPointerLockRequest
(
bool
aDispatchErrorEvents
)
{
nsAsyncPointerLockRequest
:
...
static
size_t
SizeOfStyleSheetsElementIncludingThis
(
nsIStyleSheet
*
aStyleSheet
