...
/
/
_generateAndPersistEncryptedKeys
requires
the
sync
key
...
the
count
closeTabNotificationCount
=
0
;
hasPendingCloseTabNotification
=
false
;
constructor
...
async
_generateAndPersistCloseTabKeys
(
)
{
let
...
async
_getPersistedEncryptedCloseTabKey
(
)
{
const
...
async
_generateAndPersistEncryptedCloseTabKeys
(
)
{
let
