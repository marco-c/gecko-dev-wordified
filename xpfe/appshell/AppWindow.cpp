...
:
:
MaybeSavePersistentPositionAndSize
(
PersistentAttributes
aAttributes
Element
...
:
:
MaybeSavePersistentMiscAttributes
(
PersistentAttributes
aAttributes
Element
...
:
:
browser_restoreWindowState_disabled
(
)
)
{
