...
ClipboardResultPromise
>
GetClipboardDataIfSmallerThanImpl
(
const
nsTArray
<
...
:
:
RecvGetClipboardDataIfSmallerThan
(
nsTArray
<
nsCString
...
&
aRequestingWindowContextId
GetClipboardDataIfSmallerThanResolver
&
&
aResolver
)
