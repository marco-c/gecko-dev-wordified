...
DispatchEntry
*
findQueuedDispatchEntryForEvent
(
const
EventEntry
*
...
;
nsecs_t
getTimeSpentWaitingForApplicationLocked
(
nsecs_t
currentTime
)
...
;
bool
isWindowFinishedWithPreviousInputLocked
(
const
sp
<
...
;
bool
afterMotionEventLockedInterruptible
(
const
sp
<
