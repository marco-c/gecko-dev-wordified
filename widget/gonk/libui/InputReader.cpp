...
INDENT2
"
WheelVelocityControlParameters
:
"
"
scale
...
mConfig
.
pointerGestureDragMinSwitchSpeed
)
;
dump
.
...
mConfig
.
pointerGestureMultitouchMinDistance
)
;
dump
.
...
mConfig
.
pointerGestureSwipeTransitionAngleCosine
)
;
dump
.
...
mConfig
.
pointerGestureSwipeMaxWidthRatio
)
;
dump
.
...
:
:
CHANGE_POINTER_GESTURE_ENABLEMENT
|
InputReaderConfiguration
:
:
