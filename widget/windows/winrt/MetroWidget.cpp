...
HStringReference
(
RuntimeClass_Windows_Devices_Input_PointerDevice
)
.
Get
(
...
:
:
OnAutomationProviderRequestedEvent
is
/
/
compatible
...
:
:
CSSIntPointToLayoutDeviceIntPoint
(
const
CSSIntPoint
&
