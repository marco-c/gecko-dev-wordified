...
;
mLastPointAndPointerIdByNonMouse
.
reset
(
)
...
:
:
widget_windows_mica_toplevel_backdrop
(
)
)
{
...
:
:
widget_windows_pip_decorations_enabled
(
)
)
{
...
we
update
sLastMouseMovePointByAnyPointer
even
for
touch
-
...
+
/
456d6e533cfb4531995e0ef52c279d4b5aa8a352
/
ui
/
views
...
:
:
widget_windows_pen_tilt_override_enabled
(
)
|
|
...
:
:
widget_windows_pen_twist_override_enabled
(
)
)
{
...
const
auto
GetCurrentOverrideValueWithUpdatingNextValue
=
[
]
(
