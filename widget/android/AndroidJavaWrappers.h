...
static
void
InitProgressiveUpdateDataClass
(
JNIEnv
*
jEnv
...
static
jfieldID
jDisplayportPosition
;
static
jfieldID
jDisplayportResolution
;
}
;
enum
...
static
jclass
jDomKeyLocationClass
;
static
jfieldID
jDomKeyLocationValueField
;
public
:
enum
