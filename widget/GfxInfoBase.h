...
;
nsString
mSpoofedAdapterVendorID2
;
nsString
mSpoofedAdapterDeviceID2
;
nsString
mSpoofedAdapterDriverVendor2
;
nsString
mSpoofedAdapterDriverVersion2
;
#
endif
private
