...
drawTitlebarHighlight
;
-
(
void
)
maskTopCornersInContext
:
(
CGContextRef
)
...
_createRoundedBottomRegionForRect
:
(
CGRect
)
...
#
define
NSFoundationVersionWithProperStrideSupportForSubtextureUpload
...
convertToFlippedWindowCoordinates
:
(
NSRect
)
...
static
bool
IsPotentialSwipeStartEventOverscrollingViewport
(
const
WidgetWheelEvent
&
...
shutdownAndReleaseCalledOnEventThread
;
-
(
void
)
shutdownAndReleaseCalledOnAnyThread
;
-
(
void
