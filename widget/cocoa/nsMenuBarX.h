...
referralsPageMenuItem
;
-
(
void
)
setReferralsPageMenuItem
:
(
NSMenuItem
*
...
nsIContent
>
mSetAsDefaultItemContent
;
RefPtr
<
nsIContent
>
mReferralsPageItemContent
;
RefPtr
<
nsIContent
