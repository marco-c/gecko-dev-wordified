...
;
void
Hooked_WebInitForCarbon
(
)
;
OSStatus
Hooked_InstallEventLoopIdleTimer
(
EventLoopRef
inEventLoop
EventTimerInterval
...
(
*
HIToolbox_InstallEventLoopIdleTimer
)
(
EventLoopRef
inEventLoop
