...
static
int32_t
MozFrameView_buttonBoxDisplayPixelsWidth
(
id
self
SEL
...
static
int32_t
MozFrameView_fullScreenButtonDisplayPixelsWidth
(
id
self
SEL
...
selector
(
fullScreenButtonDisplayPixelsWidth
)
(
IMP
)
...
NSString
*
kStateInactiveTitlebarColorKey
=
"
...
installTitlebarMouseHandlingView
;
-
(
void
)
uninstallTitlebarMouseHandlingView
;
end
;
implementation
...
updateWindowDraggableStateOnMouseMove
:
anEvent
]
;
