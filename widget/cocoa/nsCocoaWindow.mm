...
if
(
IsInNativeFullscreenTransition
(
)
)
{
...
ExitFullscreen
;
StartNativeFullscreenTransition
(
requestedState
)
;
...
;
HandleNativeFullscreenTransition
(
toFullscreen
)
;
...
:
:
HandleNativeFullscreenTransitionFailure
(
bool
aFullscreen
)
