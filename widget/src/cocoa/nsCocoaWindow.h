...
const
float
sLeopardHeaderBackgroundStartGrey
=
233
/
255
...
const
float
sLeopardHeaderBackgroundEndGrey
=
207
/
255
...
initWithActiveTitlebarColor
:
(
NSColor
*
)
aActiveTitlebarColor
