...
;
void
HandleXlibConfigureNotifyEvent
(
XEvent
*
event
...
;
PRBool
mBlockMozAreaFocusIn
;
void
HandleMozAreaFocusIn
(
void
)
;
void
HandleMozAreaFocusOut
(
void
)
;
