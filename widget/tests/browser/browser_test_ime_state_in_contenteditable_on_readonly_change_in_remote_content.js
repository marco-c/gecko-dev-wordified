...
.
/
file_test_ime_state_in_contenteditable_on_readonly_change
.
js
*
/
...
async
function
test_ime_state_in_contenteditable_on_readonly_change
(
)
{
const
...
wrappedJSObject
.
createIMEStateInContentEditableOnReadonlyChangeTester
(
)
;
const
...
async
function
test_ime_state_in_button_in_contenteditable_on_readonly_change
(
)
{
const
...
async
function
test_ime_state_of_text_controls_in_contenteditable_on_readonly_change
(
)
{
const
...
wrappedJSObject
.
createIMEStateOfTextControlInContentEditableOnReadonlyChangeTester
(
)
;
}
...
wrappedJSObject
.
createIMEStateOutsideContentEditableOnReadonlyChangeTester
(
)
;
}
