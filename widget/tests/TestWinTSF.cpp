...
#
define
GUID_ATOM_COMPOSING_SELECTION_ATTR
\
(
static_cast
<
...
const
LONG
PRECOMPOSITION_SEL_START
=
2
;
const
LONG
PRECOMPOSITION_SEL_END
=
PRECOMPOSITION_SEL_START
;
const
TsActiveSelEnd
PRECOMPOSITION_SEL_SELEND
=
TS_AE_END
;
TS_SELECTION_ACP
