...
;
readonly
ERROR_TYPE_NOT_INITIALIZED
?
:
6
;
readonly
ERROR_TYPE_NO_UTF8_CONVERSION
?
:
7
;
readonly
ERROR_TYPE_INVALID_GUID
?
:
8
;
readonly
ERROR_TYPE_PIPE_NOT_CONNECTED
?
:
9
;
readonly
ERROR_TYPE_PIPE_TIMEOUT
?
:
10
;
readonly
ERROR_TYPE_PIPE_BAD_WRITE_COUNT
?
:
11
;
readonly
ERROR_TYPE_PIPE_API_ERROR
?
:
12
;
readonly
ERROR_TYPE_FAILED_TO_CREATE_BITS_JOB
?
:
13
;
readonly
ERROR_TYPE_FAILED_TO_ADD_FILE_TO_JOB
?
:
14
;
readonly
ERROR_TYPE_FAILED_TO_APPLY_BITS_JOB_SETTINGS
?
:
15
;
readonly
ERROR_TYPE_FAILED_TO_RESUME_BITS_JOB
?
:
16
;
readonly
ERROR_TYPE_OTHER_BITS_ERROR
?
:
17
;
readonly
ERROR_TYPE_OTHER_BITS_CLIENT_ERROR
?
:
18
;
...
;
readonly
ERROR_TYPE_FAILED_TO_SUSPEND_BITS_JOB
?
:
21
;
readonly
ERROR_TYPE_FAILED_TO_COMPLETE_BITS_JOB
?
:
22
;
readonly
ERROR_TYPE_PARTIALLY_COMPLETED_BITS_JOB
?
:
23
;
readonly
ERROR_TYPE_FAILED_TO_CANCEL_BITS_JOB
?
:
24
;
readonly
ERROR_TYPE_MISSING_RESULT_DATA
?
:
25
;
readonly
ERROR_TYPE_MISSING_CALLBACK
?
:
26
;
readonly
ERROR_TYPE_CALLBACK_ON_WRONG_THREAD
?
:
27
;
readonly
ERROR_TYPE_MISSING_BITS_SERVICE
?
:
28
;
readonly
ERROR_TYPE_BITS_SERVICE_ON_WRONG_THREAD
?
:
29
;
readonly
ERROR_TYPE_MISSING_BITS_REQUEST
?
:
30
;
readonly
ERROR_TYPE_BITS_REQUEST_ON_WRONG_THREAD
?
:
31
;
readonly
ERROR_TYPE_MISSING_OBSERVER
?
:
32
;
readonly
ERROR_TYPE_OBSERVER_ON_WRONG_THREAD
?
:
33
;
...
;
readonly
ERROR_TYPE_CONTEXT_ON_WRONG_THREAD
?
:
35
;
readonly
ERROR_TYPE_FAILED_TO_START_THREAD
?
:
36
;
readonly
ERROR_TYPE_FAILED_TO_CONSTRUCT_TASK_RUNNABLE
?
:
37
;
readonly
ERROR_TYPE_FAILED_TO_DISPATCH_RUNNABLE
?
:
38
;
readonly
ERROR_TYPE_TRANSFER_ALREADY_COMPLETE
?
:
39
;
readonly
ERROR_TYPE_OPERATION_ALREADY_IN_PROGRESS
?
:
40
;
readonly
ERROR_TYPE_MISSING_BITS_CLIENT
?
:
41
;
readonly
ERROR_TYPE_FAILED_TO_GET_JOB_STATUS
?
:
42
;
readonly
ERROR_TYPE_BITS_STATE_ERROR
?
:
43
;
readonly
ERROR_TYPE_BITS_STATE_TRANSIENT_ERROR
?
:
44
;
readonly
ERROR_TYPE_BITS_STATE_CANCELLED
?
:
45
;
readonly
ERROR_TYPE_BITS_STATE_UNEXPECTED
?
:
46
;
...
;
readonly
ERROR_TYPE_BROWSER_SHUTTING_DOWN
?
:
51
;
...
;
readonly
ERROR_STAGE_COMMAND_THREAD
?
:
3
;
readonly
ERROR_STAGE_AGENT_COMMUNICATION
?
:
4
;
...
;
readonly
ROLE_MATHML_FRACTION
?
:
87
;
readonly
ROLE_MATHML_SQUARE_ROOT
?
:
88
;
...
;
readonly
ROLE_MATHML_UNDER_OVER
?
:
97
;
readonly
ROLE_MATHML_MULTISCRIPTS
?
:
98
;
...
;
readonly
ROLE_MATHML_LONG_DIVISION
?
:
106
;
readonly
ROLE_MATHML_STACK_GROUP
?
:
107
;
readonly
ROLE_MATHML_STACK_ROW
?
:
108
;
readonly
ROLE_MATHML_STACK_CARRIES
?
:
109
;
readonly
ROLE_MATHML_STACK_CARRY
?
:
110
;
readonly
ROLE_MATHML_STACK_LINE
?
:
111
;
...
declare
enum
nsIAppStartup_IDLShutdownPhase
{
SHUTDOWN_PHASE_NOTINSHUTDOWN
=
0
...
declare
enum
nsIDocShell_DocShellEnumeratorDirection
{
ENUMERATE_FORWARDS
=
0
...
declare
enum
nsIDocumentViewer_PermitUnloadResult
{
eContinue
=
0
...
declare
enum
nsISelectionController_ControllerScrollFlags
{
SCROLL_SYNCHRONOUS
=
2
...
declare
enum
nsIDOMWindowUtils_AsyncEnabledOption
{
ASYNC_DISABLED
=
0
...
;
readonly
WR_CAPTURE_TILE_CACHE
?
:
4
;
readonly
WR_CAPTURE_EXTERNAL_RESOURCES
?
:
8
;
...
:
Element
aVerticalScrollbarWidth
:
OutParam
<
u32
>
aHorizontalScrollbarHeight
:
OutParam
<
u32
...
;
readonly
nodeObservedByIMEContentObserver
:
Node
;
...
;
readonly
includingChangesDuringComposition
:
boolean
;
readonly
includingChangesWithoutComposition
:
boolean
;
}
...
media
/
nsIMediaPictureInPictureProvider
.
idl
interface
nsIMediaPictureInPictureProvider
...
declare
enum
nsIQuotaArtificialFailure_Category
{
CATEGORY_NONE
=
0
...
declare
enum
nsIContentSecurityPolicy_CSPDirective
{
NO_DIRECTIVE
=
0
...
>
;
maybeWriteDownloadOriginInformation
(
aTargetFile
:
nsIFile
...
declare
enum
nsIHelperAppLauncherDialog_reason
{
REASON_CANTHANDLE
=
0
...
declare
enum
imgIEncoder_CICPColourPrimaries
{
CP_BT709
=
1
...
declare
enum
imgIEncoder_CICPTransferCharacteristics
{
TC_BT709
=
1
...
declare
enum
imgIEncoder_CICPMatrixCoefficients
{
MC_IDENTITY
=
0
...
;
readonly
INPUT_FORMAT_R10G10B10A2
?
:
3
;
readonly
INPUT_FORMAT_RGBA_U10
?
:
4
;
readonly
INPUT_FORMAT_RGBA_U12
?
:
5
;
readonly
INPUT_FORMAT_RGBA_U16
?
:
6
;
readonly
INPUT_FORMAT_RGBA_F16
?
:
7
;
...
declare
enum
nsIKeyValueService_RecoveryStrategy
{
ERROR
=
0
...
declare
enum
nsIKeyValueImporter_ConflictPolicy
{
ERROR_ON_CONFLICT
=
0
...
declare
enum
nsIKeyValueImporter_CleanupPolicy
{
KEEP_AFTER_IMPORT
=
0
...
:
nsILoginInfo
aPrivateContextWithoutExplicitConsent
:
boolean
aLoginType
:
...
declare
enum
nsICacheInfoChannel_CacheDisposition
{
kCacheUnresolved
=
0
...
declare
enum
nsIClassifiedChannel_ClassificationFlags
{
...
nsIChannel
;
newChannelFromURIWithProxyFlagsAndLoadInfo
(
aURI
:
nsIURI
...
nsIWebTransport
;
originAttributesForNetworkState
(
aChannel
:
nsIChannel
...
void
;
setSimpleURIUnknownRemoteSchemes
(
aRemoteSchemes
:
string
...
declare
enum
nsILoadInfo_StoragePermissionState
{
NoStoragePermission
=
0
...
declare
enum
nsILoadInfo_HTTPSUpgradeTelemetryType
{
NOT_INITIALIZED
=
0
...
;
readonly
BLOCKING_REASON_WEBDRIVER_BIDI
?
:
7000
;
...
CrossOriginEmbedderPolicy
;
isOriginTrialCoepCredentiallessEnabledForTopLevel
:
boolean
;
isMediaRequest
...
declare
enum
nsINetworkConnectivityService_ConnectivityState
{
UNKNOWN
=
0
...
;
readonly
STATUS_TLS_HANDSHAKE_STARTING
?
:
4915212
;
readonly
STATUS_TLS_HANDSHAKE_ENDED
?
:
4915213
;
...
declare
enum
nsITimedChannel_BodyInfoAccess
{
DISALLOWED
=
0
...
declare
enum
nsICookieValidation_ValidationError
{
eOK
=
0
...
=
16384
RESOLVE_REFRESH_NEGATIVE_CACHE
=
32768
...
declare
enum
nsIDNSService_ConfirmationState
{
CONFIRM_OFF
=
0
...
;
readonly
ACTIVITY_SUBTYPE_PROXY_RESPONSE_HEADER
?
:
20487
;
...
;
readonly
ACTIVITY_SUBTYPE_EARLYHINT_RESPONSE_HEADER
?
:
20492
;
...
declare
enum
nsIHttpChannelInternal_ProxyDNSStrategy
{
PROXY_DNS_STRATEGY_ORIGIN
=
1
PROXY_DNS_STRATEGY_PROXY
=
2
}
declare
...
declare
enum
nsIWebTransport_WebTransportError
{
UNKNOWN_ERROR
=
0
...
declare
enum
nsIClientAuthRememberService_Duration
{
Once
=
0
...
declare
enum
nsIX509CertDB_PDFSignatureAlgorithm
{
ADBE_PKCS7_DETACHED
=
0
...
declare
enum
mozIPlacesAutoComplete_MatchBehaviors
{
MATCH_ANYWHERE
=
0
...
declare
enum
mozIPlacesAutoComplete_SearchBehaviors
{
BEHAVIOR_HISTORY
=
1
...
declare
enum
mozISyncedBookmarksMerger_SyncedItemKinds
{
KIND_BOOKMARK
=
1
...
declare
enum
mozISyncedBookmarksMerger_SyncedItemValidity
{
VALIDITY_VALID
=
1
...
declare
enum
nsINavBookmarksService_BookmarkType
{
TYPE_BOOKMARK
=
1
...
declare
enum
nsINavBookmarksService_ChangeSource
{
SOURCE_DEFAULT
=
0
...
declare
enum
nsINavHistoryResultNode_ResultType
{
RESULT_TYPE_URI
=
0
...
declare
enum
nsINavHistoryQueryOptions_SortByType
{
SORT_BY_NONE
=
0
...
declare
enum
nsINavHistoryQueryOptions_ResultType
{
RESULTS_AS_URI
=
0
...
declare
enum
nsINavHistoryService_TransitionType
{
TRANSITION_LINK
=
1
...
;
readonly
areUntrustedModuleLoadEventsReady
:
boolean
;
getHistogramById
...
declare
enum
nsIBounceTrackingProtection_Modes
{
MODE_DISABLED
=
0
...
=
4
PRIVACY_TRACKINGPROTECTION_CONTENT_ENABLED
=
5
...
=
9
PRIVACY_TRACKINGPROTECTION_CONTENT_TEST_ENABLED
=
10
NUM_SCOPED_BOOL_PREFS
=
11
}
declare
...
declare
enum
nsIContentAnalysisRequest_Reason
{
eUnknown
=
0
...
;
readonly
enabledFingerprintingProtectionsBaseline
:
nsIRFPTargetSetIDL
;
readonly
...
declare
enum
nsIToolkitProfileService_downgradeUIFlags
{
hasSync
=
1
...
declare
enum
nsIToolkitProfileService_downgradeUIChoice
{
quit
=
0
...
declare
enum
nsIToolkitProfileService_profileManagerResult
{
exit
=
0
...
interface
nsIApplicationUpdateServiceInternal
extends
nsISupports
{
init
...
declare
enum
nsIUrlClassifierExceptionListEntry_Category
{
...
declare
enum
nsIUrlClassifierFeature_listType
{
blocklist
=
0
...
;
readonly
WARNING_UNWANTED_PAGE_TOP_WHY_BLOCKED
?
:
18
;
readonly
WARNING_UNWANTED_PAGE_TOP_GET_ME_OUT_OF_HERE
?
:
19
;
readonly
WARNING_UNWANTED_PAGE_TOP_IGNORE_WARNING
?
:
20
;
...
;
readonly
WARNING_UNWANTED_PAGE_FRAME_WHY_BLOCKED
?
:
22
;
readonly
WARNING_UNWANTED_PAGE_FRAME_GET_ME_OUT_OF_HERE
?
:
23
;
readonly
WARNING_UNWANTED_PAGE_FRAME_IGNORE_WARNING
?
:
24
;
...
;
readonly
WARNING_HARMFUL_PAGE_TOP_WHY_BLOCKED
?
:
26
;
readonly
WARNING_HARMFUL_PAGE_TOP_GET_ME_OUT_OF_HERE
?
:
27
;
readonly
WARNING_HARMFUL_PAGE_TOP_IGNORE_WARNING
?
:
28
;
...
;
readonly
WARNING_HARMFUL_PAGE_FRAME_WHY_BLOCKED
?
:
30
;
readonly
WARNING_HARMFUL_PAGE_FRAME_GET_ME_OUT_OF_HERE
?
:
31
;
readonly
WARNING_HARMFUL_PAGE_FRAME_IGNORE_WARNING
?
:
32
;
...
u32
;
convertServerListNameToLocalListNameV5
(
serverListName
:
string
...
string
;
convertLocalListNameToServerListNameV5
(
localListName
:
string
...
string
;
convertThreatTypeToListNamesV5
(
threatType
:
u32
...
;
readonly
CHROME_DOCUMENT_PICTURE_IN_PICTURE_FLAGS
?
:
4736718
;
...
;
readonly
ENCODE_FLAGS_DISALLOW_LINE_BREAKING
?
:
16384
;
...
declare
enum
mozIExtensionListenerCallOptions_APIObjectType
{
NONE
=
0
...
declare
enum
mozIExtensionListenerCallOptions_CallbackType
{
CALLBACK_NONE
=
0
...
declare
enum
mozIExtensionAPIRequest_RequestType
{
CALL_FUNCTION
=
0
...
declare
enum
nsIClipboardHelper_SensitiveData
{
NotSensitive
=
0
...
declare
enum
nsIGfxInfo_FontVisibilityDeviceDetermination
{
Unassigned
=
0
...
string
;
getFeatureSuggestedDriverVersionStr
(
aFeature
:
string
...
declare
enum
nsIMockDragServiceController_EventType
{
eDragEnter
=
0
...
declare
enum
nsIXULRuntime_ExperimentStatus
{
...
declare
enum
nsIXULRuntime_ContentWin32kLockdownState
{
LockdownEnabled
=
1
...
declare
enum
nsIXULRuntime_FissionDecisionStatus
{
...
=
1
SUPPORTS_SHUTDOWN_TASK_DISPATCH
=
2
...
declare
enum
nsIXPCTestCEnums_testFlagsExplicit
{
shouldBe1Explicit
=
1
...
declare
enum
nsIXPCTestCEnums_testFlagsImplicit
{
shouldBe0Implicit
=
0
