...
double
*
mozilla_sampler_get_responsiveness1
(
)
;
const
...
;
void
mozilla_sampler_save2
(
)
;
char
*
mozilla_sampler_get_profile1
(
)
;
char
...
JSObject
*
mozilla_sampler_get_profile_data1
(
JSContext
*
aCx
...
JSObject
*
mozilla_sampler_get_profile_data2
(
JSContext
*
aCx
...
;
void
mozilla_sampler_print_location1
(
)
;
void
...
browsing
void
mozilla_sampler_lock1
(
)
;
void
mozilla_sampler_lock2
(
)
;
/
...
.
void
mozilla_sampler_unlock1
(
)
;
void
mozilla_sampler_unlock2
(
)
;
/
