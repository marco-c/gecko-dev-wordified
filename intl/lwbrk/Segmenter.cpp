...
:
:
icu4x_GraphemeClusterSegmenter_destroy_mv1
(
sSegmenter
)
;
...
:
:
icu4x_GraphemeClusterSegmenter_segment_utf16_mv1
(
sSegmenter
{
mText
...
:
:
icu4x_SentenceBreakIteratorUtf16_destroy_mv1
(
mIterator
)
;
...
:
:
icu4x_SentenceBreakIteratorUtf16_next_mv1
(
mIterator
)
;
