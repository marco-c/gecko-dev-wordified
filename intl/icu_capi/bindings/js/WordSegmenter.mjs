...
/
const
WordSegmenter_box_destroy_registry
=
new
...
wasm
.
icu4x_WordSegmenter_destroy_mv1
(
ptr
)
;
...
wasm
.
icu4x_WordSegmenter_create_auto_mv1
(
)
;
try
...
wasm
.
icu4x_WordSegmenter_create_lstm_with_content_locale_mv1
(
diplomatReceive
.
buffer
...
wasm
.
icu4x_WordSegmenter_create_dictionary_with_content_locale_mv1
(
diplomatReceive
.
buffer
...
wasm
.
icu4x_WordSegmenter_create_dictionary_with_content_locale_and_provider_mv1
(
diplomatReceive
.
buffer
...
wasm
.
icu4x_WordSegmenter_segment_utf16_mv1
(
this
.
ffiValue
