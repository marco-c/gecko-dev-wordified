...
:
GeneralCategory
icu4x_GeneralCategory_for_char_mv1
(
char32_t
ch
)
...
typedef
struct
icu4x_GeneralCategory_long_name_mv1_result
{
union
{
diplomat
...
typedef
struct
icu4x_GeneralCategory_short_name_mv1_result
{
union
{
diplomat
...
;
uint8_t
icu4x_GeneralCategory_to_integer_value_mv1
(
icu4x
:
:
...
:
GeneralCategoryGroup
icu4x_GeneralCategory_to_group_mv1
(
icu4x
:
:
...
typedef
struct
icu4x_GeneralCategory_from_integer_value_mv1_result
{
union
{
icu4x
...
;
icu4x_GeneralCategory_from_integer_value_mv1_result
icu4x_GeneralCategory_from_integer_value_mv1
(
uint8_t
other
)
