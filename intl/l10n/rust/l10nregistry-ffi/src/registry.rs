...
entries
=
get_l10n_registry_category_entries
(
)
;
Some
...
"
fn
l10nregistry_get_parent_process_sources
(
sources
:
&
...
"
fn
l10nregistry_register_parent_process_sources
(
sources
:
&
