...
;
case
MP4PARSE_STATUS_NO_PRIMARY_ITEM
:
AccumulateCategorical
(
LABELS_AVIF_DECODE_RESULT
...
;
case
MP4PARSE_STATUS_ITEM_LOC_NOT_FOUND
:
AccumulateCategorical
(
LABELS_AVIF_DECODE_RESULT
...
;
case
MP4PARSE_STATUS_NO_ITEM_DATA_BOX
:
AccumulateCategorical
(
LABELS_AVIF_DECODE_RESULT
