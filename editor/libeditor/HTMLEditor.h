...
*
*
SplitInlinessAndCollectEditTargetNodes
(
)
splits
text
...
and
*
CreateRangeExtendedToLineStartAndEnd
(
)
.
If
...
bool
NeedsToFallbackToDeleteSelectionWithTransaction
(
)
const
{
...
;
return
mNeedsToFallbackToDeleteSelectionWithTransaction
;
}
private
:
