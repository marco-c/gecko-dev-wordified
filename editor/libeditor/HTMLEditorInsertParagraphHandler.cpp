...
nsresult
>
deleteInvisibleLineBreakResult
=
mHTMLEditor
.
...
const
EditorDOMPoint
pointToInsertFollowingBRElement
=
[
&
]
...
const
WSScanResult
nextVisibleThingAfterLineBreak
=
WSRunScanner
:
:
...
const
WSScanResult
nextVisibleThingAfterFirstBRElement
=
WSRunScanner
:
:
...
nsresult
>
deleteInvisibleLineBreakResultOrError
=
EnsureNoInvisibleLineBreakBeforePointToSplit
(
aBlockElementToSplit
...
Element
>
deepestContainerElementToSplit
=
HTMLEditUtils
:
:
...
CreateElementResult
insertOppositeTypeListItemResult
=
insertOppositeTypeListItemResultOrError
.
unwrap
...
{
bool
maybeFollowedByInvisibleBRElement
=
true
;
EditorRawDOMPoint
