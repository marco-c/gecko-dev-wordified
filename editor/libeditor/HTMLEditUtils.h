...
*
*
IsNeverContentEditableElementByUser
(
)
returns
true
...
*
*
GetInclusiveFirstChildWhichHasOneChild
(
)
returns
the
...
*
*
GetPreviousCharOffsetExceptASCIIWhiteSpace
(
)
returns
offset
...
*
*
GetNextCharOffsetExceptASCIIWhiteSpace
(
)
returns
offset
