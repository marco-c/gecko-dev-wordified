...
{
return
mAPerformanceHint_createSession
(
manager
threadIds
size
...
{
return
mAPerformanceHint_updateTargetWorkDuration
(
session
targetDurationNanos
)
...
{
return
mAPerformanceHint_reportActualWorkDuration
(
session
actualDurationNanos
)
...
const
{
mAPerformanceHint_closeSession
(
session
)
;
...
;
using
FnAPerformanceHint_createSession
=
APerformanceHintSession
*
(
...
;
using
FnAPerformanceHint_closeSession
=
void
(
*
