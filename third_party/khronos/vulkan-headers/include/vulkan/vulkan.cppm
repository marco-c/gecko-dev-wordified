...
:
:
PFN_InternalAllocationNotification
;
using
VULKAN_HPP_NAMESPACE
:
:
PFN_InternalFreeNotification
;
using
VULKAN_HPP_NAMESPACE
:
...
:
:
PFN_DebugUtilsMessengerCallbackEXT
;
/
/
=
...
:
:
PFN_DeviceMemoryReportCallbackEXT
;
/
/
=
...
:
:
UniqueDataGraphPipelineSessionARM
;
/
/
=
...
:
:
UniqueIndirectCommandsLayoutEXT
;
using
VULKAN_HPP_NAMESPACE
:
:
UniqueIndirectExecutionSetEXT
;
#
endif
/
