...
char
*
PrintIntegralDigitsFromRightFast
(
uint64_t
v
char
...
constexpr
int
HexFloatLeadingDigitSizeInBits
(
)
{
return
...
>
bool
HexFloatNeedsRoundUp
(
Int
mantissa
int
final_nibble_displayed
uint8_t
leading
)
{
...
;
Int
mantissa_up_to_rounding_nibble_inclusive
=
mantissa
&
MaskUpToNibbleInclusive
