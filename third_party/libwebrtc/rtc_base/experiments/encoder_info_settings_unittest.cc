...
TEST
(
SimulcastEncoderAdapterSettingsTest
NoValuesWithoutFieldTrial
)
{
ExplicitKeyValueConfig
field_trials
...
(
SimulcastEncoderAdapterSettingsTest
GetResolutionBitrateLimitsWithList
)
{
ExplicitKeyValueConfig
field_trials
...
(
EncoderSettingsTest
CommonSettingsUsedIfEncoderNameUnspecified
)
{
ExplicitKeyValueConfig
field_trials
...
TEST
(
GetSinglecastBitrateLimitForResolutionWhenQpIsUntrustedTests
