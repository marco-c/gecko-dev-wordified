...
(
CodecTest
H264CostrainedBaselineIsAddedIfH264IsSupported
)
{
const
std
...
const
SdpVideoFormat
kH264ConstrainedBasedlinePacketization1
=
CreateH264Format
(
H264Profile
...
(
CodecTest
H264CostrainedBaselineIsNotAddedIfH264IsUnsupported
)
{
const
std
...
(
CodecTest
H264CostrainedBaselineNotAddedIfAlreadySpecified
)
{
const
std
...
(
CodecTest
CreateH264ConstrainedBaselineProfileReturnsCbpForBaseline
)
{
SdpVideoFormat
baseline_format
...
(
CodecTest
CreateH264ConstrainedBaselineProfileReturnsNulloptForCbp
)
{
SdpVideoFormat
cbp_format
...
(
CodecTest
CreateH264ConstrainedBaselineProfileReturnsNulloptForVp9
)
{
SdpVideoFormat
vp9_format
