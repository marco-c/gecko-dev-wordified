...
;
void
set_create_video_encode_return_nullptr
(
bool
return_nullptr
)
{
create_video_encoder_return_nullptr_
=
return_nullptr
;
}
...
void
set_enable_cpu_overuse_detection
(
bool
enable
)
...
(
TestSimulcastEncoderAdapterFake
DestructorCallsReleaseIfInitialized
)
{
SetupCodec
(
...
(
TestSimulcastEncoderAdapterFake
EncoderInfoDeactiveLayersUpdatesName
)
{
SimulcastTestFixtureImpl
:
...
const
DataRate
bandwidth_allocation_without_layer3
=
target_bitrate
+
DataRate
...
(
TestSimulcastEncoderAdapterFake
GeneratesKeyFramesOnRequestedLayers
)
{
/
/
...
(
TestSimulcastEncoderAdapterFake
ReportsEnableCpuOveruseDetection
)
{
SimulcastTestFixtureImpl
:
...
(
TestSimulcastEncoderAdapterFake
PopulatesScalabilityModeOfSubcodecs
)
{
SimulcastTestFixtureImpl
:
