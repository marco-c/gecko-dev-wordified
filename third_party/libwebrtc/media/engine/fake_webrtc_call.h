...
{
return
base_mininum_playout_delay_ms_
;
}
void
SetSyncGroup
...
>
&
GetKeyFramesRequested
(
)
const
{
return
keyframes_requested_by_rid_
;
}
private
:
...
.
int
last_sent_nonnegative_packet_id
(
)
const
{
return
last_sent_nonnegative_packet_id_
;
}
NetworkState
GetNetworkState
