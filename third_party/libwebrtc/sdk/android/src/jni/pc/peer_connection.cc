...
jobject
>
NativeToJavaCandidatePairChange
(
JNIEnv
*
env
...
;
return
Java_CandidatePairChangeEvent_Constructor
(
env
...
{
return
Java_AdapterType_fromNativeIndex
(
env
adapterType
)
...
=
Java_RTCConfiguration_getAudioJitterBufferMaxPackets
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getAudioJitterBufferFastAccelerate
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getIceConnectionReceivingTimeout
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getIceBackupCandidatePairPingInterval
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getIceCandidatePoolSize
(
jni
j_rtc_config
)
...
prune_turn_ports
=
Java_RTCConfiguration_getPruneTurnPorts
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getPresumeWritableWhenFullyRelayed
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getDisableIPv6OnWifi
(
jni
j_rtc_config
)
...
max_ipv6_networks
=
Java_RTCConfiguration_getMaxIPv6Networks
(
jni
j_rtc_config
)
...
enable_dscp
=
Java_RTCConfiguration_getEnableDscp
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getEnableCpuOveruseDetection
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getSuspendBelowMinBitrate
(
jni
j_rtc_config
)
...
(
jni
Java_RTCConfiguration_getScreencastMinBitrate
(
jni
j_rtc_config
)
...
(
jni
Java_RTCConfiguration_getCombinedAudioVideoBwe
(
jni
j_rtc_config
)
...
(
jni
Java_RTCConfiguration_getEnableDtlsSrtp
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getActiveResetSrtpParams
(
jni
j_rtc_config
)
...
(
jni
Java_RTCConfiguration_getAllowCodecSwitching
(
jni
j_rtc_config
)
...
=
Java_RTCConfiguration_getOfferExtmapAllowMixed
(
jni
j_rtc_config
)
...
;
Java_Observer_onIceConnectionReceivingChange
(
env
j_observer_global_
receiving
...
;
Java_Observer_onRenegotiationNeeded
(
env
j_observer_global_
)
