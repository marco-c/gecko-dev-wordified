...
disable_encryption
=
Java_Options_getDisableEncryption
(
jni
j_options
)
...
=
Java_Options_getDisableNetworkMonitor
(
jni
j_options
)
...
Set
in
PeerConnectionFactory_InjectLoggable
(
)
.
std
...
Set
in
PeerConnectionFactory_initializeAndroidGlobals
(
)
.
static
bool
factory_static_initialized
=
false
;
jobject
...
static
void
JNI_PeerConnectionFactory_StopInternalTracingCapture
(
JNIEnv
*
jni
...
static
jboolean
JNI_PeerConnectionFactory_StartAecDump
(
JNIEnv
*
jni
...
static
void
JNI_PeerConnectionFactory_DeleteLoggable
(
JNIEnv
*
jni
...
static
void
JNI_PeerConnectionFactory_PrintStackTrace
(
JNIEnv
*
env
