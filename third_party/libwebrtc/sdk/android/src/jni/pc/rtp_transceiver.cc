...
{
return
Java_RtpTransceiverDirection_fromNativeIndex
(
jni
static_cast
<
...
.
return
Java_RtpTransceiver_Constructor
(
env
jlongFromPointer
(
...
jobject
>
JNI_RtpTransceiver_GetMediaType
(
JNIEnv
*
jni
...
jobject
>
JNI_RtpTransceiver_GetReceiver
(
JNIEnv
*
jni
...
void
JNI_RtpTransceiver_StopInternal
(
JNIEnv
*
jni
...
>
(
Java_RtpTransceiverDirection_getNativeIndex
(
jni
j_rtp_transceiver_direction
)
