...
;
BOOL
_generatingOrientationNotifications
;
#
endif
}
...
selector
(
handleCaptureSessionRuntimeError
:
)
name
:
...
selector
(
handleCaptureSessionDidStartRunning
:
)
name
:
...
selector
(
handleCaptureSessionDidStopRunning
:
)
name
:
...
[
self
updateVideoDataOutputPixelFormat
:
format
]
;
