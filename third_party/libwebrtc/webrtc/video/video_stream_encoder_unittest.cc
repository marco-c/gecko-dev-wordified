...
(
VideoStreamEncoderTest
Vp9ResilienceIsOffFor1SL1TLWithNackEnabled
)
{
const
bool
...
(
VideoStreamEncoderTest
Vp9ResilienceIsOnFor1SL1TLWithNackDisabled
)
{
const
bool
...
(
VideoStreamEncoderTest
Vp9ResilienceIsOnFor2SL1TLWithNackEnabled
)
{
const
bool
...
(
VideoStreamEncoderTest
Vp9ResilienceIsOnFor1SL2TLWithNackEnabled
)
{
const
bool
...
(
VideoStreamEncoderTest
SinkWantsStoredByDegradationPreference
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
StatsTracksQualityAdaptationStats
)
{
video_stream_encoder_
-
...
(
VideoStreamEncoderTest
SkipsSameOrLargerAdaptDownRequest_BalancedMode
)
{
const
int
...
(
VideoStreamEncoderTest
NoChangeForInitialNormalUsage_BalancedMode
)
{
const
int
...
(
VideoStreamEncoderTest
NoChangeForInitialNormalUsage_DisabledMode
)
{
const
int
...
(
VideoStreamEncoderTest
DoesNotScaleBelowSetResolutionLimit
)
{
const
int
...
(
VideoStreamEncoderTest
OveruseDetectorUpdatedOnReconfigureAndAdaption
)
{
const
int
...
(
VideoStreamEncoderTest
FailingInitEncodeDoesntCauseCrash
)
{
fake_encoder_
.
...
(
VideoStreamEncoderTest
DoesntAdaptDownPastMinFramerate
)
{
const
int
...
(
VideoStreamEncoderTest
AdaptWithTwoReasonsAndDifferentOrder_Framerate
)
{
const
int
...
(
VideoStreamEncoderTest
AcceptsFullHdAdaptedDownSimulcastFrames
)
{
/
/
...
(
VideoStreamEncoderTest
PeriodicallyUpdatesChannelParameters
)
{
const
int
...
(
VideoStreamEncoderTest
DoesNotUpdateBitrateAllocationWhenSuspended
)
{
const
int
