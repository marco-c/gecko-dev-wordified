...
#
ifndef
TEST_NETWORK_NETWORK_EMULATION_H_
#
define
TEST_NETWORK_NETWORK_EMULATION_H_
#
...
bytes_received
SamplesStatsCounter
received_packets_size_counter
int64_t
packets_dropped
DataSize
bytes_dropped
SamplesStatsCounter
dropped_packets_size_counter
DataSize
...
overall_outgoing_stats_
(
GetOverallOutgoingStats
(
)
)
overall_incoming_stats_
(
GetOverallIncomingStats
(
)
)
{
