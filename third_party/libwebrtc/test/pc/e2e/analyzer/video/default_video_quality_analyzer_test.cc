...
constexpr
TimeDelta
kMaxFramesInFlightStorageDuration
=
TimeDelta
:
:
...
(
DefaultVideoQualityAnalyzerTest
HeavyQualityMetricsFromEqualFrames
)
{
std
:
...
(
DefaultVideoQualityAnalyzerTest
ReceiverReceivedFramesWhenSenderRemoved
)
{
std
:
...
(
DefaultVideoQualityAnalyzerTest
ReceiverRemovedBeforeCapturing2ndFrame
)
{
std
:
...
(
DefaultVideoQualityAnalyzerTest
ReceiverRemovedBeforePreEncoded
)
{
std
:
...
(
DefaultVideoQualityAnalyzerTest
UnregisterOneAndRegisterAnother
)
{
std
:
...
(
DefaultVideoQualityAnalyzerTest
InfraMetricsAreReportedWhenRequested
)
{
std
:
...
(
DefaultVideoQualityAnalyzerTest
InfraMetricsNotCollectedByDefault
)
{
std
:
...
(
WithRegisteredAndUnregisteredPeerAtTheEndOfTheCall
DefaultVideoQualityAnalyzerTimeBetweenFreezesTest
ValuesIn
(
{
