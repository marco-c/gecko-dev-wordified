...
EncodedImageBuffer
>
CreateEncodedImageBufferOfSizeNFilledWithValuesFromX
(
size_t
n
uint8_t
...
EncodedImage
CreateEncodedImageOfSizeNFilledWithValuesFromX
(
size_t
n
uint8_t
...
TEST
(
SingleProcessEncodedImageDataInjectorTest
InjectExtractDiscardFalse
)
{
...
TEST
(
SingleProcessEncodedImageDataInjectorTestDeathTest
