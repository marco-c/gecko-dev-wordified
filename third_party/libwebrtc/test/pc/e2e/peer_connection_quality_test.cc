...
constexpr
int
kMaxVideoAnalyzerThreads
=
8
;
constexpr
TimeDelta
kStatsUpdateInterval
=
TimeDelta
:
:
...
RtpCodecCapability
>
without_rtx_video_capabilities
=
FilterVideoCodecCapabilities
(
peer
