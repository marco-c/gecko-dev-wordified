...
GetFlag
(
FLAGS_test_launcher_shard_index
)
.
empty
(
...
GetFlag
(
FLAGS_test_launcher_total_shards
)
.
empty
(
...
GetFlag
(
FLAGS_isolated_script_test_output
)
;
if
(
