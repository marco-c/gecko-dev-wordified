...
(
WaitUntilTest
ReturnsFalseAfterTimeoutWithSimulatedClock
)
{
SimulatedClock
fake_clock
...
(
WaitUntilTest
RequiresOnlyMoveCopyConstructionForReturnedType
)
{
test
:
...
(
WaiterTest
ReturnsFalseWhenTimeoutIsReached
)
{
SimulatedClock
clock
...
(
WaitUntilTest
RunsPendingTasksOnCurrentThreadWithSimulatedClock
)
{
test
:
