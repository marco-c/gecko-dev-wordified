...
MediaSendChannelT
class
MediaReceiveChannelT
class
MediaSendChannelInterfaceT
class
MediaReceiveChannelInterfaceT
class
ContentT
class
MediaInfoT
...
void
TestRemovesExtensionNotPresentInRemoteAnswer
(
)
{
typename
...
void
TestRemovesExtensionNotPresentInLocalAnswer
(
)
{
typename
...
void
TestDuplicateRtpHeaderExtensionIds
(
)
{
typename
...
void
TestRtpHeaderExtensionIdOutOfRangeHigh
(
)
{
typename
...
void
TestRtpHeaderExtensionIdOutOfRangeLow
(
)
{
typename
...
void
TestRtpHeaderExtensionIdReassignment
(
)
{
typename
...
.
void
TestSetContentsExtmapAllowMixedCaller
(
bool
offer
bool
...
void
TestSetContentsExtmapAllowMixedCallee
(
bool
offer
bool
...
.
void
TestSetContentsRtcpReducedSize
(
)
{
CreateChannels
...
{
criteria_not_pending_during_add_stream_
=
true
;
}
...
bool
criteria_not_pending_during_add_stream
(
)
const
{
...
;
void
TestUpdateRemoteStreamsRaceWithRtpPacket
(
)
{
auto
...
.
void
SocketOptionsMergedOnSetTransport
(
)
{
constexpr
...
void
TestUpdateLocalStreamsWithSimulcast
(
)
{
CreateChannels
...
(
VoiceChannelSingleThreadTest
TestSetContentsExtmapAllowMixedAsCaller
)
{
Base
:
...
(
VoiceChannelSingleThreadTest
TestSetContentsExtmapAllowMixedAsCallee
)
{
Base
:
...
(
VoiceChannelSingleThreadTest
RemovesExtensionNotPresentInRemoteAnswer
)
{
Base
:
...
(
VoiceChannelSingleThreadTest
RemovesExtensionNotPresentInLocalAnswer
)
{
Base
:
...
(
VoiceChannelSingleThreadTest
DuplicateRtpHeaderExtensionIds
)
{
Base
:
...
(
VoiceChannelSingleThreadTest
RtpHeaderExtensionIdReassignment
)
{
Base
:
...
(
VideoChannelSingleThreadTest
UpdateLocalStreamsWithSimulcast
)
{
Base
:
...
(
VideoChannelSingleThreadTest
TestSetLocalOfferWithPacketization
)
{
const
Codec
...
(
VideoChannelSingleThreadTest
TestSetRemoteOfferWithPacketization
)
{
const
Codec
...
(
VideoChannelSingleThreadTest
TestSetAnswerWithPacketization
)
{
const
Codec
...
(
VideoChannelSingleThreadTest
TestSetLocalAnswerWithoutPacketization
)
{
const
Codec
...
(
VideoChannelSingleThreadTest
TestSetRemoteAnswerWithoutPacketization
)
{
Codec
local_codec
