...
(
SdpOfferAnswerTest
BundleCodecCollisionInDifferentBundlesAllowed
)
{
auto
pc
...
(
SdpOfferAnswerTest
BundleMeasuresHeaderExtensionIdCollision
)
{
auto
pc
...
(
SdpOfferAnswerTest
BundleRejectsHeaderExtensionIdCollision
)
{
auto
pc
...
(
SdpOfferAnswerTest
BundleAcceptsDifferentIdsForSameExtension
)
{
auto
pc
...
(
SdpOfferAnswerTest
AlwaysNegotiateDataChannelsNegotiationNeeded
)
{
RTCConfiguration
config
...
(
SdpOfferAnswerTest
AlwaysNegotiateDataChannelsSetConfiguration
)
{
RTCConfiguration
config
...
(
SdpOfferAnswerTest
SimulcastOfferWithExcessiveRidsClamped
)
{
auto
pc
...
(
SdpOfferAnswerTest
ExpectAllSsrcsSpecifiedInSsrcGroupFecFr
)
{
auto
pc
...
(
SdpOfferAnswerTest
ExpectTwoSsrcsInSsrcGroupFecFr
)
{
auto
pc
...
(
SdpOfferAnswerTest
ExpectAtMostFourSsrcsInSsrcGroupSIM
)
{
auto
pc
...
(
SdpOfferAnswerTest
DuplicateSsrcsDisallowedInLocalDescription
)
{
auto
pc
...
(
SdpOfferAnswerTest
AllowOnlyOneSsrcGroupPerSemanticAndPrimarySsrc
)
{
auto
pc
...
(
SdpOfferAnswerTest
OfferWithRtxAndNoMsidIsNotRejected
)
{
auto
pc
...
(
SdpOfferAnswerTest
RejectsAnswerWithInvalidTransport
)
{
auto
pc1
...
(
SdpOfferAnswerTest
SdpMungingWithInvalidPayloadTypeIsRejected
)
{
auto
pc
...
(
SdpOfferAnswerTest
MsidSignalingInSubsequentOfferAnswer
)
{
auto
pc
...
(
SdpOfferAnswerTest
MsidSignalingUnknownRespondsWithMsidAndKeepsSsrc
)
{
auto
pc
...
(
SdpOfferAnswerTest
OfferWithNoCompatibleCodecsIsRejectedInAnswer
)
{
auto
pc
...
(
SdpOfferAnswerTest
OfferWithRejectedMlineWithoutFingerprintIsAccepted
)
{
auto
pc
...
(
SdpOfferAnswerTest
MidBackfillDoesNotCheckAgainstBundleGroup
)
{
auto
pc
...
(
SdpOfferAnswerTest
TransceiverReceptiveRollbackAfterFullNegotiation
)
{
auto
caller
...
(
SdpOfferAnswerTest
SubsequentOfferDoesNotAddSctpInit
)
{
auto
pc1
...
(
SdpOfferAnswerTest
SubsequentOfferDoesNotNegotiateSctpInit
)
{
auto
pc1
...
(
SdpOfferAnswerTest
NegotiatesCcfbButNotTransportCc
)
{
auto
pc
...
pwd
:
ThisIsATestIcePasswordThatIsLongEnough
\
r
\
n
...
(
SdpOfferAnswerTest
NegotiatesTransportCcWhenCcfbMissingInOneSection
)
{
auto
pc
...
(
SdpOfferAnswerTest
NegotiatesCcfbWhenPresentInBothSections
)
{
auto
pc
...
(
SdpOfferAnswerTest
NegotiatesTransportCcWhenCcfbMissingInBothSections
)
{
auto
pc
...
(
SdpOfferAnswerTest
StopsTransceiverWhenAnswerLacksSframe
)
{
auto
caller
...
(
SdpOfferAnswerTest
AcceptsAnswerWithSframeWhenOfferedWithSframe
)
{
auto
caller
...
(
SdpOfferAnswerTest
AcceptsAnswerWithoutSframeWhenOfferedWithoutSframe
)
{
auto
caller
...
(
SdpOfferAnswerTest
SetLocalOfferPreservesSframeTrueOnTransceiver
)
{
auto
caller
...
(
SdpOfferAnswerTest
SframeTrueConsistentAfterFullNegotiation
)
{
auto
caller
...
(
SdpOfferAnswerTest
ToleratesRejectedAnswerSectionWithSpuriousSframe
)
{
auto
caller
...
(
SdpOfferAnswerTest
SframeLockedToFalseAfterNegotiationWithoutSframe
)
{
auto
caller
...
(
SdpOfferAnswerTest
BothSidesEnableSframeFullNegotiation
)
{
auto
caller
...
(
SdpOfferAnswerTest
CryptexNotOfferedAnswerDeclaresSupport
)
{
CryptoOptions
crypto_options
...
(
SdpOfferAnswerTest
CryptexRequiredDatachannelOnly
)
{
CryptoOptions
crypto_options1
