...
void
TestMemberIsOptionalIDReference
(
const
RTCStatsMemberInterface
&
...
bool
ExpectAllMembersSuccessfullyTested
(
)
{
if
...
&
=
DEPRECATED_VerifyRTCMediaStreamStats
(
stats
.
cast_to
...
&
=
VerLegacyifyRTCMediaStreamTrackStats
(
stats
.
cast_to
...
(
RTCStatsIntegrationTest
GetStatsContainsNoDuplicateMembers
)
{
StartCall
(
