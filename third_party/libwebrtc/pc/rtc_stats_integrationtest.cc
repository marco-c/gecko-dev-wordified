...
bool
ExpectAllAttributesSuccessfullyTested
(
)
{
if
...
&
=
VerifyRTCIceCandidatePairStats
(
stats
.
cast_to
...
&
=
VerifyRTCLocalIceCandidateStats
(
stats
.
cast_to
...
&
=
VerifyRTCRemoteIceCandidateStats
(
stats
.
cast_to
...
&
=
VerifyRTCRemoteInboundRtpStreamStats
(
stats
.
cast_to
...
;
auto
GetStatsReportAndReturnTrueIfRttIsDefined
=
[
&
report
...
(
RTCStatsIntegrationTest
RcvrRttNegotiatedEnablesAudioRtt
)
{
PeerConnectionInterface
:
...
(
RTCStatsIntegrationTest
RcvrRttNegotiatedEnablesVideoRtt
)
{
PeerConnectionInterface
:
...
(
RTCStatsIntegrationTest
GetStatsWithInvalidSenderSelector
)
{
StartCall
(
...
(
RTCStatsIntegrationTest
GetStatsWithInvalidReceiverSelector
)
{
StartCall
(
...
/
test
GetsStatsWhileClosingPeerConnection
because
pc
(
)
...
(
RTCStatsIntegrationTest
GetStatsContainsNoDuplicateAttributes
)
{
StartCall
(
...
(
RTCStatsIntegrationTest
ExperimentalTransportCcfbStats
)
{
/
/
...
(
RTCStatsRtpLifetimeTest
VideoOutboundRtpMissingBeforeStable
)
{
/
/
...
(
RTCStatsRtpLifetimeTest
AudioInboundRtpMissingBeforeFirstPacket
)
{
/
/
