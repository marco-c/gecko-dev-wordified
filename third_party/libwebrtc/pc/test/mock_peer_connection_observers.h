...
#
ifndef
PC_TEST_MOCK_PEER_CONNECTION_OBSERVERS_H_
#
define
PC_TEST_MOCK_PEER_CONNECTION_OBSERVERS_H_
#
...
&
&
ice_gathering_complete_callback_
)
{
/
/
...
void
SetIceGatheringCompleteCallback
(
absl
:
:
...
if
(
on_ice_candidate_removed_callback_
)
{
absl
:
