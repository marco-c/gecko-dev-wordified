...
;
class
CodecLookupHelperForPeerConnection
:
public
CodecLookupHelper
{
...
int
>
previous_ice_candidate_pool_size
)
{
/
/
...
{
return
HandleSessionDescriptionAccessor
<
&
SdpStateProvider
:
...
answer
.
ProvisionalAnswerUsage
pranswer
=
kProvisionalAnswerNotUsed
;
if
(
local_description
