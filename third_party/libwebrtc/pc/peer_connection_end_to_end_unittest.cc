...
(
PeerConnectionEndToEndTest
CreateDataChannelLargeTransfer
)
{
CreatePcs
(
...
(
PeerConnectionEndToEndTest
CloseDataChannelRemotelyWhileNotReferenced
)
{
CreatePcs
(
...
(
PeerConnectionEndToEndTest
TooManyDataChannelsOpenedBeforeConnecting
)
{
constexpr
int
kReducedMaxSctpStreams
=
4
;
SetCalleeMaxSctpStreams
