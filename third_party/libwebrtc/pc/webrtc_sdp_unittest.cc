...
.
bool
MatchesCurrentDescriptionNoCandidates
(
const
std
:
...
SessionDescriptionInterface
>
CreateSessionDescriptionWithSctpMaxMessageSize
(
const
SessionDescription
&
...
(
WebRtcSdpTest
SctpProtocolWithNonApplication
)
{
std
:
...
(
WebRtcSdpTest
RejectsInvalidCharactersInBundleGroup
)
{
std
:
...
(
WebRtcSdpTest
ShrugsOnUnknownStaticAudioCodecs
)
{
/
/
