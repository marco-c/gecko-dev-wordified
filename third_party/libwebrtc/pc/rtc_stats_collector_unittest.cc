...
RTCStatsReport
>
GetStatsReportWithSenderSelector
(
rtc
:
:
...
RTCStatsReport
>
GetStatsReportWithReceiverSelector
(
rtc
:
:
...
void
ExpectReportContainsCertificateInfo
(
const
rtc
:
...
=
"
RTCCodec_RTCTransport_TransportName_1_Send_1
"
;
cricket
:
...
=
"
RTCCodec_RTCTransport_TransportName_1_Recv_2
"
;
RtpCodecParameters
recv_codec
...
=
"
RTCRemoteOutboundRTPAudioStream_4
"
;
media_info
.
...
(
RTCStatsCollectorTest
MultipleCallbacksWithInvalidatedCacheInBetween
)
{
rtc
:
...
(
RTCStatsCollectorTest
CollectRTCCertificateStatsSingle
)
{
const
char
...
(
"
RTCCodec_RTCTransport_TransportName_1_Recv_1_minptime
=
10
;
useinbandfec
...
;
RTCCodecStats
expected_outbound_audio_codec
(
"
RTCCodec_RTCTransport_TransportName_1_Send_2
"
report
-
>
...
(
"
RTCCodec_RTCTransport_TransportName_1_Recv_3_level
-
asymmetry
-
allowed
...
;
RTCCodecStats
expected_outbound_video_codec
(
"
RTCCodec_RTCTransport_TransportName_1_Send_4
"
report
-
>
...
(
RTCStatsCollectorTest
CodecStatsAreCollectedPerTransport
)
{
/
/
...
(
RTCStatsCollectorTest
SamePayloadTypeButDifferentFmtpLines
)
{
/
/
...
(
RTCStatsCollectorTest
CollectRTCCertificateStatsMultiple
)
{
const
char
...
(
RTCStatsCollectorTest
CollectRTCCertificateStatsChain
)
{
const
char
...
(
RTCStatsCollectorTest
CollectTwoRTCDataChannelStatsWithPendingId
)
{
pc_
-
...
;
RTCMediaStreamTrackStats
expected_local_audio_track_ssrc1
(
IdForType
<
RTCMediaStreamTrackStats
...
;
RTCMediaStreamTrackStats
expected_local_video_track_ssrc1
(
stats_of_track_type
[
0
...
;
RTCMediaStreamTrackStats
expected_remote_video_track_ssrc3
(
stats_of_track_type
[
0
...
=
"
RTCCodec_RTCTransport_TransportName_1_Recv_42
"
;
expected_audio
.
...
=
"
RTCCodec_RTCTransport_TransportName_1_Send_42
"
;
expected_audio
.
...
(
RTCStatsCollectorTest
RTCAudioSourceStatsCollectedForSenderWithTrack
)
{
const
uint32_t
...
(
RTCStatsCollectorTest
RTCVideoSourceStatsCollectedForSenderWithTrack
)
{
const
uint32_t
...
const
int64_t
kRoundTripTimeSample1Ms
=
1234
;
const
double
kRoundTripTimeSample1Seconds
=
1
.
234
...
const
int64_t
kRoundTripTimeSample2Ms
=
13000
;
const
double
kRoundTripTimeSample2Seconds
=
13
;
/
...
(
RTCStatsCollectorTest
RTCRemoteOutboundRtpAudioStreamStatsCollected
)
{
ExampleStatsGraph
graph
...
(
RTCStatsCollectorTest
CollectEchoReturnLossFromTrackAudioProcessor
)
{
rtc
:
...
(
RTCStatsCollectorTest
GetStatsWithNullSenderSelector
)
{
ExampleStatsGraph
graph
...
(
RTCStatsCollectorTest
GetStatsWithNullReceiverSelector
)
{
ExampleStatsGraph
graph
...
(
RTCStatsCollectorTest
DoNotCrashWhenGetStatsCalledDuringCallback
)
{
auto
callback1
