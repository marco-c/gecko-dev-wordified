...
(
RTCStatsCollectorTest
StatsPreservedWhenChannelClearedConcurrently
)
{
VoiceMediaInfo
voice_media_info
...
(
RTCStatsCollectorTest
ProduceRTPStreamStatsWithStoppedTransceiver
)
{
const
char
...
TEST
(
RTCStatsCollectorSafetyTest
WaitPendingRequestGetsCallback
)
{
RunLoop
loop
...
(
RTCStatsCollectorSafetyTest
CancelPendingRequestReturnsImmediately
)
{
RunLoop
loop
...
(
RTCStatsCollectorSafetyTest
NetworkThreadSafetyPreventsCallback
)
{
RunLoop
loop
