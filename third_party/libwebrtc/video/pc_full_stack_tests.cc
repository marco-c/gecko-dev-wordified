...
(
PCFullStackTest
ForemanCifWithoutPacketLossMultiplexI420Frame
)
{
auto
fixture
...
(
PCFullStackTest
GeneratorWithoutPacketLossMultiplexI420AFrame
)
{
auto
fixture
...
(
PCFullStackTest
ScreenshareSlidesVP8_2TL_Simulcast_low
)
{
auto
fixture
...
{
"
screenshare_slides_simulcast_low
"
0
.
0
...
#
define
MAYBE_HighBitrateWithFakeCodec
DISABLED_HighBitrateWithFakeCodec
#
else
#
define
MAYBE_HighBitrateWithFakeCodec
HighBitrateWithFakeCodec
#
endif
/
/
...
=
"
dualstreams_moderately_restricted_screenshare_
"
+
std
:
...
=
"
dualstreams_conference_restricted_screenshare_
"
+
std
:
