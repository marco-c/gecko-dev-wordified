...
const
char
kVp8ForcedFallbackEncoderFieldTrial
[
]
=
"
...
HistogramCodecType
PayloadNameToHistogramCodecType
(
const
std
:
...
quality_limitation_reason_tracker_
(
clock_
)
...
last_num_spatial_layers_
(
0
)
last_num_simulcast_streams_
(
0
)
...
+
"
BandwidthLimitedResolutionInPercent
"
bw_limited
)
;
...
Encoder
.
ForcedSwFallbackChangesPerMinute
.
Vp8
"
fallback_info_
...
:
:
OnInitialQualityResolutionAdaptDown
(
)
{
MutexLock
