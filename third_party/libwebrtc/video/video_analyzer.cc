...
total_frames_duration_ms_
(
0
)
sum_squared_frame_durations_
(
0
)
decode_frame_rate_
...
;
int
last_frames_processed
=
-
1
;
int
last_frames_captured
=
-
1
;
...
const
double
total_freezes_duration_ms_double
=
static_cast
<
double
