...
new_send_codec
bool
was_encode_called_since_last_initialization
)
{
/
/
...
const
bool
higher_spatial_depend_on_lower
=
encoder_config
.
codecType
...
int
>
ParseVp9LowTierCoreCountThreshold
(
const
FieldTrialsView
&
