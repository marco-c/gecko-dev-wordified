...
(
RtpVideoStreamReceiver2Test
RecoversAfterLargeSequenceNumberJump
)
{
const
CopyOnWriteBuffer
...
(
SpsPpsIdrIsKeyframeAndH26xPacketBuffer
RtpVideoStreamReceiver2TestH264
Values
(
"
...
INSTANTIATE_TEST_SUITE_P
(
PaddingInMediaStreamAndH26xPacketBuffer
RtpVideoStreamReceiver2TestPadding
Values
(
"
...
(
RtpVideoStreamReceiver2Test
SetRawPayloadTypesUpdatesDepacketizer
)
{
const
std
...
;
DependencyDescriptor
keyframe_descriptor_without_structure
;
keyframe_descriptor_without_structure
.
frame_dependencies
...
(
RtpVideoStreamReceiver2Test
TransformFrameWithAbsoluteCaptureTime
)
{
scoped_refptr
<
...
(
RtpVideoStreamReceiver2Test
AddReceiveCodecWhileReceivingH265
)
{
/
/
...
(
RtpVideoStreamReceiver2Test
DoesNotLogRecoveredPacketToEventLog
)
{
RtpPacketReceived
recovered_packet
...
(
RtpVideoStreamReceiver2Test
PrunesHistoryMapsOnUndecodableFrames
)
{
const
std
...
(
RtpVideoStreamReceiver2Test
RemoveReceiveCodecsResetsState
)
{
constexpr
uint8_t
