...
:
refactor
h264_sps_pps_tracker_unittests
.
cc
to
avoid
...
(
RtpVideoStreamReceiverTest
CacheColorSpaceFromLastPacketOfKeyframe
)
{
/
/
...
(
RtpVideoStreamReceiverTest
RequestKeyframeWhenPacketBufferGetsFull
)
{
constexpr
int
...
(
RtpVideoStreamReceiverTest
SecondarySinksGetRtpNotifications
)
{
rtp_video_stream_receiver_
-
...
using
RtpVideoStreamReceiverDeathTest
=
RtpVideoStreamReceiverTest
;
TEST_F
