...
char
*
kPixelLimitResourceFieldTrialName
=
"
WebRTC
-
...
DataRate
>
GetSingleActiveLayerMaxBitrate
(
const
VideoCodec
&
...
last_stream_configuration_changed_
(
false
)
{
...
bool
last_stream_configuration_changed
(
)
const
{
