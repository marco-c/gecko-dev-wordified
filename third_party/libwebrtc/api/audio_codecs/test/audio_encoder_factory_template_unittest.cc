...
;
struct
AudioEncoderApiWithV1AndNoCodecPairId
:
BaseAudioEncoderApi
{
static
...
;
struct
AudioEncoderApiWithBothV1AndV2Make
:
BaseAudioEncoderApi
{
static
...
(
AudioEncoderFactoryTemplateTest
CanUseTraitWithOnlyV2MakeAudioEncoder
)
{
const
Environment
