...
(
HeartbeatHandlerTest
HasRunningHeartbeatIntervalTimer
)
{
AdvanceTime
(
...
(
HeartbeatHandlerTest
SendsHeartbeatRequestsOnIdleChannel
)
{
AdvanceTime
(
...
(
HeartbeatHandlerTest
DoesntObserveInvalidHeartbeats
)
{
AdvanceTime
(
...
(
HeartbeatHandlerTest
IncreasesErrorIfNotAckedInTime
)
{
DurationMs
rto
