...
-
>
set_transmission_time_offset_id
(
extension
.
id
...
-
>
set_transport_sequence_number_id
(
extension
.
id
...
uint64_t
>
base_transport_sequence_number
;
{
uint16_t
seqnum
...
uint64_t
>
unsigned_base_transmission_time_offset
;
{
int32_t
offset
...
-
>
set_transport_sequence_number_deltas
(
encoded_deltas
)
;
...
-
>
set_transmission_time_offset_deltas
(
encoded_deltas
)
;
...
uint64_t
>
base_uplink_packet_loss_fraction
;
if
(
base_event
...
-
>
set_uplink_packet_loss_fraction_deltas
(
encoded_deltas
)
;
...
-
>
set_l4s_marked_permille_deltas
(
encoded_deltas
)
;
...
-
>
add_dtls_transport_state_events
(
)
;
proto_batch
...
-
>
set_link_capacity_lower_kbps_deltas
(
encoded_deltas
)
;
...
-
>
set_link_capacity_upper_kbps_deltas
(
encoded_deltas
)
;
