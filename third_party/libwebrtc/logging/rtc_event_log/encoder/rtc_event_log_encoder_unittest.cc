...
verifier_
.
VerifyLoggedAudioNetworkAdaptationEvent
(
*
events
[
...
verifier_
.
VerifyLoggedRemoteEstimateEvent
(
*
events
[
...
(
RtcEventLogEncoderTest
RtcEventNetEqSetMinimumDelayDecoded
)
{
std
:
...
auto
&
parsed_neteq_set_minimum_delay_events_by_ssrc
=
parsed_log_
.
...
auto
&
original_neteq_set_minimum_delay_events
=
original_event_it
.
second
...
auto
&
parsed_neteq_set_minimum_delay_events
=
parsed_event_it
-
>
...
verifier_
.
VerifyLoggedNetEqSetMinimumDelay
(
*
original_neteq_set_minimum_delay_events
[
...
verifier_
.
VerifyLoggedBweDelayBasedUpdate
(
*
events
[
...
verifier_
.
VerifyLoggedBweLossBasedUpdate
(
*
events
[
...
verifier_
.
VerifyLoggedGenericPacketReceived
(
*
events
[
...
verifier_
.
VerifyLoggedGenericAckReceived
(
*
events
[
...
verifier_
.
VerifyLoggedDtlsTransportState
(
*
events
[
...
verifier_
.
VerifyLoggedIceCandidatePairConfig
(
*
event
ice_candidate_pair_configs
...
verifier_
.
VerifyLoggedIceCandidatePairEvent
(
*
event
ice_candidate_pair_events
...
verifier_
.
VerifyLoggedBweProbeClusterCreatedEvent
(
*
event
bwe_probe_cluster_created_events
...
verifier_
.
VerifyLoggedBweProbeFailureEvent
(
*
event
bwe_probe_failure_events
...
verifier_
.
VerifyLoggedRtcpPacketIncoming
(
*
events
[
...
verifier_
.
ExpectDependencyDescriptorExtensionIsSet
(
false
)
;
