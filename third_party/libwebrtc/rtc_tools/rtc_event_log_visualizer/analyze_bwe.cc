...
;
bool
previously_app_limited
=
false
;
float
app_limited_start_time
=
0
;
for
...
;
IntervalSeries
send_window_below_ref_window_series
(
"
Data
in
...
;
IntervalSeries
send_window_above_ref_window_series
(
"
Data
in
...
(
"
RefWindowScaleFactorDueToAvgMinQueueDelay
"
LineStyle
:
:
...
(
"
RefWindowScaleFactorDueToAvgLatencyDifference
"
LineStyle
:
:
...
(
"
RefWindowCombinedIncreaseScaleFactor
"
LineStyle
:
:
...
state
.
packets_recovered_per_feedback
>
0
)
{
