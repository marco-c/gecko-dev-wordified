...
(
VideoQualityAnalysisTest
GetTotalNumberOfSkippedFramesOneValue
)
{
EXPECT_EQ
(
...
(
VideoQualityAnalysisTest
GetTotalNumberOfSkippedFramesEmpty
)
{
EXPECT_EQ
(
