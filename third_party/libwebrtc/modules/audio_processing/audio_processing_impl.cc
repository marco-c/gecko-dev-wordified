...
;
void
PackRenderAudioBufferForEchoDetector
(
const
AudioBuffer
&
...
int
AudioFormatValidityToErrorCode
(
AudioFormatValidity
validity
)
...
/
If
disallow_transient_supporessor_usage
is
true
disables
transient
...
const
bool
one_and_only_one_input_volume_controller
=
hybrid_agc_config_detected
!
=
...
{
return
CaptureMultiBandProcessingPresent
(
)
;
}
...
:
:
RenderFullBandProcessingActive
(
)
const
{
...
WebRTC
-
ApmTransientSuppressorKillSwitch
"
)
)
...
capture_runtime_settings_enqueuer_
(
&
capture_runtime_settings_
)
...
;
int
render_processing_num_channels
=
multi_channel_render
?
formats_
...
:
:
AnalyzeReverseStream_StreamConfig
"
)
;
MutexLock
