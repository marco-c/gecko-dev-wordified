...
accumulated_error
float
one_over_error_sum_anchor
float
smooth_constant_increases
)
{
for
(
...
:
:
PreEchoConfiguration
&
pre_echo_configuration
const
rtc
:
:
...
double
>
threshold_field_trial_parameter
(
/
*
key
...
(
"
aec3_pre_echo_delay_winner_inst
"
pre_echo_lag
)
;
