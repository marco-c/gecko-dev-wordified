...
delay_samples
int
refined_filter_length_blocks
int
coarse_filter_length_blocks
bool
uncorrelated_inputs
const
std
...
subtractor
.
FilterFrequencyResponses
(
)
subtractor
.
FilterImpulseResponses
(
)
*
render_delay_buffer
...
(
Subtractor
RefinedFilterLongerThanCoarseFilter
)
{
const
Environment
...
(
Subtractor
CoarseFilterLongerThanRefinedFilter
)
{
const
Environment
