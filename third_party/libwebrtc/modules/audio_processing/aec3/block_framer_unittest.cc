...
.
void
RunWronglySizedInsertParameterTest
(
int
sample_rate_hz
size_t
...
(
BlockFramerDeathTest
WrongNumberOfBandsInBlockForInsertBlock
)
{
for
(
...
(
BlockFramerDeathTest
WrongNumberOfChannelsInBlockForInsertBlock
)
{
for
(
...
(
BlockFramerDeathTest
WrongNumberOfSamplesInBlockForInsertBlock
)
{
for
(
...
(
BlockFramerDeathTest
WrongNumberOfPreceedingApiCallsForInsertBlock
)
{
for
(
