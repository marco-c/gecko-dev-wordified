...
.
DataRate
reported_target_rate_
;
DataRate
reported_padding_rate_
;
DataRate
reported_pacing_rate_
;
bool
reported_is_bandwidth_limited_
=
true
;
double
reported_cwnd_reduce_ratio_
=
0
.
0
