...
(
GoogCcNetworkControllerTest
ChangeDefaultPacingFactorAfterFirstFeedback
)
{
NetworkControllerTestFixture
fixture
...
(
GoogCcNetworkControllerTest
RespectsConfiguredPacingFactor
)
{
NetworkControllerTestFixture
fixture
...
(
GoogCcNetworkControllerTest
ReactsToChangedNetworkConditionsFromRemote
)
{
NetworkControllerTestFixture
fixture
...
(
GoogCcNetworkControllerTest
LimitPacingFactorToUpperLinkCapacity
)
{
NetworkControllerTestFixture
fixture
...
(
GoogCcScenario
DoNotResetBweUnlessNetworkAdapterChangeOnRoutChange
)
{
Scenario
s
...
googcc_unit
/
do_not_reset_bwe_unless_adapter_change
"
)
;
const
...
(
GoogCcScenario
TargetRateReducedOnPacingBufferBuildup
)
{
const
DataRate
...
googcc_unit
/
default_fast_rampup_on_remb_cap_lifted
"
)
;
EXPECT_GT
...
(
GoogCcScenario
FallbackToLossBasedBweWithoutPacketFeedback
)
{
const
DataRate
