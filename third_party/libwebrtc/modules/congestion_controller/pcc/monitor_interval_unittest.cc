...
TEST
(
PccMonitorIntervalTest
InitialValuesAreEqualToOnesSetInConstructor
)
{
PccMonitorInterval
interval
...
(
PccMonitorIntervalTest
IndicatesDoneWhenFeedbackReceivedAfterInterval
)
{
PccMonitorInterval
interval
...
(
PccMonitorIntervalTest
LossRateIsOneThirdIfLostOnePacketOutOfThree
)
{
PccMonitorInterval
interval
...
(
PccMonitorIntervalTest
DelayGradientIsZeroIfNoChangeInPacketDelay
)
{
PccMonitorInterval
monitor_interval
