...
const
uint32_t
kScreenshareConferenceTl0BitrateBps
=
200000
;
static
const
uint32_t
kScreenshareCodecTargetBitrateBps
=
200000
;
static
...
(
VideoCodecInitializerTest
SingleStreamVp8ScreenshareInactive
)
{
SetUpFor
(
...
(
VideoCodecInitializerTest
TemporalLayeredVp8ScreenshareConference
)
{
SetUpFor
(
...
(
VideoCodecInitializerTest
SimulcastVp8ScreenshareInactive
)
{
SetUpFor
(
...
(
VideoCodecInitializerTest
HighFpsSimulcastVp8Screenshare
)
{
/
/
...
(
VideoCodecInitializerTest
Av1SingleSpatialLayerBitratesAreConsistent
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
Av1TwoSpatialLayersBitratesAreConsistent
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
Av1ConfiguredMinBitrateApplied
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
Av1ConfiguredMinBitrateNotAppliedIfUnset
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
Av1TwoSpatialLayersActiveByDefault
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
Av1TwoSpatialLayersOneDeactivated
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
Vp9SingleSpatialLayerBitratesAreConsistent
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
Vp9TwoSpatialLayersBitratesAreConsistent
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
UpdatesVp9SpecificFieldsWithScalabilityMode
)
{
VideoEncoderConfig
config
...
(
VideoCodecInitializerTest
H265SingleSpatialLayerBitratesAreConsistent
)
{
VideoEncoderConfig
config
