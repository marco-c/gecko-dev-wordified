...
void
PopulateEncodedImageFromVideoFrame
(
const
VideoFrame
&
...
uint32_t
>
last_encoded_timestamp_by_sid_
;
const
EncoderSpeedExperiment
encoder_speed_experiment_
;
/
/
One
