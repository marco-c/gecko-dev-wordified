...
(
TestVp9Impl
EncoderAcceptsSvcLikeSimulcast
)
{
codec_settings_
.
...
(
TestVp9Impl
SvcSimulcastThenSinglecastWithCorrectSimulcastIndex
)
{
const
int
...
(
TestVp9Impl
KeyframeRequestOnAnyStreamForcesKeyframeOnAllStreams
)
{
codec_settings_
.
...
(
Vp9ImplTest
SpatialUpswitchNotAtGOFBoundary
)
{
std
:
...
(
TestVp9Impl
ReportFrameDroppedOnZeroSizePacket
)
{
/
/
...
;
int
expected_framedrop_mode
;
int
expected_max_consec_drop
;
}
;
class
