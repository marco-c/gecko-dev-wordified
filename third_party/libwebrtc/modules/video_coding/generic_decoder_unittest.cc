...
(
GenericDecoderTest
FrameDroppedIfTooManyFramesInFlight
)
{
constexpr
int
...
(
GenericDecoderTest
CallCalculateCorruptionScoreInDecoded
)
{
constexpr
uint32_t
...
(
GenericDecoderTest
SetsScreenshareContentTypeIfSetInFrameInfo
)
{
constexpr
uint32_t
...
(
GenericDecoderTest
SetsUnspecifiedContentTypeIfSetInFrameInfo
)
{
constexpr
uint32_t
...
(
GenericDecoderTest
UsesDecoderColorSpaceIfNoneMapped
)
{
constexpr
uint32_t
