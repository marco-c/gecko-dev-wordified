...
(
QualityScalerTest
DownscalesAfterTwoThirdsIfFieldTrialEnabled
)
{
const
bool
...
(
QualityScalerTest
DoesNotScaleUntilEnoughFramesObserved
)
{
task_queue_
.
...
(
QualityScalerTest
ScalesDownAndBackUpWithMinFramesNeeded
)
{
task_queue_
.
