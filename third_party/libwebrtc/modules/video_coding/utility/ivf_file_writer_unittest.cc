...
(
IvfFileWriterTest
WritesBasicAv1FileNtpTimestamp
)
{
const
uint8_t
...
(
IvfFileWriterTest
WritesBasicUnknownCodecFileMsTimestamp
)
{
const
uint8_t
...
(
IvfFileWriterTest
UseDefaultValueWhenWidthAndHeightAreZero
)
{
const
uint8_t
...
(
IvfFileWriterTest
UseDefaultValueWhenOnlyWidthIsZero
)
{
const
uint8_t
...
(
IvfFileWriterTest
UseDefaultValueWhenOnlyHeightIsZero
)
{
const
uint8_t
...
(
IvfFileWriterTest
UseDefaultValueWhenHeightAndWidthAreNotZero
)
{
const
uint8_t
