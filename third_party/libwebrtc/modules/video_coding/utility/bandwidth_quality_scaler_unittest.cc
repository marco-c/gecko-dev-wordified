...
constexpr
TimeDelta
kDefaultBitrateStateUpdateInterval
=
TimeDelta
:
:
...
namespace
class
FakeBandwidthQualityScalerHandler
:
public
...
;
class
BandwidthQualityScalerUnderTest
:
public
...
int
GetBitrateStateUpdateIntervalMs
(
)
{
return
...
ResolutionBitrateLimits
>
GetDefaultSuitableBitrateLimit
(
int
frame_size_pixels
)
...
void
TriggerBandwidthQualityScalerTest
(
const
std
:
