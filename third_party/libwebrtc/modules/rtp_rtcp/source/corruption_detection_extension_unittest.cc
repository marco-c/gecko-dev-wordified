...
TEST
(
CorruptionDetectionExtensionTest
ValueSizeIs1UnlessSamplesAreSpecified
)
{
const
std
...
(
CorruptionDetectionExtensionTest
TruncatesSampleValuesWhenWriting
)
{
const
double
...
(
CorruptionDetectionExtensionTest
ParsesMandatoryFieldsFromExtension
)
{
CorruptionDetectionMessage
message
...
(
CorruptionDetectionExtensionTest
FailsToParseWhenGivenTooFewFields
)
{
CorruptionDetectionMessage
message
...
(
CorruptionDetectionExtensionTest
FailsToParseWhenGivenNullptrAsOutput
)
{
const
uint8_t
