...
(
SourceTrackerTest
OnFrameDeliveredRecordsSourcesDistinctSsrcs
)
{
constexpr
uint32_t
...
(
SourceTrackerTest
OnFrameDeliveredRecordsSourcesSameSsrc
)
{
constexpr
uint32_t
...
(
SourceTrackerTest
OnFrameDeliveredUpdatesSources
)
{
constexpr
uint32_t
...
(
SourceTrackerTest
OnSourceChangedCallbackFiresOnChange
)
{
constexpr
uint32_t
...
(
SourceTrackerTest
OnSourceChangedCallbackFiresIfSetAfterFrameDelivery
)
{
constexpr
uint32_t
