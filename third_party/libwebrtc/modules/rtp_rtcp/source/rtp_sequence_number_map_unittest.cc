...
.
void
RepeatedSequenceNumberInvalidatesAll
(
size_t
index_of_repeated
)
...
.
void
MaxEntriesReachedAtSameTimeAsObsoletionOfItem
(
size_t
max_entries
size_t
...
Association
>
ProduceRandomAssociationSequence
(
size_t
association_count
uint16_t
...
(
RtpSequenceNumberMapTest
GetBeforeAssociationsRecordedReturnsNullOpt
)
{
RtpSequenceNumberMap
uut
...
(
RtpSequenceNumberMapTest
GetUnknownSequenceNumberReturnsNullOpt1
)
{
RtpSequenceNumberMap
uut
...
(
RtpSequenceNumberMapTest
GetUnknownSequenceNumberReturnsNullOpt2
)
{
RtpSequenceNumberMap
uut
...
(
RtpSequenceNumberMapTest
InsertFrameOnSinglePacketFrame
)
{
RtpSequenceNumberMap
uut
...
(
RtpSequenceNumberMapTest
InsertFrameOnMultiPacketFrameNoWrapAround
)
{
RtpSequenceNumberMap
uut
...
(
RtpSequenceNumberMapTest
InsertFrameOnMultiPacketFrameWithWrapAround
)
{
RtpSequenceNumberMap
uut
...
const
uint16_t
new_association_sequence_number
=
static_cast
<
uint16_t
