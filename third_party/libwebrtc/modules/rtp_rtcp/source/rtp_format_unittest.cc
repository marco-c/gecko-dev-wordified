...
.
int
EffectivePacketsSizeDifference
(
std
:
:
...
TEST
(
RtpPacketizerSplitAboutEqually
AllPacketsAreEqualSumToPayloadLen
)
{
RtpPacketizer
:
...
(
RtpPacketizerSplitAboutEqually
AllPacketsAreEqualRespectsMaxPayloadSize
)
{
RtpPacketizer
:
...
(
RtpPacketizerSplitAboutEqually
SomePacketsAreSmallerSumToPayloadLen
)
{
RtpPacketizer
:
...
(
RtpPacketizerSplitAboutEqually
GivesNonZeroPayloadLengthEachPacket
)
{
RtpPacketizer
:
...
(
RtpPacketizerSplitAboutEqually
CantPutSinglePayloadByteInTwoPackets
)
{
RtpPacketizer
:
...
(
RtpPacketizerSplitAboutEqually
CanPutTwoPayloadBytesInTwoPackets
)
{
RtpPacketizer
:
...
(
RtpPacketizerSplitAboutEqually
CanPutSinglePayloadByteInOnePacket
)
{
RtpPacketizer
:
