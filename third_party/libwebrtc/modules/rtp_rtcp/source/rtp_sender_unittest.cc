...
(
RtpSenderTestWithoutPacer
AssignSequenceNumberMayAllowPaddingOnVideo
)
{
constexpr
size_t
...
(
RtpSenderTest
AssignSequenceNumberAllowsPaddingOnAudio
)
{
MockTransport
transport
...
(
RtpSenderTest
WritesPacerExitToTimingExtension
)
{
rtp_sender_context_
-
...
(
RtpSenderTest
WritesNetwork2ToTimingExtensionWithPacer
)
{
SetUpRtpSender
(
...
(
RtpSenderTest
WritesNetwork2ToTimingExtensionWithoutPacer
)
{
SetUpRtpSender
(
...
constexpr
size_t
kFlexfecHeaderLength
=
20
;
constexpr
size_t
kGenericCodecHeaderLength
=
1
;
constexpr
...
(
RtpSenderTestWithoutPacer
StreamDataCountersCallbacksUlpfec
)
{
const
uint8_t
...
(
RtpSenderTest
SendPacketMatchesRetransmissions
)
{
std
:
...
(
RtpSenderTest
SetsCaptureTimeAndPopulatesTransmissionOffset
)
{
rtp_sender
(
