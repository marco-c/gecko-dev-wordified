...
;
class
MockStreamDataCountersCallback
:
public
...
(
RtpSenderEgressTest
SendsPacketsOneByOneWhenNotBatching
)
{
std
:
...
(
RtpSenderEgressTest
SendsPacketsOneByOneWhenBatchingWithAudio
)
{
auto
config
...
(
RtpSenderEgressTest
CollectsPacketsWhenBatchingWithVideo
)
{
auto
config
...
(
RtpSenderEgressTest
WritesNetwork2ToTimingExtension
)
{
RtpRtcpInterface
:
...
(
RtpSenderEgressTest
WritesTransportSequenceNumberExtensionIfAllocated
)
{
RtpSenderEgress
sender
...
(
RtpSenderEgressTest
OnSendPacketUpdatedWithoutTransportSequenceNumber
)
{
std
:
...
(
RtpSenderEgressTest
DoesNotPutNotRetransmittablePacketsInHistory
)
{
std
:
...
(
RtpSenderEgressTest
PutsRetransmittablePacketsInHistory
)
{
std
:
...
(
RtpSenderEgressTest
UpdatesSendStatusOfRetransmittedPackets
)
{
std
:
...
(
RtpSenderEgressTest
SendPacketSetsPacketOptionsIdFromExtension
)
{
header_extensions_
.
...
(
RtpSenderEgressTest
TransportFeedbackObserverWithRtxRetransmission
)
{
const
uint16_t
...
(
RtpSenderEgressTest
TransportFeedbackObserverPadding
)
{
const
uint16_t
...
(
RtpSenderEgressTest
TransportFeedbackObserverRtxPadding
)
{
const
uint16_t
...
(
RtpSenderEgressTest
SupportsAbortingRetransmissions
)
{
std
:
