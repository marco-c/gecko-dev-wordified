...
mocks
/
mock_network_state_estimator_observer
.
h
"
#
...
;
class
MockRtcpLossNotificationObserver
:
public
...
;
class
MockReportBlockDataObserverImpl
:
public
...
;
class
MockVideoBitrateAllocationObserver
:
public
...
(
RtcpReceiverTest
InjectSrPacketCalculatesNegativeRTTAsOneMs
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
TwoReportBlocksWithLastOneWithoutLastSrCalculatesRtt
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
InjectSrPacketWithOneReportBlock
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
NotifiesNetworkLinkObserverOnReportBlocks
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
InjectByePacketRemovesReportBlocks
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
InjectByePacketRemovesReferenceTimeInfo
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
DoesntCalculateRttOnReceivedDlrr
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
XrDlrrCalculatesNegativeRttAsOneMillisecond
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
ReceiverRttWithMultipleMeasurements
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
ReceiverRttResetOnDlrrWithZeroTimestamp
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
ReceiverRttWithMultipleRemoteSsrcs
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
ConsumeReceivedXrReferenceTimeInfoInitiallyEmpty
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
VerifyRttObtainedFromReportBlockDataObserver
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
GetReportBlockDataAfterOneReportBlock
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
GetReportBlockDataAfterTwoReportBlocksOfSameSsrc
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
NotifiesNetworkLinkObserverOnTransportFeedback
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
NotifiesNetworkLinkObserverOnCongestionControlFeedback
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
FiltersCongestionControlFeedbackOnFirstSsrc
)
{
ReceiverMocks
mocks_1
...
(
RtcpReceiverTest
HandlesInvalidCongestionControlFeedback
)
{
ReceiverMocks
mocks
...
(
RtcpReceiverTest
NotifiesNetworkLinkObserverOnRemb
)
{
ReceiverMocks
mocks
