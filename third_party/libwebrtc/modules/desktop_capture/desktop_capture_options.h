...
"
bool
wgc_include_secondary_windows
(
)
const
{
return
wgc_include_secondary_windows_
;
}
void
set_wgc_include_secondary_windows
(
bool
include
)
...
.
bool
allow_wgc_using_texture
(
)
const
{
return
allow_wgc_using_texture_
;
}
void
