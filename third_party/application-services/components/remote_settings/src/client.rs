...
fn
test_fetch_uses_local_timestamp_as_unquoted_since
(
)
{
viaduct_dev
...
fn
test_second_signature_is_valid
(
)
-
>
...
fn
test_first_signature_has_unknown_type
(
)
-
>
...
fn
test_get_records_sync_if_empty_verifies_signature
(
)
-
>
...
fn
test_get_records_sync_if_empty_with_valid_signature
(
)
-
>
...
fn
test_reset_storage_deletes_records_and_attachments
(
)
{
let
...
fn
test_reset_storage_reverts_to_packaged_data
(
)
{
let
