...
launch
{
setExperimentParticipationOnThisThread
(
active
)
}
...
launch
{
setRolloutParticipationOnThisThread
(
active
)
}
...
NimbusHealth
.
cacheNotReadyForFeature
.
record
(
NimbusHealth
.
CacheNotReadyForFeatureExtra
(
featureId
=
featureId
...
applyLocalExperimentsOnThisThread
(
payload
)
}
...
enrolled
.
recordExperimentTelemetryEvents
(
enrollmentChangeEvents
)
updateObserver
...
{
registerPreviousGeckoPrefStatesOnThisThread
(
geckoPrefStates
)
}
...
{
recordMalformedConfigurationOnThisThread
(
featureId
partId
)
...
async
{
getAvailableFirefoxLabsOnThisThread
(
)
}
}
...
async
{
enrollInFirefoxLabOnThisThread
(
slug
)
}
...
async
{
unenrollFromFirefoxLabOnThisThread
(
slug
)
}
...
async
{
unenrollFromAllFirefoxLabsOnThisThread
(
)
}
}
