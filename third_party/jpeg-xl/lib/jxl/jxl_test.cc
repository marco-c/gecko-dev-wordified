...
(
JxlTest
RoundtripOutOfOrderProcessingBorder
)
{
FakeParallelRunner
fake_pool
...
(
JxlTest
RoundtripLossless8LightningGradient
)
{
ThreadPoolForTests
pool
...
(
JxlTest
RoundtripJpegRecompressionToPixelsAsymmetric
)
{
TEST_LIBJPEG_SUPPORT
(
...
(
JxlTest
RoundtripJpegRecompressionLumaSubsample
)
{
ThreadPoolForTests
pool
...
(
JxlTest
RoundtripJpegRecompression444wh12
)
{
/
/
...
(
JxlTest
RoundtripJpegRecompressionAsymmetric
)
{
/
/
...
(
JxlTest
RoundtripJpegRecompressionMetadata
)
{
ThreadPoolForTests
pool
...
(
JxlTest
RoundtripJpegRecompressionEmptyExif
)
{
ThreadPoolForTests
pool
...
(
JxlTest
RoundtripJpegRecompressionRestarts
)
{
ThreadPoolForTests
pool
...
(
JxlTest
RoundtripJpegRecompressionOrientationICC
)
{
ThreadPoolForTests
pool
...
(
JxlTest
RoundtripProgressiveLevel2Slow
)
{
ThreadPoolForTests
pool
...
(
JxlTest
RoundtripUnsignedCustomBitdepthLossless
)
{
ThreadPool
*
