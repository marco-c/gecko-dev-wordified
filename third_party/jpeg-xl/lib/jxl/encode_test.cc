...
(
EncodeTest
LossyEncoderUseOriginalProfileTest
)
{
{
JxlEncoderPtr
...
(
EncodeTest
CodestreamLevelVerificationTest
)
{
JxlPixelFormat
pixel_format
...
;
class
JxlChunkedFrameInputSourceAdapter
{
private
:
static
