...
{
return
reference_block_timestamp_
;
}
bool
reference_block_timestamp_set
(
)
const
{
return
reference_block_timestamp_set_
;
}
private
:
...
cb_subsampling_horz_
(
kValueNotPresent
)
cb_subsampling_vert_
(
kValueNotPresent
)
chroma_siting_horz_
...
timecode_scale
bool
write_last_frame_with_duration
=
false
bool
fixed_size_timecode
...
when
|
write_last_frame_with_duration_
|
is
set
/
...
void
set_write_last_frame_with_duration
(
bool
write_last_frame_with_duration
)
...
void
set_estimate_file_duration
(
bool
estimate_duration
)
{
estimate_file_duration_
=
estimate_duration
;
}
