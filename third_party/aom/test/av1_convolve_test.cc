...
BuildHighbdLumaParams
(
av1_highbd_dist_wtd_convolve_x_rvv
)
)
;
#
...
BuildLowbdLumaParams
(
av1_dist_wtd_convolve_y_neon_dotprod
)
)
;
#
...
BuildLowbdLumaParams
(
av1_dist_wtd_convolve_y_neon_i8mm
)
)
;
#
...
BuildHighbdLumaParams
(
av1_highbd_dist_wtd_convolve_y_rvv
)
)
;
#
...
BuildLowbdLumaParams
(
av1_dist_wtd_convolve_2d_copy_rvv
)
)
;
#
...
BuildHighbdLumaParams
(
av1_highbd_dist_wtd_convolve_2d_copy_rvv
)
)
;
#
...
BuildHighbdLumaParams
(
av1_highbd_dist_wtd_convolve_2d_rvv
)
)
;
#
