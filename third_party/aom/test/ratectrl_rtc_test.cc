...
dynamic_temporal_layers_
(
false
)
dynamic_spatial_layers_
(
false
)
num_drops_
...
(
RcExternMethodsInterfaceTest
GetLoopFilterLevelRateControllerTest
)
{
TestGetLoopFilterLevelRateControl
(
...
(
RcExternMethodsInterfaceTest
PostEncodeUpdateRateControllerTest
)
{
TestPostEncodeUpdateRateControl
(
...
(
RcExternMethodsInterfaceTest
GetSegmenationDataRateControllerTest
)
{
TestGetSegmentationDataRateControl
(
