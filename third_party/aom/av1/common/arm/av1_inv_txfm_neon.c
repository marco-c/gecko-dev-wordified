...
const
transform_1d_neon
lowbd_txfm_all_1d_zeros_w8_arr
[
TX_SIZES
]
[
...
INLINE
void
lowbd_inv_txfm2d_add_wxh_idtx_neon
(
const
int32_t
*
...
INLINE
void
lowbd_inv_txfm2d_add_v_wxh_identity_neon
(
const
int32_t
*
...
INLINE
void
lowbd_inv_txfm2d_add_h_wxh_identity_neon
(
const
int32_t
*
...
INLINE
void
lowbd_inv_txfm2d_add_wxh_no_identity_neon
(
const
int32_t
*
...
INLINE
void
lowbd_inv_txfm2d_add_wxh_universe_neon
(
const
int32_t
*
