...
INLINE
int
update_extend_mc_border_params
(
const
struct
scale_factors
...
static
void
dec_build_inter_predictors_for_planes
(
const
AV1_COMMON
*
...
static
void
dec_build_inter_predictors_sbuv
(
const
AV1_COMMON
*
...
INLINE
void
dec_build_prediction_by_above_pred
(
MACROBLOCKD
*
xd
...
INLINE
void
dec_build_prediction_by_left_pred
(
MACROBLOCKD
*
xd
...
static
int
check_trailing_bits_after_symbol_coder
(
aom_reader
*
r
