...
const
INTERNAL_COST_UPDATE_TYPE
map_cost_upd_to_internal_cost_upd
[
...
INLINE
int
is_frame_level_cost_upd_freq_set
(
const
AV1_COMMON
*
...
const
uint8_t
bsize_curvfit_model_cat_lookup
[
BLOCK_SIZES_ALL
]
=
...
static
int
sse_norm_curvfit_model_cat_lookup
(
double
sse_norm
)
...
const
uint8_t
bsize_surffit_model_cat_lookup
[
BLOCK_SIZES_ALL
]
=
...
static
void
rate_surffit_model_params_lookup
(
BLOCK_SIZE
bsize
double
...
static
void
dist_surffit_model_params_lookup
(
BLOCK_SIZE
bsize
double
