...
const
double
early_term_thresh_newmv_nearestmv
[
4
]
=
...
static
bool
use_aggressive_subpel_search_method
(
MACROBLOCK
*
x
...
static
void
estimate_single_ref_frame_costs
(
const
AV1_COMMON
*
...
inline
int
skip_mode_by_bsize_and_ref_frame
(
PREDICTION_MODE
mode
MV_REFERENCE_FRAME
...
inline
int
setup_compound_params_from_comp_idx
(
const
AV1_COMP
*
