...
#
define
FIRST_PARTITION_PASS_SAMPLE_REGION
8
#
define
FIRST_PARTITION_PASS_SAMPLE_REGION_LOG2
3
#
define
FIRST_PARTITION_PASS_STATS_TABLES
\
(
MAX_MIB_SIZE
>
...
#
define
FIRST_PARTITION_PASS_STATS_STRIDE
\
(
MAX_MIB_SIZE_LOG2
-
...
INLINE
int
av1_first_partition_pass_stats_index
(
int
mi_row
int
