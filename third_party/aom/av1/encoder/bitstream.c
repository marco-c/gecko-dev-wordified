...
static
int
av1_write_uleb_obu_size_unsafe
(
size_t
obu_payload_size
uint8_t
...
static
uint32_t
init_large_scale_tile_obu_header
(
AV1_COMP
*
const
...
inline
uint32_t
pack_large_scale_tiles_in_tg_obus
(
AV1_COMP
*
const
