...
static
void
write_inter_singleref_comp_mode
(
MACROBLOCKD
*
xd
...
w
bit
av1_get_pred_prob_uni_comp_ref_p
(
cm
xd
)
...
w
bit2
av1_get_pred_prob_uni_comp_ref_p2
(
cm
xd
)
