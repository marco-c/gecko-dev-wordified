...
inline
bool
prune_comp_eval_using_comp_avg_est_rd
(
const
int64_t
*
...
const
bool
skip_mv_refinement_for_avg_distwtd
=
enable_fast_compound_mode_search
=
=
...
const
int
max_comp_type_rd_threshold_div
=
comp_type_rd_threshold_div
[
cpi
