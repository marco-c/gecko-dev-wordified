...
;
int
ext_refresh_bwd_ref_frame
;
int
ext_refresh_alt2_ref_frame
;
int
...
;
int
ext_use_ref_frame_mvs
;
int
ext_use_error_resilient
;
int
ext_use_s_frame
;
int
ext_use_primary_ref_none
;
YV12_BUFFER_CONFIG
last_frame_uf
;
...
.
int
resize_pending_width
;
int
resize_pending_height
;
int
frame_flags
;
