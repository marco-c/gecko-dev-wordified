...
;
int
av1_fp_compute_num_enc_workers
(
AV1_COMP
*
cpi
...
CONFIG_REALTIME_ONLY
void
av1_tpl_row_mt_sync_read_dummy
(
...
;
void
av1_tpl_row_mt_sync_write_dummy
(
AV1TplRowMultiThreadSync
*
tpl_mt_sync
...
;
void
av1_compute_num_workers_for_mt
(
AV1_COMP
*
cpi
...
CONFIG_MULTITHREAD
int
av1_get_num_mod_workers_for_alloc
(
const
