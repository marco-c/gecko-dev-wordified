...
const
int
tpl_inter_mode_prune_mul_factor
[
3
]
[
...
const
int
num_ref_frame_pair_match_thresh
=
thresholds
[
sf
...
;
int
prune_cpd_using_sr_stats_ready
;
}
InterModeSFArgs
;
...
;
int
is_best_y_mode_intra
=
0
;
RD_STATS
best_intra_rd_stats_y
;
int64_t
best_rd_y
=
