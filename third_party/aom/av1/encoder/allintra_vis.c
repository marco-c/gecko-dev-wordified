...
#
define
MB_WIENER_PRED_BLOCK_SIZE
BLOCK_128X128
#
define
MB_WIENER_PRED_BUF_STRIDE
128
/
/
Maximum
...
TfLiteModelCreate
(
av1_deltaq4_model_file
av1_deltaq4_model_fsize
)
;
if
(
