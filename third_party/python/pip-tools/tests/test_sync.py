...
def
test_diff_should_install_with_markers
(
from_line
)
:
...
def
test_diff_with_no_url_versions
(
fake_dist
from_line
)
...
def
test_temporary_requirement_file_deleted
(
from_line
from_editable
mocked_tmp_file
...
def
test_sync_requirement_file_with_hashes
(
...
def
test_sync_dry_run_would_install
(
echo
from_line
)
...
def
test_sync_dry_run_would_uninstall
(
echo
from_line
)
