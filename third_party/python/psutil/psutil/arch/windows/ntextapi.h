...
typedef
struct
_MEMORY_WORKING_SET_INFORMATION
{
ULONG_PTR
NumberOfEntries
;
...
;
SIZE_T
NumberOfShareablePages
;
}
PSUTIL_PROCESS_WS_COUNTERS
*
PPSUTIL_PROCESS_WS_COUNTERS
;
/
/
exe
