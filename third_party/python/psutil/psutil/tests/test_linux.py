...
def
test_cpu_count_logical_w_sysdev_cpu_online
(
self
)
:
...
def
test_cpu_count_logical_w_sysdev_cpu_num
(
self
)
:
...
def
test_cpu_freq_emulate_multi_cpu
(
self
)
:
...
def
test_cpu_freq_no_scaling_cur_freq_file
(
self
)
:
...
def
test_net_connections_ipv6_unsupported
(
self
supports_ipv6
inet_ntop
...
def
test_disk_io_counters_kernel_2_4_mocked
(
self
)
:
...
def
test_disk_io_counters_kernel_2_6_full_mocked
(
self
)
:
...
def
test_disk_io_counters_kernel_2_6_limited_mocked
(
self
)
:
