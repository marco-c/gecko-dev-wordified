...
Tests
for
local_device_instrumentation_test_run
.
"
"
"
...
def
testShouldRetry_retryOnFailure
(
self
)
:
...
def
testIsWPRRecordReplayTest_matchedWithKey
(
self
)
:
...
def
testIsWPRRecordReplayTest_noMatchedKey
(
self
)
:
...
def
testGetWPRArchivePath_matchedWithKey
(
self
)
:
...
def
testGetWPRArchivePath_noMatchedWithKey
(
self
)
:
...
def
testIsRenderTest_matchedWithKey
(
self
)
:
...
class
LocalDeviceInstrumentationTestRunShardingTest
(
unittest
.
TestCase
...
def
test_GroupTestsIntoBatchesAndOthers
(
self
)
:
