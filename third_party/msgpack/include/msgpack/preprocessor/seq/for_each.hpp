...
#
ifndef
MSGPACK_PREPROCESSOR_SEQ_FOR_EACH_HPP
#
define
MSGPACK_PREPROCESSOR_SEQ_FOR_EACH_HPP
#
...
MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK
(
macro
data
seq
...
MSGPACK_PP_SEQ_FOR_EACH_P
MSGPACK_PP_SEQ_FOR_EACH_O
MSGPACK_PP_SEQ_FOR_EACH_M
)
#
define
...
\
MSGPACK_PP_SEQ_FOR_EACH_O_I_DEC
(
macro
data
seq
...
MSGPACK_PP_SEQ_FOR_EACH_DETAIL_CHECK_R
(
r
macro
data
