...
.
uint64_t
allowExtensionDisableAfterNonPPTokensInWebGL
:
1
;
/
...
;
int
ShadingRateFlag4VerticalPixelsEXT
;
int
...
constexpr
uint32_t
kDriverUniformsMiscLayeredFramebufferOffset
=
22
;
constexpr
uint32_t
kDriverUniformsMiscLayeredFramebufferMask
=
0x1
;
}
