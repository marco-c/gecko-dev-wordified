...
#
define
GL_CHROMIUM_frambuffer_mixed_samples
1
#
define
...
(
GL_APIENTRYP
PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERUIVROBUSTANGLEPROC
)
(
GLint
plane
...
(
GL_APIENTRYP
PFNGLENDPIXELLOCALSTORAGEIMPLICITANGLEPROC
)
(
void
)
...
(
GL_APIENTRYP
PFNGLGETFRAMEBUFFERPIXELLOCALSTORAGEPARAMETERUIVANGLEPROC
)
(
GLint
plane
...
(
GL_APIENTRYP
PFNGLBLOBCACHECALLBACKSANGLEPROC
)
(
GLSETBLOBPROCANGLE
GLGETBLOBPROCANGLE
