...
ANGLE_ENABLE_HLSL
GLenum
GetGeometryShaderPrimitiveTypeEnum
(
sh
:
:
...
:
:
initialize_global_pool_index_workaround
(
)
;
#
...
:
:
free_global_pool_index_workaround
(
)
;
#
