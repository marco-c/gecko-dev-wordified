...
;
void
emitOrdinaryVariableDeclaration
(
const
VarDecl
&
...
;
size_t
mDriverUniformsBindingIndex
=
0
;
size_t
mUBOArgumentBufferBindingIndex
=
0
;
bool
...
;
bool
mInjectAsmStatementIntoLoopBodies
=
false
;
}
