...
mIsInternalIncompleteTexture
(
false
)
mIsExternalMemoryTexture
(
false
)
mHasBeenBoundAsImage
(
false
)
...
mHasBeenBoundAsSourceOfEglImage
(
false
)
mImmutableFormat
...
(
!
computeSamplerCompletenessForCopyImage
(
samplerState
state
)
...
the
surface
releaseTexImageInternalNoRedefinition
(
context
)
;
