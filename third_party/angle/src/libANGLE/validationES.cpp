...
{
return
kAdvancedBlendEquationNotEnabled
;
}
}
return
...
(
GL_INVALID_ENUM
kInternalFormatNotSupportedTexStorage
)
;
return
false
...
BufferBinding
>
kValidElementArrayBufferBindingTargets
(
{
BufferBinding
:
...
static
bool
IsRenderbufferBoundToFramebuffer
(
const
Context
*
