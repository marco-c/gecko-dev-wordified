...
>
&
getExternalImageBindingsToRestore
(
)
{
return
mExternalImageBindingsToRestore
;
}
void
...
;
void
trackFramebufferAttachmentUpdate
(
const
gl
:
...
size_t
>
mClientVertexArrayCallIndices
;
gl
:
:
AttributesMask
mClientVertexArrayDirtyAttribMask
;
/
/
We
