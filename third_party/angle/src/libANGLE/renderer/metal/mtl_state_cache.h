...
mStencilFailureOperation
(
MTLStencilOperationKeep
)
mDepthFailureOperation
(
MTLStencilOperationKeep
)
mDepthStencilPassOperation
(
MTLStencilOperationKeep
)
mStencilCompareFunction
(
...
mSourceRgbBlendFactor
(
MTLBlendFactorOne
)
mSourceAlphaBlendFactor
(
MTLBlendFactorOne
)
mDestinationRgbBlendFactor
(
MTLBlendFactorZero
)
mDestinationAlphaBlendFactor
(
MTLBlendFactorZero
)
mRgbBlendOperation
...
:
mDepthAttachmentPixelFormat
(
0
)
mStencilAttachmentPixelFormat
(
0
)
