...
;
size_t
last_subsection_payload_offset_
=
0
;
/
...
;
CodeMetadataSections
code_metadata_sections_
;
Offset
cur_func_start_offset_
;
Index
cur_func_index_
;
