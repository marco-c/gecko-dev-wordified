...
self
.
try_write_entry_point_task_return
(
value_id
ir_result
result_members
...
fn
maybe_write_uniform_matcx2_dynamic_access
(
&
mut
self
...
Uniform
fn
maybe_write_load_uniform_matcx2_struct_member
(
&
mut
self
