...
self
.
write_wrapped_convert_from_std140_compat_type
(
ir_module
pointer_type
)
...
self
.
write_wrapped_matcx2_get_column
(
ir_module
base_type
)
...
:
:
write_std140_compat_type_declaration
]
for
more
details
...
self
.
write_entry_point_mesh_shader_info
(
iface
local_invocation_index_var_id
ir_module
...
fn
write_numeric_type_declaration_local
(
&
mut
self
...
fn
write_cooperative_type_declaration_local
(
&
mut
self
