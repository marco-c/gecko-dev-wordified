...
:
:
ray_query_generate_intersection
(
query_id
depth_id
)
...
fn
write_ray_query_confirm_intersection
(
&
mut
self
...
:
:
ray_query_confirm_intersection
(
query_id
)
)
...
:
:
ray_query_return_vertex_position
(
rq_get_vertex_positions_ty_id
vertices_id
query_id
