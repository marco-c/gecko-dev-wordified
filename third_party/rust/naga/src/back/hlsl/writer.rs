...
fn
write_ep_argument_initialization
(
&
mut
self
...
;
let
needs_local_invocation_index_name
=
need_workgroup_variables_initialization
|
|
...
self
.
write_function_external_texture_argument
(
module
handle
index
...
self
.
sampler_binding_array_info_from_expression
(
module
func_ctx
base
