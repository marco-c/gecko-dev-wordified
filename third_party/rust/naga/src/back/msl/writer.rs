...
=
"
naga_atomic_compare_exchange_weak_explicit
"
;
pub
(
...
.
fn
binding_array_index_from_chain
(
&
self
mut
...
+
/
d9e2d1f718678ebee0728b999830576c410cce0a
/
src
/
tint
...
fn
put_cast_to_uint_scalar_or_vector
(
&
mut
self
...
commit
/
aa95220576706122d79c91c7f5c522e6c7416425
let
value_ty
=
context
...
fn
put_binding_array_size_member_index
(
&
mut
self
...
self
.
put_wrapped_expression_for_packed_vec3_access
(
vector
context
false
...
/
WhatsNewiniOS10tvOS10andOSX1012
/
WhatsNewiniOS10tvOS10andOSX1012
.
html
...
;
let
accessing_wrapped_binding_array
=
matches
!
(
...
let
mut
generated_argument_buffer_wrapper
=
false
;
let
mut
generated_external_texture_wrapper
=
false
;
for
...
fn
write_wrapped_cooperative_load
(
&
mut
self
...
fn
write_wrapped_cooperative_multiply_add
(
&
mut
self
...
self
.
write_rq_get_intersection_function
(
module
committed
options
...
:
:
UnsupportedWritableStorageTexture
(
ep
.
stage
...
self
.
write_workgroup_variable_initialization
(
module
module_info
var
