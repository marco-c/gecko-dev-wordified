...
InvalidLocalVariableAddressSpace
(
Span
)
UnknownRayFlag
...
SizeAttributeRequiresFixedFootprint
(
Span
)
...
FunctionMustUseReturnsVoid
(
Span
Span
)
FunctionMustUseOnNonFunction
(
Span
)
...
UnexpectedIdentForEnumerant
(
Span
)
UnexpectedExprForEnumerant
(
Span
)
UnusedArgsForTemplate
(
Vec
<
Span
...
UnexpectedExprForTypeExpression
(
Span
)
MissingIncomingPayload
(
Span
)
