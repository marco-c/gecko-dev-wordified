...
MissingAccelerationStructureVertexReturn
(
Handle
<
crate
...
the
span
NonUniformWorkgroupUniformLoad
(
UniformityDisruptor
)
/
...
WorkgroupUniformLoadExpressionMismatch
(
Handle
<
crate
...
WorkgroupUniformLoadInvalidPointer
(
Handle
<
crate
...
ConflictingTaskPayloadVariables
(
Handle
<
crate
...
self
.
trace_rays_vertex_return
=
super
:
:
TraceRayVertexReturnState
:
:
NoVertexReturn
(
