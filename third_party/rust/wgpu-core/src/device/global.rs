...
unsafe
fn
device_create_shader_module_passthrough
(
&
self
device_id
...
self
.
device_create_general_render_pipeline
(
desc
.
clone
...
:
:
create_general_render_pipeline
"
)
;
let
...
unsafe
fn
device_start_graphics_debugger_capture
(
&
self
device_id
...
unsafe
fn
device_stop_graphics_debugger_capture
(
&
self
device_id
