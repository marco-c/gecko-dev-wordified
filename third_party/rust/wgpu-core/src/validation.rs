...
&
self
is_reffed_by_sampler_in_entrypoint
:
bool
)
-
...
let
mut
max_vertex_shader_output_variables
=
self
.
limits
...
let
mut
max_vertex_shader_output_location
=
max_vertex_shader_output_variables
-
1
