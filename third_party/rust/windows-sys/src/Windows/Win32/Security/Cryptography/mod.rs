...
from_u128
(
0x961f180f_f55c_413d_a9b3_7d2af4d8e42f
)
;
pub
const
...
from_u128
(
0x38373906_5433_4633_b0fb_29b7e78262e1
)
;
pub
const
...
from_u128
(
0xafe2fa32_41b1_459d_a5de_49add8a72182
)
;
pub
const
...
from_u128
(
0x9902f3bc_88af_4cf8_ae62_7140531552b6
)
;
pub
const
...
pub
const
CERT_CHAIN_ENABLE_DISALLOWED_CA
:
u32
=
131072u32
...
from_u128
(
0xaa4f5c02_8e7c_49c4_94fa_67a5cc5eadb4
)
;
pub
const
...
from_u128
(
0xdf9d8cd0_1501_11d1_8c7a_00c04fc297eb
)
;
pub
const
...
(
"
SmartCardDismissUITimeoutSeconds
"
)
;
pub
...
:
SIGNER_SIGNATURE_ATTRIBUTE_CHOICE
=
1u32
;
pub
...
(
"
MICROSOFT_PCP_KSP_RSA_SEAL_KEY_3BD1C4BF
-
004E
-
4E2F
