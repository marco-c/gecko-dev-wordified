...
from_u128
(
0x633c80a4_1843_482b_9ef2_be2834c5fdd4
)
;
pub
const
...
from_u128
(
0xd3a1dbe1_8ec4_4c17_9f4c_ea97ad1c343d
)
;
pub
const
...
from_u128
(
0x537e597d_251e_48da_9664_29ca496b70f8
)
;
pub
const
...
from_u128
(
0xdd6a0022_58e4_4a67_9d9b_d48eb881a53d
)
;
pub
const
...
from_u128
(
0xa7ce72a9_0f7f_40d7_b3cc_d0c02d5c3212
)
;
pub
const
...
from_u128
(
0x718f2615_7933_40e3_a511_5f68fe14dd74
)
;
pub
const
...
pub
const
ConvertToEmfPlusFlagsInvalidRecord
:
ConvertToEmfPlusFlags
=
4i32
...
from_u128
(
0xf2e455dc_09b3_4316_8260_676ada32481c
)
;
pub
const
...
from_u128
(
0x66087055_ad66_4c7c_9a18_38a2310b8337
)
;
pub
const
...
from_u128
(
0xae7a62a0_ee2c_49d8_9d07_1ba8a927596e
)
;
pub
const
...
from_u128
(
0xe09d739d_ccd4_44ee_8eba_3fbf8be4fc58
)
;
pub
const
...
from_u128
(
0x63875e13_1f1d_45ab_9195_a29b6066a650
)
;
pub
const
...
from_u128
(
0xedb33bce_0266_4a77_b904_27216099e717
)
;
pub
const
...
from_u128
(
0x1d5be4b5_fa4a_452d_9cdd_5db35105e7eb
)
;
pub
const
...
from_u128
(
0x6d42c53a_229a_4825_8bb7_5c99e2b9a8b8
)
;
pub
const
...
from_u128
(
0xa219bbc9_0a9d_4005_a3ee_3a421b8bb06c
)
;
pub
const
...
from_u128
(
0x292266fc_ac40_47bf_8cfc_a85b89a655de
)
;
pub
const
...
from_u128
(
0x3a4e2661_3109_4e56_8536_42c156e7dcfa
)
;
pub
const
...
from_u128
(
0x8d0eb2d1_a58e_4ea8_aa14_108074b7b6f9
)
;
pub
const
...
from_u128
(
0x24d18c76_814a_41a4_bf53_1c219cccf797
)
;
pub
const
...
from_u128
(
0xe5836cbe_5eef_4f1d_acde_ae4c43b608ce
)
;
pub
const
...
from_u128
(
0x1c4afdcd_6177_43cf_abc7_5f51af39ee85
)
;
pub
const
...
from_u128
(
0x7462dc86_6180_4c7e_8e3f_ee7333a7a483
)
;
pub
const
...
from_u128
(
0x84236f7b_3bd3_428f_8dab_4ea1439ca315
)
;
pub
const
...
from_u128
(
0x6aedbd6d_3fb5_418a_83a6_7f45229dc872
)
;
pub
const
...
pub
const
GdiplusStartupTransparencyMask
:
GdiplusStartupParams
=
-
...
from_u128
(
0x8b2dd6c3_eb07_4d87_a5f0_7108e26a9c5f
)
;
pub
const
...
from_u128
(
0xb96b3cab_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cac_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cb2_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cb0_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cb6_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cb5_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cae_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3caa_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3caf_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cb1_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3ca9_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cb7_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0xb96b3cad_0728_11d3_9d7b_0000f81ef32e
)
;
pub
const
...
from_u128
(
0x99c354ec_2a31_4f3a_8c34_17a803b33a25
)
;
pub
const
...
pub
const
PropertyTagExifDeviceSettingDesc
:
u32
=
41995u32
...
pub
const
PropertyTagExifDigitalZoomRatio
:
u32
=
41988u32
...
pub
const
PropertyTagExifFocalLengthIn35mmFilm
:
u32
=
41989u32
...
pub
const
PropertyTagExifSceneCaptureType
:
u32
=
41990u32
...
pub
const
PropertyTagExifSubjectDistanceRange
:
u32
=
41996u32
...
pub
const
PropertyTagGpsProcessingMethod
:
u32
=
27u32
...
from_u128
(
0x74d29d05_69a4_4266_9549_3cc52836b632
)
;
pub
const
...
from_u128
(
0x63cbf3ee_c526_402c_8f71_62c540bf5142
)
;
pub
const
...
from_u128
(
0x1077af00_2848_4441_9489_44ad4c2d7a2c
)
;
pub
const
