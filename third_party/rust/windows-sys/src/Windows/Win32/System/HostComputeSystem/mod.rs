...
pub
const
HcsEventSystemGuestConnectionClosed
:
HCS_EVENT_TYPE
=
6i32
...
pub
const
HcsEventSystemRdpEnhancedModeStateChanged
:
HCS_EVENT_TYPE
=
4i32
...
pub
const
HcsNotificationOperationProgressUpdate
:
HCS_NOTIFICATIONS
=
256i32
...
pub
const
HcsNotificationSystemCrashInitiated
:
HCS_NOTIFICATIONS
=
13i32
...
pub
const
HcsNotificationSystemGuestConnectionClosed
:
HCS_NOTIFICATIONS
=
14i32
...
pub
const
HcsNotificationSystemModifyCompleted
:
HCS_NOTIFICATIONS
=
12i32
...
pub
const
HcsNotificationSystemOperationCompletion
:
HCS_NOTIFICATIONS
=
15i32
...
pub
const
HcsNotificationSystemRdpEnhancedModeStateChanged
:
HCS_NOTIFICATIONS
=
9i32
...
pub
const
HcsNotificationSystemShutdownFailed
:
HCS_NOTIFICATIONS
=
10i32
...
pub
const
HcsOperationOptionProgressUpdate
:
HCS_OPERATION_OPTIONS
=
1i32
