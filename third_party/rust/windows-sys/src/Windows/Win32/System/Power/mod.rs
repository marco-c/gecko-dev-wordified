...
from_u128
(
0xef98db24_0014_4c25_a50b_c724ae5cd371
)
;
pub
const
...
from_u128
(
0x40b40565_96f7_4435_8694_97e0e4395905
)
;
pub
const
...
from_u128
(
0x535a3767_1ac2_49bc_a077_3f7a02e40aec
)
;
pub
const
...
from_u128
(
0x05e1e463_e4e2_4ea9_80cb_9bd4b3ca0655
)
;
pub
const
...
from_u128
(
0xcddfa0c3_7c5b_4e43_a034_059fa5b84364
)
;
pub
const
...
from_u128
(
0xfc4670d1_ebbf_416e_87ce_374a4ebc111a
)
;
pub
const
...
from_u128
(
0x5e1f6e19_8786_4d23_94fc_9e746bd5d888
)
;
pub
const
...
from_u128
(
0x1a52a14d_adce_4a44_9a3e_c8d8f15ff2c2
)
;
pub
const
...
from_u128
(
0x4d1e55b2_f16f_11cf_88cb_001111000030
)
;
pub
const
...
from_u128
(
0x97f99bf6_4497_4f18_bb22_4b9fb2fbef9c
)
;
pub
const
...
from_u128
(
0x629758ee_986e_4d9e_8e47_de27f8ab054d
)
;
pub
const
...
from_u128
(
0x45bd8344_7ed6_49cf_a440_c276c933b053
)
;
pub
const
...
from_u128
(
0x05ecd13d_81da_4a2a_8a4c_524f23dd4dc9
)
;
pub
const
...
from_u128
(
0x4afa3d52_74a7_11d0_be5e_00a0c9062857
)
;
pub
const
...
from_u128
(
0x3fd0f03d_92e0_45fb_b75c_5ed8ffb01021
)
;
pub
const
...
from_u128
(
0xcd48a365_fa94_4ce2_a232_a1b764e5d8b4
)
;
pub
const
...
from_u128
(
0x97fadb10_4e33_40ae_359c_8bef029dbdd0
)
;
pub
const
...
from_u128
(
0x4afa3d53_74a7_11d0_be5e_00a0c9062857
)
;
pub
const
...
from_u128
(
0x4afa3d51_74a7_11d0_be5e_00a0c9062857
)
;
pub
const
...
from_u128
(
0xdbe4373d_3c81_40cb_ace4_e0e5d05f0c9f
)
;
pub
const
...
from_u128
(
0x927ec093_69a4_4bc0_bd02_711664714463
)
;
pub
const
...
pub
const
IOCTL_GET_ACPI_TIME_AND_ALARM_CAPABILITIES
:
u32
=
2703900u32
...
from_u128
(
0xba138e10_e250_4ad7_8616_cf1a7ad410e7
)
;
pub
const
...
from_u128
(
0x4838fe4f_f71c_4e51_9ecc_8430a7ac4c6c
)
;
pub
const
...
from_u128
(
0xd67abd39_81f8_4a5e_8152_72e31ec912ee
)
;
pub
const
...
from_u128
(
0xe2a26f78_ae07_4ee0_a30f_ce54f55a94cd
)
;
pub
const
...
from_u128
(
0x7fd18652_0cfe_40d2_b0a1_0b066a87759e
)
;
pub
const
...
from_u128
(
0x5708cc20_7d40_4bf4_b4aa_2b01338d0126
)
;
pub
const
...
from_u128
(
0xa5b32ddd_7f39_4abc_b892_900e43b59ebb
)
;
pub
const
...
from_u128
(
0x995e6b7f_d653_497a_b978_36a30c29bf01
)
;
pub
const
...
from_u128
(
0xa852c2c8_1a4c_423b_8c2c_f30d82931a88
)
;
pub
const
...
from_u128
(
0x48f377b8_6880_4c7b_8bdc_380176c6654d
)
;
#
[
...
from_u128
(
0x5724c81d_d5af_4c1f_a103_a06e28f204c6
)
pid
:
1
