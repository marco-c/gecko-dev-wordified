...
pub
struct
RestorationFilterNonserialized
{
encoding
:
Encoding
...
pub
fn
should_do_adaptive_lf_smoothing
(
&
self
)
...
fn
test_invalid_blending_alpha_channel
(
)
{
let
...
fn
test_invalid_ec_upsampling_after_dim_shift
(
)
{
let
