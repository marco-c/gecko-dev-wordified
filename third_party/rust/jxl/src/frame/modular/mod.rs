...
:
bool
can_do_early_partial_render
:
bool
decoded_section0_channels
:
usize
needed_section0_channels_for_early_render
:
usize
global_header
:
...
.
let
has_problematic_palette_transform
=
header
.
transforms
