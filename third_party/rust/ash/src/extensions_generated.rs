...
:
:
AMD_SHADER_TRINARY_MINMAX_NAME
as
NAME
crate
:
...
:
:
AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_NAME
as
NAME
crate
:
...
:
:
AMD_NEGATIVE_VIEWPORT_HEIGHT_NAME
as
NAME
crate
:
...
:
:
AMD_GPU_SHADER_HALF_FLOAT_NAME
as
NAME
crate
:
...
:
:
AMD_TEXTURE_GATHER_BIAS_LOD_NAME
as
NAME
crate
:
...
:
:
AMD_SHADER_IMAGE_LOAD_STORE_LOD_NAME
as
NAME
crate
:
...
:
:
AMD_MIXED_ATTACHMENT_SAMPLES_NAME
as
NAME
crate
:
...
:
:
AMD_PIPELINE_COMPILER_CONTROL_NAME
as
NAME
crate
:
...
:
:
AMD_SHADER_CORE_PROPERTIES_NAME
as
NAME
crate
:
...
:
:
AMD_MEMORY_OVERALLOCATION_BEHAVIOR_NAME
as
NAME
crate
:
...
:
:
AMD_SHADER_CORE_PROPERTIES2_NAME
as
NAME
crate
:
...
:
:
AMD_SHADER_CORE_PROPERTIES2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
AMD_DEVICE_COHERENT_MEMORY_NAME
as
NAME
crate
:
...
:
:
AMD_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_NAME
as
NAME
crate
:
...
:
:
ANDROID_NATIVE_BUFFER_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
ImageUsageFlags
_swapchain_image_usage
:
SwapchainImageUsageFlagsANDROID
_gralloc_consumer_usage
:
*
mut
u64
_gralloc_producer_usage
:
*
mut
u64
...
:
:
ANDROID_EXTERNAL_MEMORY_ANDROID_HARDWARE_BUFFER_NAME
as
NAME
crate
:
...
:
:
ANDROID_EXTERNAL_FORMAT_RESOLVE_NAME
as
NAME
crate
:
...
:
:
ARM_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_NAME
as
NAME
crate
:
...
:
:
ARM_SHADER_CORE_PROPERTIES_NAME
as
NAME
crate
:
...
:
:
EXT_DEPTH_RANGE_UNRESTRICTED_NAME
as
NAME
crate
:
...
:
CommandBuffer
_first_counter_buffer
:
u32
_counter_buffer_count
:
u32
_p_counter_buffers
:
...
:
:
EXT_SHADER_SUBGROUP_BALLOT_NAME
as
NAME
crate
:
...
:
:
EXT_TEXTURE_COMPRESSION_ASTC_HDR_NAME
as
NAME
crate
:
...
:
:
EXT_CONDITIONAL_RENDERING_NAME
as
NAME
crate
:
...
:
CommandBuffer
_p_conditional_rendering_begin
:
*
const
...
:
:
EXT_DISPLAY_SURFACE_COUNTER_NAME
as
NAME
crate
:
...
:
CommandBuffer
_first_discard_rectangle
:
u32
_discard_rectangle_count
:
u32
_p_discard_rectangles
:
*
const
Rect2D
...
:
:
EXT_CONSERVATIVE_RASTERIZATION_NAME
as
NAME
crate
:
...
:
:
EXT_SWAPCHAIN_COLORSPACE_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
EXT_EXTERNAL_MEMORY_DMA_BUF_NAME
as
NAME
crate
:
...
:
:
EXT_SAMPLER_FILTER_MINMAX_NAME
as
NAME
crate
:
...
:
:
EXT_SHADER_STENCIL_EXPORT_NAME
as
NAME
crate
:
...
:
:
EXT_BLEND_OPERATION_ADVANCED_NAME
as
NAME
crate
:
...
:
:
EXT_IMAGE_DRM_FORMAT_MODIFIER_NAME
as
NAME
crate
:
...
:
:
EXT_SHADER_VIEWPORT_INDEX_LAYER_NAME
as
NAME
crate
:
...
const
c_void
_p_memory_host_pointer_properties
:
*
mut
...
:
:
EXT_CALIBRATED_TIMESTAMPS_NAME
as
NAME
crate
:
...
:
:
EXT_VERTEX_ATTRIBUTE_DIVISOR_NAME
as
NAME
crate
:
...
:
:
EXT_PIPELINE_CREATION_FEEDBACK_NAME
as
NAME
crate
:
...
:
:
EXT_SUBGROUP_SIZE_CONTROL_NAME
as
NAME
crate
:
...
:
:
EXT_SHADER_IMAGE_ATOMIC_INT64_NAME
as
NAME
crate
:
...
:
:
EXT_BUFFER_DEVICE_ADDRESS_NAME
as
NAME
crate
:
...
:
:
EXT_SEPARATE_STENCIL_USAGE_NAME
as
NAME
crate
:
...
:
:
EXT_FRAGMENT_SHADER_INTERLOCK_NAME
as
NAME
crate
:
...
:
:
EXT_FULL_SCREEN_EXCLUSIVE_NAME
as
NAME
crate
:
...
:
:
EXT_EXTENDED_DYNAMIC_STATE_NAME
as
NAME
crate
:
...
:
:
EXT_SHADER_ATOMIC_FLOAT2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
EXT_SURFACE_MAINTENANCE1_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
EXT_SWAPCHAIN_MAINTENANCE1_NAME
as
NAME
crate
:
...
:
:
EXT_SWAPCHAIN_MAINTENANCE1_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
EXT_SHADER_DEMOTE_TO_HELPER_INVOCATION_NAME
as
NAME
crate
:
...
:
:
EXT_TEXEL_BUFFER_ALIGNMENT_NAME
as
NAME
crate
:
...
:
:
EXT_PIPELINE_CREATION_CACHE_CONTROL_NAME
as
NAME
crate
:
...
:
:
EXT_GRAPHICS_PIPELINE_LIBRARY_NAME
as
NAME
crate
:
...
:
:
EXT_YCBCR_2PLANE_444_FORMATS_NAME
as
NAME
crate
:
...
:
:
EXT_FRAGMENT_DENSITY_MAP2_NAME
as
NAME
crate
:
...
:
:
EXT_FRAGMENT_DENSITY_MAP2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
EXT_IMAGE_COMPRESSION_CONTROL_NAME
as
NAME
crate
:
...
:
:
EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_NAME
as
NAME
crate
:
...
:
:
EXT_VERTEX_INPUT_DYNAMIC_STATE_NAME
as
NAME
crate
:
...
:
u32
_p_vertex_binding_descriptions
:
*
const
...
:
u32
_p_vertex_attribute_descriptions
:
*
const
...
:
:
EXT_DEVICE_ADDRESS_BINDING_REPORT_NAME
as
NAME
crate
:
...
:
:
EXT_PRIMITIVE_TOPOLOGY_LIST_RESTART_NAME
as
NAME
crate
:
...
:
:
EXT_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_NAME
as
NAME
crate
:
...
:
:
EXT_EXTENDED_DYNAMIC_STATE2_NAME
as
NAME
crate
:
...
:
:
EXT_EXTENDED_DYNAMIC_STATE2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
EXT_PRIMITIVES_GENERATED_QUERY_NAME
as
NAME
crate
:
...
:
:
EXT_GLOBAL_PRIORITY_QUERY_NAME
as
NAME
crate
:
...
:
:
EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_NAME
as
NAME
crate
:
...
:
:
EXT_IMAGE_SLICED_VIEW_OF_3D_NAME
as
NAME
crate
:
...
:
:
EXT_NON_SEAMLESS_CUBE_MAP_NAME
as
NAME
crate
:
...
:
:
EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_NAME
as
NAME
crate
:
...
:
:
EXT_NESTED_COMMAND_BUFFER_NAME
as
NAME
crate
:
...
:
:
EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_NAME
as
NAME
crate
:
...
:
:
EXT_EXTENDED_DYNAMIC_STATE3_NAME
as
NAME
crate
:
...
:
:
EXT_EXTENDED_DYNAMIC_STATE3_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
EXT_SUBPASS_MERGE_FEEDBACK_NAME
as
NAME
crate
:
...
:
:
EXT_SHADER_MODULE_IDENTIFIER_NAME
as
NAME
crate
:
...
:
:
EXT_PIPELINE_PROTECTED_ACCESS_NAME
as
NAME
crate
:
...
:
:
EXT_MUTABLE_DESCRIPTOR_TYPE_NAME
as
NAME
crate
:
...
:
:
EXT_PIPELINE_LIBRARY_GROUP_HANDLES_NAME
as
NAME
crate
:
...
:
:
EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_NAME
as
NAME
crate
:
...
:
:
EXT_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_NAME
as
NAME
crate
:
...
:
:
FUCHSIA_IMAGEPIPE_SURFACE_NAME
as
NAME
crate
:
...
:
zx_handle_t
_p_memory_zircon_handle_properties
:
*
mut
...
:
:
FUCHSIA_EXTERNAL_SEMAPHORE_NAME
as
NAME
crate
:
...
:
Device
_p_import_semaphore_zircon_handle_info
:
*
const
...
:
:
FUCHSIA_BUFFER_COLLECTION_NAME
as
NAME
crate
:
...
:
:
GGP_STREAM_DESCRIPTOR_SURFACE_NAME
as
NAME
crate
:
...
:
SwapchainKHR
_p_presentation_timing_count
:
*
mut
u32
_p_presentation_timings
:
*
mut
...
:
:
GOOGLE_HLSL_FUNCTIONALITY1_NAME
as
NAME
crate
:
...
:
:
HUAWEI_CLUSTER_CULLING_SHADER_NAME
as
NAME
crate
:
...
:
:
IMG_RELAXED_LINE_RASTERIZATION_NAME
as
NAME
crate
:
...
:
:
INTEL_SHADER_INTEGER_FUNCTIONS2_NAME
as
NAME
crate
:
...
:
:
INTEL_SHADER_INTEGER_FUNCTIONS2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
Device
_p_device_group_present_capabilities
:
*
mut
...
:
:
KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_NAME
as
NAME
crate
:
...
:
VideoSessionKHR
_p_memory_requirements_count
:
*
mut
u32
_p_memory_requirements
:
*
mut
...
:
VideoSessionKHR
_bind_session_memory_info_count
:
u32
_p_bind_session_memory_infos
:
*
const
...
:
:
KHR_VIDEO_ENCODE_H265_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_GET_PHYSICAL_DEVICE_PROPERTIES2_NAME
as
NAME
crate
:
...
:
:
KHR_GET_PHYSICAL_DEVICE_PROPERTIES2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
PhysicalDevice
_p_queue_family_property_count
:
*
mut
u32
...
:
u32
_remote_device_index
:
u32
_p_peer_memory_features
:
*
mut
...
:
:
KHR_SHADER_DRAW_PARAMETERS_NAME
as
NAME
crate
:
...
:
:
KHR_DEVICE_GROUP_CREATION_NAME
as
NAME
crate
:
...
:
Instance
_p_physical_device_group_count
:
*
mut
u32
...
:
:
KHR_EXTERNAL_MEMORY_CAPABILITIES_NAME
as
NAME
crate
:
...
:
:
KHR_EXTERNAL_MEMORY_WIN32_NAME
as
NAME
crate
:
...
:
:
KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_NAME
as
NAME
crate
:
...
:
:
KHR_EXTERNAL_SEMAPHORE_WIN32_NAME
as
NAME
crate
:
...
:
Device
_p_import_semaphore_win32_handle_info
:
*
const
...
:
:
KHR_EXTERNAL_SEMAPHORE_FD_NAME
as
NAME
crate
:
...
:
u32
_descriptor_write_count
:
u32
_p_descriptor_writes
:
*
const
WriteDescriptorSet
...
:
:
KHR_DESCRIPTOR_UPDATE_TEMPLATE_NAME
as
NAME
crate
:
...
:
:
KHR_IMAGELESS_FRAMEBUFFER_NAME
as
NAME
crate
:
...
:
:
KHR_CREATE_RENDERPASS2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_SHARED_PRESENTABLE_IMAGE_NAME
as
NAME
crate
:
...
:
:
KHR_EXTERNAL_FENCE_CAPABILITIES_NAME
as
NAME
crate
:
...
:
Device
_p_import_fence_win32_handle_info
:
*
const
...
:
PhysicalDevice
_p_performance_query_create_info
:
*
const
...
:
:
KHR_GET_SURFACE_CAPABILITIES2_NAME
as
NAME
crate
:
...
:
:
KHR_GET_SURFACE_CAPABILITIES2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_GET_DISPLAY_PROPERTIES2_NAME
as
NAME
crate
:
...
:
:
KHR_GET_DISPLAY_PROPERTIES2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_STORAGE_BUFFER_STORAGE_CLASS_NAME
as
NAME
crate
:
...
:
:
KHR_GET_MEMORY_REQUIREMENTS2_NAME
as
NAME
crate
:
...
:
:
KHR_GET_MEMORY_REQUIREMENTS2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
_
>
_p_sparse_memory_requirement_count
:
*
mut
u32
...
:
:
KHR_ACCELERATION_STRUCTURE_NAME
as
NAME
crate
:
...
:
CommandBuffer
_p_raygen_shader_binding_table
:
*
const
StridedDeviceAddressRegionKHR
_p_miss_shader_binding_table
:
*
const
StridedDeviceAddressRegionKHR
_p_hit_shader_binding_table
:
*
const
StridedDeviceAddressRegionKHR
...
:
:
KHR_SAMPLER_YCBCR_CONVERSION_NAME
as
NAME
crate
:
...
:
:
KHR_SHADER_SUBGROUP_EXTENDED_TYPES_NAME
as
NAME
crate
:
...
:
:
KHR_SHADER_FLOAT_CONTROLS_NAME
as
NAME
crate
:
...
:
:
KHR_DEPTH_STENCIL_RESOLVE_NAME
as
NAME
crate
:
...
:
:
KHR_SWAPCHAIN_MUTABLE_FORMAT_NAME
as
NAME
crate
:
...
:
:
KHR_SHADER_TERMINATE_INVOCATION_NAME
as
NAME
crate
:
...
:
:
KHR_FRAGMENT_SHADING_RATE_NAME
as
NAME
crate
:
...
:
PhysicalDevice
_p_fragment_shading_rate_count
:
*
mut
u32
_p_fragment_shading_rates
:
*
mut
...
:
:
KHR_DYNAMIC_RENDERING_LOCAL_READ_NAME
as
NAME
crate
:
...
:
:
KHR_SURFACE_PROTECTED_CAPABILITIES_NAME
as
NAME
crate
:
...
:
:
KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_NAME
as
NAME
crate
:
...
:
:
KHR_UNIFORM_BUFFER_STANDARD_LAYOUT_NAME
as
NAME
crate
:
...
:
:
KHR_BUFFER_DEVICE_ADDRESS_NAME
as
NAME
crate
:
...
:
:
KHR_DEFERRED_HOST_OPERATIONS_NAME
as
NAME
crate
:
...
:
:
KHR_PIPELINE_EXECUTABLE_PROPERTIES_NAME
as
NAME
crate
:
...
_
>
_p_internal_representation_count
:
*
mut
u32
_p_internal_representations
:
*
mut
...
:
:
KHR_SHADER_INTEGER_DOT_PRODUCT_NAME
as
NAME
crate
:
...
:
:
KHR_SHADER_NON_SEMANTIC_INFO_NAME
as
NAME
crate
:
...
:
Device
_p_video_session_parameters_info
:
*
const
...
:
:
KHR_SYNCHRONIZATION2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_FRAGMENT_SHADER_BARYCENTRIC_NAME
as
NAME
crate
:
...
:
:
KHR_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_NAME
as
NAME
crate
:
...
:
:
KHR_ZERO_INITIALIZE_WORKGROUP_MEMORY_NAME
as
NAME
crate
:
...
:
:
KHR_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_NAME
as
NAME
crate
:
...
:
:
KHR_COPY_COMMANDS2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_FORMAT_FEATURE_FLAGS2_NAME
as
NAME
crate
:
...
:
:
KHR_FORMAT_FEATURE_FLAGS2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_RAY_TRACING_MAINTENANCE1_NAME
as
NAME
crate
:
...
:
:
KHR_RAY_TRACING_MAINTENANCE1_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_SHADER_SUBGROUP_ROTATE_NAME
as
NAME
crate
:
...
:
:
KHR_SHADER_MAXIMAL_RECONVERGENCE_NAME
as
NAME
crate
:
...
:
:
KHR_RAY_TRACING_POSITION_FETCH_NAME
as
NAME
crate
:
...
:
:
KHR_VIDEO_DECODE_AV1_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_VIDEO_MAINTENANCE1_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_VERTEX_ATTRIBUTE_DIVISOR_NAME
as
NAME
crate
:
...
:
:
KHR_SHADER_FLOAT_CONTROLS2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
KHR_CALIBRATED_TIMESTAMPS_NAME
as
NAME
crate
:
...
:
CommandBuffer
_p_set_descriptor_buffer_offsets_info
:
*
const
...
:
:
LUNARG_DIRECT_DRIVER_LOADING_NAME
as
NAME
crate
:
...
:
:
NV_EXTERNAL_MEMORY_CAPABILITIES_NAME
as
NAME
crate
:
...
:
:
NV_SAMPLE_MASK_OVERRIDE_COVERAGE_NAME
as
NAME
crate
:
...
:
:
NV_GEOMETRY_SHADER_PASSTHROUGH_NAME
as
NAME
crate
:
...
:
:
NV_FRAGMENT_COVERAGE_TO_COLOR_NAME
as
NAME
crate
:
...
:
:
NV_FRAMEBUFFER_MIXED_SAMPLES_NAME
as
NAME
crate
:
...
:
CommandBuffer
_raygen_shader_binding_table_buffer
:
Buffer
...
:
Buffer
_miss_shader_binding_offset
:
DeviceSize
_miss_shader_binding_stride
:
DeviceSize
_hit_shader_binding_table_buffer
:
Buffer
_hit_shader_binding_offset
:
DeviceSize
_hit_shader_binding_stride
:
DeviceSize
_callable_shader_binding_table_buffer
:
Buffer
_callable_shader_binding_offset
:
DeviceSize
...
:
:
NV_REPRESENTATIVE_FRAGMENT_TEST_NAME
as
NAME
crate
:
...
:
:
NV_SHADER_SUBGROUP_PARTITIONED_NAME
as
NAME
crate
:
...
:
:
NV_COMPUTE_SHADER_DERIVATIVES_NAME
as
NAME
crate
:
...
:
:
NV_FRAGMENT_SHADER_BARYCENTRIC_NAME
as
NAME
crate
:
...
:
:
NV_SHADER_IMAGE_FOOTPRINT_NAME
as
NAME
crate
:
...
:
CommandBuffer
_first_exclusive_scissor
:
u32
_exclusive_scissor_count
:
u32
_p_exclusive_scissor_enables
:
*
const
Bool32
...
:
:
NV_DEVICE_DIAGNOSTIC_CHECKPOINTS_NAME
as
NAME
crate
:
...
:
:
NV_DEDICATED_ALLOCATION_IMAGE_ALIASING_NAME
as
NAME
crate
:
...
:
:
NV_COVERAGE_REDUCTION_MODE_NAME
as
NAME
crate
:
...
:
:
NV_DEVICE_GENERATED_COMMANDS_NAME
as
NAME
crate
:
...
:
:
NV_INHERITED_VIEWPORT_SCISSOR_NAME
as
NAME
crate
:
...
:
:
NV_DEVICE_DIAGNOSTICS_CONFIG_NAME
as
NAME
crate
:
...
:
:
NV_FRAGMENT_SHADING_RATE_ENUMS_NAME
as
NAME
crate
:
...
:
:
NV_RAY_TRACING_MOTION_BLUR_NAME
as
NAME
crate
:
...
:
Device
_p_memory_get_remote_address_info
:
*
const
...
:
CommandBuffer
_decompress_region_count
:
u32
_p_decompress_memory_regions
:
*
const
...
:
CommandBuffer
_indirect_commands_address
:
DeviceAddress
_indirect_commands_count_address
:
DeviceAddress
_stride
:
...
pub
mod
device_generated_commands_compute
{
use
super
:
...
:
:
NV_DEVICE_GENERATED_COMMANDS_COMPUTE_NAME
as
NAME
crate
:
...
:
:
NV_LINEAR_COLOR_ATTACHMENT_NAME
as
NAME
crate
:
...
:
PhysicalDevice
_p_optical_flow_image_format_info
:
*
const
...
:
:
NV_RAY_TRACING_INVOCATION_REORDER_NAME
as
NAME
crate
:
...
:
:
NV_EXTENDED_SPARSE_ADDRESS_SPACE_NAME
as
NAME
crate
:
...
:
:
NV_PER_STAGE_DESCRIPTOR_SET_NAME
as
NAME
crate
:
...
:
:
NV_DESCRIPTOR_POOL_OVERALLOCATION_NAME
as
NAME
crate
:
...
:
:
NV_SHADER_ATOMIC_FLOAT16_VECTOR_NAME
as
NAME
crate
:
...
:
:
NV_RAY_TRACING_VALIDATION_NAME
as
NAME
crate
:
...
:
:
NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_NAME
as
NAME
crate
:
...
:
:
QCOM_RENDER_PASS_SHADER_RESOLVE_NAME
as
NAME
crate
:
...
:
:
QCOM_RENDER_PASS_TRANSFORM_NAME
as
NAME
crate
:
...
:
:
QCOM_RENDER_PASS_STORE_OPS_NAME
as
NAME
crate
:
...
:
:
QCOM_ROTATED_COPY_COMMANDS_NAME
as
NAME
crate
:
...
:
:
QCOM_FRAGMENT_DENSITY_MAP_OFFSET_NAME
as
NAME
crate
:
...
:
:
QCOM_MULTIVIEW_PER_VIEW_VIEWPORTS_NAME
as
NAME
crate
:
...
:
:
QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_NAME
as
NAME
crate
:
...
:
:
QCOM_IMAGE_PROCESSING2_SPEC_VERSION
as
SPEC_VERSION
}
;
...
:
:
QCOM_FILTER_CUBIC_WEIGHTS_NAME
as
NAME
crate
:
...
:
:
QNX_EXTERNAL_MEMORY_SCREEN_BUFFER_NAME
as
NAME
crate
:
...
:
:
VALVE_MUTABLE_DESCRIPTOR_TYPE_NAME
as
NAME
crate
:
...
:
:
VALVE_DESCRIPTOR_SET_HOST_MAPPING_NAME
as
NAME
crate
:
