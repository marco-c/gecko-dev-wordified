...
const
WriteDescriptorSet
_descriptor_copy_count
:
u32
_p_descriptor_copies
:
*
const
CopyDescriptorSet
...
:
CommandBuffer
_depth_bias_constant_factor
:
f32
_depth_bias_clamp
:
f32
_depth_bias_slope_factor
:
f32
)
-
...
const
MemoryBarrier
_buffer_memory_barrier_count
:
u32
_p_buffer_memory_barriers
:
*
const
BufferMemoryBarrier
_image_memory_barrier_count
:
u32
_p_image_memory_barriers
:
*
const
ImageMemoryBarrier
