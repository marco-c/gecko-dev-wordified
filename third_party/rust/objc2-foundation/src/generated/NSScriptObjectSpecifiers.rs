...
&
self
container_is_object_being_tested
:
bool
)
;
...
&
self
container_is_range_container_object
:
bool
)
;
...
mod
private_NSObjectNSScriptObjectSpecifiers
{
pub
trait
Sealed
