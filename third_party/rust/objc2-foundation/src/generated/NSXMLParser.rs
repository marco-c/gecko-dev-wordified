...
pub
const
ResolveExternalEntitiesNoNetwork
:
Self
=
Self
...
pub
const
ResolveExternalEntitiesSameOriginOnly
:
Self
=
Self
...
&
self
should_report_namespace_prefixes
:
bool
)
;
...
&
self
external_entity_resolving_policy
:
NSXMLParserExternalEntityResolvingPolicy
)
;
...
&
self
should_resolve_external_entities
:
bool
)
;
