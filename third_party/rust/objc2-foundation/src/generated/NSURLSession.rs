...
&
self
count_of_bytes_client_expects_to_receive
:
i64
)
;
...
&
self
allows_expensive_network_access
:
bool
)
;
...
&
self
allows_constrained_network_access
:
bool
)
;
...
&
self
should_use_extended_background_idle_mode
:
bool
)
;
...
fn
URLSession_didBecomeInvalidWithError
(
&
self
session
...
unsafe
fn
URLSession_didReceiveChallenge_completionHandler
(
&
self
session
...
unsafe
fn
URLSession_task_willBeginDelayedRequest_completionHandler
(
&
self
session
...
fn
URLSession_taskIsWaitingForConnectivity
(
&
self
session
...
unsafe
fn
URLSession_task_willPerformHTTPRedirection_newRequest_completionHandler
(
&
self
session
...
unsafe
fn
URLSession_task_didReceiveChallenge_completionHandler
(
&
self
session
...
unsafe
fn
URLSession_task_needNewBodyStreamFromOffset_completionHandler
(
&
self
session
...
fn
URLSession_task_didSendBodyData_totalBytesSent_totalBytesExpectedToSend
(
&
self
session
...
fn
URLSession_task_didReceiveInformationalResponse
(
&
self
session
...
fn
URLSession_task_didFinishCollectingMetrics
(
&
self
session
...
fn
URLSession_task_didCompleteWithError
(
&
self
session
...
unsafe
fn
URLSession_dataTask_didReceiveResponse_completionHandler
(
&
self
session
...
fn
URLSession_dataTask_didBecomeDownloadTask
(
&
self
session
...
fn
URLSession_dataTask_didBecomeStreamTask
(
&
self
session
...
fn
URLSession_dataTask_didReceiveData
(
&
self
session
...
unsafe
fn
URLSession_dataTask_willCacheResponse_completionHandler
(
&
self
session
...
fn
URLSession_downloadTask_didFinishDownloadingToURL
(
&
self
session
...
fn
URLSession_downloadTask_didWriteData_totalBytesWritten_totalBytesExpectedToWrite
(
&
self
session
...
fn
URLSession_downloadTask_didResumeAtOffset_expectedTotalBytes
(
&
self
session
...
fn
URLSession_readClosedForStreamTask
(
&
self
session
...
fn
URLSession_writeClosedForStreamTask
(
&
self
session
...
fn
URLSession_betterRouteDiscoveredForStreamTask
(
&
self
session
...
fn
URLSession_streamTask_didBecomeInputStream_outputStream
(
&
self
session
...
fn
URLSession_webSocketTask_didOpenWithProtocol
(
&
self
session
...
fn
URLSession_webSocketTask_didCloseWithCode_reason
(
&
self
session
