...
spellServer
:
suggestCompletionsForPartialWordRange
:
inString
:
language
...
unsafe
fn
spellServer_checkGrammarInString_language_details
(
&
self
sender
...
fn
spellServer_recordResponse_toCorrection_forWord_language
(
&
self
sender
