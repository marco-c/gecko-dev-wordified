...
FileManager
/
fetchLatestRemoteVersionOfItem
(
at
:
completionHandler
...
paused
call
uploadLocalVersionOfUbiquitousItem
(
at
:
...
method
(
resumeSyncForUbiquitousItemAtURL
:
withBehavior
:
completionHandler
...
method
(
fetchLatestRemoteVersionOfItemAtURL
:
completionHandler
:
)
...
method
(
uploadLocalVersionOfUbiquitousItemAtURL
:
withConflictResolutionPolicy
:
completionHandler
