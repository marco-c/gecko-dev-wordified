...
&
self
notification_batching_interval
:
NSTimeInterval
)
;
...
fn
metadataQuery_replacementObjectForResultObject
(
&
self
query
...
unsafe
fn
metadataQuery_replacementValueForAttribute_value
(
&
self
query
