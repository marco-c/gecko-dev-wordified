...
&
self
always_shows_decimal_separator
:
bool
)
;
...
&
self
partial_string_validation_enabled
:
bool
)
;
...
&
self
attributed_string_for_not_a_number
:
&
NSAttributedString
)
