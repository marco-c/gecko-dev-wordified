...
let
mut
changed_storage_binding_stages
=
pso
:
:
...
PerformanceCounters
{
immediate_command_buffers
:
usize
deferred_command_buffers
:
usize
remote_command_buffers
:
usize
signal_command_buffers
:
usize
frame_wait_duration
:
...
(
mut
temp_binding_sizes_vs
mut
temp_binding_sizes_ps
)
=
(
Vec
