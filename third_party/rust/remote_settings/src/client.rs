...
rev
/
df850fa290fe962c2c5ae8b63d0943ce768e3cc4
/
services
/
settings
...
fn
test_attachment_can_be_downloaded
(
)
{
viaduct_reqwest
...
fn
test_attachment_errors_if_server_not_configured_for_attachments
(
)
{
viaduct_reqwest
...
fn
test_get_records_none_cached_sync_with_empty
(
)
{
let
...
fn
test_get_records_filtered_app_version_pass
(
)
{
let
...
fn
test_get_records_filtered_app_version_too_low
(
)
{
let
...
fn
test_no_cached_data_use_packaged_data
(
)
-
>
...
fn
test_packaged_data_newer_than_cached
(
)
-
>
...
fn
test_no_cached_data_no_packaged_data_sync_if_empty_true
(
)
-
>
...
fn
test_no_cached_data_no_packaged_data_sync_if_empty_false
(
)
-
>
...
fn
test_cached_data_exists_and_not_empty
(
)
-
>
...
fn
test_cached_data_empty_sync_if_empty_false
(
)
-
>
...
fn
test_no_cached_data_use_packaged_attachment
(
)
-
>
...
fn
test_packaged_attachment_outdated_fetch_from_api
(
)
-
>
...
HX4IiD0SCy
+
NO7gwKqRRZ8IhGd8PTaIHIBgM6RDLRyDeswXgV
+
2kGUoHyzkbNKZt
zlrS3AhqeUCtl1g6ECqSmZBbRTjCpn
/
UCpCnMLL0T0goxtAB8Rmi3CdM0cBUo4GD
MIGAMA4GA1UdDwEB
/
wQEAwIHgDATBgNVHSUEDDAKBggrBgEFBQcDAzAfBgNVHSME
GDAWgBQlZawrqt0eUz
/
t6OdN45oKfmzy6DA4BgNVHREEMTAvgi1yZW1vdGUtc2V0
dGluZ3MuY29udGVudC1zaWduYXR1cmUubW96aWxsYS5vcmcwCgYIKoZIzj0EAwMD
aQAwZgIxAPh43Bxl4MxPT6Ra1XvboN5O2OvIn2r8rHvZPWR
/
jJ9vcTwH9X3F0aLJ
9FiresnsLAIxAOoAcREYB24gFBeWxbiiXaG7TR
/
yM1
/
MXw4qxbN965FFUaoB
...
xV5aNiHJPa
/
fVHO6kxJn3oZLVotJ0DzFZA9r1sQf8i0
+
v78Pg0
/
c3nTAyZWfkULz
...
GEGBtisxCkDJ
+
F3NuLPpSIg3fX25pH0LE15fvASBVcr8tKLVHeOmjggG6
MIIBtjAMBgNVHRMEBTADAQH
/
MA4GA1UdDwEB
/
wQEAwIBBjAWBgNVHSUBAf8EDDAK
BggrBgEFBQcDAzAdBgNVHQ4EFgQUJWWsK6rdHlM
/
7ejnTeOaCn5s8ugwgdkGA1Ud
IwSB0TCBzoAUhtg0HE5Y0RNcmV
/
YQpjtFA8Z8l2hga
+
kgawwgakxCzAJBgNVBAYT
...
b25zQG1vemlsbGEuY29tggRgJZg7MDMGCWCGSAGG
+
EIBBAQmFiRodHRwOi8vYWRk
...
qiF8ylW5L
/
IQ2NzT3sFFAvPW1vW1wZC0xAHMsuVyo
+
BTGrv
+
4mlD0AUR9acRfiTZ
9qyZ3sJbyhQwJAXLKU4YpnzuFOf58T
/
yOnOdwpH2ky
/
0FuHskMyfXaAz2Az4JXJH
TCgggqfdZNvsZ5eOnQlKoC5NadMa8oTI5sd4SyR5ANUPAtYok931MvVSz3IMbwTr
v4PPWXdl9SGXuOknSqdY6
/
bS1LGvC2KprsT
+
PBlvVtS6YgZOH0uCgTTLpnrco87O
ErzC2PJBA1Ftn3Mbaou6xy7O
+
YX
+
reJ6soNUV
...
MRGYMOP2NuKv8s2
+
CtNH7asPq3KuTQpM5RerjdouHMIedX7wpNlNk0CYbg
VMJLxZfAdwcingLWda
/
H3j7PxMoAm0N
+
eA24TGDQPC652ZakYk4MQL
/
45lm0A5f0
xLGKEe6JMZcTBQyO7ANWcrpVjKMiwot6bY6S2xU17mf
/
h7J32JXZJ23OPOKpMS8d
mljj4nkdoYDT35zFuS1z
+
5q6R5flLca35vRHzC3XA0H
/
XJvgOKUNLEW
/
IiJIqLNi
ab3Ao0RubuX
+
CAdFML5HaJmkyuJvL3YtwIOwe93RGcGRZSKZsnMS
+
uY5QN8
+
qKQz
...
DwAwggIKAoICAQDKRVty
/
FRsO4Ech6EYleyaKgAueaLYfMSsAIyPC
/
N8n
/
P8QcH8
rjoiMJrKHRlqiJmMBSmjUZVzZAP0XJku0orLKWPKq7cATt
+
xhGY
/
RJtOzenMMsr5
eN02V3GzUd1jOShUpERjzXdaO3pnfZqhdqNYqP9ocqQpyno7bZ3FZQ2vei
+
bF52k
51uPioTZo
+
1zduoR
/
rT01twGtZm3QpcwU4mO74ysyxxgqEy3kpojq8Nt6haDwzrj
khV9M6DGPLHZD71QaUiz5lOhD9CS8x0uqXhBhwMUBBkHsUDSxbN4ZhjDDWpCmwaD
OtbJMUJxDGPCr9qj49QESccb367OeXLrfZ2Ntu
/
US2Bw9EDfhyNsXr9dg9NHj5yf
4sDUqBHG0W8zaUvJx5T2Ivwtno1YZLyJwQW5pWeWn8bEmpQKD2KS
/
3y2UjlDg
+
YM
NdNASjFe0fh6I5NCFYmFWA73DpDGlUx0BtQQU
/
eZQJ
+
oLOTLzp8d3dvenTBVnKF
+
uwEmoNfZwc4TTWJOhLgwxA4uK
+
Paaqo4Ap2RGS2ZmVkPxmroB3gL5n3k3QEXvULh
7v8Psk4
+
MuNWnxudrPkN38MGJo7ju7gDOO8h1jLD4tdfuAqbtQLduLXzT4DJPA4y
JBTFIRMIpMqP9CovaS8VPtMFLTrYlFh9UnEGpCeLPanJr
+
VEj7ae5sc8YwIDAQAB
o4IBmDCCAZQwDAYDVR0TBAUwAwEB
/
zAOBgNVHQ8BAf8EBAMCAQYwFgYDVR0lAQH
/
BAwwCgYIKwYBBQUHAwMwLAYJYIZIAYb4QgENBB8WHU9wZW5TU0wgR2VuZXJhdGVk
IENlcnRpZmljYXRlMDMGCWCGSAGG
+
EIBBAQmFiRodHRwOi8vYWRkb25zLm1vemls
...
nowyJv8UaIV7NA0B3wkWratq6FgA1s
/
PzetG
/
ZKZDIW5YtfUvvyy72HDAwgKbtap
...
qHr
+
SOCc1LNeSMCuQqvHwwM0
+
AU1GxhzBWDkealTS34FpVxF4sT5sKLODdIS5HXJr2COHHfYkw2SW
/
Sfpt6fsOwaF
2iiDaK4LPWHWhhIYa6yaynJ
+
6O6KPlpvKYCChaTOVdc
+
...
dj
+
olGaDn38T0WI8ycWaFhQfKwATeLWfiQepr8JfoNlC2vvSDzGUGfdAfZfsJJZ8
5xZxahHoTFGS0mDRfXqzKH5uD578GgjOZp0fULmzkcjWsgzdpDhadGjExRZFKlAy
iKv8cXTONrGY0fyBDKennuX0uAca3V0Qm6v2VRp
+
7wG
/
pywWwc5n
+
04qgxTQPxgO
6pPB9UUsNbaLMDR5QPYAWrNhqJ7B07XqIYJZSwGP5xB9NqUZLF4z
+
AOMYgWtDpmg
...
#
"
fJJcOpwdnkjEWFeHXfdOJN6GaGLuDTPGzQOxA2jn6ldIleIk6KqMhZcy2GZv2uYiGwl6DERWwpaoUfQFLyCAOcVjck1qlaaEFZGY1BQba9p99xEc9FNQ3YPPfvSSZqsw
"
#
;
const
...
fn
test_valid_signature_after_retry
(
)
-
>
...
fn
test_invalid_certificate_value
(
)
-
>
...
fn
test_invalid_signature_expired_cert
(
)
-
>
...
fn
test_invalid_signature_invalid_data
(
)
-
>
...
fn
test_invalid_signature_invalid_signer_name
(
)
-
>
