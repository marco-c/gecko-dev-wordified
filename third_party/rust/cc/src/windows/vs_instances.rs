...
fn
it_parses_vswhere_output_correctly
(
)
{
let
...
fn
it_returns_an_error_for_empty_output
(
)
{
let
...
fn
it_returns_an_error_for_output_consisting_of_empty_lines
(
)
{
let
...
fn
it_returns_an_error_for_output_without_required_properties
(
)
{
let
