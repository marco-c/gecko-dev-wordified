...
pub
const
RTL_USER_PROC_APP_MANIFEST_PRESENT
:
ULONG
=
0x00002000
...
pub
const
RTL_USER_PROC_IMAGE_KEY_MISSING
:
ULONG
=
0x00004000
...
pub
const
HeapDetailedFailureInformation
:
u32
=
0x80000001
...
{
HEAP_COMPATIBILITY_STANDARD
=
0
HEAP_COMPATIBILITY_LAL
=
1
HEAP_COMPATIBILITY_LFH
=
2
}
}
...
:
ULONG_PTR
FirstRegionInformationOffset
:
ULONG_PTR
NextHeapInformationOffset
:
ULONG_PTR
}
}
...
pub
const
RTL_QUERY_PROCESS_VERIFIER_OPTIONS
:
ULONG
=
0x00000080
...
pub
const
RTL_QUERY_PROCESS_HEAP_ENTRIES_EX
:
ULONG
=
0x00000200
...
pub
const
RTL_ERRORMODE_FAILCRITICALERRORS
:
ULONG
=
0x0010
...
pub
const
RTL_ATOM_TABLE_DEFAULT_NUMBER_OF_BUCKETS
:
u32
=
37
...
InstallerDetectEnabled
set_InstallerDetectEnabled
[
2
.
.
...
EnableAdditionalAuditingOption
set_EnableAdditionalAuditingOption
[
3
.
.
...
EnableAdditionalPolicyOption
set_EnableAdditionalPolicyOption
[
3
.
.
...
{
struct
RTL_IMAGE_MITIGATION_DEP_POLICY
{
Dep
:
RTL_IMAGE_MITIGATION_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_DEP_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_DEP_POLICY
...
{
struct
RTL_IMAGE_MITIGATION_ASLR_POLICY
{
ForceRelocateImages
:
RTL_IMAGE_MITIGATION_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_ASLR_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_ASLR_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_STRICT_HANDLE_CHECK_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_STRICT_HANDLE_CHECK_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_SYSTEM_CALL_DISABLE_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_SYSTEM_CALL_DISABLE_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_CONTROL_FLOW_GUARD_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_CONTROL_FLOW_GUARD_POLICY
...
{
BlockNonMicrosoftSignedBinaries
:
RTL_IMAGE_MITIGATION_POLICY
EnforceSigningOnModuleDependencies
:
RTL_IMAGE_MITIGATION_POLICY
}
}
pub
type
PRTL_IMAGE_MITIGATION_BINARY_SIGNATURE_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_BINARY_SIGNATURE_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_FONT_DISABLE_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_FONT_DISABLE_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_IMAGE_LOAD_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_IMAGE_LOAD_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_CHILD_PROCESS_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_CHILD_PROCESS_POLICY
...
{
struct
RTL_IMAGE_MITIGATION_SEHOP_POLICY
{
Sehop
:
RTL_IMAGE_MITIGATION_POLICY
...
pub
type
PRTL_IMAGE_MITIGATION_SEHOP_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_SEHOP_POLICY
...
{
struct
RTL_IMAGE_MITIGATION_HEAP_POLICY
{
TerminateOnHeapErrors
:
RTL_IMAGE_MITIGATION_POLICY
}
}
pub
type
PRTL_IMAGE_MITIGATION_HEAP_POLICY
=
*
mut
RTL_IMAGE_MITIGATION_HEAP_POLICY
...
pub
const
RTL_IMAGE_MITIGATION_FLAG_RESET
:
ULONG
=
0x1
...
pub
const
RTL_IMAGE_MITIGATION_FLAG_REMOVE
:
ULONG
=
0x2
...
pub
const
RTL_IMAGE_MITIGATION_FLAG_OSDEFAULT
:
ULONG
=
0x4
...
pub
const
RTL_IMAGE_MITIGATION_FLAG_AUDIT
:
ULONG
=
0x8
