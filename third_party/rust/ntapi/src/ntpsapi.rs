...
{
struct
PROCESS_DEVICEMAP_INFORMATION_Query
{
DriveMap
:
ULONG
...
{
struct
PROCESS_DEVICEMAP_INFORMATION_EX_u_Set
{
DirectoryHandle
:
HANDLE
...
{
struct
PROCESS_DEVICEMAP_INFORMATION_EX_u_Query
{
DriveMap
:
ULONG
...
{
union
PROCESS_DEVICEMAP_INFORMATION_EX_u
{
Set
:
PROCESS_DEVICEMAP_INFORMATION_EX_u_Set
...
pub
const
PROCESS_HANDLE_RAISE_EXCEPTION_ON_INVALID_HANDLE_CLOSE_ENABLED
:
ULONG
=
0x00000001
...
pub
const
PROCESS_HANDLE_TRACING_MAX_SLOTS
:
ULONG
=
0x20000
...
{
union
PROCESS_MITIGATION_POLICY_INFORMATION_u
{
ASLRPolicy
:
PROCESS_MITIGATION_ASLR_POLICY
...
pub
type
PPROCESS_TELEMETRY_ID_INFORMATION
=
*
mut
PROCESS_TELEMETRY_ID_INFORMATION
...
:
SIZE_T
CommittedMemResetSize
:
SIZE_T
RepurposedMemResetSize
:
SIZE_T
}
}
...
set_ForceReleaseMemResetCommit
[
2
.
.
...
pub
type
PPROCESS_COMMIT_RELEASE_INFORMATION
=
*
mut
PROCESS_COMMIT_RELEASE_INFORMATION
...
{
ProhibitChildProcesses
:
BOOLEAN
AlwaysAllowSecureChildProcess
:
BOOLEAN
AuditProhibitChildProcesses
:
BOOLEAN
}
}
pub
type
PPROCESS_CHILD_PROCESS_INFORMATION
=
*
mut
PROCESS_CHILD_PROCESS_INFORMATION
...
pub
type
PPROCESS_ENERGY_TRACKING_STATE
=
*
mut
PROCESS_ENERGY_TRACKING_STATE
...
pub
const
PROCESS_READWRITEVM_LOGGING_ENABLE_READVM
:
UCHAR
=
1
...
pub
const
PROCESS_READWRITEVM_LOGGING_ENABLE_WRITEVM
:
UCHAR
=
2
...
pub
const
PROCESS_READWRITEVM_LOGGING_ENABLE_READVM_V
:
UCHAR
=
1
...
pub
const
PROCESS_READWRITEVM_LOGGING_ENABLE_WRITEVM_V
:
UCHAR
=
2
...
pub
type
PPROCESS_SYSTEM_RESOURCE_MANAGEMENT
=
*
mut
PROCESS_SYSTEM_RESOURCE_MANAGEMENT
...
pub
type
PPROCESS_SECURITY_DOMAIN_INFORMATION
=
*
mut
PROCESS_SECURITY_DOMAIN_INFORMATION
...
set_EnableProcessSuspendResumeLogging
[
2
.
.
...
set_EnableThreadSuspendResumeLogging
[
3
.
.
...
pub
type
PPROCESS_LEAP_SECOND_INFORMATION
=
*
mut
PROCESS_LEAP_SECOND_INFORMATION
...
set_IFEODoNotPropagateKeyState
[
3
.
.
...
set_ProhibitedImageCharacteristics
[
16
.
.
...
pub
type
PJOBOBJECT_WAKE_INFORMATION_V1
=
*
mut
JOBOBJECT_WAKE_INFORMATION_V1
...
pub
type
PJOBOBJECT_INTERFERENCE_INFORMATION
=
*
mut
JOBOBJECT_INTERFERENCE_INFORMATION
...
pub
type
PJOBOBJECT_MEMORY_USAGE_INFORMATION
=
*
mut
JOBOBJECT_MEMORY_USAGE_INFORMATION
