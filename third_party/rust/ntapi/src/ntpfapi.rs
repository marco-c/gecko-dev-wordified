...
pub
const
PREFETCHER_INFORMATION_VERSION
:
ULONG
=
23
...
:
ULONG
SavedSectInfoTracesMax
:
ULONG
SavedPageAccessTracesMax
:
ULONG
ScenarioPrefetchTimeoutStandby
:
ULONG
ScenarioPrefetchTimeoutHibernate
:
ULONG
}
}
...
pub
const
PF_PFN_PRIO_REQUEST_QUERY_MEMORY_LIST
:
u32
=
0x1
...
pub
const
PF_PFN_PRIO_REQUEST_VALID_FLAGS
:
u32
=
0x1
...
{
union
PF_PRIVSOURCE_INFO_u
{
WsSwapPages
:
ULONG_PTR
SessionPagedPoolPages
:
ULONG_PTR
StoreSizePages
:
...
pub
const
PF_PRIVSOURCE_QUERY_REQUEST_VERSION
:
u32
=
3
...
pub
const
PF_SCENARIO_PHASE_INFO_VERSION
:
u32
=
4
...
:
ULONGLONG
StandbyMediumPageCount
:
ULONGLONG
StandbyHighPageCount
:
ULONGLONG
FreePageCount
:
...
pub
const
PF_PHYSICAL_MEMORY_RANGE_INFO_VERSION
:
u32
=
1
...
pub
const
PF_REPURPOSED_BY_PREFETCH_INFO_VERSION
:
u32
=
1
...
pub
const
SUPERFETCH_INFORMATION_VERSION
:
ULONG
=
45
