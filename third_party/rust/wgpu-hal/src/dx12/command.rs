...
:
:
from_indirect_draw_call_params
(
first_vertex
first_instance
)
...
:
:
map_acceleration_structure_build_flags
(
descriptor
.
flags
...
;
let
src_acceleration_structure_address
=
descriptor
.
...
:
:
map_acceleration_structure_copy_mode
(
copy
)
)
