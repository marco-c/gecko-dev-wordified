...
.
new_command_queue_with_max_command_buffer_count
(
MAX_COMMAND_BUFFERS
)
;
...
metal
/
gpu_counters_and_counter_sample_buffers
/
converting_gpu_timestamps_into_cpu_time
/
/
Not
only
...
drc
=
76be2f9f117654f3fe4faa477b0445114fccedda
;
bpv
=
0
...
tables
const
INDIRECT_DRAW_DISPATCH_SUPPORT
:
&
[
MTLFeatureSet
...
;
const
FUNCTION_SPECIALIZATION_SUPPORT
:
&
[
MTLFeatureSet
...
metal
/
developing_metal_apps_that_run_in_simulator
let
os_is_xr
=
version
...
device
.
supports_32bit_float_filtering
(
)
)
format_depth24_stencil8
