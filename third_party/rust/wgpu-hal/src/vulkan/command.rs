...
{
fn
write_pass_end_timestamp_if_requested
(
&
mut
self
...
:
:
map_acceleration_structure_build_mode
(
desc
.
mode
...
:
:
map_acceleration_structure_usage_to_barrier
(
barrier
.
usage
