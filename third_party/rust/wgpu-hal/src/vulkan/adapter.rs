...
fn
supports_storage_input_output_16
(
&
self
)
...
is_format_16bit_norm_supported
(
instance
phd
)
...
:
:
EXPERIMENTAL_RAY_TRACING_PIPELINES
/
/
Same
reason
...
:
FLOAT32_FILTERABLE
is_float32_filterable_supported
(
instance
phd
)
...
:
FLOAT32_BLENDABLE
is_float32_blendable_supported
(
instance
phd
)
...
;
let
ignore_max_fragment_combined_output_resources
=
ignore_max_fragment_combined_output_resources_by_device
|
|
...
ray_tracing_pipeline_group_data_alignment
:
self
.
ray_tracing_pipeline
...
ray_tracing_pipeline_data_offset_alignment
:
self
.
ray_tracing_pipeline
...
cooperative_matrix_properties
=
query_cooperative_matrix_properties
(
&
coop_matrix
phd
