...
Member
:
GetNumNonIndexedTriListVertices
/
/
/
/
...
;
HRESULT
RenderPrecomputedIndexedTriangles
(
__range
(
1
...
-
>
RealizeColorSourcesAndSendState
(
m_pVB
)
)
