...
:
ident
double_stride_both_aligned
:
ident
double_stride_src_aligned
:
ident
)
=
...
macro_rules
!
latin1_simd_check_align_unrolled
{
(
name
:
...
macro_rules
!
ascii_to_ascii_simd_double_stride
{
(
name
:
...
!
(
ascii_to_ascii_stride_both_aligned
load16_aligned
store16_aligned
)
;
...
!
(
ascii_to_ascii_stride_src_aligned
load16_aligned
store16_unaligned
)
;
...
!
(
ascii_to_ascii_stride_dst_aligned
load16_unaligned
store16_aligned
)
;
