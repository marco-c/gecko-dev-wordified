...
fn
test_iso_2022_jp_half_width_katakana_length
(
)
{
let
...
fn
test_iso_2022_jp_length_after_escape
(
)
{
let
...
fn
test_iso_2022_jp_encode_from_two_low_surrogates
(
)
{
let
