...
:
ident
decode_to_utf_after_one_potential_bom_byte
:
ident
decode_to_utf_after_two_potential_bom_bytes
:
ident
decode_to_utf_checking_end_with_offset
:
ident
code_unit
:
