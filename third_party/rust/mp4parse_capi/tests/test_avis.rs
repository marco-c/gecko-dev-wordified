...
fn
loop_four_times_due_to_ceiling
(
)
{
check_loop_count
...
fn
repeated_get_info_returns_stable_pointers
(
)
{
let
...
fn
repeated_get_image_returns_stable_pointers
(
)
{
let
...
fn
repeated_get_indice_table_returns_stable_pointer
(
)
{
let
...
fn
empty_avif_byte_slices_use_null_pointers
(
)
{
let
