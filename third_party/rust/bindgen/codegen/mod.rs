...
.
trait
WithImplicitTemplateParams
{
fn
with_implicit_template_params
(
self
ctx
:
...
:
:
names_will_be_identical_after_mangling
(
&
canonical_name
link_name
