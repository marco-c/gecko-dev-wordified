...
USB_HUB_DEVICE_INFO
CompositeDeviceInfo
CompositeDeviceInfo_mut
:
USB_COMPOSITE_DEVICE_INFO
ControllerDeviceInfo
ControllerDeviceInfo_mut
:
USB_CONTROLLER_DEVICE_INFO
DeviceInformation
DeviceInformation_mut
:
[
UCHAR
;
...
UsbHubDescriptor
UsbHubDescriptor_mut
:
USB_HUB_DESCRIPTOR
Usb30HubDescriptor
Usb30HubDescriptor_mut
:
USB_30_HUB_DESCRIPTOR
}
}
...
set_DeviceIsSuperSpeedCapableOrHigher
[
1
.
.
...
set_DeviceIsOperatingAtSuperSpeedPlusOrHigher
[
2
.
.
...
set_DeviceIsSuperSpeedPlusCapableOrHigher
[
3
.
.
