...
FixedInstanceSize
FixedInstanceSize_mut
:
ULONG
OffsetInstanceDataAndLength
OffsetInstanceDataAndLength_mut
:
[
OFFSETINSTANCEDATAANDLENGTH
;
...
TargetInstanceIndex
TargetInstanceIndex_mut
:
ULONG
TargetInstanceName
TargetInstanceName_mut
:
[
WCHAR
;
