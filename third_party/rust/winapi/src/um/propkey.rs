...
pub
const
CALENDAR_RESPONSESTATUS_ORGANIZED
:
DWORD
=
1
...
pub
const
CALENDAR_RESPONSESTATUS_TENTATIVE
:
DWORD
=
2
...
pub
const
CALENDAR_RESPONSESTATUS_ACCEPTED
:
DWORD
=
3
...
pub
const
CALENDAR_RESPONSESTATUS_DECLINED
:
DWORD
=
4
...
pub
const
CALENDAR_RESPONSESTATUS_NOTRESPONDED
:
DWORD
=
5
...
pub
const
COMMUNICATION_DIRECTION_UNKNOWN
:
DWORD
=
0
...
pub
const
COMMUNICATION_DIRECTION_INCOMING
:
DWORD
=
1
...
pub
const
FILEOFFLINEAVAILABILITYSTATUS_PROP_NOTAVAILABLEOFFLINE
:
DWORD
=
0
...
pub
const
FILEOFFLINEAVAILABILITYSTATUS_PROP_PARTIALLYAVAILABLEOFFLINE
:
DWORD
=
1
...
pub
const
IMAGE_COMPRESSION_UNCOMPRESSED
:
DWORD
=
1
