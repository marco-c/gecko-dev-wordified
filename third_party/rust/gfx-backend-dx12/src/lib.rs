...
CopyDescriptors
.
avoid_cpu_descriptor_overwrites
:
bool
}
/
...
:
:
STORAGE_BUFFER_DESCRIPTOR_INDEXING
|
Features
:
:
UNIFORM_BUFFER_DESCRIPTOR_INDEXING
|
Features
:
:
