...
fn
view_image_as_unordered_access
(
&
self
info
...
unsafe
fn
create_allocate_external_buffer
(
&
self
_external_memory_type
:
hal
:
:
...
unsafe
fn
create_allocate_external_image
(
&
self
_external_memory_type
