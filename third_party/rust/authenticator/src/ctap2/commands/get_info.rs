...
pub
const
AUTHENTICATOR_INFO_UNKNOWN_VERSIONS
:
&
[
u8
...
fn
parse_authenticator_info_fido_2_2
(
)
{
assert_eq
...
fn
parse_authenticator_info_unknown_algorithm
(
)
{
/
...
fn
parse_authenticator_info_unknown_versions
(
)
{
assert_eq
