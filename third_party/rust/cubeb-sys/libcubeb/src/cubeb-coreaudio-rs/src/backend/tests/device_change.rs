...
cargo
test
test_register_device_changed_callback
-
-
-
-
...
:
{
get_devices_info_in_scope
test_create_device_change_listener
test_device_in_scope
...
;
test_get_started_stream_in_scope
(
scope
.
clone
...
{
test_switch_device_in_scope_while_paused
(
Scope
:
:
...
{
test_plug_and_unplug_device_in_scope
(
Scope
:
:
...
let
default_device_before_plugging
=
test_get_default_device
(
device_scope
...
changes
fn
test_default_device_change_triggers_callback
(
scope
:
Scope
...
"
fn
input_device_collection_changed_callback
(
_context
:
*
...
"
fn
output_device_collection_changed_callback
(
_context
:
*
