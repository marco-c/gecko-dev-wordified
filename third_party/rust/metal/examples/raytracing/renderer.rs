...
geometry
.
get_intersection_function_name
(
)
.
is_none
...
accel_descriptor
.
set_instanced_acceleration_structures
(
&
Array
:
...
accel_descriptor
.
set_instance_descriptor_buffer
(
&
instance_buffer
)
...
:
:
new_specialised_function_with_name
(
&
library
resources_stride
