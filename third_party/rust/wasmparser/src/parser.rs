...
BeginPassiveElementSectionEntry
(
Type
)
BeginActiveElementSectionEntry
(
u32
)
...
self
.
create_custom_section_binary_reader
(
)
;
self
.
read_section_body_bytes
(
)
?
;
