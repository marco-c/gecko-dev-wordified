...
constexpr
bool
SwisstableGenerationsOrDebugEnabled
(
)
{
#
...
constexpr
size_t
MaxCapacityWithBlockedElements
(
)
{
return
...
constexpr
bool
IsCapacityValidForBlockedElements
(
size_t
cap
)
...
GrowthInfoLowerBound
RebalanceGrowthLeftLowerBoundLargeCapacity
(
)
;
/
...
See
also
InitializeSmallControlBytesAfterSoo
(
)
.
It
