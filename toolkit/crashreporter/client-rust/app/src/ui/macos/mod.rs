...
NSTextField_NSTextFieldConvenience
NSView_NSConstraintBasedLayoutInstallingConstraints
NSView_NSConstraintBasedLayoutLayering
NSView_NSSafeAreas
PNSObject
}
;
...
fn
application_should_terminate_after_window_closed
(
&
mut
self
