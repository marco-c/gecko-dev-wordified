...
patch
.
downloadWriteFailureTelemetrySent
)
{
AUSTLMY
.
...
patch
.
applyWriteFailureTelemetrySent
)
{
/
/
...
request
.
checkWriteFailureTelemetrySent
)
{
let
pingSuffix
...
_writeUpdateAutoConfig
:
async
function
AUS__writeUpdateAutoPref
(
enabledValue
)
{
...
auto
.
_maybeUpdateAutoConfigChanged
:
function
AUS__maybeUpdateAutoConfigChanged
(
newValue
)
{
