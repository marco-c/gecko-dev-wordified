...
;
const
WRITE_ERROR_SHARING_VIOLATION_NOPROCESSFORPID
=
47
;
const
WRITE_ERROR_SHARING_VIOLATION_NOPID
=
48
;
const
...
const
PING_BGUC_INVALID_OVERRIDE_URL
=
4
;
/
...
const
PING_BGUC_DISABLED_FOR_SESSION
=
8
;
/
...
const
PING_BGUC_CERT_ATTR_NO_UPDATE_NOTIFY
=
11
;
/
...
const
PING_BGUC_CERT_ATTR_WITH_UPDATE_NOTIFY
=
13
;
/
...
const
PING_BGUC_GENERAL_ERROR_NOTIFY
=
15
;
/
...
const
PING_BGUC_GENERAL_ERROR_SILENT
=
16
;
/
...
const
PING_BGUC_NO_COMPAT_UPDATE_FOUND
=
18
;
/
...
const
PING_BGUC_UPDATE_PREVIOUS_VERSION
=
19
;
/
...
const
PING_BGUC_ADDON_UPDATES_FOR_INCOMPAT
=
29
;
/
...
{
function
submitHasPermissionsTelemetryPing
(
val
)
{
...
*
/
_sendServiceInstalledTelemetryPing
:
function
AUS__svcInstallTelemetryPing
(
)
{
let
...
*
/
_sendIntPrefTelemetryPing
:
function
AUS__intTelemetryPing
(
pref
histogram
)
...
*
/
_sendLastNotifyIntervalPing
:
function
AUS__notifyIntervalPing
(
)
{
if
...
(
"
UPDATER_INVALID_LASTUPDATETIME_
"
+
idSuffix
)
...
(
"
UPDATER_LAST_NOTIFY_INTERVAL_DAYS_
"
+
idSuffix
)
...
:
function
AUS__backgroundUpdateCheckCodePing
(
code
)
{
