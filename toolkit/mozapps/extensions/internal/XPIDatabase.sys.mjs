...
updateBlocklistAttentionDismissed
(
val
)
{
...
XPIDatabase
.
maybeUpdateBlocklistAttentionAddonIdsSet
(
this
)
;
...
shouldShowBlocklistAttentionForAddon
(
addonInternal
)
{
...
removeFromBlocklistAttentionAddonIdsSet
(
addonInternal
)
{
