...
function
getAndUpdateStatsTsMemoForPcid
(
pcid
)
{
...
;
const
userModifiedConfigSection
=
await
renderUserPrefSection
(
)
;
primarySections
...
;
const
peerConnectionAutoRefreshState
=
{
/
*
...
{
const
closedPeerConnectionDisclosure
=
...
function
renderPeerConnectionMediaSummary
(
rndr
report
)
