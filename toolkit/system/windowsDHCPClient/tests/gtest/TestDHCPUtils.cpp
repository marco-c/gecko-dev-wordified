...
{
mLastRequestedNetworkAdapterName
.
Assign
(
AdapterName
...
void
Given_Network_Adapter_Supports_DHCP_V4
(
IP_ADAPTER_ADDRESSES
&
adapterAddresses
...
void
Given_Network_Adapter_Supports_DHCP_V6
(
IP_ADAPTER_ADDRESSES
&
adapterAddresses
...
(
TestDHCPUtils
TestGetAdaptersAddressesNoAvailableNetworks
)
{
IP_ADAPTER_ADDRESSES
adapterAddresses
...
(
TestDHCPUtils
TestGetAdaptersAddressesNoNetworksWithDHCP
)
{
IP_ADAPTER_ADDRESSES
adapterAddresses
...
(
TestDHCPUtils
TestGetAdaptersAddressesSecondNetworkIsAvailable
)
{
IP_ADAPTER_ADDRESSES
adapterAddresses
...
(
TestNsWindowsDHCPClient
TestGettingOptionThroughNSWindowsDHCPClient
)
{
IP_ADAPTER_ADDRESSES
adapterAddresses
