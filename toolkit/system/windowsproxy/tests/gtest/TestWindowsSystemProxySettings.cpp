...
;
class
TestWindowsSystemProxySettings
:
public
:
:
...
(
TestWindowsSystemProxySettings
GetPACURI_NoPacFlag_ReturnsEmpty
)
{
mMock
-
...
(
TestWindowsSystemProxySettings
GetPACURI_WithPacFlag_ReturnsUrl
)
{
mMock
-
...
(
TestWindowsSystemProxySettings
GetProxyForURI_SocksProxy_ReturnsSocks
)
{
mMock
-
