...
;
const
TOGGLE_FIRST_TIME_DURATION_DAYS
=
28
;
const
...
this
.
updateUrlbarPipVideoEligibility
(
event
.
target
...
this
.
handleEligiblePipVideoMutation
(
mutationList
)
;
...
.
#
captionChangeListenerRegistered
=
false
;
/
...
this
.
closePictureInPictureIfDisconnected
(
{
reason
video
...
PictureInPicture
:
SetTimestampAndScrubberPosition
"
{
scrubberPosition
timestamp
...
this
.
setPictureInPictureWindowInstance
(
pipInstance
)
;
...
rev
/
cfd1cc461f1efe0d66c2fdc17c024a203d5a2fd8
/
toolkit
/
content
