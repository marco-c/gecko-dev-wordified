...
/
const
ONNX_AVAILABILITY_REPORTED_PREF
=
"
browser
.
...
/
class
PipelineOptionsValidationError
extends
Error
{
/
...
static
#
nativeOnnxRuntimeAvailabilityPromise
=
null
;
static
...
.
#
requestNativeOnnxRuntimeAvailability
(
)
;
}
