...
#
define
BOOKMARKS_TO_KEYWORDS_INITIAL_CACHE_SIZE
64
#
define
...
:
:
kFindURIBookmarksIndex_ParentId
=
2
;
const
...
:
:
kFindURIBookmarksIndex_LastModified
=
3
;
const
...
:
:
kFindURIBookmarksIndex_ParentGuid
=
4
;
const
...
:
:
kFindURIBookmarksIndex_GrandParentId
=
5
;
/
...
:
:
kGetItemPropertiesIndex_Position
=
3
;
const
...
:
:
kGetItemPropertiesIndex_PlaceId
=
4
;
const
...
:
:
kGetItemPropertiesIndex_ParentId
=
5
;
const
...
:
:
kGetItemPropertiesIndex_ServiceContractId
=
7
;
const
...
:
:
kGetItemPropertiesIndex_ParentGuid
=
11
;
const
...
:
:
kGetItemPropertiesIndex_GrandParentId
=
12
;
using
...
ExecuteSimpleSQL
(
CREATE_KEYWORD_VALIDITY_TRIGGER
)
;
NS_ENSURE_SUCCESS
(
...
{
DECLARE_AND_ASSIGN_SCOPED_LAZY_STMT_RET
(
stmt
mDBIsRealBookmark
PR_FALSE
