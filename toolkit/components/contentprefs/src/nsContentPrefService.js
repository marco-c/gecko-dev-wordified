...
:
function
ContentPrefService_QueryInterface
(
aIID
)
{
...
:
function
ContentPrefService___dbMigrate0To2
(
aDBConnection
)
{
...
:
function
ContentPrefService__getAppPref
(
aPrefName
aDefaultValue
)
...
:
function
HostnameGrouper_QueryInterface
(
aIID
)
{
