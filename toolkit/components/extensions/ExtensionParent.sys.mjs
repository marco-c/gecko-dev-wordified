...
used
by
notifyBackgroundScriptSuspendIgnored
/
/
in
ext
...
(
test_ext_background_file_invalid
.
js
)
reject
...
{
const
abortControllerForShutdownSignal
=
new
AbortController
(
