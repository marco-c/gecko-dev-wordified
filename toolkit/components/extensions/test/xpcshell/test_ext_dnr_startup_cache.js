...
async
function
test_dnr_startup_cache_save_and_load
(
)
{
resetTelemetryData
...
;
const
assertDNRStoreDataLoadOnStartup
=
async
(
{
...
async
function
test_detect_and_reschedule_save_cache_on_new_changes
(
)
{
const
...
;
let
resolvePromiseSaveCacheRescheduled
;
let
promiseSaveCacheRescheduled
=
new
Promise
(
...
;
const
realDetectStartupCacheDataChanged
=
dnrStore
.
