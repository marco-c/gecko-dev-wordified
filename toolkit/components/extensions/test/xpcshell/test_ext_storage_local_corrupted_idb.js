...
async
function
assertStorageLocalCorruptedGleanEvents
(
expected
msg
)
...
function
assertNoStorageLocalCorruptedGleanEvents
(
)
{
return
...
async
function
assertUnexpectedErrorOnTestMessage
(
testMessage
assertMessage
)
...
async
function
testErrorOnInactiveAddonBeforeOpenForPrincipal
(
)
{
Services
...
test
task
testSkipResetForPrincipalOnInactiveAddon
is
instead
/
/
...
;
const
deferredOpenForPrincipalCallReceived
=
Promise
.
withResolvers
...
;
const
deferredOpenForPrincipalCallResult
=
Promise
.
withResolvers
...
async
function
testDropAndReopenOnInactiveAddon
(
)
{
Services
