...
rev
/
26a98a7ba56f315df146512c43449412f0592942
/
toolkit
/
components
...
async
function
do_test_userScripts_permission_unavailable
(
manifest_version
)
{
...
extensionId
=
permission_disabled_by_pref_mv
{
manifest_version
}
;
...
async
function
userScripts_permission_disabled_by_pref_mv2
(
)
{
/
...
async
function
userScripts_permission_disabled_by_pref_mv3
(
)
{
await
...
async
function
reject_userScripts_permission_request_when_disabled_by_pref
(
)
{
let
