...
.
const
OLDEST_ALLOWED_TELEMETRY_POLICY_ACCEPTANCE_YEAR
=
2012
;
/
...
=
{
DATAREPORTING_POLICY_TAB_OR_INFOBAR
:
0
...
comment
in
acceptedTOUDuringExperimentationPhase
for
more
details
.
...
const
bypassTOUFlowViaNimbusVariables
=
(
!
Services
...
this
.
_requestAndAwaitUserResponseViaFxMS
(
)
)
{
