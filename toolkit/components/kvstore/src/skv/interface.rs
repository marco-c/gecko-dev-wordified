...
;
KeyValueServiceShutdownBlocker
:
:
register
(
...
allocate
(
InitKeyValueServiceShutdownBlocker
{
client
}
)
...
allocate
(
InitRkvSafeModeKeyValueImporter
{
client
/
/
...
allocate
(
InitKeyValueDatabaseImportOptions
{
conflict_policy
:
AtomicCell
