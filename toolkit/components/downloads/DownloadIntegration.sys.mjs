...
/
async
_getCustomDirectoryOrDownloads
(
pref
)
{
...
DownloadObserver
.
_contentAnalysisInProgressDownloads
.
set
(
download
...
*
/
_contentAnalysisWarnInProgressDownloads
:
new
Set
(
