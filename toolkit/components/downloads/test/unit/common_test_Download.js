...
;
const
kDecodeContentForKnownCompressedExtensions
=
"
network
.
http
.
decode_content_for_known_compressed_extensions
"
;
ChromeUtils
.
...
async
function
test_macos_xattrItemWhereFroms
(
)
{
/
...
async
function
test_with_content_encoding_matching_extension
(
)
{
Services
...
async
function
test_preferredDownloadsDirectoryMatches
(
)
{
const
...
async
function
test_allowDirectoriesIsOnlyLocallySet
(
)
{
Assert
...
async
function
test_blocked_applicationReputation_confirmBlock_sets_deleted
(
)
{
let
...
async
function
test_download_cancel_retry_finalize
(
)
{
/
...
async
function
test_blocked_removeByHand_confirmBlock
(
)
{
let
...
async
function
test_launchWhenSucceeded_deleteTempFileOnExit_with_launcherId
(
)
{
let
