...
;
const
NOT_DIACRITIC_FROM_END_REG_EXP
=
/
(
\
...
;
const
NOT_DIACRITIC_FROM_START_REG_EXP
=
/
^
\
...
this
.
_pageNumberToDestHashCapability
=
null
;
this
...
const
pageNumberToDestHash
=
await
this
.
_getPageNumberToDestHash
(
this
.
_pdfDocument
...
;
const
DRAG_THRESHOLD_IN_PIXELS
=
5
;
const
PIXELS_TO_SCROLL_WHEN_DRAGGING
=
20
;
const
SPACE_FOR_DRAG_MARKER_WHEN_NO_NEXT_ELEMENT
=
15
;
class
...
(
"
PDFThumbnailViewer_setPageLabels
:
Invalid
page
labels
...
web
/
annotation_editor_layer_builder
.
js
class
...
;
#
elementsToAddToTextLayer
=
null
;
#
elementsToHideInTextLayer
=
null
;
#
elementsToStealFromTextLayer
=
null
;
constructor
...
=
{
FORCE_SCROLL_MODE_PAGE
:
10000
FORCE_LAZY_PAGE_INIT
:
5000
...
;
#
switchAnnotationEditorModeAC
=
null
;
#
switchAnnotationEditorModeTimeoutId
=
null
;
#
...
;
const
CERT_EXPIRED_WITH_DATE_L10N_ID
=
"
pdfjs
-
