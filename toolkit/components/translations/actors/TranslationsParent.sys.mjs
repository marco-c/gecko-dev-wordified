...
sync
with
browser_translations_full_page_language_id_behavior
.
js
.
*
...
/
static
LANGUAGE_MODEL_MAJOR_VERSION_MIN
=
3
;
static
...
/
#
isTranslationStartupInProgress
=
false
;
/
...
/
#
subFrameTranslationWebProgress
=
null
;
/
...
/
#
subFrameTranslationProgressListener
=
null
;
/
...
async
#
translateSubFrameFromTopLevelLanguagePair
(
languagePair
)
{
...
async
#
createSubFrameActorsForActiveTranslation
(
languagePair
)
{
...
.
#
onSubFrameWindowLoadStateChange
(
progress
stateFlags
)
...
rev
/
d951c4a19a6958816b35a228ff38fc6ae2c34f13
/
uriloader
/
base
...
.
#
buildTranslationsOfferInstruction
(
langTags
)
;
...
.
#
shouldAutoTranslateResolvedLangTags
(
resolvedLangTags
)
)
...
.
#
getTranslationsOfferMatrixScenario
(
conditions
)
;
...
.
#
createOfferInstructionFromSupportedSource
(
{
action
langTags
...
.
#
identifyLanguageFromTextSample
(
)
;
if
...
.
#
langTagMatchesWebContentLanguageForOffer
(
langTag
)
}
...
static
#
invalidateMostRecentTargetLanguages
(
)
{
TranslationsParent
...
static
#
invalidateUserSettingsLanguages
(
)
{
TranslationsParent
...
.
#
invalidateTranslationModelRecords
)
;
break
;
...
.
const
recordsWithAttachmentsToReplace
=
[
]
;
...
TranslationsUtils
.
translationsModelsCollectionName
)
;
TranslationsParent
.
...
TranslationsUtils
.
translationsWasmCollectionName
)
;
TranslationsParent
.
...
async
#
maybeFetchLocalBergamotWasmBlob
(
)
{
if
...
static
async
deleteLanguageFilesToAndFromPair
(
languageA
languageB
deletePivots
...
TranslationsParent
.
getRecordsForTranslatingToAndFromPair
(
languageA
languageB
deletePivots
...
/
static
findCompatibleSourceLangTagSync
(
langTag
languagePairs
)
...
this
.
setNeverTranslateSitePermissions
(
false
)
;
