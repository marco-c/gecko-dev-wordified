...
/
#
translationRequestTelemetryThrottleTimeoutId
=
null
;
/
...
/
#
isManualCopyButtonResetEnabled
=
false
;
/
...
.
#
onSourceSectionClearButtonMouseDown
)
;
sourceSectionTextArea
.
...
.
#
maybeUpdateDetectedSourceLanguage
(
)
;
this
...
;
const
previouslyDetectedLanguageWasExplicitlySelected
=
sourceLanguageSelector
.
value
...
.
#
recordTopLevelMessageBarTelemetry
(
messageBar
)
;
...
.
#
getTopLevelMessageBarVisibilityEventNames
(
messageBar
)
;
...
async
#
maybeRecordTranslationRequestTelemetry
(
{
sourceLanguage
targetLanguage
...
async
#
ensureTranslatorMatchesSelectedLanguagePair
(
)
{
if
...
;
const
detectedLanguageUnsupportedHeight
=
detectedLanguageUnsupportedMessage
?
.
...
;
const
sourceSectionTextAreaHeightPixels
=
{
Math
.
...
;
const
targetSectionTextAreaHeightPixels
=
{
Math
.
...
async
function
ensureAboutTranslationsInitialized
(
)
{
if
