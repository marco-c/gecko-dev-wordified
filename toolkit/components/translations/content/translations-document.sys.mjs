...
/
#
queuedIntersectionPrunableContentElements
=
new
Map
(
...
/
#
queuedIntersectionPrunableAttributeElements
=
new
Map
(
...
/
#
elementsThatNeedContentUpdates
=
new
Set
(
...
/
#
elementsThatNeedAttributeUpdates
=
new
Set
(
...
/
#
hasPendingPrioritizationCallback
=
false
;
/
...
/
#
intersectionObservedContentElements
=
new
Map
(
...
/
#
intersectionObservedAttributeElements
=
new
Map
(
...
/
#
contentWithinViewportInitialObservation
=
Promise
.
withResolvers
...
/
#
contentBeyondViewportInitialObservation
=
Promise
.
withResolvers
...
/
#
attributesWithinViewportInitialObservation
=
Promise
.
withResolvers
...
/
#
attributesBeyondViewportInitialObservation
=
Promise
.
withResolvers
...
.
#
preventUnscheduledContentTranslations
(
target
)
;
...
.
#
maybePrioritizeRequestsAndSubmitToScheduler
(
)
;
}
...
.
#
enqueueForIntersectionPrunableContentPrioritization
(
target
)
;
...
.
#
preventUnscheduledAttributeTranslations
(
target
)
;
...
.
#
enqueueForIntersectionPrunableAttributePrioritization
(
target
)
;
...
.
#
waitForFirstIntersectionObservations
(
)
;
const
...
.
#
getPendingParentElementFromTarget
(
mutation
.
target
...
(
[
getObservableElementForContentTranslation
(
removedNode
)
getObservableElementForContentTranslation
...
.
#
removeFromContentIntersectionObservation
(
observableElement
targetNode
)
...
See
#
waitForFirstIntersectionObservation
for
an
explanation
why
...
/
const
firstIntersectionObservationsTimeout
=
Promise
.
withResolvers
...
.
#
maybeObserveElementForAttributePrioritization
(
element
attributes
)
...
*
#
maybePreventUnscheduledContentTranslation
function
.
*
*
...
*
#
maybePreventUnscheduledAttributeTranslations
function
.
*
*
...
/
#
maybeEnqueueForIntersectionExemptAttributePrioritization
(
element
)
{
...
.
#
enqueueForIntersectionExemptContentPrioritization
(
element
)
;
...
.
#
observeOrEnqueueNodeForContentPrioritization
(
currentNode
)
;
...
.
#
determineNodeContentUpdateEligibility
(
element
targetNode
translationId
...
the
#
maybePreventContentTranslation
function
should
be
used
...
the
#
maybePreventAttributeTranslations
*
function
should
be
...
the
#
unscheduledRequestsPriorityMap
.
*
*
type
...
use
the
maybePreventUnscheduledTranslation
method
.
*
*
...
.
#
maybeScheduleTranslationRequest
(
request
)
;
...
.
#
maybeAddProfilerMarkersForStacks
(
stackSizesAtStart
)
;
...
blob
/
bd6b453b7effa78b292812dbe218491624994526
/
src
/
css
