...
.
#
queueNodeForAttributeTranslation
(
node
attributes
)
...
;
const
childNodesWithTranslatableAttributes
=
element
.
querySelectorAll
...
this
.
scheduleNodeUpdateWithTranslation
(
node
translatedHTML
translationId
