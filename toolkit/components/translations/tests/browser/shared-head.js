...
rev
/
14f68f084d6a3bc438a3f973ed81d3a4dbab9629
/
toolkit
/
components
...
;
const
DOCUMENT_LANGUAGE_METADATA_LOAD_TIMEOUT_MS_PREF
=
"
dom
.
...
;
const
DOCUMENT_LANGUAGE_METADATA_RETRY_DELAY_BASE_MS_PREF
=
"
dom
.
...
async
function
waitForTranslationsLanguageState
(
browser
)
{
...
aboutTranslationsTestUtils
.
setManualCopyButtonResetEnabled
(
requireManualCopyButtonReset
)
;
...
aboutTranslationsTestUtils
.
clearCopyButtonResetDelayOverride
(
)
;
await
...
/
static
PolicyDisabledInfoMessageShown
=
"
AboutTranslationsTest
:
...
/
static
PolicyDisabledInfoMessageHidden
=
"
AboutTranslationsTest
:
...
/
static
LanguageLoadErrorMessageHidden
=
"
AboutTranslationsTest
:
...
/
async
setTranslationRequestTelemetryThrottleDelay
(
ms
)
{
...
.
TRANSLATION_REQUEST_TELEMETRY_THROTTLE_DELAY
=
ms
;
}
...
aboutTranslations
.
testSetCopyButtonResetDelayOverride
(
delayMs
)
;
...
aboutTranslations
.
testSetManualCopyButtonResetEnabled
(
enabled
)
;
