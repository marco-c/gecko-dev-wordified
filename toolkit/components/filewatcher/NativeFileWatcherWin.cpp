...
unsigned
int
WATCHED_RES_MAXIMUM_NOTIFICATIONS
=
100
;
/
...
static
PLDHashOperator
WatchedPathsInfoHashtableTraverser
(
nsVoidPtrHashKey
:
:
...
;
nsresult
AddDirectoryToWatchList
(
WatchedResourceDescriptor
*
aDirectoryDescriptor
)
;
void
