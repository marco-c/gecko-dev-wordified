...
;
uint16_t
uniffi_relevancy_checksum_method_relevancystore_calculate_metrics
(
)
;
uint16_t
...
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_echo_sequential_value
(
)
;
uint16_t
...
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_get_sequential_discriminant
(
)
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_echo_explicit_value
(
)
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_echo_gapped_value
(
)
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_get_explicit_discriminant
(
)
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_get_explicit_enum_values
(
)
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_get_gapped_discriminant
(
)
;
uint16_t
uniffi_uniffi_custom_types_checksum_func_get_gapped_enum_values
(
)
;
uint32_t
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncEchoSequentialValue
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncGetSequentialDiscriminant
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncEchoExplicitValue
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncEchoGappedValue
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncGetExplicitDiscriminant
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncGetExplicitEnumValues
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncGetGappedDiscriminant
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiCustomTypesFnFuncGetGappedEnumValues
:
public
UniffiSyncCallHandler
{
