...
;
uint16_t
uniffi_logins_checksum_method_loginstore_is_breach_alert_dismissed
(
)
;
uint16_t
...
;
uint16_t
uniffi_logins_checksum_method_loginstore_is_potentially_breached
(
)
;
uint16_t
...
;
uint16_t
uniffi_logins_checksum_method_loginstore_record_breach
(
)
;
uint16_t
...
;
uint16_t
uniffi_tracing_support_checksum_func_register_min_level_event_sink
(
)
;
uint16_t
...
;
uint16_t
uniffi_tracing_support_checksum_func_unregister_min_level_event_sink
(
)
;
RustBuffer
...
;
class
ScaffoldingCallHandlerUniffiLoginsFnMethodLoginstoreIsBreachAlertDismissed
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiLoginsFnMethodLoginstoreIsPotentiallyBreached
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiLoginsFnMethodLoginstoreRecordBreach
:
public
UniffiSyncCallHandler
{
