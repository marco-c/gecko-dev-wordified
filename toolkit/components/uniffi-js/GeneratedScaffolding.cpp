...
;
uint16_t
uniffi_logins_checksum_method_loginstore_get_checkpoint
(
)
;
uint16_t
...
;
uint16_t
uniffi_logins_checksum_method_loginstore_set_checkpoint
(
)
;
uint16_t
...
;
class
ScaffoldingCallHandlerUniffiLoginsFnMethodLoginstoreGetCheckpoint
:
public
UniffiSyncCallHandler
{
