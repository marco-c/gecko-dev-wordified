...
;
uint16_t
uniffi_uniffi_bindings_tests_checksum_func_async_callback_interface_call_get_value
(
)
;
uint16_t
uniffi_uniffi_bindings_tests_checksum_func_async_callback_interface_call_throw_error
(
)
;
uint16_t
...
;
uint16_t
uniffi_uniffi_bindings_tests_checksum_func_invoke_test_callback_interface_method
(
)
;
uint16_t
...
;
uint16_t
uniffi_uniffi_bindings_tests_checksum_method_testasynccallbackinterface_throw_error
(
)
;
uint16_t
...
MOZ_UNIFFI_FIXTURES
class
ScaffoldingCallHandlerUniffiUniffiBindingsTestsFnFuncAsyncCallbackInterfaceCallGetValue
:
public
...
;
class
ScaffoldingCallHandlerUniffiUniffiBindingsTestsFnFuncAsyncCallbackInterfaceCallThrowError
:
public
UniffiAsyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiUniffiBindingsTestsFnFuncInvokeTestCallbackInterfaceMethod
:
public
UniffiSyncCallHandler
{
