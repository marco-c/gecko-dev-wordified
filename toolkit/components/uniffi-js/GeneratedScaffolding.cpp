...
;
uint16_t
uniffi_autofill_checksum_method_addressesbridgedengine_prepare_for_sync
(
)
;
uint16_t
...
;
uint16_t
uniffi_autofill_checksum_method_addressesbridgedengine_set_last_sync
(
)
;
uint16_t
...
;
class
ScaffoldingCallHandlerUniffiAutofillFnMethodAddressesbridgedenginePrepareForSync
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiAutofillFnMethodAddressesbridgedengineSetLastSync
:
public
UniffiSyncCallHandler
{
...
;
class
ScaffoldingCallHandlerUniffiLoginsFnMethodLoginsbridgedengineSetLastSync
:
public
UniffiSyncCallHandler
{
