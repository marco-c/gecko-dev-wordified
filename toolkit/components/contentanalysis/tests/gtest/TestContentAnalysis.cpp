...
(
ContentAnalysisTest
CheckTwoRequestsHaveSameUserActionId
)
{
nsCOMPtr
<
...
(
ContentAnalysisTest
CheckNoCachedResultWhenDifferentText
)
{
nsCOMPtr
<
...
(
ContentAnalysisTest
CheckNoCachedResultWhenDifferentUrl
)
{
nsCOMPtr
<
...
(
ContentAnalysisTest
CheckNoCachedResultWhenFilePath
)
{
nsCOMPtr
<
