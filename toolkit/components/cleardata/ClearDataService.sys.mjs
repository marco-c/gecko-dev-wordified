...
.
const
CookieBannerExecutedRecordCleaner
=
{
async
deleteAll
...
/
async
_qmsClearStoragesForPrincipalsMatching
(
filterFn
)
{
...
_thirdPartyStoragePermissionMatchesHost
(
permissionType
aHost
)
...
;
const
BounceTrackingProtectionStateCleaner
=
{
async
deleteAll
