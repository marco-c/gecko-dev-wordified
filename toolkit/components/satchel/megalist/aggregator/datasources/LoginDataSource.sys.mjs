...
.
passwordOSAuthDialogCaption
ExportFilePickerTitle
:
strings
.
passwordsExportFilePickerTitle
FilePickerExportButton
:
strings
.
passwordsExportFilePickerExportButton
...
pwmgr
.
mgmtMenuItemUsedExportComplete
.
record
(
)
...
this
.
setPrimaryPasswordAuthenticated
(
true
)
;
