...
;
#
visibilityStateObserverByElement
=
new
WeakMap
(
...
*
*
fillOnFormChangeData
.
isWithinDynamicFormChangeThreshold
:
*
Flags
if
...
isVisiblityStateObserverSetUpByElement
(
element
)
{
...
setVisibilityStateObserverByElement
(
element
observer
)
...
clearVisibilityStateObserverByElement
(
element
)
{
