...
external
fun
uniffi_tabs_checksum_method_tabsbridgedengine_reset_last_sync
(
)
:
Short
...
external
fun
uniffi_tabs_checksum_method_tabsbridgedengine_set_clients
(
)
:
Short
...
external
fun
uniffi_tabs_checksum_method_tabsstore_set_local_tabs_info
(
)
:
Short
...
{
return
FfiConverterSequenceTypePendingCommand
.
lift
(
callWithHandle
...
(
it
FfiConverterTypePendingCommand
.
lower
(
command
...
{
return
FfiConverterSequenceTypeClientRemoteTabs
.
lift
(
callWithHandle
...
public
object
FfiConverterTypeClientRemoteTabs
:
FfiConverterRustBuffer
<
ClientRemoteTabs
...
FfiConverterMapStringTypeTabGroup
.
read
(
buf
)
FfiConverterMapStringTypeWindow
.
read
(
buf
...
public
object
FfiConverterTypeRemoteTabRecord
:
FfiConverterRustBuffer
<
RemoteTabRecord
