...
code
.
writePointerRemoteSettingsClient
(
value
)
{
...
code
.
writePointerRemoteSettingsService
(
value
)
{
...
=
>
FfiConverterTypeRemoteSettingsResponse
.
lift
(
result
...
try
{
FfiConverterTypeRemoteSettingsConfig2
.
checkType
(
config
...
try
{
FfiConverterOptionalTypeRsJsonObject
.
checkType
(
customTargetingAttributes
