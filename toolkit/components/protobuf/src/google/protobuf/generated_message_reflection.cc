...
NDEBUG
void
ReportReflectionUsageMessageError
(
const
Descriptor
*
...
#
define
USAGE_CHECK_EXPOSE_LEGACY_REPEATED_FIELD
(
intent
METHOD
)
...
void
MaybeInitializeLazyDescriptors
(
const
DescriptorTable
*
