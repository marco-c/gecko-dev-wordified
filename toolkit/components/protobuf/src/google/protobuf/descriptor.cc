...
#
ifdef
PROTOBUF_UNSAFE_DISABLE_MAX_FIELD_COUNT_CHECK
constexpr
int
...
>
bool
IsLegacyJsonFieldConflictEnabled
(
const
OptionsT
&
...
;
using
EnumValuesByNumberSetOffsetPtr
=
absl
:
:
...
:
string
SerializeToDeterministicString
(
const
Message
&
