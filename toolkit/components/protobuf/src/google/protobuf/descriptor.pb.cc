...
protoc_insertion_point
(
generalized_merge_from_cast_success
:
google
.
protobuf
...
from
.
_internal_has_source_code_info
(
)
)
{
...
ParseMessage
(
_internal_add_uninterpreted_option
(
)
ptr
)
...
from
.
_internal_has_java_outer_classname
(
)
)
{
...
from
.
_internal_has_objc_class_prefix
(
)
)
{
...
from
.
_internal_has_csharp_namespace
(
)
)
{
...
from
.
_internal_has_php_class_prefix
(
)
)
{
...
from
.
_internal_has_php_metadata_namespace
(
)
)
{
...
str
=
_internal_mutable_java_package
(
)
;
ptr
...
str
=
_internal_mutable_java_outer_classname
(
)
;
ptr
...
str
=
_internal_mutable_objc_class_prefix
(
)
;
ptr
...
str
=
_internal_mutable_csharp_namespace
(
)
;
ptr
...
str
=
_internal_mutable_swift_prefix
(
)
;
ptr
...
str
=
_internal_mutable_php_class_prefix
(
)
;
ptr
...
str
=
_internal_mutable_php_namespace
(
)
;
ptr
...
str
=
_internal_mutable_php_metadata_namespace
(
)
;
ptr
...
str
=
_internal_mutable_ruby_package
(
)
;
ptr
...
-
>
_internal_php_generic_services
(
)
target
)
...
from
.
_internal_has_deprecated
(
)
)
{
_internal_set_deprecated
(
from
.
_internal_deprecated
...
{
_internal_set_idempotency_level
(
static_cast
<
PROTOBUF_NAMESPACE_ID
...
protoc_insertion_point
(
required_fields_byte_size_fallback_start
:
google
.
protobuf
...
from
.
_internal_has_identifier_value
(
)
)
{
...
str
=
_internal_mutable_identifier_value
(
)
;
ptr
...
from
.
_internal_has_leading_comments
(
)
)
{
...
from
.
_internal_has_trailing_comments
(
)
)
{
...
str
=
_internal_add_leading_detached_comments
(
)
;
ptr
