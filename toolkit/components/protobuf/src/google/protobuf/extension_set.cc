...
{
InternalReserveSmallCapacityFromEmpty
(
arena
flat_size_
)
...
defined
(
PROTOBUF_INTERNAL_DIRECT_LAZY_FIELD_IN_EXTENSION_SET
)
LazyField
*
ExtensionSet
