...
#
ifndef
PROTOBUF_google_2fprotobuf_2fstruct_2eproto__INCLUDED
#
define
PROTOBUF_google_2fprotobuf_2fstruct_2eproto__INCLUDED
#
...
:
void
_slow_mutable_struct_value
(
)
;
void
_slow_set_allocated_struct_value
(
:
:
google
...
:
void
_slow_mutable_list_value
(
)
;
void
_slow_set_allocated_list_value
(
:
:
google
