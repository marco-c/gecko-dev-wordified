...
:
uintptr_t
ResolveRedirectedAddressForTest
(
FARPROC
aFunc
)
...
volatile
bool
sCouldUnwindFromDetouredCallCallee
=
false
;
void
...
s
:
expectCalledPatchedDetouredCall
(
%
d
)
