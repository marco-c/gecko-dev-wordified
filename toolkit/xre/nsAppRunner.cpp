...
glean
/
ToolkitMozappsUpdateSharedMetrics
.
h
"
#
...
:
:
GetSessionStorePlatformCollection
(
bool
*
aResult
...
:
:
toolkit_crash_annotation_testing_validation
(
)
)
{
...
:
:
browser_startup_preXulSkeletonUI
(
)
;
bool
startupBlankWindowPref
=
StaticPrefs
:
:
browser_startup_blankWindow
(
)
;
bool
...
static
nsresult
ProfileEncryptionMismatchDialog
(
const
char
*
...
/
/
MOZ_WAYLAND_PROTOCOL_ERROR_DETAILS
=
0
turns
capture
...
(
"
MOZ_TEST_SHOULD_NOT_PROCESS_UPDATES
"
)
)
{
...
{
return
NS_ERROR_OMNIJAR_OR_DIR_MISSING
;
}
}
#
