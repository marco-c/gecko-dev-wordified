...
;
void
Gecko_NoteAnimationOnlyDirtyDescendants
(
RawGeckoElementBorrowed
element
)
...
;
void
Gecko_CSSCounterStyle_GetCssText
(
const
nsCSSCounterStyleRule
*
