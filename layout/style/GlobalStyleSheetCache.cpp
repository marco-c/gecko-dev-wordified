...
:
:
GetPrefName_browser_display_show_focus_rings
(
)
StaticPrefs
:
:
GetPrefName_browser_display_focus_ring_style
(
)
StaticPrefs
:
...
:
:
GetPrefName_browser_display_focus_ring_on_anything
(
)
StaticPrefs
:
:
GetPrefName_browser_display_use_focus_colors
(
)
StaticPrefs
:
:
GetPrefName_browser_underline_anchors
(
)
}
;
