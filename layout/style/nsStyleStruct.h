...
;
see
DependsOnDependsOnPositioningAreaSizeSize
.
enum
DimensionType
{
...
/
/
NS_STYLE_TEXT_DECORATION_LINE_
*
uint8_t
...
/
/
NS_STYLE_TEXT_EMPHASIS_POSITION_
*
uint8_t
mTextEmphasisStyle
;
...
/
/
NS_STYLE_CONTEXT_PROPERTY_FILL_
*
values
/
/
