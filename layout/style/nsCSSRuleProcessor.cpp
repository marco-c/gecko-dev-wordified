...
:
:
ePseudoClass_mozLWThemeBrightText
:
{
if
(
...
:
:
ePseudoClass_mozLWThemeDarkText
:
{
if
(
...
:
:
ePseudoClass_mozWindowInactive
:
if
(
!
...
:
:
ePseudoClass_mozTableBorderNonzero
:
{
if
(
