...
def
gen_position_try_descriptors_webidl
(
output
)
:
...
deps
def
gen_counted_unknown_properties
(
output
prop_file
)
...
deps
def
gen_compositor_animatable_properties
(
output
)
:
...
deps
def
gen_non_custom_css_property_id
(
output
template
)
