...
flattening
.
MayContainNonIsolated3DTransform
=
1
<
<
...
StackingContextBits
GetStackingContextBits
(
)
const
{
return
mStackingContextBits
;
}
void
SetStackingContextBits
(
StackingContextBits
aBits
)
...
*
>
GetBaseASRForAncestorOfContainedASR
(
)
const
{
...
;
class
nsDisplayViewTransitionCapture
final
:
public
nsDisplayOwnLayer
