...
nsIFragmentContentSink
NS_NewXHTMLParanoidFragmentSink2
)
MAKE_CTOR
(
...
NS_DEFINE_NAMED_CID
(
NS_ICONTENTUTILS_MOZILLA_2_0_BRANCH_CID
)
;
#
endif
...
{
&
kNS_HTMLPARANOIDFRAGMENTSINK_CID
false
NULL
CreateHTMLParanoidFragmentSink
}
{
&
kNS_HTMLPARANOIDFRAGMENTSINK2_CID
false
NULL
CreateHTMLParanoidFragmentSink2
}
{
&
kMOZ_SANITIZINGHTMLSERIALIZER_CID
false
NULL
CreateSanitizingHTMLSerializer
}
...
{
&
kNS_XHTMLPARANOIDFRAGMENTSINK_CID
false
NULL
CreateXHTMLParanoidFragmentSink
}
{
&
kNS_XHTMLPARANOIDFRAGMENTSINK2_CID
false
NULL
CreateXHTMLParanoidFragmentSink2
}
...
{
&
kTRANSFORMIIX_XPATH1_SCHEME_CID
false
NULL
...
{
&
kNS_FILEDATAPROTOCOLHANDLER_CID
false
NULL
...
{
&
kNS_ICONTENTUTILS_MOZILLA_2_0_BRANCH_CID
false
NULL
nsIContentUtils_MOZILLA_2_0_BRANCHConstructor
}
#
endif
{
...
{
&
kNS_WORKERFACTORY_CID
false
NULL
nsWorkerFactoryConstructor
}
{
NULL
}
