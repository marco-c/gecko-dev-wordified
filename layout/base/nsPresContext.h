...
nsMargin
&
EmbedderScrollbarInset
(
)
const
{
return
mEmbedderScrollbarInset
;
}
void
SetEmbedderScrollbarInset
(
const
nsMargin
&
...
bool
NeedsToUpdateHiddenByContentVisibilityForAnimations
(
)
const
{
...
{
return
mAnimationsPlayBackRateMultiplier
;
}
protected
:
