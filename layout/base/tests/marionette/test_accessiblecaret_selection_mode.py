...
def
test_long_press_to_select_a_word
(
self
el_id
)
...
def
test_minimum_select_one_character
(
self
el_id
)
...
def
test_minimum_select_one_character2
(
self
el_id
)
...
def
test_long_press_changes_focus_from
(
self
el1_id
el2_id
...
def
test_focus_not_changed_by_long_press_on_non_selectable
(
self
el_id
)
...
def
test_handle_tilt_when_carets_overlap_each_other
(
self
el_id
)
...
def
test_drag_swappable_caret_over_non_selectable_field
(
self
)
:
...
def
test_select_word_inside_an_unfocused_iframe
(
self
)
:
...
def
test_carets_initialized_in_display_none
(
self
)
:
...
def
test_carets_should_not_appear_when_long_pressing_svg_shapes
(
self
)
:
...
def
test_select_word_scroll_then_drag_caret
(
self
)
:
...
def
test_carets_not_show_after_key_scroll_down_and_up
(
self
)
:
