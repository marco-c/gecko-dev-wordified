...
def
_test_focus_not_being_changed_by_long_press_on_non_selectable
(
self
el
)
...
def
test_input_focus_not_changed_by_long_press_on_non_selectable
(
self
)
:
...
def
test_textarea_focus_not_changed_by_long_press_on_non_selectable
(
self
)
:
...
def
test_textarea_rtl_focus_not_changed_by_long_press_on_non_selectable
(
self
)
:
...
def
test_contenteditable_focus_not_changed_by_long_press_on_non_selectable
(
self
)
:
