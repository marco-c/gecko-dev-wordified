...
def
_test_move_caret_to_front_by_dragging_touch_caret_to_top_left_corner
(
self
el
assertFunc
...
def
_test_scroll_by_dragging_touch_caret_to_bottom_right_corner
(
self
el
assertFunc
...
def
test_input_scroll_by_dragging_touch_caret_to_bottom_right_corner
(
self
)
:
...
def
test_textarea_scroll_by_dragging_touch_caret_to_bottom_right_corner
(
self
)
:
...
def
test_contenteditable_scroll_by_dragging_touch_caret_to_bottom_right_corner
(
self
)
:
