...
mEscapeKeyDownCountForFullscreenKeyboardLockWarning
(
0
)
{
...
aFrameSelection
CanMoveLastSelectionForToString
aCanMoveLastSelectionForToString
)
{
if
(
...
static
ScrollMode
GetScrollModeForScrollIntoView
(
const
ScrollContainerFrame
*
...
:
:
layout_scroll_fixed_content_into_view_visually
(
)
)
{
...
mApproximatelyVisibleFrames
in
RebuildFrameVisibilityDisplayList
to
see
/
/
...
const
auto
ClearMouseLocationIfSetByTouch
=
[
&
]
...
auto
cleanUpPointerCapturingElementAtLastPointerUp
=
MakeScopeExit
(
[
...
-
>
ShouldShowFullscreenKeyboardLockWarning
(
*
aKeyboardEvent
)
...
:
:
AnchorPosUpdateResult
PresShell
:
:
UpdateAnchorPosLayout
(
)
{
if
...
const
bool
escapeKeyDownWithinWarnInterval
=
previousEscapeKeyDownTime
&
&
