...
(
ThebesLayerInvalidRegionProperty
DestroyRefCountedRegion
)
static
void
...
NS_DECLARE_FRAME_PROPERTY
(
ThebesLayerLastPaintOffsetProperty
DestroyPoint
)
/
*
...
ThebesDisplayItemLayerUserData
*
GetThebesDisplayItemLayerUserData
(
Layer
*
aLayer
...
static
bool
sPaintFlashingEnabled
;
static
bool
sPaintFlashingPrefCached
=
false
;
if
...
:
:
GetDisplayItemDataArrayForFrame
(
nsIFrame
*
aFrame
...
nsDisplayTransform
*
FindTransformForContainerFrame
(
nsIFrame
*
aContainerFrame
