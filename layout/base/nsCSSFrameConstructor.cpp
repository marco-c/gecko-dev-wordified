...
and
calls
DoCleanupFrameReference
(
)
static
void
CleanupFrameReferences
(
nsFrameManager
*
aFrameManager
...
mInitialContainingBlockIsAbsPosContainer
(
PR_FALSE
)
...
SetViewFlags
(
NS_VIEW_PUBLIC_FLAG_DONT_CHECK_CHILDREN
)
;
/
/
...
PRBool
&
aHasRequiredExtensions
PRBool
&
aHasRequiredFeatures
PRBool
&
aHasSystemLanguage
)
