...
return
GetNearestScrollContainerFrameToScrollTowards
(
aFrame
sides
)
...
;
return
ScaleThenRoundGfxRectToAppRect
(
result
aAncestor
.
...
:
:
browser_display_auto_quality_min_font_size
(
)
)
)
...
:
:
GetPrefName_general_smoothScroll
(
)
!
LookAndFeel
...
nsIContent
*
GetOriginatingElementForScrollbarPart
(
const
nsIFrame
*
...
FramePosition
>
GetFrameRectVisibleRectOnScreen
(
const
nsIFrame
*
