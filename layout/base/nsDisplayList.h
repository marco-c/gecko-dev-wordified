...
nsIFrame
*
GetCurrentScrollParent
(
)
{
return
mCurrentScrollParent
;
}
/
*
...
/
nsRect
GetDisplayPortConsideringAncestors
(
)
{
return
...
/
nsRect
GetScrollPortConsideringAncestors
(
)
{
return
...
nsIFrame
*
GetPrevAnimatedGeometryRoot
(
)
const
{
return
mPrevAnimatedGeometryRoot
;
}
bool
IsAnimatedGeometryRoot
...
*
If
aNewScrollParentFrom
is
SCROLLFRAMES_ON_PATH_TO_ROOT
aFrame
is
*
interpreted
...
;
nsRect
mOldDisplayPortConsideringAncestors
;
nsRect
mOldScrollPortConsideringAncestors
;
ViewID
mOldScrollParentId
;
...
DisplayItemClip
*
aContainingBlockClip
const
DisplayItemScrollClip
*
aContainingBlockScrollClip
const
nsRect
&
aDirtyRect
nsIFrame
*
aCurrentScrollParent
ViewID
aCurrentScrollParentId
const
nsRect
&
aDisplayPortConsideringAncestors
const
nsRect
&
aScrollPortConsideringAncestors
)
:
...
/
void
UpdateCurrentScrollParentForOutOfFlow
(
const
OutOfFlowDisplayData
*
...
;
void
SetParticipatesInPreserve3D
(
bool
aParticipatesInPreserve3D
)
{
mParticipatesInPreserve3D
=
aParticipatesInPreserve3D
;
}
