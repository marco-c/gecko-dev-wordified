...
virtual
nsRect
GetScreenRectInAppUnitsExternal
(
)
const
;
...
of
*
BeginDeferringInvalidatesForDisplayRoot
for
a
frame
must
...
=
0x80
INVALIDATE_ALREADY_TRANSFORMED
=
0x100
}
;
