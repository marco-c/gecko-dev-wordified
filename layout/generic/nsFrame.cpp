...
*
*
GetContentToCaptureForSelection
(
)
returns
a
...
*
*
GetSelectionRootContentForCapturingContent
(
)
returns
a
...
*
*
FindNearestScrollableFrameForSelection
(
)
returns
the
...
nsIContent
*
selectionRootOfCapturedContent
=
capturingContent
-
>
...
nsIContent
*
contentToCaptureForTableSelection
=
GetContentToCaptureForSelection
(
frame
...
nsFrameSelection
*
selectionFrameForSelectingByMouse
=
GetFrameSelectionForSelectingByMouse
(
)
...
static
void
InvalidateRectForFrameSizeChange
(
nsIFrame
*
aFrame
