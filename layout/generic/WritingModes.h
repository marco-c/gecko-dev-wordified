...
ignores
the
StyleWritingMode_VERTICAL_SIDEWAYS
and
/
/
...
mWritingMode
&
StyleWritingMode_INLINE_REVERSED
)
;
}
/
...
mWritingMode
&
StyleWritingMode_LINE_INVERTED
)
;
}
/
