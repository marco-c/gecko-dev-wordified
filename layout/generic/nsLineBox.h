...
/
/
mTextBoxTrimStartApplied
bit
void
SetTextBoxTrimStartApplied
(
)
{
mFlags
...
/
/
mTextBoxTrimEndApplied
bit
void
SetTextBoxTrimEndApplied
(
)
{
mFlags
