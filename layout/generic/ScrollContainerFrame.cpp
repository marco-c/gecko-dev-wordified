...
:
:
mousewheel_line_scroll_amount_use_line_height
(
)
?
ReflowInput
...
{
bool
isInScrollbarButtonClickAndHold
=
(
mVScrollbarBox
?
...
:
:
layout_css_fake_webkit_scrollbar_enabled
(
)
)
{
...
auto
PrefGatedScrollbarWidth
=
[
]
(
StyleScrollbarWidth
aComputedScrollbarWidth
)
{
if
(
...
:
:
layout_css_scroll_behavior_same_physics_as_user_input
(
)
?
ScrollMode
