...
.
auto
BorderBoxRectRelativeToInlineFrame
=
[
&
]
...
:
:
ReflowAbsoluteDescendantsInInlineFrame
(
nsPresContext
*
aPresContext
...
=
ReflowAbsoluteFramesInInlineFrame
(
inlineFrame
aPresContext
aReflowInput
...
static
bool
IsInlineFrameCompleteInCurrentFragmentainer
(
const
nsBlockFrame
*
...
static
bool
RestrictPaddingInflationInInline
(
const
nsIFrame
*
...
const
bool
considerPositiveMarginsForInFlowChildBounds
=
isScrolled
&
&
...
static
bool
IsFirstNonEmptyColumnSetOrSpanner
(
nsIFrame
*
aFrame
...
static
bool
IsLastNonEmptyColumnSetOrSpanner
(
nsIFrame
*
aFrame
...
const
nscoord
potentialTrimEndAmount
=
aLineLayout
.
PotentialTextBoxTrimEndAmount
(
)
;
const
bool
doesLineFitWithTrimEnd
=
newBCoord
-
potentialTrimEndAmount
...
static
void
WalkInlineDescendantsToDisplayAbsoluteFrames
(
nsDisplayListBuilder
*
aBuilder
...
static
void
DisplayAbsoluteDescendantsInInlineFrame
(
nsDisplayListBuilder
*
aBuilder
...
:
:
layout_css_webkit_line_clamp_skip_paint
(
)
)
{
...
;
DisplayAbsoluteFramesNotBuiltByPlaceholder
(
aBuilder
aLists
)
