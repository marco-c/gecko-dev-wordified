...
{
case
NS_BLOCK_FRAME_FLOAT_LIST_INDEX
:
return
nsGkAtoms
:
...
;
case
NS_BLOCK_FRAME_BULLET_LIST_INDEX
:
return
nsGkAtoms
:
...
;
case
NS_BLOCK_FRAME_OVERFLOW_LIST_INDEX
:
return
nsGkAtoms
:
...
;
case
NS_BLOCK_FRAME_OVERFLOW_OOF_LIST_INDEX
:
return
nsGkAtoms
:
...
if
(
VERIFY_REFLOW_INCLUDE_SPACE_MANAGER
&
verifyReflowFlags
)
{
...
if
(
HandleOverflowPlaceholdersOnPulledLine
(
aState
nifLine
)
...
if
(
IBMBIDI_CONTROLSTEXTMODE_LOGICAL
!
=
GET_BIDI_OPTION_CONTROLSTEXTMODE
(
options
)
)
