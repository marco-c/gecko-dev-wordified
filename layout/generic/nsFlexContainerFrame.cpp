...
static
nscoord
PhysicalPosFromLogicalPos
(
nscoord
aLogicalPosn
nscoord
aLogicalContainerSize
AxisOrientationType
aAxis
)
{
...
;
float
GetShareOfFlexWeightSoFar
(
)
const
{
return
mShareOfFlexWeightSoFar
;
}
bool
IsFrozen
...
below
bool
FrameWantsToBeInAnonymousFlexItem
(
nsIFrame
*
aFrame
...
.
nscoord
firstLineBaselineOffsetWRTContainer
=
firstLineBaselineOffset
+
crossAxisPosnTracker
