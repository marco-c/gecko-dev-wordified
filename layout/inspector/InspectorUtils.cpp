...
{
case
StyleMatchingDeclarationBlockOrigin
:
:
Author
:
...
{
Servo_Property_GetCSSWideKeywords
(
&
aResult
)
...
exact
=
Servo_SlowRgbToNearestColorName
(
aR
aG
aB
...
|
!
Servo_PseudoStyleType_EnabledForAllContent
(
type
)
)
...
:
:
GetComputationStepsSupportedCSSFunctions
(
GlobalObject
&
aGlobalObject
...
{
Servo_GetComputationStepsSupportedCSSFunctions
(
&
aResult
)
