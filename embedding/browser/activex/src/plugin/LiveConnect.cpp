...
/
/
unuse_java_lang_String
(
env
)
;
unuse_java_lang_Number
(
env
)
;
...
/
/
unuse_java_lang_Double
(
env
)
;
unuse_java_lang_Character
(
env
)
;
...
/
/
use_java_lang_String
(
env
)
;
use_java_lang_Number
(
env
)
;
...
/
/
use_java_lang_Double
(
env
)
;
use_java_lang_Character
(
env
)
;
...
netscape_plugin_Plugin_getPeer
(
env
reinterpret_cast
<
...
native_MozAxPlugin_xsetProperty2
(
JRIEnv
*
env
...
native_MozAxPlugin_xsetProperty1
(
JRIEnv
*
env
...
native_java_lang_Throwable_printStackTrace0
(
JRIEnv
*
env
...
native_java_lang_Throwable_fillInStackTrace
(
JRIEnv
*
env
