...
#
define
HAVE_LARGEST_CONTIGUOUS_BLOCK_REPORTERS
1
static
nsresult
...
:
:
GetJSMainRuntimeCompartmentsSystem
(
int64_t
*
aAmount
...
:
:
GetJSMainRuntimeCompartmentsUser
(
int64_t
*
aAmount
