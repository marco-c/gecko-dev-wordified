...
/
/
TraceNativeGrayRootsInCollectingZones
using
an
additional
color
...
which
=
JSHoldersRequiredForGrayMarking
;
}
return
self
...
(
global
eUseCounter_custom_JS_large_oom_recovered
)
;
break
;
...
(
global
eUseCounter_custom_JS_small_oom_recovered
)
;
break
;
...
(
global
eUseCounter_custom_JS_large_oom_reported
)
;
break
;
...
(
global
eUseCounter_custom_JS_small_oom_reported
)
;
break
;
