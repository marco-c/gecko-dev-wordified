...
(
sAppleMenuDirectory
NS_MAC_APPLE_MENU_DIR
)
DIR_ATOM
(
sControlPanelDirectory
NS_MAC_CONTROL_PANELS_DIR
)
DIR_ATOM
(
sExtensionDirectory
NS_MAC_EXTENSIONS_DIR
)
DIR_ATOM
(
sFontsDirectory
...
(
sDocumentsDirectory
NS_MAC_DOCUMENTS_DIR
)
DIR_ATOM
(
sInternetSearchDirectory
NS_MAC_INTERNET_SEARCH_DIR
)
DIR_ATOM
(
sUserLibDirectory
...
NS_OSX_LOCAL_DESKTOP_DIR
)
DIR_ATOM
(
sUserApplicationsDirectory
NS_OSX_USER_APPLICATIONS_DIR
)
DIR_ATOM
(
...
NS_OSX_USER_DOCUMENTS_DIR
)
DIR_ATOM
(
sLocalDocumentsDirectory
NS_OSX_LOCAL_DOCUMENTS_DIR
)
DIR_ATOM
(
sUserInternetPlugInDirectory
NS_OSX_USER_INTERNET_PLUGIN_DIR
)
DIR_ATOM
(
sLocalInternetPlugInDirectory
NS_OSX_LOCAL_INTERNET_PLUGIN_DIR
)
DIR_ATOM
(
sUserFrameworksDirectory
NS_OSX_USER_FRAMEWORKS_DIR
)
DIR_ATOM
(
...
(
sBitbucket
NS_WIN_BITBUCKET_DIR
)
DIR_ATOM
(
sStartmenu
NS_WIN_STARTMENU_DIR
)
DIR_ATOM
(
sDesktopdirectory
NS_WIN_DESKTOP_DIRECTORY
)
DIR_ATOM
(
sDrives
...
(
sCommon_Programs
NS_WIN_COMMON_PROGRAMS_DIR
)
DIR_ATOM
(
sCommon_Startup
NS_WIN_COMMON_STARTUP_DIR
)
DIR_ATOM
(
sCommon_Desktopdirectory
NS_WIN_COMMON_DESKTOP_DIRECTORY
)
DIR_ATOM
(
sCommon_AppData
...
(
sXDGPublicShare
NS_UNIX_XDG_PUBLIC_SHARE_DIR
)
DIR_ATOM
(
sXDGTemplates
NS_UNIX_XDG_TEMPLATES_DIR
)
DIR_ATOM
(
sXDGVideos
