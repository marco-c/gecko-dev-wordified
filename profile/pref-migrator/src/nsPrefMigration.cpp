...
:
:
ConvertPersistentStringToFileSpec
(
const
char
*
...
#
ifdef
NEED_TO_COPY_AND_RENAME_NEWSRC_FILES
/
*
in
4
...
rv
=
RenameAndMove4xImapFilterFiles
(
profilePath
)
;
