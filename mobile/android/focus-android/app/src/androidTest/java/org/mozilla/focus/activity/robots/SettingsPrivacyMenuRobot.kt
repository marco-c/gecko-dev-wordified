...
assertTrue
(
block3rdPartyTrackerCookiesOnlyOption
.
waitForExists
(
waitingTimeShort
...
string
.
preference_safe_browsing_summary
)
)
)
privacySettingsList
...
string
.
preference_block_cookies_title
)
)
)
private
...
string
.
preference_privacy_should_block_cookies_no_option2
)
)
)
private
