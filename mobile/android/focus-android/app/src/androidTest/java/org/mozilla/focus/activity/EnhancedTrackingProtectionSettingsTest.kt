...
class
EnhancedTrackingProtectionSettingsTest
:
TestSetup
(
)
...
Test
fun
trackingProtectionTogglesListTest
(
)
{
homeScreen
...
verifyBlockAnalyticTrackersEnabled
(
true
)
verifyBlockSocialTrackersEnabled
(
true
)
