...
/
class
CookieBannerReducerDetailsPanel
(
context
:
Context
...
private
val
defaultCookieBannerInteractor
:
DefaultCookieBannerReducerInteractor
)
:
BottomSheetDialog
(
...
defaultCookieBannerInteractor
.
handleToggleCookieBannerException
(
isChecked
)
updateViews
...
string
.
cookie_banner_exception_panel_switch_state_on
)
updateSwitchItem
(
)
