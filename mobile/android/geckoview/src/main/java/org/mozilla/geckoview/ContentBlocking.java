...
(
final
CBCBounceTrackingProtectionMode
int
mode
)
{
...
.
setSafeBrowsingRealTimeEnabled
(
enabled
)
;
...
.
setSafeBrowsingRealTimeSimulationEnabled
(
enabled
)
;
...
.
setSafeBrowsingRealTimeSimulationHitProbability
(
hitProbability
)
;
...
.
setSafeBrowsingRealTimeSimulationCacheTTLSec
(
cacheTTLSec
)
;
...
.
setSafeBrowsingRealTimeSimulationNegativeCacheEnabled
(
enabled
)
;
...
.
setSafeBrowsingRealTimeSimulationNegativeCacheTTLSec
(
negativeCacheTTLSec
)
;
...
Integer
>
mSbRealTimeSimulationHitProbability
=
new
Pref
<
...
Integer
>
mSbRealTimeSimulationCacheTTLSec
=
new
Pref
<
...
Boolean
>
mSbRealTimeSimulationNegativeCacheEnabled
=
new
Pref
<
...
Integer
>
mSbRealTimeSimulationNegativeCacheTTLSec
=
new
Pref
<
...
Boolean
>
mAllowListBaselineTrackingProtection
=
new
Pref
<
...
Boolean
>
mAllowListConvenienceTrackingProtection
=
new
Pref
<
...
public
boolean
getSafeBrowsingGlobalCacheEnabled
(
)
{
return
...
public
boolean
getSafeBrowsingRealTimeEnabled
(
)
{
return
...
public
boolean
getSafeBrowsingRealTimeSimulationEnabled
(
)
{
return
...
public
int
getSafeBrowsingRealTimeSimulationHitProbability
(
)
{
return
...
public
int
getSafeBrowsingRealTimeSimulationCacheTTLSec
(
)
{
return
...
public
int
getSafeBrowsingRealTimeSimulationNegativeCacheTTLSec
(
)
{
return
...
{
return
mapToBounceTrackingProtectionMode
(
mBounceTrackingProtectionMode
.
get
...
public
boolean
getContentBlockingDatabaseStatus
(
)
{
return
