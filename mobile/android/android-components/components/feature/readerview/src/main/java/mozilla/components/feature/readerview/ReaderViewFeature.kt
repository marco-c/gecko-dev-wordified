...
(
engineSession
ActiveReaderViewContentMessageHandler
(
store
session
.
...
(
engineSession
ReaderViewContentMessageHandler
(
store
session
.
...
optBoolean
(
READERABLE_RESPONSE_MESSAGE_KEY
false
)
store
.
...
getString
(
ACTIVE_URL_RESPONSE_MESSAGE_KEY
)
store
.
dispatch
