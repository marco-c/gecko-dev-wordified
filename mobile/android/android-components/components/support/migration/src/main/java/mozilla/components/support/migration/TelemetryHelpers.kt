...
PINNED_SITES_READ_FAILURE
(
35
)
GECKO_FAILED_TO_DELETE_PREFS
(
36
)
GECKO_FAILED_TO_WRITE_BACKUP
(
37
)
GECKO_FAILED_TO_WRITE_PREFS
(
38
)
FXA_MIGRATE_EXCEPTION
(
39
)
TELEMETRY_IDENTIFIERS_PARSE_SET_EXCEPTION
(
40
)
PINNED_SITES_EXCEPTION
(
41
)
}
...
TELEMETRY_IDENTIFIERS_MIGRATED
(
16
)
FXA_WILL_RETRY
...
PINNED_SITES_MIGRATED
(
20
)
GECKO_MIGRATED_NO_PREFS_JS_FILE
(
21
)
GECKO_MIGRATED_PREFS_REMOVED_NO_PREFS
(
22
)
GECKO_MIGRATED_PREFS_REMOVED_INVALID_PREFS
(
23
)
GECKO_MIGRATED_PREFS_JS_MIGRATED
(
24
)
}
