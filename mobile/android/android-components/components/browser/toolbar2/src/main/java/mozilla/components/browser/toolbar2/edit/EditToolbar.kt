...
id
.
mozac_browser_toolbar_edit_actions_start
)
editActionsEnd
=
rootView
...
id
.
mozac_browser_toolbar_edit_actions_end
)
clear
=
rootView
...
id
.
mozac_browser_toolbar_erase_view
)
.
apply
{
...
dimen
.
mozac_browser_toolbar_url_gone_margin_end
)
)
...
id
.
mozac_browser_action_separator
)
)
/
*
...
id
.
mozac_browser_toolbar_container
)
set
.
clone
