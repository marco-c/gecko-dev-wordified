...
styleable
.
BrowserToolbar_browserToolbarProgressBarGravity
BOTTOM_PROGRESS_BAR
)
hintColor
=
...
styleable
.
BrowserToolbar_browserToolbarHintColor
hintColor
)
textColor
=
...
styleable
.
BrowserToolbar_browserToolbarTextColor
textColor
)
textSize
=
...
styleable
.
BrowserToolbar_browserToolbarTrackingProtectionAndSecurityIndicatorSeparatorColor
displayToolbar
.
separatorColor
)
...
styleable
.
BrowserToolbar_browserToolbarSuggestionForegroundColor
)
!
=
null
...
styleable
.
BrowserToolbar_browserToolbarSuggestionBackgroundColor
suggestionBackgroundColor
)
val
inSecureIcon
...
styleable
.
BrowserToolbar_browserToolbarInsecureIcon
)
?
:
displayToolbar
...
styleable
.
BrowserToolbar_browserToolbarSecureIcon
)
?
:
displayToolbar
...
styleable
.
BrowserToolbar_browserToolbarInsecureColor
displayToolbar
.
defaultColor
)
...
styleable
.
BrowserToolbar_browserToolbarFadingEdgeSize
resources
.
getDimensionPixelSize
(
