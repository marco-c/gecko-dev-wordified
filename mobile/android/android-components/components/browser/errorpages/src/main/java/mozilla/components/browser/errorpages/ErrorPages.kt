...
string
.
mozac_browser_errorpages_archive_checking
)
.
urlEncode
(
...
string
.
mozac_browser_errorpages_archive_not_found
)
.
urlEncode
(
...
string
.
mozac_browser_errorpages_archive_search_web
)
.
urlEncode
(
...
string
.
mozac_browser_errorpages_archive_unreachable
)
.
urlEncode
(
...
string
.
mozac_browser_errorpages_archive_retry
)
.
urlEncode
(
...
string
.
mozac_browser_errorpages_no_internet_message_2
R
.
string
.
...
string
.
mozac_error_no_internet_connection
errorCode
=
R
.
string
.
mozac_browser_errorpages_no_internet_error_code
)
ERROR_MALFORMED_URI
(
R
...
string
.
mozac_browser_errorpages_harmful_addon_uri_title
R
.
string
.
mozac_browser_errorpages_harmful_addon_uri_message
)
ERROR_HTTPS_ONLY
(
R
