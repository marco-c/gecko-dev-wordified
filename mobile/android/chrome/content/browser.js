...
selectedTab
.
clearReflowOnZoomPendingActions
(
)
;
}
...
;
const
kFormHelperModeDisabled
=
0
;
const
kFormHelperModeEnabled
=
1
;
const
kFormHelperModeDynamic
=
2
;
/
...
SearchEngines
.
migrateSearchActivityDefaultPref
(
)
;
}
...
compositor
.
isBrowserContentDocumentDisplayed
:
function
(
)
...
:
function
linkOpenableNonPrivateContextMatches
(
aElement
)
{
...
:
function
linkBookmarkableContextMatches
(
aElement
)
{
...
:
function
imageLinkCopyableContextMatches
(
aElement
)
{
...
*
/
_getHTMLContextMenuItemsForElement
:
function
(
element
...
this
.
_getHTMLContextMenuItemsForMenu
(
htmlMenu
element
)
...
mochitest
:
test_browserElement_inproc_ContextmenuEvents
.
html
.
if
...
_getRequestLoadContext
:
function
ua_getRequestLoadContext
(
aRequest
)
{
...
this
.
viewportExcludesHorizontalMargins
=
true
;
this
.
viewportExcludesVerticalMargins
=
true
;
this
...
this
.
lastPageSizeAfterViewportRemeasure
=
{
width
:
...
{
let
viewportShouldExcludeHorizontalMargins
=
(
pageWidth
<
...
{
let
viewportShouldExcludeVerticalMargins
=
(
pageHeight
<
...
engine
.
PREF_SEARCH_ACTIVITY_ENGINE_KEY
:
"
search
.
...
only
.
_handleSearchEnginesGetVisible
:
function
_handleSearchEnginesGetVisible
(
