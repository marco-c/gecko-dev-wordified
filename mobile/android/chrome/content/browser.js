...
come
from
pref_tracking_protection_entries
in
arrays
.
xml
...
2
"
PREF_TRACKING_PROTECTION_ENABLED_PB
:
"
1
"
PREF_TRACKING_PROTECTION_DISABLED
:
"
0
"
...
:
function
imageBlockingPolicyContextMatches
(
aElement
)
{
...
this
.
_findMediaElementHostFromControls
(
this
.
_target
...
UpdateMediaPlaybackRelatedObserver
:
function
(
active
...
ShouldNotifyMediaPlaybackChange
:
function
(
activeState
...
this
.
_monitorReportSiteIssueEnabledPref
(
)
;
break
