...
databinding
.
AmoCollectionOverrideDialogBinding
import
org
.
mozilla
...
-
>
localNetworkPermissionRequestAttempted
=
true
...
string
.
pref_key_learn_about_marketing_telemetry
)
getString
(
R
...
id
.
action_settingsFragment_to_settingsSearchFragment
)
}
)
}
...
val
openLinksInAppsSettingsPreference
=
requirePreference
<
Preference
...
SettingsFragmentDirections
.
actionSettingsFragmentToHomeSettingsFragment
(
)
}
resources
...
SettingsFragmentDirections
.
actionSettingsFragmentToEmailMasksSettingsFragment
(
)
}
resources
...
(
"
global_settings_from_preferences
"
)
)
SettingsFragmentDirections
.
actionSettingsFragmentToTranslationsSettingsFragment
(
)
}
resources
...
SettingsFragmentDirections
.
actionSettingsFragmentToPageSummariesSettingsFragment
(
)
}
resources
...
SettingsFragmentDirections
.
actionSettingsFragmentToAiControlsFragment
(
)
}
/
...
SettingsFragmentDirections
.
actionSettingsFragmentToHttpsOnlyFragment
(
)
}
resources
...
string
.
pref_key_ip_protection_settings
)
-
>
{
...
SettingsFragmentDirections
.
actionSettingsFragmentToDohSettingsFragment
(
)
}
resources
...
layout
.
amo_collection_override_dialog
null
)
val
binding
...
SettingsFragmentDirections
.
actionSettingsFragmentToLinkSharingFragment
(
)
}
resources
...
SettingsFragmentDirections
.
actionSettingsFragmentToOpenLinksInAppsFragment
(
)
}
resources
...
SettingsFragmentDirections
.
actionSettingsFragmentToOpenDownloadsSettingsFragment
(
)
}
resources
...
SettingsFragmentDirections
.
actionSettingsFragmentToSyncDebugFragment
(
)
}
/
...
SettingsFragmentDirections
.
actionSettingsFragmentToSecretSettingsFragment
(
)
}
/
...
SettingsFragmentDirections
.
actionSettingsFragmentToNimbusExperimentsFragment
(
)
}
/
...
SettingsFragmentDirections
.
actionSettingsFragmentToStopProfilerDialog
(
)
}
else
...
SettingsFragmentDirections
.
actionSettingsFragmentToStartProfilerDialog
(
)
}
}
...
setupDnsOverHttpsPreference
(
settings
)
setupEmailMaskPreference
(
settings
requireComponents
)
...
string
.
local_network_access_allowed_summary
)
}
else
{
...
string
.
local_network_access_not_allowed_summary
)
}
}
}
...
setupSearchPreference
(
selectedOrDefaultSearchEngineName
:
String
?
)
