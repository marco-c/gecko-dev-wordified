...
CollectionInteractor
.
onCollectionOpenTabClicked
]
*
/
fun
handleCollectionOpenTabClicked
(
tab
:
ComponentTab
...
/
fun
handleCollectionOpenTabsTapped
(
collection
:
TabCollection
...
/
fun
handleCollectionShareTabsClicked
(
collection
:
TabCollection
...
/
fun
handlePrivateBrowsingLearnMoreClicked
(
)
/
*
...
/
fun
handleReadPrivacyNoticeClicked
(
)
/
*
...
ExperimentCardInteractor
.
onCloseExperimentCardClicked
]
*
/
fun
handleCloseExperimentCard
(
)
/
*
...
HomeFragmentDirections
.
actionGlobalHomeOnboardingDialog
(
)
)
}
