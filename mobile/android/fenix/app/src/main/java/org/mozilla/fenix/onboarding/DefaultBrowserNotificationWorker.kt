...
putExtra
(
INTENT_DEFAULT_BROWSER_NOTIFICATION
true
)
val
pendingIntent
...
string
.
notification_default_browser_title
appName
)
getString
(
...
string
.
notification_default_browser_text
appName
)
pendingIntent
)
...
false
fun
setDefaultBrowserNotificationIfNeeded
(
context
:
Context
