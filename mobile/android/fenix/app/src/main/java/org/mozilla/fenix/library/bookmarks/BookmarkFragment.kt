...
menu
.
bookmarks_select_multi_not_item
menu
)
}
else
...
id
.
open_bookmarks_in_new_tabs_multi_select
-
>
{
openItemsInNewTab
...
id
.
open_bookmarks_in_private_tabs_multi_select
-
>
{
openItemsInNewTab
...
updatePendingBookmarksToDelete
(
selected
)
pendingBookmarkDeletionJob
...
>
{
getRemoveBookmarksSnackBarMessage
(
selected
containsFolders
=
