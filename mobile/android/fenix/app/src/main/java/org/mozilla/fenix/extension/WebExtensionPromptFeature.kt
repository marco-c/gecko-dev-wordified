...
>
{
handleInstallationStartedRequest
(
promptRequest
)
...
guardPromptActionWithDownloadDialogDelay
{
handleBeforeInstallationRequest
(
promptRequest
)
consumePromptRequest
...
findPreviousDownloadAddonDialogFragment
(
)
?
.
...
if
(
hasExistingDownloadAddonDialogFragment
(
)
)
{
...
:
:
handleDownloadAddonDialogCancelled
dialog
.
show
(
...
private
fun
hasExistingAddonPostInstallationDialogFragment
(
)
:
Boolean
...
layout
.
addon_installation_failed_dialog
null
)
val
messageView
