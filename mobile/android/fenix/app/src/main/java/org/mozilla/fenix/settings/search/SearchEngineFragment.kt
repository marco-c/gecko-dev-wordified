...
state
.
selectedOrDefaultPrivateSearchEngine
import
mozilla
.
components
...
string
.
pref_key_search_optimization_cards
)
.
apply
{
...
string
.
pref_key_google_lens_integration_user_enabled
)
)
val
...
settings
.
shouldShowSearchOptimizationCards
}
searchWidgetPreference
.
...
string
.
preferences_category_select_private_search_engine
)
"
{
normalEngine
...
string
.
preferences_google_lens_availability_caption
)
preference
.
isChecked
