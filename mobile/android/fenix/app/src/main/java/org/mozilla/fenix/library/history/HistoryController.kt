...
/
fun
handleDeleteTimeRangeConfirmed
(
timeFrame
:
RemoveTimeFrame
...
syncedhistory
.
SyncedHistoryFragment
]
*
/
fun
handleEnterSyncedHistory
(
)
}
Suppress
...
.
actionGlobalHistoryMetadataGroup
(
title
=
item
...
HistoryFragmentDirections
.
actionGlobalHistorySearchDialog
(
)
}
navController
...
HistoryFragmentDirections
.
actionHistoryFragmentToSyncedHistoryFragment
(
)
)
}
