...
=
true
isTranslationsFeatureSupported
=
false
)
override
...
.
isTabStripEnabled
updateToolbarCategoryBasedOnTabStrip
(
tabletAndTabStripEnabled
)
...
(
isSwipeToolbarToSwitchTabsVisible
=
!
tabletAndTabStripEnabled
isSummarizationEnabled
...
val
isAnyShortcutSelectedForSimpleToolbar
=
settings
.
...
=
ToolbarSimpleNoShortcutPreference
(
requireContext
(
)
...
string
.
pref_key_toolbar_simple_no_shortcut
)
layoutResource
=
R
...
string
.
pref_key_toolbar_tab_strip_no_shortcut
)
layoutResource
=
R
...
string
.
pref_key_customization_category_toolbar_layout
)
as
PreferenceCategory
)
...
drawable
.
ic_toolbar_bottom_expanded
R
.
drawable
.
ic_toolbar_bottom_simple
)
}
else
{
...
drawable
.
ic_toolbar_top_expanded
R
.
drawable
.
ic_toolbar_top_simple
)
}
}
}
