...
const
val
showLoginsSecureWarningMaxCount
=
1
const
val
...
const
val
MIN_DAYS_SINCE_FEEDBACK_PROMPT
=
120
private
fun
...
fun
incrementSearchWidgetCFRDismissed
(
)
{
preferences
...
fun
incrementNumTimesFeedbackPromptShown
(
)
{
preferences
...
fun
incrementNumTimesOpenedAfterInstall
(
)
{
preferences
...
fun
incrementTimeWhenPromptWasLastShown
(
)
{
preferences
...
val
showPrivateModeContextualFeatureRecommender
:
Boolean
get
(
