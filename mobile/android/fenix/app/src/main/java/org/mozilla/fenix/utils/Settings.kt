...
string
.
remote_settings_server_prod_v2
)
-
>
{
...
string
.
preferences_remote_settings_server_prod_label_v2
)
}
appContext
.
...
string
.
remote_settings_server_stage_v2
)
-
>
{
...
string
.
preferences_remote_settings_server_stage_label_v2
)
}
appContext
.
...
string
.
preferences_remote_settings_server_dev_label_v2
)
}
else
-
...
1
val
shouldEnableCookieBannerDetectOnly
:
Boolean
get
(
...
CookieBannersSection
.
FEATURE_SETTING_DETECT_ONLY
]
=
=
1
val
shouldEnableCookieBannerGlobalRules
:
Boolean
get
(
...
private
val
userNeedsToVisitInstallableSites
:
Boolean
get
(
...
string
.
pref_key_enable_homepage_sports_widget
)
default
=
{
...
/
val
sportsWidgetFetchThrottleSeconds
:
Int
get
(
...
string
.
pref_key_use_mock_world_cup_server
)
default
=
false
...
string
.
pref_key_mock_world_cup_server_session
)
default
=
"
...
string
.
pref_key_show_homepage_sports_widget
)
default
=
true
...
string
.
pref_key_show_homepage_countdown_widget
)
default
=
true
...
string
.
pref_key_sports_selected_countries
)
default
=
setOf
...
string
.
pref_key_sports_has_skipped_follow_team
)
default
=
false
