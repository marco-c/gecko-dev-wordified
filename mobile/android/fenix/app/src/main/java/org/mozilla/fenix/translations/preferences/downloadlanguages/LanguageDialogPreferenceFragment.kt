...
/
class
LanguageDialogPreferenceFragment
:
DialogFragment
(
)
...
{
setPrefDeleteLanguageFileDialog
(
view
)
}
...
{
DownloadLanguageFileDialogType
.
AllLanguages
}
else
...
.
ignoreTranslationsDataSaverWarning
=
checkBoxEnabled
findNavController
(
