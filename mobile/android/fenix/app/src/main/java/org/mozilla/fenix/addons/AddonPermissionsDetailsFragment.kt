...
/
class
AddonPermissionsDetailsFragment
:
Fragment
(
)
...
navArgs
<
AddonPermissionsDetailsFragmentArgs
>
(
)
Suppress
...
addon
.
translateOptionalDataCollectionPermissions
(
requireContext
(
)
...
addon
.
translateRequiredDataCollectionPermissions
(
requireContext
(
)
