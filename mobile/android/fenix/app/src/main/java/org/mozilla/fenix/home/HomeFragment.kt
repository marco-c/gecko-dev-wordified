...
color
.
fx_mobile_layer_color_gradient_end
)
getColor
(
requireContext
...
color
.
fx_mobile_layer_color_gradient_start
)
)
popupVerticalOffset
=
ENCOURAGE_SEARCH_CFR_VERTICAL_OFFSET
.
dp
dismissButtonColor
=
...
drawable
.
home_bottom_bar_background_no_divider
false
0
.
0f
...
drawable
.
private_home_background_gradient
)
}
hideToolbar
(
...
evaluateMessagesForMicrosurvey
(
components
)
...
val
currentAddWidgetSuccessCallback
=
WidgetPinnedReceiver
.
getPendingIntent
