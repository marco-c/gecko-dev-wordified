...
!
fun
updateSelectedEngineIfNecessary
(
newState
:
AwesomeBarState
...
fun
updateEnginePickerVisibilityIfNecessary
(
newState
:
AwesomeBarState
...
if
(
shouldUpdateShortcutEnginePickerVisibility
(
newState
)
)
