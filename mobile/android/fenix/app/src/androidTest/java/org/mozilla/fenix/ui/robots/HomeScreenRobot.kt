...
automaticThemeToggle
(
isAutomaticThemeChecked
)
)
assertAppItemsWithResourceIdAndDescription
(
...
assertAppItemsContainingText
(
toolbarPlacementHeader
toolbarPlacementDescription
)
assertAppItemsStateWithResourceId
(
toolbarPlacementBottomRadioButton
(
isBottomChecked
)
toolbarPlacementTopRadioButton
(
isTopChecked
)
)
...
string
.
onboarding_tracking_protection_header
)
)
assertAppItemsContainingText
(
...
assertAppItemsStateWithResourceId
(
standardTrackingProtectionToggle
(
isStandardChecked
)
strictTrackingProtectionToggle
(
isStrictChecked
)
)
...
assertAppItemsWithResourceIdAndText
(
tabCounter
(
numberOfOpenTabs
...
=
assertSponsoredTopSitesNotDisplayed
(
)
fun
...
=
assertSponsoredTopSiteIsDisplayed
(
sponsoredShortcutTitle
position
)
...
=
assertJumpBackInSectionIsDisplayed
(
)
fun
...
=
assertRecentlyVisitedSectionIsDisplayed
(
)
fun
...
=
assertRecentlyVisitedSectionIsNotDisplayed
(
)
fun
...
=
assertRecentBookmarksSectionIsDisplayed
(
)
fun
...
=
assertPocketSectionIsDisplayed
(
)
fun
...
=
assertPocketSectionIsNotDisplayed
(
)
fun
...
Transition
{
sponsoredShortcutsSettingsButton
.
waitForExists
(
waitingTime
...
{
assertSponsoredShortcutTitle
(
sponsoredShortcutTitle
position
)
assertSponsoredSubtitleIsDisplayed
(
position
)
}
...
string
.
onboarding_toolbar_placement_description
)
)
private
fun
