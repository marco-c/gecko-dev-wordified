...
=
assertHTTPSOnlyModeButton
(
)
fun
verifyHTTPSOnlyModeSummary
(
HTTPSOnlyModeSummary
:
String
)
=
...
=
assertLoginsAndPasswordsButton
(
)
fun
...
=
assertEnhancedTrackingProtectionState
(
option
)
fun
...
fun
verifyDeleteBrowsingDataOnQuitState
(
state
:
String
...
=
assertOpenLinksInAppsButton
(
)
fun
verifyOpenLinksInAppsState
(
state
:
String
...
fun
deleteBrowsingDataOnQuitButton
(
)
=
mDevice
