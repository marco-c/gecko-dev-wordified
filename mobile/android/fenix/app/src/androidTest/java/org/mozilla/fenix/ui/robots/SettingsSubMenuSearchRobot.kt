...
fun
verifyDefaultSearchEngineSummary
(
engineName
:
String
...
fun
verifyShowSearchSuggestionsEnabled
(
enabled
:
Boolean
...
fun
verifyShowSearchSuggestionsInPrivateEnabled
(
enabled
:
Boolean
...
fun
verifyShowClipboardSuggestionsEnabled
(
enabled
:
Boolean
...
fun
verifySearchBrowsingHistoryEnabled
(
enabled
:
Boolean
...
verifyDefaultSearchEngineSelected
(
searchEngineName
)
break
...
fun
verifySaveSearchEngineButtonEnabled
(
enabled
:
Boolean
...
fun
typeSearchEngineSuggestionString
(
...
visible
fun
openCustomShortcutOverflowMenu
(
testRule
:
ComposeTestRule
...
fun
verifyErrorConnectingToSearchString
(
searchEngineName
:
String
...
fun
verifyTheHomeScreenWidgetToggle
(
enabled
:
Boolean
...
id
.
custom_search_suggestions_learn_more
)
)
.
click
...
string
.
preferences_add_search_widget_from_settings
)
)
)
