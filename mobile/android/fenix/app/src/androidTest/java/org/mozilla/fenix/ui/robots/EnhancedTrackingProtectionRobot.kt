...
=
assertEnhancedTrackingProtectionNotice
(
)
fun
...
=
assertEnhancedTrackingProtectionShield
(
)
fun
...
=
assertEnhancedTrackingProtectionSheetStatus
(
status
state
)
...
=
assertEnhancedTrackingProtectionDetailsStatus
(
status
)
fun
...
=
assertBasicLevelTrackingContentBlocked
(
)
class
Transition
...
Transition
{
disableEnhancedTrackingProtection
(
)
.
click
...
interact
:
SettingsSubMenuEnhancedTrackingProtectionRobot
.
(
)
-
...
Transition
{
openEnhancedTrackingProtectionSettings
(
)
.
click
