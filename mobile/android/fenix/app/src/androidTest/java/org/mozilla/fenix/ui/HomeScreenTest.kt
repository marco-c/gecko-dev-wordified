...
Test
fun
dismissOnboardingUsingBookmarksTest
(
)
{
homeScreen
...
Test
fun
dismissOnboardingWithPageLoadTest
(
)
{
activityTestRule
...
Test
fun
toolbarTapDoesntDismissOnboardingTest
(
)
{
homeScreen
...
Test
fun
verifyPocketHomepageStoriesTest
(
)
{
activityTestRule
...
homeScreen
{
verifyStoriesByTopicItemState
(
activityTestRule
false
1
)
clickStoriesByTopicItem
(
activityTestRule
1
)
