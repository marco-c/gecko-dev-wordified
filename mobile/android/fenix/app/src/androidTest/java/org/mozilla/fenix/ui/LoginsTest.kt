...
Test
fun
saveLoginsAndPasswordsOptionsItemsTest
(
)
{
homeScreen
...
Test
fun
verifyLoginWithNoUserNameCanBeSavedTest
(
)
{
val
...
verifyAskToSaveRadioButton
(
true
)
verifyNeverSaveSaveRadioButton
(
false
)
}
