...
fun
verifyTheAddBookmarkMenuItemInACustomTabTest
(
)
{
val
...
fun
verifyTheDeleteBookmarkMenuItemInACustomTabTest
(
)
{
val
...
verifyTabHistorySheetIsDisplayed
(
true
)
verifyTabHistoryContainsWebsite
(
nextWebPage
.
url
...
Test
fun
verifyTheMoreMainMenuSummarizePageButtonTest
(
)
{
composeTestRule
...
Test
fun
verifyTheMoreMainMenuSummarizePageButtonFunctionalityTest
(
)
{
composeTestRule
