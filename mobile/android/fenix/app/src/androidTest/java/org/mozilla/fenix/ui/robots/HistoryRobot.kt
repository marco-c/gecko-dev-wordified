...
=
assertDeleteConfirmationMessage
(
)
fun
verifyHomeScreen
...
=
assertUndoDeleteSnackBarButton
(
)
fun
...
fun
verifyHistorySearchBarPosition
(
defaultPosition
:
Boolean
...
fun
verifySearchedHistoryItemExists
(
historyItemUrl
:
String
