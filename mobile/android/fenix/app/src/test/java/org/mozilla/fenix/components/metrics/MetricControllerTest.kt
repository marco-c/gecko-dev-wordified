...
Companion
.
SHARE_LINK_CONTEXT_MENU_ITEM_ID
import
org
.
mozilla
...
TrackingProtection
.
privacyReportTrackingCookiesTapped
.
testGetValue
(
)
...
TrackingProtection
.
privacyReportFingerprintsTapped
.
testGetValue
(
)
...
TrackingProtection
.
privacyReportTrackingContentTapped
.
testGetValue
(
)
...
Items
.
AUTOFILL_CREDIT_CARD_FORM_DETECTED
to
CreditCards
.
formDetected
...
Items
.
AUTOFILL_CREDIT_CARD_PROMPT_SHOWN
to
CreditCards
.
autofillPromptShown
...
Items
.
AUTOFILL_CREDIT_CARD_PROMPT_DISMISSED
to
CreditCards
.
...
Awesomebar
.
trendingSearchSuggestionClicked
.
testGetValue
(
)
...
Awesomebar
.
trendingSearchSuggestionsDisplayed
.
testGetValue
(
)
...
Awesomebar
.
recentSearchSuggestionsDisplayed
.
testGetValue
(
)
...
Awesomebar
.
optimizedSuggestionCardDisplayed
.
testGetValue
(
)
...
Awesomebar
.
optimizedSuggestionCardClicked
.
testGetValue
(
)
