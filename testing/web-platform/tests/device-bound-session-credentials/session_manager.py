...
self
.
session_to_early_challenge_map
=
{
}
...
(
"
earlyChallengeForNextRegisteredSession
"
)
...
def
get_sessions_instructions_response_credentials
(
self
session_id
request
