...
/
var
integerSenderConnectionBinding
=
new
Binding
(
...
;
var
kStructHeaderNumBytesOffset
=
0
;
var
kStructHeaderVersionOffset
=
4
;
var
...
prototype
.
decodeAssociatedEndpointHandle
=
function
(
)
...
prototype
.
serializeAssociatedEndpointHandles
=
function
(
...
prototype
.
deserializeAssociatedEndpointHandles
=
function
(
associatedGroupController
...
messageValidator
.
validateMessageIsRequestExpectingResponse
(
)
;
if
...
delegate
.
onPeerAssociatedEndpointClosed
(
event
.
id
...
this
.
constructPeerEndpointClosedMessage
(
interfaceId
reason
)
...
:
'
VALIDATION_ERROR_INVALID_UNION_SIZE
'
...
prototype
.
validateAssociatedEndpointHandle
=
function
(
offset
...
prototype
.
validateAssociatedInterfaceRequest
=
function
(
offset
...
this
.
validateInterfaceRequestElements
(
elementsOffset
numElements
nullable
...
this
.
validateAssociatedInterfaceElements
(
elementsOffset
numElements
nullable
...
this
.
validateAssociatedInterfaceRequestElements
(
elementsOffset
numElements
nullable
