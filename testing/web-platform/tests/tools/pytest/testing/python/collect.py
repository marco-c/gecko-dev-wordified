...
def
test_generative_methods_with_explicit_names
(
self
testdir
)
...
def
test_generative_order_of_execution
(
)
:
...
def
test_order_of_execution_generator_different_codeline
(
self
testdir
)
...
def
test_generative_tests_different_codeline
(
)
:
...
def
test_setupstate_is_preserved_134
(
self
testdir
)
