...
def
test_find_all_test_files_in_dir
(
mock_source_file_class
mock_listdir
)
:
...
def
test_map_tests_to_web_features_recursive
(
...
def
fake_find_all_test_files_in_dir
(
root
rel_path
url_root
...
5
def
test_parser_with_path_provided_abs_path
(
)
:
...
"
def
populate_test_web_features_map
(
web_features_map
)
:
...
def
fake_map_tests_to_web_features
(
