...
(
"
0b0a205a648fcf82d85f128b67bbe08053e6
"
)
...
(
"
e1a3c80c797ea401c08fc9c342a2d90d
"
)
...
def
test_pull_long_header_dcid_too_long
(
self
)
:
...
def
test_pull_long_header_scid_too_long
(
self
)
:
...
def
test_pull_long_header_no_fixed_bit
(
self
)
:
...
def
test_pull_long_header_too_short
(
self
)
:
...
def
test_pull_short_header_no_fixed_bit
(
self
)
:
...
def
test_encode_quic_version_negotiation
(
self
)
:
...
def
test_params_disable_active_migration
(
self
)
:
...
def
test_params_disable_active_migration_legacy
(
self
)
:
...
def
test_params_preferred_address_legacy
(
self
)
:
...
def
test_preferred_address_ipv4_only
(
self
)
:
...
def
test_preferred_address_ipv6_only
(
self
)
:
...
def
test_ack_frame_with_one_range_2
(
self
)
:
...
def
test_ack_frame_with_one_range_3
(
self
)
:
...
def
test_ack_frame_with_two_ranges
(
self
)
:
