...
def
test_members_is_ordereddict_if_ordered
(
self
)
:
...
def
test_members_is_always_ordered
(
self
)
:
...
def
test_iteration_order_with_unorderable_values
(
self
)
:
...
def
test_programatic_function_iterable_with_weird_names
(
self
)
:
...
def
test_programatic_function_unicode
(
self
)
:
...
def
test_programatic_function_unicode_list
(
self
)
:
...
def
test_programatic_function_from_unicode_dict
(
self
)
:
...
def
test_programatic_function_unicode_type
(
self
)
:
...
def
test_programatic_function_unicode_type_from_subclass
(
self
)
:
...
def
test_programmatic_function_unicode_class
(
self
)
:
...
def
test_empty_with_functional_api
(
self
)
:
