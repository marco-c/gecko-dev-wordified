...
exceptions
class
TestReceivingInformationalResponses
(
object
)
:
...
def
test_single_informational_response
(
self
frame_factory
end_stream
...
def
test_receiving_multiple_header_blocks
(
self
frame_factory
end_stream
...
def
test_receiving_multiple_informational_responses
(
self
...
def
test_receive_provisional_response_with_end_stream
(
self
...
class
TestSendingInformationalResponses
(
object
)
:
