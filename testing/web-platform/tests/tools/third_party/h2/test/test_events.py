...
def
test_only_reports_changed_settings
(
self
...
def
test_correctly_reports_changed_settings
(
self
...
def
test_informationalresponsereceived_repr
(
self
)
:
...
def
test_pushedstreamreceived_repr
(
self
)
:
...
def
test_alternativeserviceavailable_repr
(
self
)
:
...
def
test_all_events_subclass_from_event
(
event
)
:
