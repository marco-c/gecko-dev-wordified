...
def
test_sending_data_in_memoryview
(
self
)
:
...
def
test_close_connection_with_error_code
(
self
frame_factory
error_code
...
def
test_close_connection_with_last_stream_id
(
self
frame_factory
...
def
test_close_connection_with_additional_data
(
self
frame_factory
...
def
test_reset_stream_with_error_code
(
self
frame_factory
error_code
...
def
test_cannot_reset_nonexistent_stream
(
self
frame_factory
)
...
def
test_unknown_frames_are_ignored
(
self
frame_factory
frame_id
...
def
test_receiving_multiple_goaway_frames
(
self
frame_factory
)
...
def
test_receiving_goaway_frame_with_additional_data
(
self
frame_factory
)
...
def
test_receiving_goaway_frame_with_unknown_error
(
self
frame_factory
)
