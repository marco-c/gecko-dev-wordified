...
def
test_transfer_encoding_trailers_is_valid
(
self
frame_factory
)
...
class
TestSendingInvalidFrameSequences
(
object
)
:
...
forbidden_request_headers_unicode
=
(
u
'
...
def
test_response_header_without_status
(
self
hdr_validation_flags
)
...
def
test_outbound_req_header_missing_pseudo_headers
(
self
