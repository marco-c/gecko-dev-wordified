...
def
test_no_validator_no_converter
(
self
)
:
...
def
test_validate_respects_run_validators_config
(
self
)
:
...
def
test_frozen_on_setattr_class_is_caught
(
self
)
:
...
def
test_frozen_on_setattr_attribute_is_caught
(
self
)
:
...
def
test_slotted_class_can_have_custom_setattr
(
self
)
:
