...
base
of
DragSourceChildContext
and
DragTargetChildContext
export
class
DragChildContextBase
{
/
/
The
...
from
EventUtils
nodeIsFlattenedTreeDescendantOf
(
aPossibleDescendant
aPossibleAncestor
)
...
from
EventUtils
getInclusiveFlattenedTreeParentElement
(
aNode
)
{
